...
meta3.setContent(std::string("CaliforniaCampuses.x3d"));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(std::string("description"));
meta4.setContent(std::string("Viewpoints and tour of California campuses"));
head1.addMeta(&meta4);

meta& meta5 =  meta();
meta5.setName(std::string("creator"));
meta5.setContent(std::string("Don Brutzman, Dale Tourtelotte, Mike Bailey, Don McGregor"));
head1.addMeta(&meta5);

meta& meta6 =  meta();
meta6.setName(std::string("created"));
meta6.setContent(std::string("4 March 2010"));
head1.addMeta(&meta6);

meta& meta7 =  meta();
meta7.setName(std::string("modified"));
meta7.setContent(std::string("20 October 2019"));
head1.addMeta(&meta7);

meta& meta8 =  meta();
meta8.setName(std::string("reference"));
meta8.setContent(std::string("CaliforniaCampuses.kml"));
head1.addMeta(&meta8);

meta& meta9 =  meta();
meta9.setName(std::string("reference"));
meta9.setContent(std::string("https://www.web3d.org/x3d-earth"));
head1.addMeta(&meta9);

meta& meta10 =  meta();
meta10.setName(std::string("reference"));
meta10.setContent(std::string("http://x3d-earth.nps.edu"));
head1.addMeta(&meta10);

meta& meta11 =  meta();
meta11.setName(std::string("reference"));
meta11.setContent(std::string("http://hamming.uc.nps.edu"));
head1.addMeta(&meta11);

meta& meta12 =  meta();
meta12.setName(std::string("subject"));
meta12.setContent(std::string("X3D Earth"));
head1.addMeta(&meta12);

meta& meta13 =  meta();
meta13.setName(std::string("identifier"));
meta13.setContent(std::string("https://www.web3d.org/x3d/content/examples/Basic/Geospatial/CaliforniaCampuses.x3d"));
head1.addMeta(&meta13);

meta& meta14 =  meta();
meta14.setName(std::string("reference"));
meta14.setContent(std::string("http://mmog.ern.nps.edu/California/California.x3d"));
head1.addMeta(&meta14);

meta& meta15 =  meta();
meta15.setName(std::string("warning"));
meta15.setContent(std::string("under development"));
head1.addMeta(&meta15);

meta& meta16 =  meta();
meta16.setName(std::string("warning"));
meta16.setContent(std::string("mmog.ern.nps.edu restricted to internal access within NPS firewall only"));
head1.addMeta(&meta16);

meta& meta17 =  meta();
meta17.setName(std::string("generator"));
meta17.setContent(std::string("KmlToX3dViewpoints.xslt"));
...
meta19.setContent(std::string("https://savage.nps.edu/Savage/license.html"));
...
WorldInfo21.setTitle(std::string("CaliforniaCampuses.x3d"));
Scene20.addChild(&WorldInfo21);

Switch& Switch22 =  Switch();
Switch22.setDEF(std::string("SwitchGlobes"));
...
Group& Group25 =  Group();
Group25.setDEF(std::string("PlacemarkGroup"));
GeoViewpoint& GeoViewpoint26 =  GeoViewpoint();
GeoViewpoint26.setDEF(std::string("View01"));
GeoViewpoint26.setDescription(std::string("Naval Postgraduate School"));
...
GeoViewpoint27.setDEF(std::string("View02"));
GeoViewpoint27.setDescription(std::string("University of California Davis"));
...
GeoViewpoint28.setDEF(std::string("View03"));
GeoViewpoint28.setDescription(std::string("University of California Berkeley"));
...
GeoViewpoint29.setDEF(std::string("View04"));
GeoViewpoint29.setDescription(std::string("University of California San Francisco"));
...
GeoViewpoint30.setDEF(std::string("View05"));
GeoViewpoint30.setDescription(std::string("University of California Santa Cruz"));
...
GeoViewpoint31.setDEF(std::string("View06"));
GeoViewpoint31.setDescription(std::string("University of California Merced"));
...
GeoViewpoint32.setDEF(std::string("View07"));
GeoViewpoint32.setDescription(std::string("University of California Santa Barbara"));
...
GeoViewpoint33.setDEF(std::string("View08"));
GeoViewpoint33.setDescription(std::string("University of California Los Angeles"));
...
GeoViewpoint34.setDEF(std::string("View09"));
GeoViewpoint34.setDescription(std::string("University of California Irvine"));
...
GeoViewpoint35.setDEF(std::string("View10"));
GeoViewpoint35.setDescription(std::string("University of California Riverside"));
...
GeoViewpoint36.setDEF(std::string("View11"));
GeoViewpoint36.setDescription(std::string("University of California San Diego"));
...
GeoViewpoint37.setDEF(std::string("View12"));
GeoViewpoint37.setDescription(std::string("Humboldt State University"));
...
GeoViewpoint38.setDEF(std::string("View13"));
GeoViewpoint38.setDescription(std::string("California State University, Chico"));
...
GeoViewpoint39.setDEF(std::string("View14"));
GeoViewpoint39.setDescription(std::string("California State University Sacramento"));
...
GeoViewpoint40.setDEF(std::string("View15"));
GeoViewpoint40.setDescription(std::string("Sonoma State University"));
...
GeoViewpoint41.setDEF(std::string("View16"));
GeoViewpoint41.setDescription(std::string("California Maritime Academy"));
...
GeoViewpoint42.setDEF(std::string("View17"));
GeoViewpoint42.setDescription(std::string("San Francisco State University"));
...
GeoViewpoint43.setDEF(std::string("View18"));
GeoViewpoint43.setDescription(std::string("California State University, East Bay"));
...
GeoViewpoint44.setDEF(std::string("View19"));
GeoViewpoint44.setDescription(std::string("California State University Stanislaus"));
...
GeoViewpoint45.setDEF(std::string("View20"));
GeoViewpoint45.setDescription(std::string("San Jose State University"));
...
GeoViewpoint46.setDEF(std::string("View21"));
GeoViewpoint46.setDescription(std::string("California State University, Monterey Bay"));
...
GeoViewpoint47.setDEF(std::string("View22"));
GeoViewpoint47.setDescription(std::string("Fresno State University"));
...
GeoViewpoint48.setDEF(std::string("View23"));
GeoViewpoint48.setDescription(std::string("California State University, Bakersfield"));
...
GeoViewpoint49.setDEF(std::string("View24"));
GeoViewpoint49.setDescription(std::string("California Polytechnic State University"));
...
GeoViewpoint50.setDEF(std::string("View25"));
GeoViewpoint50.setDescription(std::string("California State University, Channel Islands"));
...
GeoViewpoint51.setDEF(std::string("View26"));
GeoViewpoint51.setDescription(std::string("California State University, Northridge"));
...
GeoViewpoint52.setDEF(std::string("View27"));
GeoViewpoint52.setDescription(std::string("California State University, Los Angeles"));
...
GeoViewpoint53.setDEF(std::string("View28"));
GeoViewpoint53.setDescription(std::string("California State Polytechnic University, Pomona"));
...
GeoViewpoint54.setDEF(std::string("View29"));
GeoViewpoint54.setDescription(std::string("California State University, San Bernardino"));
...
GeoViewpoint55.setDEF(std::string("View30"));
GeoViewpoint55.setDescription(std::string("California State University, Fullerton"));
...
GeoViewpoint56.setDEF(std::string("View31"));
GeoViewpoint56.setDescription(std::string("California State University Dominguez Hills"));
...
GeoViewpoint57.setDEF(std::string("View32"));
GeoViewpoint57.setDescription(std::string("California State University, Long Beach"));
...
GeoViewpoint58.setDEF(std::string("View33"));
GeoViewpoint58.setDescription(std::string("California State University, San Marcos"));
...
GeoViewpoint59.setDEF(std::string("View34"));
GeoViewpoint59.setDescription(std::string("San Diego State University"));
...
GeoViewpoint60.setDEF(std::string("View35"));
GeoViewpoint60.setDescription(std::string("CENIC"));
...
field62.setAppinfo(std::string("whether CrossHair prototype is enabled or not"));
field62.setType(std::string("SFBool"));
ExternProtoDeclare61.addChild(&field62);

field& field63 =  field();
field63.setName(std::string("set_enabled"));
field63.setAccessType(std::string("inputOnly"));
field63.setAppinfo(std::string("control whether enabled/disabled"));
field63.setType(std::string("SFBool"));
ExternProtoDeclare61.addChild(&field63);

field& field64 =  field();
field64.setName(std::string("markerColor"));
field64.setAccessType(std::string("inputOutput"));
field64.setAppinfo(std::string("color of CrossHair marker"));
field64.setType(std::string("SFColor"));
ExternProtoDeclare61.addChild(&field64);

field& field65 =  field();
field65.setName(std::string("scale"));
field65.setAccessType(std::string("inputOutput"));
field65.setAppinfo(std::string("size of CrossHair in meters"));
field65.setType(std::string("SFVec3f"));
ExternProtoDeclare61.addChild(&field65);

field& field66 =  field();
field66.setName(std::string("positionOffsetFromCamera"));
field66.setAccessType(std::string("inputOutput"));
field66.setAppinfo(std::string("distance in front of HUD viewpoint"));
...
ProtoInstance67.setName(std::string("CrossHair"));
ProtoInstance67.setDEF(std::string("CrossHairInstance"));
fieldValue& fieldValue68 =  fieldValue();
fieldValue68.setName(std::string("enabled"));
fieldValue68.setValue(std::string("true"));
ProtoInstance67.addChild(&fieldValue68);

fieldValue& fieldValue69 =  fieldValue();
fieldValue69.setName(std::string("markerColor"));
fieldValue69.setValue(std::string("0.1 0.8 0.1"));
ProtoInstance67.addChild(&fieldValue69);

fieldValue& fieldValue70 =  fieldValue();
fieldValue70.setName(std::string("scale"));
fieldValue70.setValue(std::string("0.5 0.5 0.5"));
ProtoInstance67.addChild(&fieldValue70);

fieldValue& fieldValue71 =  fieldValue();
fieldValue71.setName(std::string("positionOffsetFromCamera"));
fieldValue71.setValue(std::string("0 0 -5"));
...
field73.setAppinfo(std::string("X3D content positioned at HUD offset"));
field73.setType(std::string("MFNode"));
ExternProtoDeclare72.addChild(&field73);

field& field74 =  field();
field74.setName(std::string("screenOffset"));
field74.setAccessType(std::string("inputOutput"));
field74.setAppinfo(std::string("offset position for HUD relative to current view location, default 0 0 -5"));
field74.setType(std::string("SFVec3f"));
ExternProtoDeclare72.addChild(&field74);

field& field75 =  field();
field75.setName(std::string("position_changed"));
field75.setAccessType(std::string("outputOnly"));
field75.setAppinfo(std::string("HUD position update (in world coordinates) relative to original location"));
field75.setType(std::string("SFVec3f"));
ExternProtoDeclare72.addChild(&field75);

field& field76 =  field();
field76.setName(std::string("orientation_changed"));
field76.setAccessType(std::string("outputOnly"));
field76.setAppinfo(std::string("HUD orientation update relative to original location"));
field76.setType(std::string("SFRotation"));
...
field78.setAppinfo(std::string("Viewpoint USE nodes that are sequentially bound"));
field78.setType(std::string("MFNode"));
ExternProtoDeclare77.addChild(&field78);

field& field79 =  field();
field79.setName(std::string("interval"));
field79.setAccessType(std::string("inputOutput"));
field79.setAppinfo(std::string("number of seconds between viewpoint shifts"));
field79.setType(std::string("SFTime"));
ExternProtoDeclare77.addChild(&field79);

field& field80 =  field();
field80.setName(std::string("enabled"));
field80.setAccessType(std::string("inputOutput"));
field80.setAppinfo(std::string("whether ViewpointSequencer is enabled or not"));
field80.setType(std::string("SFBool"));
ExternProtoDeclare77.addChild(&field80);

field& field81 =  field();
field81.setName(std::string("set_enabled"));
field81.setAccessType(std::string("inputOnly"));
field81.setAppinfo(std::string("whether ViewpointSequencer is enabled or not"));
field81.setType(std::string("SFBool"));
ExternProtoDeclare77.addChild(&field81);

field& field82 =  field();
field82.setName(std::string("previous"));
field82.setAccessType(std::string("inputOnly"));
field82.setAppinfo(std::string("bind previous Viewpoint in list"));
field82.setType(std::string("SFBool"));
ExternProtoDeclare77.addChild(&field82);

field& field83 =  field();
field83.setName(std::string("next"));
field83.setAccessType(std::string("inputOnly"));
field83.setAppinfo(std::string("bind next Viewpoint in list"));
field83.setType(std::string("SFBool"));
ExternProtoDeclare77.addChild(&field83);

field& field84 =  field();
field84.setName(std::string("toggleMessage"));
field84.setAccessType(std::string("inputOutput"));
field84.setAppinfo(std::string("Select message to toggle ViewpointSequencer"));
field84.setType(std::string("MFString"));
ExternProtoDeclare77.addChild(&field84);

field& field85 =  field();
field85.setName(std::string("toggleMessageFontSize"));
field85.setAccessType(std::string("initializeOnly"));
field85.setAppinfo(std::string("Color for toggleMessage text"));
field85.setType(std::string("SFFloat"));
ExternProtoDeclare77.addChild(&field85);

field& field86 =  field();
field86.setName(std::string("toggleMessageColor"));
field86.setAccessType(std::string("inputOutput"));
field86.setAppinfo(std::string("Color for toggleMessage text"));
field86.setType(std::string("SFColor"));
ExternProtoDeclare77.addChild(&field86);

field& field87 =  field();
field87.setName(std::string("traceEnabled"));
field87.setAccessType(std::string("inputOutput"));
field87.setAppinfo(std::string("enable console output"));
field87.setType(std::string("SFBool"));
ExternProtoDeclare77.addChild(&field87);

Scene20.addChild(&ExternProtoDeclare77);

ProtoInstance& ProtoInstance88 =  ProtoInstance();
ProtoInstance88.setName(std::string("ViewpointSequencer"));
ProtoInstance88.setDEF(std::string("ViewpointTour"));
fieldValue& fieldValue89 =  fieldValue();
fieldValue89.setName(std::string("interval"));
fieldValue89.setValue(std::string("30"));
ProtoInstance88.addChild(&fieldValue89);

fieldValue& fieldValue90 =  fieldValue();
fieldValue90.setName(std::string("enabled"));
fieldValue90.setValue(std::string("true"));
ProtoInstance88.addChild(&fieldValue90);

fieldValue& fieldValue91 =  fieldValue();
fieldValue91.setName(std::string("toggleMessage"));
fieldValue91.setValue(std::string("\"ViewpointSequencer tour\""));
...
Viewpoint128.setDescription(std::string("View four (-X axis)"));
...
TouchSensor136.setDEF(std::string("TourTouch"));
TouchSensor136.setDescription(std::string("Touch text to turn tour on/off"));
GeoLocation129.addChildren(&TouchSensor136);

BooleanToggle& BooleanToggle137 =  BooleanToggle();
BooleanToggle137.setDEF(std::string("TourToggle"));
GeoLocation129.addChildren(BooleanToggle137);

ROUTE& ROUTE138 =  ROUTE();
ROUTE138.setFromField(std::string("isActive"));
...
field141.setAppinfo(std::string("Whether or not ViewPositionOrientation sends output to console"));
field141.setType(std::string("SFBool"));
ExternProtoDeclare140.addChild(&field141);

field& field142 =  field();
field142.setName(std::string("traceEnabled"));
field142.setAccessType(std::string("initializeOnly"));
field142.setAppinfo(std::string("Output internal trace messages for debugging this node, intended for developer use only"));
field142.setType(std::string("SFBool"));
ExternProtoDeclare140.addChild(&field142);

field& field143 =  field();
field143.setName(std::string("set_traceEnabled"));
field143.setAccessType(std::string("inputOnly"));
field143.setAppinfo(std::string("Ability to turn output tracing on/off at runtime"));
field143.setType(std::string("SFBool"));
ExternProtoDeclare140.addChild(&field143);

field& field144 =  field();
field144.setName(std::string("position_changed"));
field144.setAccessType(std::string("outputOnly"));
field144.setAppinfo(std::string("Output local position"));
field144.setType(std::string("SFVec3f"));
ExternProtoDeclare140.addChild(&field144);

field& field145 =  field();
field145.setName(std::string("orientation_changed"));
field145.setAccessType(std::string("outputOnly"));
field145.setAppinfo(std::string("Output local orientation"));
field145.setType(std::string("SFRotation"));
ExternProtoDeclare140.addChild(&field145);

field& field146 =  field();
field146.setName(std::string("outputViewpointString"));
field146.setAccessType(std::string("outputOnly"));
field146.setAppinfo(std::string("MFString value of new Viewpoint"));
...
ProtoInstance147.setName(std::string("ViewPositionOrientation"));
ProtoInstance147.setDEF(std::string("ExampleViewPositionOrientation"));
fieldValue& fieldValue148 =  fieldValue();
fieldValue148.setName(std::string("enabled"));
fieldValue148.setValue(std::string("false"));
