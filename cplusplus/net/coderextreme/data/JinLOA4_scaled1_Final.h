...
meta3.setContent(std::string("JinLOA4.x3d"));
head1.addMeta(&meta3);
...
meta8.setContent(std::string("27 January 2023"));
head1.addMeta(&meta8);

meta& meta9 =  meta();
meta9.setName(std::string("description"));
meta9.setContent(std::string("Articulated 3D game character designed with a general graphics tool"));
head1.addMeta(&meta9);

meta& meta10 =  meta();
meta10.setName(std::string("reference"));
meta10.setContent(std::string("KoreanCharacter00ReadMe.txt"));
head1.addMeta(&meta10);

meta& meta11 =  meta();
meta11.setName(std::string("reference"));
meta11.setContent(std::string("KoreanCharacterHumanMotion_Infotech2014_140706.pdf"));
head1.addMeta(&meta11);

meta& meta12 =  meta();
meta12.setName(std::string("reference"));
meta12.setContent(std::string("KoreanCharactersIllustrated.pdf"));
head1.addMeta(&meta12);

meta& meta13 =  meta();
meta13.setName(std::string("identifier"));
meta13.setContent(std::string("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinLOA4.x3d"));
head1.addMeta(&meta13);

meta& meta14 =  meta();
meta14.setName(std::string("generator"));
meta14.setContent(std::string("3DS MAX, http://www.autodesk.com/products/autodesk-3ds-max/overview"));
head1.addMeta(&meta14);

meta& meta15 =  meta();
meta15.setName(std::string("generator"));
meta15.setContent(std::string("Suwon HAnim Converter"));
head1.addMeta(&meta15);

meta& meta16 =  meta();
meta16.setName(std::string("generator"));
meta16.setContent(std::string("Gnu Image Manipulation Program, http://www.gimp.org"));
head1.addMeta(&meta16);

meta& meta17 =  meta();
meta17.setName(std::string("generator"));
meta17.setContent(std::string("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"));
...
WorldInfo20.setTitle(std::string("JinLOA4.x3d"));
...
Viewpoint22.setDescription(std::string("JinLOA4"));
Viewpoint22.setPosition(new float[]{0.0,1.0,3.0});
Scene19.addChild(&Viewpoint22);

HAnimHumanoid& HAnimHumanoid23 =  HAnimHumanoid();
HAnimHumanoid23.X3DNode::setName(std::string("JinLOA4"));
HAnimHumanoid23.setDEF(std::string("hanim_JinLOA4"));
...
MetadataFloat29.setValue(new float[]{1.5});
...
HAnimJoint40.setCenter(new float[]{0.0,0.707175,-0.015921});
...
HAnimSegment41.addChild(&Shape42);

HAnimJoint40.addChildren(&HAnimSegment41);

HAnimJoint& HAnimJoint49 =  HAnimJoint();
HAnimJoint49.X3DNode::setName(std::string("l_hip"));
HAnimJoint49.setDEF(std::string("hanim_l_hip"));
HAnimJoint49.setCenter(new float[]{0.094657496,0.8266501,-0.018348752});
HAnimSegment& HAnimSegment50 =  HAnimSegment();
HAnimSegment50.X3DNode::setName(std::string("l_thigh"));
...
HAnimSegment50.addChild(&Shape51);

HAnimJoint49.addChildren(&HAnimSegment50);

HAnimJoint& HAnimJoint58 =  HAnimJoint();
HAnimJoint58.X3DNode::setName(std::string("l_knee"));
HAnimJoint58.setDEF(std::string("hanim_l_knee"));
HAnimJoint58.setCenter(new float[]{0.09261001,0.408825,-0.01943775});
HAnimSegment& HAnimSegment59 =  HAnimSegment();
HAnimSegment59.X3DNode::setName(std::string("l_calf"));
...
HAnimJoint67.X3DNode::setName(std::string("l_talocrural"));
HAnimJoint67.setDEF(std::string("hanim_l_talocrural"));
HAnimJoint67.setCenter(new float[]{0.08883,0.09544501,-0.010451251});
HAnimSegment& HAnimSegment68 =  HAnimSegment();
HAnimSegment68.X3DNode::setName(std::string("l_talus"));
...
HAnimJoint76.X3DNode::setName(std::string("l_talocalcaneonavicular"));
HAnimJoint76.setDEF(std::string("hanim_l_talocalcaneonavicular"));
HAnimJoint76.setCenter(new float[]{0.07830001,0.036900003,0.0048645});
HAnimSegment& HAnimSegment77 =  HAnimSegment();
HAnimSegment77.X3DNode::setName(std::string("l_navicular"));
...
HAnimSegment77.addChild(&Shape78);

HAnimJoint76.addChildren(&HAnimSegment77);

HAnimJoint& HAnimJoint85 =  HAnimJoint();
HAnimJoint85.X3DNode::setName(std::string("l_cuneonavicular_1"));
HAnimJoint85.setDEF(std::string("hanim_l_cuneonavicular_1"));
HAnimJoint85.setCenter(new float[]{0.067365,0.032107502,0.018391501});
HAnimSegment& HAnimSegment86 =  HAnimSegment();
HAnimSegment86.X3DNode::setName(std::string("l_cuneiform_1"));
...
HAnimSegment86.addChild(&Shape87);

HAnimJoint85.addChildren(&HAnimSegment86);

HAnimJoint& HAnimJoint94 =  HAnimJoint();
HAnimJoint94.X3DNode::setName(std::string("l_tarsometatarsal_1"));
HAnimJoint94.setDEF(std::string("hanim_l_tarsometatarsal_1"));
HAnimJoint94.setCenter(new float[]{0.06462,0.023242502,0.04419});
HAnimSegment& HAnimSegment95 =  HAnimSegment();
HAnimSegment95.X3DNode::setName(std::string("l_metatarsal_1"));
...
HAnimSegment95.addChild(&Shape96);

HAnimJoint94.addChildren(&HAnimSegment95);

HAnimJoint& HAnimJoint103 =  HAnimJoint();
HAnimJoint103.X3DNode::setName(std::string("l_metatarsophalangeal_1"));
HAnimJoint103.setDEF(std::string("hanim_l_metatarsophalangeal_1"));
HAnimJoint103.setCenter(new float[]{0.0621225,0.014424751,0.0936225});
HAnimSegment& HAnimSegment104 =  HAnimSegment();
HAnimSegment104.X3DNode::setName(std::string("l_tarsal_proximal_phalanx_1"));
...
HAnimSegment104.addChild(&Shape105);

HAnimJoint103.addChildren(&HAnimSegment104);

HAnimJoint& HAnimJoint112 =  HAnimJoint();
HAnimJoint112.X3DNode::setName(std::string("l_tarsal_distal_interphalangeal_1"));
HAnimJoint112.setDEF(std::string("hanim_l_tarsal_distal_interphalangeal_1"));
HAnimJoint112.setCenter(new float[]{0.0621225,0.0121365,0.1153125});
HAnimSegment& HAnimSegment113 =  HAnimSegment();
HAnimSegment113.X3DNode::setName(std::string("l_tarsal_distal_phalanx_1"));
...
HAnimSegment113.addChild(&Shape114);
...
HAnimJoint121.X3DNode::setName(std::string("l_cuneonavicular_2"));
HAnimJoint121.setDEF(std::string("hanim_l_cuneonavicular_2"));
HAnimJoint121.setCenter(new float[]{0.0814275,0.033525,0.02142675});
HAnimSegment& HAnimSegment122 =  HAnimSegment();
HAnimSegment122.X3DNode::setName(std::string("l_cuneiform_2"));
...
HAnimSegment122.addChild(&Shape123);

HAnimJoint121.addChildren(&HAnimSegment122);

HAnimJoint& HAnimJoint130 =  HAnimJoint();
HAnimJoint130.X3DNode::setName(std::string("l_tarsometatarsal_2"));
HAnimJoint130.setDEF(std::string("hanim_l_tarsometatarsal_2"));
HAnimJoint130.setCenter(new float[]{0.08019,0.0261,0.041062504});
HAnimSegment& HAnimSegment131 =  HAnimSegment();
HAnimSegment131.X3DNode::setName(std::string("l_metatarsal_2"));
...
IndexedFaceSet136.setCreaseAngle(3.14159);
...
HAnimSegment131.addChild(&Shape132);

HAnimJoint130.addChildren(&HAnimSegment131);

HAnimJoint& HAnimJoint139 =  HAnimJoint();
HAnimJoint139.X3DNode::setName(std::string("l_metatarsophalangeal_2"));
HAnimJoint139.setDEF(std::string("hanim_l_metatarsophalangeal_2"));
HAnimJoint139.setCenter(new float[]{0.08253,0.014976,0.097830005});
HAnimSegment& HAnimSegment140 =  HAnimSegment();
HAnimSegment140.X3DNode::setName(std::string("l_tarsal_proximal_phalanx_2"));
...
HAnimSegment140.addChild(&Shape141);

HAnimJoint139.addChildren(&HAnimSegment140);

HAnimJoint& HAnimJoint148 =  HAnimJoint();
HAnimJoint148.X3DNode::setName(std::string("l_tarsal_proximal_interphalangeal_2"));
HAnimJoint148.setDEF(std::string("hanim_l_tarsal_proximal_interphalangeal_2"));
HAnimJoint148.setCenter(new float[]{0.0843075,0.012647251,0.1140075});
HAnimSegment& HAnimSegment149 =  HAnimSegment();
HAnimSegment149.X3DNode::setName(std::string("l_tarsal_middle_phalanx_2"));
...
HAnimSegment149.addChild(&Shape150);

HAnimJoint148.addChildren(&HAnimSegment149);

HAnimJoint& HAnimJoint157 =  HAnimJoint();
HAnimJoint157.X3DNode::setName(std::string("l_tarsal_distal_interphalangeal_2"));
HAnimJoint157.setDEF(std::string("hanim_l_tarsal_distal_interphalangeal_2"));
HAnimJoint157.setCenter(new float[]{0.0843075,0.00982575,0.123435006});
HAnimSegment& HAnimSegment158 =  HAnimSegment();
HAnimSegment158.X3DNode::setName(std::string("l_tarsal_distal_phalanx_2"));
...
HAnimSegment158.addChild(&Shape159);
...
HAnimJoint76.addChildren(&HAnimJoint121);

HAnimJoint& HAnimJoint166 =  HAnimJoint();
HAnimJoint166.X3DNode::setName(std::string("l_cuneonavicular_3"));
HAnimJoint166.setDEF(std::string("hanim_l_cuneonavicular_3"));
HAnimJoint166.setCenter(new float[]{0.092970006,0.03339,0.019818});
HAnimSegment& HAnimSegment167 =  HAnimSegment();
HAnimSegment167.X3DNode::setName(std::string("l_cuneiform_3"));
...
HAnimSegment167.addChild(&Shape168);

HAnimJoint166.addChildren(&HAnimSegment167);

HAnimJoint& HAnimJoint175 =  HAnimJoint();
HAnimJoint175.X3DNode::setName(std::string("l_tarsometatarsal_3"));
HAnimJoint175.setDEF(std::string("hanim_l_tarsometatarsal_3"));
HAnimJoint175.setCenter(new float[]{0.09459,0.0261,0.039397504});
HAnimSegment& HAnimSegment176 =  HAnimSegment();
HAnimSegment176.X3DNode::setName(std::string("l_metatarsal_3"));
...
HAnimSegment176.addChild(&Shape177);

HAnimJoint175.addChildren(&HAnimSegment176);

HAnimJoint& HAnimJoint184 =  HAnimJoint();
HAnimJoint184.X3DNode::setName(std::string("l_metatarsophalangeal_3"));
HAnimJoint184.setDEF(std::string("hanim_l_metatarsophalangeal_3"));
HAnimJoint184.setCenter(new float[]{0.096480004,0.015057,0.09542251});
HAnimSegment& HAnimSegment185 =  HAnimSegment();
HAnimSegment185.X3DNode::setName(std::string("l_tarsal_proximal_phalanx_3"));
...
HAnimSegment185.addChild(&Shape186);

HAnimJoint184.addChildren(&HAnimSegment185);

HAnimJoint& HAnimJoint193 =  HAnimJoint();
HAnimJoint193.X3DNode::setName(std::string("l_tarsal_proximal_interphalangeal_3"));
HAnimJoint193.setDEF(std::string("hanim_l_tarsal_proximal_interphalangeal_3"));
HAnimJoint193.setCenter(new float[]{0.098865,0.011922751,0.110475});
HAnimSegment& HAnimSegment194 =  HAnimSegment();
HAnimSegment194.X3DNode::setName(std::string("l_tarsal_middle_phalanx_3"));
...
HAnimSegment194.addChild(&Shape195);

HAnimJoint193.addChildren(&HAnimSegment194);

HAnimJoint& HAnimJoint202 =  HAnimJoint();
HAnimJoint202.X3DNode::setName(std::string("l_tarsal_distal_interphalangeal_3"));
HAnimJoint202.setDEF(std::string("hanim_l_tarsal_distal_interphalangeal_3"));
HAnimJoint202.setCenter(new float[]{0.1004175,0.00982575,0.11970001});
HAnimSegment& HAnimSegment203 =  HAnimSegment();
HAnimSegment203.X3DNode::setName(std::string("l_tarsal_distal_phalanx_3"));
...
HAnimSegment203.addChild(&Shape204);
...
HAnimJoint76.addChildren(&HAnimJoint166);

HAnimJoint67.addChildren(&HAnimJoint76);

HAnimJoint& HAnimJoint211 =  HAnimJoint();
HAnimJoint211.X3DNode::setName(std::string("l_calcaneocuboid"));
HAnimJoint211.setDEF(std::string("hanim_l_calcaneocuboid"));
HAnimJoint211.setCenter(new float[]{0.0891,0.0579825,-0.025965001});
HAnimSegment& HAnimSegment212 =  HAnimSegment();
HAnimSegment212.X3DNode::setName(std::string("l_calcaneus"));
...
HAnimSegment212.addChild(&Shape213);

HAnimJoint211.addChildren(&HAnimSegment212);

HAnimJoint& HAnimJoint220 =  HAnimJoint();
HAnimJoint220.X3DNode::setName(std::string("l_transversetarsal"));
HAnimJoint220.setDEF(std::string("hanim_l_transversetarsal"));
HAnimJoint220.setCenter(new float[]{0.1106325,0.03528,0.002089125});
HAnimSegment& HAnimSegment221 =  HAnimSegment();
HAnimSegment221.X3DNode::setName(std::string("l_cuboid"));
...
HAnimSegment221.addChild(&Shape222);

HAnimJoint220.addChildren(&HAnimSegment221);

HAnimJoint& HAnimJoint229 =  HAnimJoint();
HAnimJoint229.X3DNode::setName(std::string("l_tarsometatarsal_4"));
HAnimJoint229.setDEF(std::string("hanim_l_tarsometatarsal_4"));
HAnimJoint229.setCenter(new float[]{0.1064925,0.0245475,0.03843});
HAnimSegment& HAnimSegment230 =  HAnimSegment();
HAnimSegment230.X3DNode::setName(std::string("l_metatarsal_4"));
...
HAnimSegment230.addChild(&Shape231);

HAnimJoint229.addChildren(&HAnimSegment230);

HAnimJoint& HAnimJoint238 =  HAnimJoint();
HAnimJoint238.X3DNode::setName(std::string("l_metatarsophalangeal_4"));
HAnimJoint238.setDEF(std::string("hanim_l_metatarsophalangeal_4"));
HAnimJoint238.setCenter(new float[]{0.109867506,0.01435275,0.091170006});
HAnimSegment& HAnimSegment239 =  HAnimSegment();
HAnimSegment239.X3DNode::setName(std::string("l_tarsal_proximal_phalanx_4"));
...
HAnimSegment239.addChild(&Shape240);

HAnimJoint238.addChildren(&HAnimSegment239);

HAnimJoint& HAnimJoint247 =  HAnimJoint();
HAnimJoint247.X3DNode::setName(std::string("l_tarsal_proximal_interphalangeal_4"));
HAnimJoint247.setDEF(std::string("hanim_l_tarsal_proximal_interphalangeal_4"));
HAnimJoint247.setCenter(new float[]{0.114165,0.0122445,0.1063125});
HAnimSegment& HAnimSegment248 =  HAnimSegment();
HAnimSegment248.X3DNode::setName(std::string("l_tarsal_middle_phalanx_4"));
...
HAnimSegment248.addChild(&Shape249);

HAnimJoint247.addChildren(&HAnimSegment248);

HAnimJoint& HAnimJoint256 =  HAnimJoint();
HAnimJoint256.X3DNode::setName(std::string("l_tarsal_distal_interphalangeal_4"));
HAnimJoint256.setDEF(std::string("hanim_l_tarsal_distal_interphalangeal_4"));
HAnimJoint256.setCenter(new float[]{0.1156725,0.009369,0.11369251});
HAnimSegment& HAnimSegment257 =  HAnimSegment();
HAnimSegment257.X3DNode::setName(std::string("l_tarsal_distal_phalanx_4"));
...
Shape258.setGeometry(&IndexedFaceSet262);

HAnimSegment257.addChild(&Shape258);
...
HAnimJoint265.X3DNode::setName(std::string("l_tarsometatarsal_5"));
HAnimJoint265.setDEF(std::string("hanim_l_tarsometatarsal_5"));
HAnimJoint265.setCenter(new float[]{0.120825,0.020945251,0.03474});
HAnimSegment& HAnimSegment266 =  HAnimSegment();
HAnimSegment266.X3DNode::setName(std::string("l_metatarsal_5"));
...
Shape267.setGeometry(&IndexedFaceSet271);

HAnimSegment266.addChild(&Shape267);

HAnimJoint265.addChildren(&HAnimSegment266);

HAnimJoint& HAnimJoint274 =  HAnimJoint();
HAnimJoint274.X3DNode::setName(std::string("l_metatarsophalangeal_5"));
HAnimJoint274.setDEF(std::string("hanim_l_metatarsophalangeal_5"));
HAnimJoint274.setCenter(new float[]{0.124065004,0.013671,0.0865575});
HAnimSegment& HAnimSegment275 =  HAnimSegment();
HAnimSegment275.X3DNode::setName(std::string("l_tarsal_proximal_phalanx_5"));
...
Shape276.setGeometry(&IndexedFaceSet280);
...
HAnimJoint283.X3DNode::setName(std::string("l_tarsal_proximal_interphalangeal_5"));
HAnimJoint283.setDEF(std::string("hanim_l_tarsal_proximal_interphalangeal_5"));
HAnimJoint283.setCenter(new float[]{0.1263825,0.01085625,0.09414});
HAnimSegment& HAnimSegment284 =  HAnimSegment();
HAnimSegment284.X3DNode::setName(std::string("l_tarsal_middle_phalanx_5"));
...
HAnimSegment284.addChild(&Shape285);

HAnimJoint283.addChildren(&HAnimSegment284);

HAnimJoint& HAnimJoint292 =  HAnimJoint();
HAnimJoint292.X3DNode::setName(std::string("l_tarsal_distal_interphalangeal_5"));
HAnimJoint292.setDEF(std::string("hanim_l_tarsal_distal_interphalangeal_5"));
HAnimJoint292.setCenter(new float[]{0.1272825,0.008563501,0.10188});
HAnimSegment& HAnimSegment293 =  HAnimSegment();
HAnimSegment293.X3DNode::setName(std::string("l_tarsal_distal_phalanx_5"));
...
HAnimSegment293.addChild(&Shape294);

HAnimJoint292.addChildren(&HAnimSegment293);

HAnimJoint283.addChildren(&HAnimJoint292);

HAnimJoint274.addChildren(&HAnimJoint283);

HAnimJoint265.addChildren(&HAnimJoint274);

HAnimJoint220.addChildren(&HAnimJoint265);

HAnimJoint211.addChildren(&HAnimJoint220);

HAnimJoint67.addChildren(&HAnimJoint211);

HAnimJoint58.addChildren(&HAnimJoint67);

HAnimJoint49.addChildren(&HAnimJoint58);

HAnimJoint40.addChildren(&HAnimJoint49);
...
HAnimJoint301.setCenter(new float[]{-0.094657496,0.8266501,-0.018348752});
...
HAnimSegment302.addChild(&Shape303);

HAnimJoint301.addChildren(&HAnimSegment302);

HAnimJoint& HAnimJoint310 =  HAnimJoint();
HAnimJoint310.X3DNode::setName(std::string("r_knee"));
HAnimJoint310.setDEF(std::string("hanim_r_knee"));
HAnimJoint310.setCenter(new float[]{-0.09261001,0.408825,-0.01943775});
HAnimSegment& HAnimSegment311 =  HAnimSegment();
HAnimSegment311.X3DNode::setName(std::string("r_calf"));
...
IndexedFaceSet316.setTexCoordIndex(new int32_t[]{0,1,2,-1,2,3,4,-1,2,4,5,-1,0,2,5,-1,6,0,5,-1,9,10,7,-1,7,8,9,-1,12,9,8,-1,8,11,12,-1,14,12,11,-1,11,13,14,-1,16,14,13,-1,13,15,16,-1,18,16,15,-1,15,17,18,-1,20,18,17,-1,17,19,20,-1,10,20,19,-1,19,7,10,-1,21,22,10,-1,10,9,21,-1,23,21,9,-1,9,12,23,-1,24,23,12,-1,12,14,24,-1,25,24,14,-1,14,16,25,-1,26,25,16,-1,16,18,26,-1,27,26,18,-1,18,20,27,-1,22,27,20,-1,20,10,22,-1,1,0,22,-1,22,21,1,-1,2,1,21,-1,21,23,2,-1,3,2,23,-1,23,24,3,-1,4,3,24,-1,24,25,4,-1,5,4,25,-1,25,26,5,-1,6,5,26,-1,26,27,6,-1,0,6,27,-1,27,22,0,-1,8,7,28,-1,28,29,8,-1,11,8,29,-1,29,30,11,-1,13,11,30,-1,30,31,13,-1,15,13,31,-1,31,32,15,-1,17,15,32,-1,32,33,17,-1,19,17,33,-1,33,34,19,-1,7,19,34,-1,34,28,7,-1,29,28,35,-1,35,36,29,-1,30,29,36,-1,36,37,30,-1,31,30,37,-1,37,38,31,-1,32,31,38,-1,38,39,32,-1,33,32,39,-1,39,40,33,-1,34,33,40,-1,40,41,34,-1,28,34,41,-1,41,35,28,-1}, 300);
Coordinate& Coordinate317 =  Coordinate();
Coordinate317.setPoint(new float[]{-0.10877851,0.43062302,-0.018911252,-0.10078201,0.43062302,0.0016087501,-0.08281576,0.43062302,0.00576225,-0.06840001,0.43062302,-0.0058702505,-0.06840001,0.43062302,-0.028237501,-0.08281576,0.43062302,-0.0398655,-0.10078201,0.43062302,-0.0357165,-0.1451925,0.30503252,-0.018911252,-0.12546001,0.32733002,0.025989752,-0.12042001,0.372195,0.035012253,-0.140265,0.36580503,-0.018911252,-0.07436026,0.32733002,0.038319748,-0.075807005,0.372195,0.045879755,-0.041895006,0.30503252,0.00879975,-0.040027507,0.36580503,0.0025965006,-0.041895006,0.2877075,-0.05021775,-0.040027507,0.36580503,-0.040419,-0.07436026,0.2877075,-0.08475526,-0.075807005,0.36580503,-0.072717756,-0.12546001,0.2877075,-0.07242525,-0.12042001,0.36580503,-0.061850253,-0.11783251,0.408753,0.02322225,-0.13610251,0.408753,-0.018911252,-0.07673401,0.408753,0.032717254,-0.043785006,0.408753,0.006122251,-0.043785006,0.408753,-0.040236752,-0.07673401,0.408753,-0.065810256,-0.11783251,0.408753,-0.05633775,-0.1287675,0.11812501,-0.01936575,-0.11334601,0.11835001,0.015774751,-0.078682505,0.11835001,0.02445975,-0.050895005,0.11812501,0.00013950035,-0.050895005,0.117675014,-0.04140225,-0.078682505,0.117675014,-0.058632754,-0.11334601,0.117675014,-0.04994775,-0.108522005,0.08190001,-0.018900001,-0.100719005,0.08190001,-0.00112275,-0.08318701,0.08190001,0.0032647487,-0.069120005,0.08190001,-0.009033751,-0.069120005,0.08167501,-0.030044252,-0.08318701,0.08167501,-0.0387585,-0.100719005,0.08167501,-0.034366503}, 126);
...
HAnimSegment311.addChild(&Shape312);

HAnimJoint310.addChildren(&HAnimSegment311);

HAnimJoint& HAnimJoint319 =  HAnimJoint();
HAnimJoint319.X3DNode::setName(std::string("r_talocrural"));
HAnimJoint319.setDEF(std::string("hanim_r_talocrural"));
HAnimJoint319.setCenter(new float[]{-0.088447504,0.09544501,-0.010451251});
HAnimSegment& HAnimSegment320 =  HAnimSegment();
HAnimSegment320.X3DNode::setName(std::string("r_talus"));
...
HAnimSegment320.addChild(&Shape321);

HAnimJoint319.addChildren(&HAnimSegment320);

HAnimJoint& HAnimJoint328 =  HAnimJoint();
HAnimJoint328.X3DNode::setName(std::string("r_talocalcaneonavicular"));
HAnimJoint328.setDEF(std::string("hanim_r_talocalcaneonavicular"));
HAnimJoint328.setCenter(new float[]{-0.07794,0.036900003,0.0048645});
HAnimSegment& HAnimSegment329 =  HAnimSegment();
HAnimSegment329.X3DNode::setName(std::string("r_navicular"));
...
Shape330.setGeometry(&IndexedFaceSet334);
...
HAnimJoint337.X3DNode::setName(std::string("r_cuneonavicular_1"));
HAnimJoint337.setDEF(std::string("hanim_r_cuneonavicular_1"));
HAnimJoint337.setCenter(new float[]{-0.0669825,0.032107502,0.018391501});
HAnimSegment& HAnimSegment338 =  HAnimSegment();
HAnimSegment338.X3DNode::setName(std::string("r_cuneiform_1"));
...
HAnimSegment338.addChild(&Shape339);

HAnimJoint337.addChildren(&HAnimSegment338);

HAnimJoint& HAnimJoint346 =  HAnimJoint();
HAnimJoint346.X3DNode::setName(std::string("r_tarsometatarsal_1"));
HAnimJoint346.setDEF(std::string("hanim_r_tarsometatarsal_1"));
HAnimJoint346.setCenter(new float[]{-0.06426,0.023242502,0.04419});
HAnimSegment& HAnimSegment347 =  HAnimSegment();
HAnimSegment347.X3DNode::setName(std::string("r_metatarsal_1"));
...
Shape348.setGeometry(&IndexedFaceSet352);

HAnimSegment347.addChild(&Shape348);

HAnimJoint346.addChildren(&HAnimSegment347);

HAnimJoint& HAnimJoint355 =  HAnimJoint();
HAnimJoint355.X3DNode::setName(std::string("r_metatarsophalangeal_1"));
HAnimJoint355.setDEF(std::string("hanim_r_metatarsophalangeal_1"));
HAnimJoint355.setCenter(new float[]{-0.0617625,0.014424751,0.0936225});
HAnimSegment& HAnimSegment356 =  HAnimSegment();
HAnimSegment356.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_1"));
...
Shape357.setGeometry(&IndexedFaceSet361);

HAnimSegment356.addChild(&Shape357);

HAnimJoint355.addChildren(&HAnimSegment356);

HAnimJoint& HAnimJoint364 =  HAnimJoint();
HAnimJoint364.X3DNode::setName(std::string("r_tarsal_distal_interphalangeal_1"));
HAnimJoint364.setDEF(std::string("hanim_r_tarsal_distal_interphalangeal_1"));
HAnimJoint364.setCenter(new float[]{-0.06174,0.0121365,0.1153125});
HAnimSegment& HAnimSegment365 =  HAnimSegment();
HAnimSegment365.X3DNode::setName(std::string("r_tarsal_distal_phalanx_1"));
...
Shape366.setGeometry(&IndexedFaceSet370);

HAnimSegment365.addChild(&Shape366);

HAnimJoint364.addChildren(&HAnimSegment365);

HAnimJoint355.addChildren(&HAnimJoint364);

HAnimJoint346.addChildren(&HAnimJoint355);

HAnimJoint337.addChildren(&HAnimJoint346);

HAnimJoint328.addChildren(&HAnimJoint337);

HAnimJoint& HAnimJoint373 =  HAnimJoint();
HAnimJoint373.X3DNode::setName(std::string("r_cuneonavicular_2"));
HAnimJoint373.setDEF(std::string("hanim_r_cuneonavicular_2"));
HAnimJoint373.setCenter(new float[]{-0.081045,0.033525,0.02142675});
HAnimSegment& HAnimSegment374 =  HAnimSegment();
HAnimSegment374.X3DNode::setName(std::string("r_cuneiform_2"));
...
HAnimSegment374.addChild(&Shape375);

HAnimJoint373.addChildren(&HAnimSegment374);

HAnimJoint& HAnimJoint382 =  HAnimJoint();
HAnimJoint382.X3DNode::setName(std::string("r_tarsometatarsal_2"));
HAnimJoint382.setDEF(std::string("hanim_r_tarsometatarsal_2"));
HAnimJoint382.setCenter(new float[]{-0.079830006,0.0261,0.041062504});
HAnimSegment& HAnimSegment383 =  HAnimSegment();
HAnimSegment383.X3DNode::setName(std::string("r_metatarsal_2"));
...
HAnimJoint391.X3DNode::setName(std::string("r_metatarsophalangeal_2"));
HAnimJoint391.setDEF(std::string("hanim_r_metatarsophalangeal_2"));
HAnimJoint391.setCenter(new float[]{-0.0821475,0.014976,0.097830005});
HAnimSegment& HAnimSegment392 =  HAnimSegment();
HAnimSegment392.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_2"));
...
HAnimSegment392.addChild(&Shape393);

HAnimJoint391.addChildren(&HAnimSegment392);

HAnimJoint& HAnimJoint400 =  HAnimJoint();
HAnimJoint400.X3DNode::setName(std::string("r_tarsal_proximal_interphalangeal_2"));
HAnimJoint400.setDEF(std::string("hanim_r_tarsal_proximal_interphalangeal_2"));
HAnimJoint400.setCenter(new float[]{-0.083925,0.012647251,0.1140075});
HAnimSegment& HAnimSegment401 =  HAnimSegment();
HAnimSegment401.X3DNode::setName(std::string("r_tarsal_middle_phalanx_2"));
...
HAnimJoint409.X3DNode::setName(std::string("r_tarsal_distal_interphalangeal_2"));
HAnimJoint409.setDEF(std::string("hanim_r_tarsal_distal_interphalangeal_2"));
HAnimJoint409.setCenter(new float[]{-0.083925,0.00982575,0.123435006});
HAnimSegment& HAnimSegment410 =  HAnimSegment();
HAnimSegment410.X3DNode::setName(std::string("r_tarsal_distal_phalanx_2"));
...
Shape411.setGeometry(&IndexedFaceSet415);
...
HAnimJoint373.addChildren(&HAnimJoint382);

HAnimJoint328.addChildren(&HAnimJoint373);

HAnimJoint& HAnimJoint418 =  HAnimJoint();
HAnimJoint418.X3DNode::setName(std::string("r_cuneonavicular_3"));
HAnimJoint418.setDEF(std::string("hanim_r_cuneonavicular_3"));
HAnimJoint418.setCenter(new float[]{-0.09261001,0.03339,0.019818});
HAnimSegment& HAnimSegment419 =  HAnimSegment();
HAnimSegment419.X3DNode::setName(std::string("r_cuneiform_3"));
...
Shape420.setGeometry(&IndexedFaceSet424);
...
HAnimJoint427.X3DNode::setName(std::string("r_tarsometatarsal_3"));
HAnimJoint427.setDEF(std::string("hanim_r_tarsometatarsal_3"));
HAnimJoint427.setCenter(new float[]{-0.09423001,0.0261,0.039397504});
HAnimSegment& HAnimSegment428 =  HAnimSegment();
HAnimSegment428.X3DNode::setName(std::string("r_metatarsal_3"));
...
HAnimSegment428.addChild(&Shape429);

HAnimJoint427.addChildren(&HAnimSegment428);

HAnimJoint& HAnimJoint436 =  HAnimJoint();
HAnimJoint436.X3DNode::setName(std::string("r_metatarsophalangeal_3"));
HAnimJoint436.setDEF(std::string("hanim_r_metatarsophalangeal_3"));
HAnimJoint436.setCenter(new float[]{-0.0960975,0.015057,0.09542251});
HAnimSegment& HAnimSegment437 =  HAnimSegment();
HAnimSegment437.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_3"));
...
Shape438.setGeometry(&IndexedFaceSet442);

HAnimSegment437.addChild(&Shape438);

HAnimJoint436.addChildren(&HAnimSegment437);

HAnimJoint& HAnimJoint445 =  HAnimJoint();
HAnimJoint445.X3DNode::setName(std::string("r_tarsal_proximal_interphalangeal_3"));
HAnimJoint445.setDEF(std::string("hanim_r_tarsal_proximal_interphalangeal_3"));
HAnimJoint445.setCenter(new float[]{-0.098505,0.011922751,0.110475});
HAnimSegment& HAnimSegment446 =  HAnimSegment();
HAnimSegment446.X3DNode::setName(std::string("r_tarsal_middle_phalanx_3"));
...
IndexedFaceSet451.setCreaseAngle(3.14159);
...
Shape447.setGeometry(&IndexedFaceSet451);

HAnimSegment446.addChild(&Shape447);

HAnimJoint445.addChildren(&HAnimSegment446);

HAnimJoint& HAnimJoint454 =  HAnimJoint();
HAnimJoint454.X3DNode::setName(std::string("r_tarsal_distal_interphalangeal_3"));
HAnimJoint454.setDEF(std::string("hanim_r_tarsal_distal_interphalangeal_3"));
HAnimJoint454.setCenter(new float[]{-0.100035004,0.00982575,0.11970001});
HAnimSegment& HAnimSegment455 =  HAnimSegment();
HAnimSegment455.X3DNode::setName(std::string("r_tarsal_distal_phalanx_3"));
...
HAnimJoint445.addChildren(&HAnimJoint454);

HAnimJoint436.addChildren(&HAnimJoint445);

HAnimJoint427.addChildren(&HAnimJoint436);

HAnimJoint418.addChildren(&HAnimJoint427);

HAnimJoint328.addChildren(&HAnimJoint418);

HAnimJoint319.addChildren(&HAnimJoint328);

HAnimJoint& HAnimJoint463 =  HAnimJoint();
HAnimJoint463.X3DNode::setName(std::string("r_calcaneocuboid"));
HAnimJoint463.setDEF(std::string("hanim_r_calcaneocuboid"));
HAnimJoint463.setCenter(new float[]{-0.088717505,0.0579825,-0.025965001});
HAnimSegment& HAnimSegment464 =  HAnimSegment();
HAnimSegment464.X3DNode::setName(std::string("r_calcaneus"));
...
HAnimSegment464.addChild(&Shape465);

HAnimJoint463.addChildren(&HAnimSegment464);

HAnimJoint& HAnimJoint472 =  HAnimJoint();
HAnimJoint472.X3DNode::setName(std::string("r_transversetarsal"));
HAnimJoint472.setDEF(std::string("hanim_r_transversetarsal"));
HAnimJoint472.setCenter(new float[]{-0.110272504,0.03528,0.002089125});
HAnimSegment& HAnimSegment473 =  HAnimSegment();
HAnimSegment473.X3DNode::setName(std::string("r_cuboid"));
...
HAnimSegment473.addChild(&Shape474);

HAnimJoint472.addChildren(&HAnimSegment473);

HAnimJoint& HAnimJoint481 =  HAnimJoint();
HAnimJoint481.X3DNode::setName(std::string("r_tarsometatarsal_4"));
HAnimJoint481.setDEF(std::string("hanim_r_tarsometatarsal_4"));
HAnimJoint481.setCenter(new float[]{-0.10613251,0.0245475,0.03843});
HAnimSegment& HAnimSegment482 =  HAnimSegment();
HAnimSegment482.X3DNode::setName(std::string("r_metatarsal_4"));
...
HAnimSegment482.addChild(&Shape483);

HAnimJoint481.addChildren(&HAnimSegment482);

HAnimJoint& HAnimJoint490 =  HAnimJoint();
HAnimJoint490.X3DNode::setName(std::string("r_metatarsophalangeal_4"));
HAnimJoint490.setDEF(std::string("hanim_r_metatarsophalangeal_4"));
HAnimJoint490.setCenter(new float[]{-0.10950751,0.01435275,0.091170006});
HAnimSegment& HAnimSegment491 =  HAnimSegment();
HAnimSegment491.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_4"));
...
Shape492.setGeometry(&IndexedFaceSet496);

HAnimSegment491.addChild(&Shape492);

HAnimJoint490.addChildren(&HAnimSegment491);

HAnimJoint& HAnimJoint499 =  HAnimJoint();
HAnimJoint499.X3DNode::setName(std::string("r_tarsal_proximal_interphalangeal_4"));
HAnimJoint499.setDEF(std::string("hanim_r_tarsal_proximal_interphalangeal_4"));
HAnimJoint499.setCenter(new float[]{-0.11378251,0.0122445,0.1063125});
HAnimSegment& HAnimSegment500 =  HAnimSegment();
HAnimSegment500.X3DNode::setName(std::string("r_tarsal_middle_phalanx_4"));
...
Shape501.setGeometry(&IndexedFaceSet505);

HAnimSegment500.addChild(&Shape501);

HAnimJoint499.addChildren(&HAnimSegment500);

HAnimJoint& HAnimJoint508 =  HAnimJoint();
HAnimJoint508.X3DNode::setName(std::string("r_tarsal_distal_interphalangeal_4"));
HAnimJoint508.setDEF(std::string("hanim_r_tarsal_distal_interphalangeal_4"));
HAnimJoint508.setCenter(new float[]{-0.1153125,0.009369,0.11369251});
HAnimSegment& HAnimSegment509 =  HAnimSegment();
HAnimSegment509.X3DNode::setName(std::string("r_tarsal_distal_phalanx_4"));
...
IndexedFaceSet& IndexedFaceSet514 =  IndexedFaceSet();
...
IndexedFaceSet514.setCreaseAngle(3.14159);
...
Shape510.setGeometry(&IndexedFaceSet514);

HAnimSegment509.addChild(&Shape510);

HAnimJoint508.addChildren(&HAnimSegment509);

HAnimJoint499.addChildren(&HAnimJoint508);

HAnimJoint490.addChildren(&HAnimJoint499);

HAnimJoint481.addChildren(&HAnimJoint490);

HAnimJoint472.addChildren(&HAnimJoint481);

HAnimJoint& HAnimJoint517 =  HAnimJoint();
HAnimJoint517.X3DNode::setName(std::string("r_tarsometatarsal_5"));
HAnimJoint517.setDEF(std::string("hanim_r_tarsometatarsal_5"));
HAnimJoint517.setCenter(new float[]{-0.12044251,0.020945251,0.03474});
HAnimSegment& HAnimSegment518 =  HAnimSegment();
HAnimSegment518.X3DNode::setName(std::string("r_metatarsal_5"));
...
HAnimSegment518.addChild(&Shape519);

HAnimJoint517.addChildren(&HAnimSegment518);

HAnimJoint& HAnimJoint526 =  HAnimJoint();
HAnimJoint526.X3DNode::setName(std::string("r_metatarsophalangeal_5"));
HAnimJoint526.setDEF(std::string("hanim_r_metatarsophalangeal_5"));
HAnimJoint526.setCenter(new float[]{-0.12368251,0.013671,0.0865575});
HAnimSegment& HAnimSegment527 =  HAnimSegment();
HAnimSegment527.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_5"));
...
Shape528.setGeometry(&IndexedFaceSet532);

HAnimSegment527.addChild(&Shape528);

HAnimJoint526.addChildren(&HAnimSegment527);

HAnimJoint& HAnimJoint535 =  HAnimJoint();
HAnimJoint535.X3DNode::setName(std::string("r_tarsal_proximal_interphalangeal_5"));
HAnimJoint535.setDEF(std::string("hanim_r_tarsal_proximal_interphalangeal_5"));
HAnimJoint535.setCenter(new float[]{-0.126,0.01085625,0.09414});
HAnimSegment& HAnimSegment536 =  HAnimSegment();
HAnimSegment536.X3DNode::setName(std::string("r_tarsal_middle_phalanx_5"));
...
HAnimSegment536.addChild(&Shape537);

HAnimJoint535.addChildren(&HAnimSegment536);

HAnimJoint& HAnimJoint544 =  HAnimJoint();
HAnimJoint544.X3DNode::setName(std::string("r_tarsal_distal_interphalangeal_5"));
HAnimJoint544.setDEF(std::string("hanim_r_tarsal_distal_interphalangeal_5"));
HAnimJoint544.setCenter(new float[]{-0.1269225,0.008563501,0.10188});
HAnimSegment& HAnimSegment545 =  HAnimSegment();
HAnimSegment545.X3DNode::setName(std::string("r_tarsal_distal_phalanx_5"));
...
Shape546.setGeometry(&IndexedFaceSet550);

HAnimSegment545.addChild(&Shape546);
...
HAnimJoint517.addChildren(&HAnimJoint526);

HAnimJoint472.addChildren(&HAnimJoint517);

HAnimJoint463.addChildren(&HAnimJoint472);

HAnimJoint319.addChildren(&HAnimJoint463);

HAnimJoint310.addChildren(&HAnimJoint319);

HAnimJoint301.addChildren(&HAnimJoint310);

HAnimJoint40.addChildren(&HAnimJoint301);

HAnimJoint& HAnimJoint553 =  HAnimJoint();
HAnimJoint553.X3DNode::setName(std::string("vl5"));
HAnimJoint553.setDEF(std::string("hanim_vl5"));
HAnimJoint553.setCenter(new float[]{0.0,0.92542505,-0.013763251});
HAnimSegment& HAnimSegment554 =  HAnimSegment();
HAnimSegment554.X3DNode::setName(std::string("l5"));
...
HAnimJoint562.X3DNode::setName(std::string("vl4"));
HAnimJoint562.setDEF(std::string("hanim_vl4"));
HAnimJoint562.setCenter(new float[]{0.0,0.94972503,-0.013763251});
HAnimSegment& HAnimSegment563 =  HAnimSegment();
HAnimSegment563.X3DNode::setName(std::string("l4"));
...
HAnimSegment563.addChild(&Shape564);

HAnimJoint562.addChildren(&HAnimSegment563);

HAnimJoint& HAnimJoint571 =  HAnimJoint();
HAnimJoint571.X3DNode::setName(std::string("vl3"));
HAnimJoint571.setDEF(std::string("hanim_vl3"));
HAnimJoint571.setCenter(new float[]{0.0,0.96592504,-0.013763251});
HAnimSegment& HAnimSegment572 =  HAnimSegment();
HAnimSegment572.X3DNode::setName(std::string("l3"));
...
HAnimSegment572.addChild(&Shape573);

HAnimJoint571.addChildren(&HAnimSegment572);

HAnimJoint& HAnimJoint580 =  HAnimJoint();
HAnimJoint580.X3DNode::setName(std::string("vl2"));
HAnimJoint580.setDEF(std::string("hanim_vl2"));
HAnimJoint580.setCenter(new float[]{0.0,0.98235005,-0.013763251});
HAnimSegment& HAnimSegment581 =  HAnimSegment();
HAnimSegment581.X3DNode::setName(std::string("l2"));
...
Shape582.setGeometry(&IndexedFaceSet586);
...
HAnimJoint589.X3DNode::setName(std::string("vl1"));
HAnimJoint589.setDEF(std::string("hanim_vl1"));
HAnimJoint589.setCenter(new float[]{0.0,0.99967504,-0.013763251});
HAnimSegment& HAnimSegment590 =  HAnimSegment();
HAnimSegment590.X3DNode::setName(std::string("l1"));
...
Shape591.setGeometry(&IndexedFaceSet595);

HAnimSegment590.addChild(&Shape591);

HAnimJoint589.addChildren(&HAnimSegment590);

HAnimJoint& HAnimJoint598 =  HAnimJoint();
HAnimJoint598.X3DNode::setName(std::string("vt12"));
HAnimJoint598.setDEF(std::string("hanim_vt12"));
HAnimJoint598.setCenter(new float[]{0.0,1.0230751,-0.013763251});
HAnimSegment& HAnimSegment599 =  HAnimSegment();
HAnimSegment599.X3DNode::setName(std::string("t12"));
...
Shape600.setGeometry(&IndexedFaceSet604);

HAnimSegment599.addChild(&Shape600);

HAnimJoint598.addChildren(&HAnimSegment599);

HAnimJoint& HAnimJoint607 =  HAnimJoint();
HAnimJoint607.X3DNode::setName(std::string("vt11"));
HAnimJoint607.setDEF(std::string("hanim_vt11"));
HAnimJoint607.setCenter(new float[]{0.0,1.0467,-0.013763251});
HAnimSegment& HAnimSegment608 =  HAnimSegment();
HAnimSegment608.X3DNode::setName(std::string("t11"));
...
HAnimSegment608.addChild(&Shape609);

HAnimJoint607.addChildren(&HAnimSegment608);

HAnimJoint& HAnimJoint616 =  HAnimJoint();
HAnimJoint616.X3DNode::setName(std::string("vt10"));
HAnimJoint616.setDEF(std::string("hanim_vt10"));
HAnimJoint616.setCenter(new float[]{0.0,1.0638,-0.013785751});
HAnimSegment& HAnimSegment617 =  HAnimSegment();
HAnimSegment617.X3DNode::setName(std::string("t10"));
...
Shape618.setGeometry(&IndexedFaceSet622);

HAnimSegment617.addChild(&Shape618);

HAnimJoint616.addChildren(&HAnimSegment617);

HAnimJoint& HAnimJoint625 =  HAnimJoint();
HAnimJoint625.X3DNode::setName(std::string("vt9"));
HAnimJoint625.setDEF(std::string("hanim_vt9"));
HAnimJoint625.setCenter(new float[]{0.0,1.078425,-0.013763251});
HAnimSegment& HAnimSegment626 =  HAnimSegment();
HAnimSegment626.X3DNode::setName(std::string("t9"));
...
Shape627.setGeometry(&IndexedFaceSet631);
...
HAnimJoint634.X3DNode::setName(std::string("vt8"));
HAnimJoint634.setDEF(std::string("hanim_vt8"));
HAnimJoint634.setCenter(new float[]{0.0,1.0930501,-0.013763251});
HAnimSegment& HAnimSegment635 =  HAnimSegment();
HAnimSegment635.X3DNode::setName(std::string("t8"));
...
Shape636.setGeometry(&IndexedFaceSet640);

HAnimSegment635.addChild(&Shape636);

HAnimJoint634.addChildren(&HAnimSegment635);

HAnimJoint& HAnimJoint643 =  HAnimJoint();
HAnimJoint643.X3DNode::setName(std::string("vt7"));
HAnimJoint643.setDEF(std::string("hanim_vt7"));
HAnimJoint643.setCenter(new float[]{0.0,1.1088,-0.013763251});
HAnimSegment& HAnimSegment644 =  HAnimSegment();
HAnimSegment644.X3DNode::setName(std::string("t7"));
...
HAnimSegment644.addChild(&Shape645);

HAnimJoint643.addChildren(&HAnimSegment644);

HAnimJoint& HAnimJoint652 =  HAnimJoint();
HAnimJoint652.X3DNode::setName(std::string("vt6"));
HAnimJoint652.setDEF(std::string("hanim_vt6"));
HAnimJoint652.setCenter(new float[]{0.0,1.1216251,-0.013763251});
HAnimSegment& HAnimSegment653 =  HAnimSegment();
HAnimSegment653.X3DNode::setName(std::string("t6"));
...
HAnimSegment653.addChild(&Shape654);

HAnimJoint652.addChildren(&HAnimSegment653);

HAnimJoint& HAnimJoint661 =  HAnimJoint();
HAnimJoint661.X3DNode::setName(std::string("vt5"));
HAnimJoint661.setDEF(std::string("hanim_vt5"));
HAnimJoint661.setCenter(new float[]{0.0,1.13715,-0.013763251});
HAnimSegment& HAnimSegment662 =  HAnimSegment();
HAnimSegment662.X3DNode::setName(std::string("t5"));
...
HAnimJoint670.X3DNode::setName(std::string("vt4"));
HAnimJoint670.setDEF(std::string("hanim_vt4"));
HAnimJoint670.setCenter(new float[]{0.0,1.1524501,-0.013763251});
HAnimSegment& HAnimSegment671 =  HAnimSegment();
HAnimSegment671.X3DNode::setName(std::string("t4"));
...
Shape672.setGeometry(&IndexedFaceSet676);

HAnimSegment671.addChild(&Shape672);

HAnimJoint670.addChildren(&HAnimSegment671);

HAnimJoint& HAnimJoint679 =  HAnimJoint();
HAnimJoint679.X3DNode::setName(std::string("vt3"));
HAnimJoint679.setDEF(std::string("hanim_vt3"));
HAnimJoint679.setCenter(new float[]{0.0,1.1709001,-0.013763251});
HAnimSegment& HAnimSegment680 =  HAnimSegment();
HAnimSegment680.X3DNode::setName(std::string("t3"));
...
Shape681.setGeometry(&IndexedFaceSet685);
...
HAnimJoint688.X3DNode::setName(std::string("vt2"));
HAnimJoint688.setDEF(std::string("hanim_vt2"));
HAnimJoint688.setCenter(new float[]{0.0,1.19565,-0.013785751});
HAnimSegment& HAnimSegment689 =  HAnimSegment();
HAnimSegment689.X3DNode::setName(std::string("t2"));
...
Shape690.setGeometry(&IndexedFaceSet694);
...
HAnimJoint697.X3DNode::setName(std::string("vt1"));
HAnimJoint697.setDEF(std::string("hanim_vt1"));
HAnimJoint697.setCenter(new float[]{0.0,1.2195001,-0.013763251});
HAnimSegment& HAnimSegment698 =  HAnimSegment();
HAnimSegment698.X3DNode::setName(std::string("t1"));
...
HAnimJoint706.X3DNode::setName(std::string("vc7"));
HAnimJoint706.setDEF(std::string("hanim_vc7"));
HAnimJoint706.setCenter(new float[]{0.0,1.245375,-0.015063751});
HAnimSegment& HAnimSegment707 =  HAnimSegment();
HAnimSegment707.X3DNode::setName(std::string("c7"));
...
Shape708.addChild(&Appearance709);
...
Shape708.setGeometry(&IndexedFaceSet712);

HAnimSegment707.addChild(&Shape708);

HAnimJoint706.addChildren(&HAnimSegment707);

HAnimJoint& HAnimJoint715 =  HAnimJoint();
HAnimJoint715.X3DNode::setName(std::string("vc6"));
HAnimJoint715.setDEF(std::string("hanim_vc6"));
HAnimJoint715.setCenter(new float[]{0.0,1.2575251,-0.015063751});
HAnimSegment& HAnimSegment716 =  HAnimSegment();
HAnimSegment716.X3DNode::setName(std::string("c6"));
...
Shape717.setGeometry(&IndexedFaceSet721);

HAnimSegment716.addChild(&Shape717);

HAnimJoint715.addChildren(&HAnimSegment716);

HAnimJoint& HAnimJoint724 =  HAnimJoint();
HAnimJoint724.X3DNode::setName(std::string("vc5"));
HAnimJoint724.setDEF(std::string("hanim_vc5"));
HAnimJoint724.setCenter(new float[]{0.0,1.2699,-0.015063751});
HAnimSegment& HAnimSegment725 =  HAnimSegment();
HAnimSegment725.X3DNode::setName(std::string("c5"));
...
Shape726.addChild(&Appearance727);

IndexedFaceSet& IndexedFaceSet730 =  IndexedFaceSet();
IndexedFaceSet730.setCoordIndex(new int32_t[]{12,20,8,-1,8,0,12,-1,13,12,0,-1,0,1,13,-1,14,13,1,-1,1,2,14,-1,15,14,2,-1,2,3,15,-1,21,15,3,-1,3,9,21,-1,18,19,7,-1,7,6,18,-1,19,23,11,-1,11,7,19,-1,16,21,9,-1,9,4,16,-1,20,22,10,-1,10,8,20,-1,22,18,6,-1,6,10,22,-1,17,16,4,-1,4,5,17,-1,23,17,5,-1,5,11,23,-1,26,27,28,-1,28,29,30,-1,30,31,32,-1,28,30,32,-1,32,33,34,-1,34,35,24,-1,32,34,24,-1,28,32,24,-1,26,28,24,-1,25,26,24,-1,38,39,40,-1,40,41,42,-1,42,43,44,-1,40,42,44,-1,44,45,46,-1,46,47,36,-1,44,46,36,-1,40,44,36,-1,38,40,36,-1,37,38,36,-1,0,8,25,-1,25,24,0,-1,8,10,26,-1,26,25,8,-1,10,6,27,-1,27,26,10,-1,6,7,28,-1,28,27,6,-1,7,11,29,-1,29,28,7,-1,11,5,30,-1,30,29,11,-1,5,4,31,-1,31,30,5,-1,4,9,32,-1,32,31,4,-1,9,3,33,-1,33,32,9,-1,3,2,34,-1,34,33,3,-1,2,1,35,-1,35,34,2,-1,1,0,24,-1,24,35,1,-1,20,12,37,-1,37,36,20,-1,12,13,38,-1,38,37,12,-1,13,14,39,-1,39,38,13,-1,14,15,40,-1,40,39,14,-1,15,21,41,-1,41,40,15,-1,21,16,42,-1,42,41,21,-1,16,17,43,-1,43,42,16,-1,17,23,44,-1,44,43,17,-1,23,19,45,-1,45,44,23,-1,19,18,46,-1,46,45,19,-1,18,22,47,-1,47,46,18,-1,22,20,36,-1,36,47,22,-1}, 368);
IndexedFaceSet730.setCreaseAngle(3.14159);
IndexedFaceSet730.setTexCoordIndex(new int32_t[]{12,20,8,-1,8,0,12,-1,13,12,0,-1,0,1,13,-1,14,13,1,-1,1,2,14,-1,15,14,2,-1,2,3,15,-1,21,15,3,-1,3,9,21,-1,18,19,7,-1,7,6,18,-1,19,23,11,-1,11,7,19,-1,16,21,9,-1,9,4,16,-1,20,22,10,-1,10,8,20,-1,22,18,6,-1,6,10,22,-1,17,16,4,-1,4,5,17,-1,23,17,5,-1,5,11,23,-1,26,27,28,-1,28,29,30,-1,30,31,32,-1,28,30,32,-1,32,33,34,-1,34,35,24,-1,32,34,24,-1,28,32,24,-1,26,28,24,-1,25,26,24,-1,38,39,40,-1,40,41,42,-1,42,43,44,-1,40,42,44,-1,44,45,46,-1,46,47,36,-1,44,46,36,-1,40,44,36,-1,38,40,36,-1,37,38,36,-1,0,8,25,-1,25,24,0,-1,8,10,26,-1,26,25,8,-1,10,6,27,-1,27,26,10,-1,6,7,28,-1,28,27,6,-1,7,11,29,-1,29,28,7,-1,11,5,30,-1,30,29,11,-1,5,4,31,-1,31,30,5,-1,4,9,32,-1,32,31,4,-1,9,3,33,-1,33,32,9,-1,3,2,34,-1,34,33,3,-1,2,1,35,-1,35,34,2,-1,1,0,24,-1,24,35,1,-1,20,12,37,-1,37,36,20,-1,12,13,38,-1,38,37,12,-1,13,14,39,-1,39,38,13,-1,14,15,40,-1,40,39,14,-1,15,21,41,-1,41,40,15,-1,21,16,42,-1,42,41,21,-1,16,17,43,-1,43,42,16,-1,17,23,44,-1,44,43,17,-1,23,19,45,-1,45,44,23,-1,19,18,46,-1,46,45,19,-1,18,22,47,-1,47,46,18,-1,22,20,36,-1,36,47,22,-1}, 368);
Coordinate& Coordinate731 =  Coordinate();
Coordinate731.setPoint(new float[]{0.01208025,1.282176,-0.04035375,0.025627503,1.282176,-0.03419775,0.035145003,1.282176,-0.013423501,0.0274275,1.282176,0.0010305007,0.0,1.282176,0.011823752,-0.013612501,1.282176,0.009708749,-0.025627503,1.282176,-0.03419775,-0.035145003,1.282176,-0.013423501,0.0,1.282176,-0.041951254,0.013612501,1.282176,0.009708749,-0.01208025,1.282176,-0.04035375,-0.0274275,1.282176,0.0010305007,0.01208025,1.269927,-0.04035375,0.025627503,1.269927,-0.03419775,0.035145003,1.269927,-0.013423501,0.0274275,1.269927,0.0010305007,0.0,1.269927,0.011823752,-0.013612501,1.269927,0.009708749,-0.025627503,1.269927,-0.03419775,-0.035145003,1.269927,-0.013423501,0.0,1.269927,-0.041951254,0.013612501,1.269927,0.009708749,-0.01208025,1.269927,-0.04035375,-0.0274275,1.269927,0.0010305007,0.011130751,1.2866266,-0.03609675,0.0,1.2866266,-0.037563752,-0.011130751,1.2866266,-0.03609675,-0.022680001,1.2866266,-0.030849751,-0.030622499,1.2866266,-0.013511251,-0.0245475,1.2866266,-0.0021600004,-0.0122895,1.2866266,0.00555075,0.0,1.2866266,0.0074587516,0.0122895,1.2866266,0.00555075,0.0245475,1.2866266,-0.0021600004,0.030622499,1.2866266,-0.013511251,0.022680001,1.2866266,-0.030849751,0.0,1.2647655,-0.037563752,0.011130751,1.2647655,-0.03609675,0.022680001,1.2647655,-0.030849751,0.030622499,1.2647655,-0.013511251,0.0245475,1.2647655,-0.0021600004,0.0122895,1.2647655,0.00555075,0.0,1.2647655,0.0074587516,-0.0122895,1.2647655,0.00555075,-0.0245475,1.2647655,-0.0021600004,-0.030622499,1.2647655,-0.013511251,-0.022680001,1.2647655,-0.030849751,-0.011130751,1.2647655,-0.03609675}, 144);
...
Shape726.setGeometry(&IndexedFaceSet730);

HAnimSegment725.addChild(&Shape726);

HAnimJoint724.addChildren(&HAnimSegment725);

HAnimJoint& HAnimJoint733 =  HAnimJoint();
HAnimJoint733.X3DNode::setName(std::string("vc4"));
HAnimJoint733.setDEF(std::string("hanim_vc4"));
HAnimJoint733.setCenter(new float[]{0.0,1.2822751,-0.015063751});
HAnimSegment& HAnimSegment734 =  HAnimSegment();
HAnimSegment734.X3DNode::setName(std::string("c4"));
...
Coordinate740.setPoint(new float[]{0.01208025,1.295271,-0.04035375,0.025627503,1.295271,-0.03419775,0.035145003,1.295271,-0.013423501,0.0274275,1.295271,0.0010305007,0.0,1.295271,0.011823752,-0.013612501,1.295271,0.009708749,-0.025627503,1.295271,-0.03419775,-0.035145003,1.295271,-0.013423501,0.0,1.295271,-0.041951254,0.013612501,1.295271,0.009708749,-0.01208025,1.295271,-0.04035375,-0.0274275,1.295271,0.0010305007,0.01208025,1.2823133,-0.04035375,0.025627503,1.2823133,-0.03419775,0.035145003,1.2823133,-0.013423501,0.0274275,1.2823133,0.0010305007,0.0,1.2823133,0.011823752,-0.013612501,1.2823133,0.009708749,-0.025627503,1.2823133,-0.03419775,-0.035145003,1.2823133,-0.013423501,0.0,1.2823133,-0.041951254,0.013612501,1.2823133,0.009708749,-0.01208025,1.2823133,-0.04035375,-0.0274275,1.2823133,0.0010305007,0.011130751,1.2997216,-0.03609675,0.0,1.2997216,-0.037563752,-0.011130751,1.2997216,-0.03609675,-0.022680001,1.2997216,-0.030849751,-0.030622499,1.2997216,-0.013511251,-0.0245475,1.2997216,-0.0021600004,-0.0122895,1.2997216,0.00555075,0.0,1.2997216,0.0074587516,0.0122895,1.2997216,0.00555075,0.0245475,1.2997216,-0.0021600004,0.030622499,1.2997216,-0.013511251,0.022680001,1.2997216,-0.030849751,0.0,1.2769021,-0.037563752,0.011130751,1.2769021,-0.03609675,0.022680001,1.2769021,-0.030849751,0.030622499,1.2769021,-0.013511251,0.0245475,1.2769021,-0.0021600004,0.0122895,1.2769021,0.00555075,0.0,1.2769021,0.0074587516,-0.0122895,1.2769021,0.00555075,-0.0245475,1.2769021,-0.0021600004,-0.030622499,1.2769021,-0.013511251,-0.022680001,1.2769021,-0.030849751,-0.011130751,1.2769021,-0.03609675}, 144);
...
HAnimSegment734.addChild(&Shape735);

HAnimJoint733.addChildren(&HAnimSegment734);

HAnimJoint& HAnimJoint742 =  HAnimJoint();
HAnimJoint742.X3DNode::setName(std::string("vc3"));
HAnimJoint742.setDEF(std::string("hanim_vc3"));
HAnimJoint742.setCenter(new float[]{0.0,1.2951001,-0.015063751});
HAnimSegment& HAnimSegment743 =  HAnimSegment();
HAnimSegment743.X3DNode::setName(std::string("c3"));
...
Coordinate749.setPoint(new float[]{0.01208025,1.3066921,-0.04035375,0.025627503,1.3066921,-0.03419775,0.035145003,1.3066921,-0.013423501,0.0274275,1.3066921,0.0010305007,0.0,1.3066921,0.011823752,-0.013612501,1.3066921,0.009708749,-0.025627503,1.3066921,-0.03419775,-0.035145003,1.3066921,-0.013423501,0.0,1.3066921,-0.041951254,0.013612501,1.3066921,0.009708749,-0.01208025,1.3066921,-0.04035375,-0.0274275,1.3066921,0.0010305007,0.01208025,1.2951338,-0.04035375,0.025627503,1.2951338,-0.03419775,0.035145003,1.2951338,-0.013423501,0.0274275,1.2951338,0.0010305007,0.0,1.2951338,0.011823752,-0.013612501,1.2951338,0.009708749,-0.025627503,1.2951338,-0.03419775,-0.035145003,1.2951338,-0.013423501,0.0,1.2951338,-0.041951254,0.013612501,1.2951338,0.009708749,-0.01208025,1.2951338,-0.04035375,-0.0274275,1.2951338,0.0010305007,0.011130751,1.3111606,-0.03609675,0.0,1.3111606,-0.037563752,-0.011130751,1.3111606,-0.03609675,-0.022680001,1.3111606,-0.030849751,-0.030622499,1.3111606,-0.013511251,-0.0245475,1.3111606,-0.0021600004,-0.0122895,1.3111606,0.00555075,0.0,1.3111606,0.0074587516,0.0122895,1.3111606,0.00555075,0.0245475,1.3111606,-0.0021600004,0.030622499,1.3111606,-0.013511251,0.022680001,1.3111606,-0.030849751,0.0,1.2897046,-0.037563752,0.011130751,1.2897046,-0.03609675,0.022680001,1.2897046,-0.030849751,0.030622499,1.2897046,-0.013511251,0.0245475,1.2897046,-0.0021600004,0.0122895,1.2897046,0.00555075,0.0,1.2897046,0.0074587516,-0.0122895,1.2897046,0.00555075,-0.0245475,1.2897046,-0.0021600004,-0.030622499,1.2897046,-0.013511251,-0.022680001,1.2897046,-0.030849751,-0.011130751,1.2897046,-0.03609675}, 144);
...
HAnimJoint751.X3DNode::setName(std::string("vc2"));
HAnimJoint751.setDEF(std::string("hanim_vc2"));
HAnimJoint751.setCenter(new float[]{0.0,1.3068001,-0.015063751});
HAnimSegment& HAnimSegment752 =  HAnimSegment();
HAnimSegment752.X3DNode::setName(std::string("c2"));
...
Coordinate758.setPoint(new float[]{0.01208025,1.318536,-0.04035375,0.0,1.318536,-0.041951254,0.025627503,1.318536,-0.03419775,0.035145003,1.318536,-0.0134212505,0.0274275,1.318536,0.0010305007,0.013612501,1.318536,0.009708749,0.0,1.318536,0.011823752,-0.01208025,1.318536,-0.04035375,-0.025627503,1.318536,-0.03419775,-0.035145003,1.318536,-0.013423501,-0.0274275,1.318536,0.0010305007,-0.013612501,1.318536,0.009708749,0.0107955,1.3238798,-0.0358695,0.0,1.3238798,-0.0373005,-0.0107955,1.3238798,-0.0358695,-0.022149,1.3238798,-0.030708,-0.0299925,1.3238798,-0.01357875,-0.02394,1.3238798,-0.0022252505,-0.011963251,1.3238798,0.0053032506,0.0,1.3238798,0.0071595,0.011963251,1.3238798,0.0053032506,0.02394,1.3238798,-0.0022252505,0.0299925,1.3238798,-0.01357875,0.022149,1.3238798,-0.030708,0.01208025,1.3068405,-0.04035375,0.025627503,1.3068405,-0.03419775,0.035145003,1.3068405,-0.0134212505,0.0274275,1.3068405,0.0010305007,0.0,1.3068405,0.011823752,-0.013612501,1.3068405,0.009708749,-0.025627503,1.3068405,-0.03419775,-0.035145003,1.3068405,-0.013423501,0.0,1.3068405,-0.041951254,0.013612501,1.3068405,0.009708749,-0.01208025,1.3068405,-0.04035375,-0.0274275,1.3068405,0.0010305007,0.0,1.3019716,-0.037563752,0.011130751,1.3019716,-0.03609675,0.022680001,1.3019716,-0.030849751,0.030622499,1.3019716,-0.013511251,0.0245475,1.3019716,-0.0021600004,0.0122895,1.3019716,0.00555075,0.0,1.3019716,0.0074587516,-0.0122895,1.3019716,0.00555075,-0.0245475,1.3019716,-0.0021600004,-0.030622499,1.3019716,-0.013511251,-0.022680001,1.3019716,-0.030849751,-0.011130751,1.3019716,-0.03609675}, 144);
...
HAnimSegment752.addChild(&Shape753);

HAnimJoint751.addChildren(&HAnimSegment752);

HAnimJoint& HAnimJoint760 =  HAnimJoint();
HAnimJoint760.X3DNode::setName(std::string("vc1"));
HAnimJoint760.setDEF(std::string("hanim_vc1"));
HAnimJoint760.setCenter(new float[]{0.0,1.3185,-0.015063751});
HAnimSegment& HAnimSegment761 =  HAnimSegment();
HAnimSegment761.X3DNode::setName(std::string("c1"));
...
Shape762.addChild(&Appearance763);

IndexedFaceSet& IndexedFaceSet766 =  IndexedFaceSet();
IndexedFaceSet766.setCoordIndex(new int32_t[]{8,0,12,-1,12,20,8,-1,0,1,13,-1,13,12,0,-1,1,2,14,-1,14,13,1,-1,2,3,15,-1,15,14,2,-1,3,9,21,-1,21,15,3,-1,7,6,18,-1,18,19,7,-1,11,7,19,-1,19,23,11,-1,9,4,16,-1,16,21,9,-1,10,8,20,-1,20,22,10,-1,6,10,22,-1,22,18,6,-1,4,5,17,-1,17,16,4,-1,5,11,23,-1,23,17,5,-1,26,27,28,-1,28,29,30,-1,30,31,32,-1,28,30,32,-1,32,33,34,-1,34,35,24,-1,32,34,24,-1,28,32,24,-1,26,28,24,-1,25,26,24,-1,38,39,40,-1,40,41,42,-1,42,43,44,-1,40,42,44,-1,44,45,46,-1,46,47,36,-1,44,46,36,-1,40,44,36,-1,38,40,36,-1,37,38,36,-1,0,8,25,-1,25,24,0,-1,8,10,26,-1,26,25,8,-1,10,6,27,-1,27,26,10,-1,6,7,28,-1,28,27,6,-1,7,11,29,-1,29,28,7,-1,11,5,30,-1,30,29,11,-1,5,4,31,-1,31,30,5,-1,4,9,32,-1,32,31,4,-1,9,3,33,-1,33,32,9,-1,3,2,34,-1,34,33,3,-1,2,1,35,-1,35,34,2,-1,1,0,24,-1,24,35,1,-1,20,12,37,-1,37,36,20,-1,12,13,38,-1,38,37,12,-1,13,14,39,-1,39,38,13,-1,14,15,40,-1,40,39,14,-1,15,21,41,-1,41,40,15,-1,21,16,42,-1,42,41,21,-1,16,17,43,-1,43,42,16,-1,17,23,44,-1,44,43,17,-1,23,19,45,-1,45,44,23,-1,19,18,46,-1,46,45,19,-1,18,22,47,-1,47,46,18,-1,22,20,36,-1,36,47,22,-1}, 368);
IndexedFaceSet766.setCreaseAngle(3.14159);
IndexedFaceSet766.setTexCoordIndex(new int32_t[]{8,0,12,-1,12,20,8,-1,0,1,13,-1,13,12,0,-1,1,2,14,-1,14,13,1,-1,2,3,15,-1,15,14,2,-1,3,9,21,-1,21,15,3,-1,7,6,18,-1,18,19,7,-1,11,7,19,-1,19,23,11,-1,9,4,16,-1,16,21,9,-1,10,8,20,-1,20,22,10,-1,6,10,22,-1,22,18,6,-1,4,5,17,-1,17,16,4,-1,5,11,23,-1,23,17,5,-1,26,27,28,-1,28,29,30,-1,30,31,32,-1,28,30,32,-1,32,33,34,-1,34,35,24,-1,32,34,24,-1,28,32,24,-1,26,28,24,-1,25,26,24,-1,38,39,40,-1,40,41,42,-1,42,43,44,-1,40,42,44,-1,44,45,46,-1,46,47,36,-1,44,46,36,-1,40,44,36,-1,38,40,36,-1,37,38,36,-1,0,8,25,-1,25,24,0,-1,8,10,26,-1,26,25,8,-1,10,6,27,-1,27,26,10,-1,6,7,28,-1,28,27,6,-1,7,11,29,-1,29,28,7,-1,11,5,30,-1,30,29,11,-1,5,4,31,-1,31,30,5,-1,4,9,32,-1,32,31,4,-1,9,3,33,-1,33,32,9,-1,3,2,34,-1,34,33,3,-1,2,1,35,-1,35,34,2,-1,1,0,24,-1,24,35,1,-1,20,12,37,-1,37,36,20,-1,12,13,38,-1,38,37,12,-1,13,14,39,-1,39,38,13,-1,14,15,40,-1,40,39,14,-1,15,21,41,-1,41,40,15,-1,21,16,42,-1,42,41,21,-1,16,17,43,-1,43,42,16,-1,17,23,44,-1,44,43,17,-1,23,19,45,-1,45,44,23,-1,19,18,46,-1,46,45,19,-1,18,22,47,-1,47,46,18,-1,22,20,36,-1,36,47,22,-1}, 368);
Coordinate& Coordinate767 =  Coordinate();
Coordinate767.setPoint(new float[]{0.01208025,1.331379,-0.04035375,0.025627503,1.331379,-0.03419775,0.035145003,1.331379,-0.0134212505,0.0274275,1.331379,0.0010305007,0.0,1.331379,0.011823752,-0.013612501,1.331379,0.009708749,-0.025627503,1.331379,-0.03419775,-0.035145003,1.331379,-0.013423501,0.0,1.331379,-0.041951254,0.013612501,1.331379,0.009708749,-0.01208025,1.331379,-0.04035375,-0.0274275,1.331379,0.0010305007,0.01208025,1.3185495,-0.04035375,0.025627503,1.3185495,-0.03419775,0.035145003,1.3185495,-0.013423501,0.0274275,1.3185495,0.0010305007,0.0,1.3185495,0.011823752,-0.013612501,1.3185495,0.009708749,-0.025627503,1.3185495,-0.03419775,-0.035145003,1.3185495,-0.013423501,0.0,1.3185495,-0.041951254,0.013612501,1.3185495,0.009708749,-0.01208025,1.3185495,-0.04035375,-0.0274275,1.3185495,0.0010305007,0.011130751,1.3358318,-0.03609675,0.0,1.3358318,-0.037563752,-0.011130751,1.3358318,-0.03609675,-0.022680001,1.3358318,-0.030849751,-0.030622499,1.3358318,-0.013511251,-0.0245475,1.3358318,-0.0021600004,-0.0122895,1.3358318,0.00555075,0.0,1.3358318,0.0074587516,0.0122895,1.3358318,0.00555075,0.0245475,1.3358318,-0.0021600004,0.030622499,1.3358318,-0.013511251,0.022680001,1.3358318,-0.030849751,0.0,1.3138245,-0.037563752,0.011130751,1.3138245,-0.03609675,0.022680001,1.3138245,-0.030849751,0.030622499,1.3138245,-0.013511251,0.0245475,1.3138245,-0.0021600004,0.0122895,1.3138245,0.00555075,0.0,1.3138245,0.0074587516,-0.0122895,1.3138245,0.00555075,-0.0245475,1.3138245,-0.0021600004,-0.030622499,1.3138245,-0.013511251,-0.022680001,1.3138245,-0.030849751,-0.011130751,1.3138245,-0.03609675}, 144);
...
Shape762.setGeometry(&IndexedFaceSet766);

HAnimSegment761.addChild(&Shape762);

HAnimJoint760.addChildren(&HAnimSegment761);

HAnimJoint& HAnimJoint769 =  HAnimJoint();
HAnimJoint769.X3DNode::setName(std::string("skullbase"));
HAnimJoint769.setDEF(std::string("hanim_skullbase"));
HAnimJoint769.setCenter(new float[]{0.0,1.3126501,-0.01544175});
HAnimSegment& HAnimSegment770 =  HAnimSegment();
HAnimSegment770.X3DNode::setName(std::string("skull"));
...
Shape771.setGeometry(&IndexedFaceSet775);

HAnimSegment770.addChild(&Shape771);

HAnimJoint769.addChildren(&HAnimSegment770);

HAnimJoint& HAnimJoint778 =  HAnimJoint();
HAnimJoint778.X3DNode::setName(std::string("l_eyelid_joint"));
HAnimJoint778.setDEF(std::string("hanim_l_eyelid_joint"));
HAnimJoint778.setCenter(new float[]{0.0505125,1.42425,0.03294});
HAnimSegment& HAnimSegment779 =  HAnimSegment();
HAnimSegment779.X3DNode::setName(std::string("l_eyelid"));
...
Shape780.addChild(&Appearance781);

IndexedFaceSet& IndexedFaceSet784 =  IndexedFaceSet();
...
IndexedFaceSet784.setCreaseAngle(3.14159);
...
Shape780.setGeometry(&IndexedFaceSet784);
...
HAnimJoint787.X3DNode::setName(std::string("r_eyelid_joint"));
HAnimJoint787.setDEF(std::string("hanim_r_eyelid_joint"));
HAnimJoint787.setCenter(new float[]{-0.0505125,1.42425,0.03294});
HAnimSegment& HAnimSegment788 =  HAnimSegment();
HAnimSegment788.X3DNode::setName(std::string("r_eyelid"));
...
HAnimSegment788.addChild(&Shape789);

HAnimJoint787.addChildren(&HAnimSegment788);

HAnimJoint769.addChildren(&HAnimJoint787);

HAnimJoint& HAnimJoint796 =  HAnimJoint();
HAnimJoint796.X3DNode::setName(std::string("l_eyeball_joint"));
HAnimJoint796.setDEF(std::string("hanim_l_eyeball_joint"));
HAnimJoint796.setCenter(new float[]{0.048127502,1.4049001,0.0830475});
HAnimSegment& HAnimSegment797 =  HAnimSegment();
HAnimSegment797.X3DNode::setName(std::string("l_eyeball"));
...
Shape798.setGeometry(&IndexedFaceSet802);

HAnimSegment797.addChild(&Shape798);

HAnimJoint796.addChildren(&HAnimSegment797);

HAnimJoint769.addChildren(&HAnimJoint796);

HAnimJoint& HAnimJoint805 =  HAnimJoint();
HAnimJoint805.X3DNode::setName(std::string("r_eyeball_joint"));
HAnimJoint805.setDEF(std::string("hanim_r_eyeball_joint"));
HAnimJoint805.setCenter(new float[]{-0.048127502,1.4049001,0.0830475});
HAnimSegment& HAnimSegment806 =  HAnimSegment();
HAnimSegment806.X3DNode::setName(std::string("r_eyeball"));
...
IndexedFaceSet& IndexedFaceSet811 =  IndexedFaceSet();
...
IndexedFaceSet811.setCreaseAngle(3.14159);
...
Coordinate812.setPoint(new float[]{-0.035271,1.407843,0.106042504,-0.04827375,1.4122688,0.10307925,-0.068949,1.393335,0.078867,-0.02277,1.4001908,0.1064475,-0.02985075,1.3947142,0.10174725,-0.072225004,1.3961812,0.076779,-0.0676035,1.4155313,0.089601755,-0.082575,1.4078475,0.07194375,-0.06240825,1.3930538,0.085353754,-0.04069125,1.3934723,0.096680254,-0.0277155,1.4117355,0.09791326,-0.041780252,1.418481,0.09326925,-0.06625125,1.3883828,0.069507,-0.013522499,1.40049,0.0988605,-0.021599999,1.3898183,0.09364501,-0.0701415,1.3931887,0.067113005,-0.065421,1.4220135,0.080226004,-0.080505,1.4098231,0.062649004,-0.0588735,1.3877865,0.07619625,-0.0340335,1.3880363,0.088218,-0.0387135,1.4152567,0.08419275,-0.06027975,1.4180603,0.0730845,-0.072225004,1.4094428,0.0596025,-0.065889,1.3987283,0.06316425,-0.061913252,1.395549,0.0653895,-0.05586975,1.3950877,0.07102125,-0.03096,1.3957515,0.0821655,-0.0202275,1.3975043,0.0861435,-0.016312499,1.4013765,0.08707275,-0.02621925,1.4096116,0.0877455,-0.0546795,1.4028931,0.095818505}, 93);
...
Shape807.setGeometry(&IndexedFaceSet811);

HAnimSegment806.addChild(&Shape807);

HAnimJoint805.addChildren(&HAnimSegment806);

HAnimJoint769.addChildren(&HAnimJoint805);

HAnimJoint& HAnimJoint814 =  HAnimJoint();
HAnimJoint814.X3DNode::setName(std::string("l_eyebrow_joint"));
HAnimJoint814.setDEF(std::string("hanim_l_eyebrow_joint"));
HAnimJoint814.setCenter(new float[]{0.021748502,1.4139,0.1069425});
HAnimSegment& HAnimSegment815 =  HAnimSegment();
HAnimSegment815.X3DNode::setName(std::string("l_eyebrow"));
...
Shape816.setGeometry(&IndexedFaceSet820);

HAnimSegment815.addChild(&Shape816);

HAnimJoint814.addChildren(&HAnimSegment815);

HAnimJoint769.addChildren(&HAnimJoint814);

HAnimJoint& HAnimJoint823 =  HAnimJoint();
HAnimJoint823.X3DNode::setName(std::string("r_eyebrow_joint"));
HAnimJoint823.setDEF(std::string("hanim_r_eyebrow_joint"));
HAnimJoint823.setCenter(new float[]{-0.021748502,1.4139,0.1069425});
HAnimSegment& HAnimSegment824 =  HAnimSegment();
HAnimSegment824.X3DNode::setName(std::string("r_eyebrow"));
...
Coordinate830.setPoint(new float[]{-0.014508001,1.4087296,0.12278925,-0.046116002,1.4273416,0.1154835,-0.0464085,1.4234064,0.114228,-0.07300351,1.4280931,0.09362475,-0.086751,1.4287546,0.0771975,-0.02509875,1.420407,0.12194325,-0.073521,1.4311485,0.093296245,-0.046881,1.4196465,0.1114965,-0.0714285,1.4240319,0.09249975,-0.01602675,1.4072468,0.120141,-0.0863685,1.426707,0.076725,-0.0155070005,1.4090401,0.1170135,-0.046026003,1.4268713,0.1108215,-0.084906004,1.428678,0.075757496,-0.02571075,1.4199684,0.1166895,-0.072801,1.4305388,0.09049725,-0.046746,1.4193541,0.107163,-0.0705735,1.423665,0.089759246,-0.017172001,1.4074875,0.11459025,-0.08429851,1.4261446,0.075307496,-0.027978752,1.4166541,0.11952225,-0.030271502,1.4138843,0.116379,-0.029373752,1.4129685,0.11156175}, 69);
...
HAnimSegment824.addChild(&Shape825);

HAnimJoint823.addChildren(&HAnimSegment824);

HAnimJoint769.addChildren(&HAnimJoint823);

HAnimJoint& HAnimJoint832 =  HAnimJoint();
HAnimJoint832.X3DNode::setName(std::string("temporomandibular"));
HAnimJoint832.setDEF(std::string("hanim_temporomandibular"));
HAnimJoint832.setCenter(new float[]{0.0,1.312875,0.015378751});
HAnimSegment& HAnimSegment833 =  HAnimSegment();
HAnimSegment833.X3DNode::setName(std::string("jaw"));
...
HAnimSegment833.addChild(&Shape834);

HAnimJoint832.addChildren(&HAnimSegment833);

HAnimJoint769.addChildren(&HAnimJoint832);

HAnimJoint760.addChildren(&HAnimJoint769);

HAnimJoint751.addChildren(&HAnimJoint760);

HAnimJoint742.addChildren(&HAnimJoint751);

HAnimJoint733.addChildren(&HAnimJoint742);

HAnimJoint724.addChildren(&HAnimJoint733);
...
HAnimJoint841.X3DNode::setName(std::string("l_sternoclavicular"));
HAnimJoint841.setDEF(std::string("hanim_l_sternoclavicular"));
HAnimJoint841.setCenter(new float[]{0.038475003,1.2087001,-0.013785751});
HAnimSegment& HAnimSegment842 =  HAnimSegment();
HAnimSegment842.X3DNode::setName(std::string("l_clavicle"));
...
IndexedFaceSet847.setCoordIndex(new int32_t[]{9,6,1,-1,1,0,9,-1,6,5,2,-1,2,1,6,-1,8,3,2,-1,2,5,8,-1,8,7,4,-1,4,3,8,-1,9,0,4,-1,4,7,9,-1,2,3,4,-1,2,4,0,-1,1,2,0,-1,13,14,10,-1,12,13,10,-1,11,12,10,-1,6,9,11,-1,11,10,6,-1,9,7,12,-1,12,11,9,-1,7,8,13,-1,13,12,7,-1,8,5,14,-1,14,13,8,-1,5,6,10,-1,10,14,5,-1}, 104);
IndexedFaceSet847.setCreaseAngle(3.14159);
IndexedFaceSet847.setTexCoordIndex(new int32_t[]{9,6,1,-1,1,0,9,-1,6,5,2,-1,2,1,6,-1,8,3,2,-1,2,5,8,-1,8,7,4,-1,4,3,8,-1,9,0,4,-1,4,7,9,-1,2,3,4,-1,2,4,0,-1,1,2,0,-1,13,14,10,-1,12,13,10,-1,11,12,10,-1,6,9,11,-1,11,10,6,-1,9,7,12,-1,12,11,9,-1,7,8,13,-1,13,12,7,-1,8,5,14,-1,14,13,8,-1,5,6,10,-1,10,14,5,-1}, 104);
Coordinate& Coordinate848 =  Coordinate();
Coordinate848.setPoint(new float[]{0.15075,1.21104,-0.033234753,0.1526175,1.2199343,-0.012728251,0.14436,1.2125138,0.0131692495,0.14267251,1.1677725,0.01105425,0.14166,1.1716201,-0.01659375,0.114435,1.217439,0.026061753,0.1260225,1.2309526,-0.014994,0.1328175,1.152675,-0.026640002,0.137205,1.152675,0.018366752,0.1230975,1.2159855,-0.051855754,0.035691753,1.222902,-0.0180225,0.035691753,1.2154658,-0.034994252,0.035691753,1.1767951,-0.019584,0.035691753,1.1773801,0.0003082502,0.035691753,1.2145185,0.0046170005}, 45);
...
HAnimJoint850.X3DNode::setName(std::string("l_acromioclavicular"));
HAnimJoint850.setDEF(std::string("hanim_l_acromioclavicular"));
HAnimJoint850.setCenter(new float[]{0.12294001,1.191825,-0.012897001});
HAnimSegment& HAnimSegment851 =  HAnimSegment();
HAnimSegment851.X3DNode::setName(std::string("l_scapula"));
...
Shape852.addChild(&Appearance853);
...
IndexedFaceSet856.setCreaseAngle(3.14159);
...
Shape852.setGeometry(&IndexedFaceSet856);

HAnimSegment851.addChild(&Shape852);

HAnimJoint850.addChildren(&HAnimSegment851);

HAnimJoint& HAnimJoint859 =  HAnimJoint();
HAnimJoint859.X3DNode::setName(std::string("l_shoulder"));
HAnimJoint859.setDEF(std::string("hanim_l_shoulder"));
HAnimJoint859.setCenter(new float[]{0.16506,1.1785501,-0.0032670002});
HAnimSegment& HAnimSegment860 =  HAnimSegment();
HAnimSegment860.X3DNode::setName(std::string("l_upperarm"));
...
Shape861.setGeometry(&IndexedFaceSet865);

HAnimSegment860.addChild(&Shape861);

HAnimJoint859.addChildren(&HAnimSegment860);

HAnimJoint& HAnimJoint868 =  HAnimJoint();
HAnimJoint868.X3DNode::setName(std::string("l_elbow"));
HAnimJoint868.setDEF(std::string("hanim_l_elbow"));
HAnimJoint868.setCenter(new float[]{0.18209252,0.9288,-0.0056295004});
HAnimSegment& HAnimSegment869 =  HAnimSegment();
HAnimSegment869.X3DNode::setName(std::string("l_forearm"));
...
IndexedFaceSet874.setCreaseAngle(3.14159);
...
HAnimSegment869.addChild(&Shape870);

HAnimJoint868.addChildren(&HAnimSegment869);

HAnimJoint& HAnimJoint877 =  HAnimJoint();
HAnimJoint877.X3DNode::setName(std::string("l_radiocarpal"));
HAnimJoint877.setDEF(std::string("hanim_l_radiocarpal"));
HAnimJoint877.setCenter(new float[]{0.18193501,0.724275,-0.00502425});
HAnimSegment& HAnimSegment878 =  HAnimSegment();
HAnimSegment878.X3DNode::setName(std::string("l_carpal"));
...
HAnimJoint& HAnimJoint886 =  HAnimJoint();
HAnimJoint886.X3DNode::setName(std::string("l_midcarpal_1"));
HAnimJoint886.setDEF(std::string("hanim_l_midcarpal_1"));
HAnimJoint886.setCenter(new float[]{0.1812825,0.70605004,0.0193275});
HAnimSegment& HAnimSegment887 =  HAnimSegment();
HAnimSegment887.X3DNode::setName(std::string("l_trapezium"));
...
Shape888.addChild(&Appearance889);
...
Shape888.setGeometry(&IndexedFaceSet892);

HAnimSegment887.addChild(&Shape888);

HAnimJoint886.addChildren(&HAnimSegment887);

HAnimJoint& HAnimJoint895 =  HAnimJoint();
HAnimJoint895.X3DNode::setName(std::string("l_carpometacarpal_1"));
HAnimJoint895.setDEF(std::string("hanim_l_carpometacarpal_1"));
HAnimJoint895.setCenter(new float[]{0.18049501,0.69255006,0.0259875});
HAnimSegment& HAnimSegment896 =  HAnimSegment();
HAnimSegment896.X3DNode::setName(std::string("l_metacarpal_1"));
...
Shape897.setGeometry(&IndexedFaceSet901);
...
HAnimJoint904.X3DNode::setName(std::string("l_metacarpophalangeal_1"));
HAnimJoint904.setDEF(std::string("hanim_l_metacarpophalangeal_1"));
HAnimJoint904.setCenter(new float[]{0.181035,0.67275,0.035775002});
HAnimSegment& HAnimSegment905 =  HAnimSegment();
HAnimSegment905.X3DNode::setName(std::string("l_carpal_proximal_phalanx_1"));
...
Shape906.addChild(&Appearance907);

IndexedFaceSet& IndexedFaceSet910 =  IndexedFaceSet();
...
IndexedFaceSet910.setCreaseAngle(3.14159);
...
Shape906.setGeometry(&IndexedFaceSet910);

HAnimSegment905.addChild(&Shape906);

HAnimJoint904.addChildren(&HAnimSegment905);

HAnimJoint& HAnimJoint913 =  HAnimJoint();
HAnimJoint913.X3DNode::setName(std::string("l_carpal_interphalangeal_1"));
HAnimJoint913.setDEF(std::string("hanim_l_carpal_interphalangeal_1"));
HAnimJoint913.setCenter(new float[]{0.182655,0.654075,0.0496575});
HAnimSegment& HAnimSegment914 =  HAnimSegment();
HAnimSegment914.X3DNode::setName(std::string("l_carpal_distal_phalanx_1"));
...
HAnimSegment914.addChild(&Shape915);

HAnimJoint913.addChildren(&HAnimSegment914);

HAnimJoint904.addChildren(&HAnimJoint913);
...
HAnimJoint922.X3DNode::setName(std::string("l_midcarpal_2"));
HAnimJoint922.setDEF(std::string("hanim_l_midcarpal_2"));
HAnimJoint922.setCenter(new float[]{0.1812825,0.70695,0.008417251});
HAnimSegment& HAnimSegment923 =  HAnimSegment();
HAnimSegment923.X3DNode::setName(std::string("l_trapezoid"));
...
HAnimJoint931.X3DNode::setName(std::string("l_carpometacarpal_2"));
HAnimJoint931.setDEF(std::string("hanim_l_carpometacarpal_2"));
HAnimJoint931.setCenter(new float[]{0.1812825,0.6876,0.009729});
HAnimSegment& HAnimSegment932 =  HAnimSegment();
HAnimSegment932.X3DNode::setName(std::string("l_metacarpal_2"));
...
HAnimJoint940.X3DNode::setName(std::string("l_metacarpophalangeal_2"));
HAnimJoint940.setDEF(std::string("hanim_l_metacarpophalangeal_2"));
HAnimJoint940.setCenter(new float[]{0.18373501,0.6372,0.015075001});
HAnimSegment& HAnimSegment941 =  HAnimSegment();
HAnimSegment941.X3DNode::setName(std::string("l_carpal_proximal_phalanx_2"));
...
Shape942.setGeometry(&IndexedFaceSet946);

HAnimSegment941.addChild(&Shape942);

HAnimJoint940.addChildren(&HAnimSegment941);

HAnimJoint& HAnimJoint949 =  HAnimJoint();
HAnimJoint949.X3DNode::setName(std::string("l_carpal_proximal_interphalangeal_2"));
HAnimJoint949.setDEF(std::string("hanim_l_carpal_proximal_interphalangeal_2"));
HAnimJoint949.setCenter(new float[]{0.18171,0.606825,0.014184001});
HAnimSegment& HAnimSegment950 =  HAnimSegment();
HAnimSegment950.X3DNode::setName(std::string("l_carpal_middle_phalanx_2"));
...
Shape951.setGeometry(&IndexedFaceSet955);

HAnimSegment950.addChild(&Shape951);

HAnimJoint949.addChildren(&HAnimSegment950);

HAnimJoint& HAnimJoint958 =  HAnimJoint();
HAnimJoint958.X3DNode::setName(std::string("l_carpal_distal_interphalangeal_2"));
HAnimJoint958.setDEF(std::string("hanim_l_carpal_distal_interphalangeal_2"));
HAnimJoint958.setCenter(new float[]{0.180675,0.58162504,0.013385251});
HAnimSegment& HAnimSegment959 =  HAnimSegment();
HAnimSegment959.X3DNode::setName(std::string("l_carpal_distal_phalanx_2"));
...
Shape960.setGeometry(&IndexedFaceSet964);

HAnimSegment959.addChild(&Shape960);

HAnimJoint958.addChildren(&HAnimSegment959);

HAnimJoint949.addChildren(&HAnimJoint958);

HAnimJoint940.addChildren(&HAnimJoint949);

HAnimJoint931.addChildren(&HAnimJoint940);

HAnimJoint922.addChildren(&HAnimJoint931);

HAnimJoint877.addChildren(&HAnimJoint922);

HAnimJoint& HAnimJoint967 =  HAnimJoint();
HAnimJoint967.X3DNode::setName(std::string("l_midcarpal_3"));
HAnimJoint967.setDEF(std::string("hanim_l_midcarpal_3"));
HAnimJoint967.setCenter(new float[]{0.18108001,0.708525,-0.0047970004});
HAnimSegment& HAnimSegment968 =  HAnimSegment();
HAnimSegment968.X3DNode::setName(std::string("l_capitate"));
...
HAnimSegment968.addChild(&Shape969);

HAnimJoint967.addChildren(&HAnimSegment968);

HAnimJoint& HAnimJoint976 =  HAnimJoint();
HAnimJoint976.X3DNode::setName(std::string("l_carpometacarpal_3"));
HAnimJoint976.setDEF(std::string("hanim_l_carpometacarpal_3"));
HAnimJoint976.setCenter(new float[]{0.18108001,0.6858,-0.0062527503});
HAnimSegment& HAnimSegment977 =  HAnimSegment();
HAnimSegment977.X3DNode::setName(std::string("l_metacarpal_3"));
...
HAnimJoint985.X3DNode::setName(std::string("l_metacarpophalangeal_3"));
HAnimJoint985.setDEF(std::string("hanim_l_metacarpophalangeal_3"));
HAnimJoint985.setCenter(new float[]{0.18369,0.63495,-0.00391725});
HAnimSegment& HAnimSegment986 =  HAnimSegment();
HAnimSegment986.X3DNode::setName(std::string("l_carpal_proximal_phalanx_3"));
...
Shape987.setGeometry(&IndexedFaceSet991);

HAnimSegment986.addChild(&Shape987);

HAnimJoint985.addChildren(&HAnimSegment986);

HAnimJoint& HAnimJoint994 =  HAnimJoint();
HAnimJoint994.X3DNode::setName(std::string("l_carpal_proximal_interphalangeal_3"));
HAnimJoint994.setDEF(std::string("hanim_l_carpal_proximal_interphalangeal_3"));
HAnimJoint994.setCenter(new float[]{0.18171,0.603225,-0.003537});
HAnimSegment& HAnimSegment995 =  HAnimSegment();
HAnimSegment995.X3DNode::setName(std::string("l_carpal_middle_phalanx_3"));
...
Shape996.setGeometry(&IndexedFaceSet1000);

HAnimSegment995.addChild(&Shape996);

HAnimJoint994.addChildren(&HAnimSegment995);

HAnimJoint& HAnimJoint1003 =  HAnimJoint();
HAnimJoint1003.X3DNode::setName(std::string("l_carpal_distal_interphalangeal_3"));
HAnimJoint1003.setDEF(std::string("hanim_l_carpal_distal_interphalangeal_3"));
HAnimJoint1003.setCenter(new float[]{0.180675,0.575325,-0.0037597502});
HAnimSegment& HAnimSegment1004 =  HAnimSegment();
HAnimSegment1004.X3DNode::setName(std::string("l_carpal_distal_phalanx_3"));
...
HAnimSegment1004.addChild(&Shape1005);

HAnimJoint1003.addChildren(&HAnimSegment1004);

HAnimJoint994.addChildren(&HAnimJoint1003);

HAnimJoint985.addChildren(&HAnimJoint994);

HAnimJoint976.addChildren(&HAnimJoint985);

HAnimJoint967.addChildren(&HAnimJoint976);

HAnimJoint877.addChildren(&HAnimJoint967);

HAnimJoint& HAnimJoint1012 =  HAnimJoint();
HAnimJoint1012.X3DNode::setName(std::string("l_midcarpal_4_5"));
HAnimJoint1012.setDEF(std::string("hanim_l_midcarpal_4_5"));
HAnimJoint1012.setCenter(new float[]{0.18108001,0.70582503,-0.025740001});
HAnimSegment& HAnimSegment1013 =  HAnimSegment();
HAnimSegment1013.X3DNode::setName(std::string("l_hamate"));
...
HAnimSegment1013.addChild(&Shape1014);

HAnimJoint1012.addChildren(&HAnimSegment1013);

HAnimJoint& HAnimJoint1021 =  HAnimJoint();
HAnimJoint1021.X3DNode::setName(std::string("l_carpometacarpal_4"));
HAnimJoint1021.setDEF(std::string("hanim_l_carpometacarpal_4"));
HAnimJoint1021.setCenter(new float[]{0.18108001,0.68625003,-0.01991925});
HAnimSegment& HAnimSegment1022 =  HAnimSegment();
HAnimSegment1022.X3DNode::setName(std::string("l_metacarpal_4"));
...
HAnimSegment1022.addChild(&Shape1023);

HAnimJoint1021.addChildren(&HAnimSegment1022);

HAnimJoint& HAnimJoint1030 =  HAnimJoint();
HAnimJoint1030.X3DNode::setName(std::string("l_metacarpophalangeal_4"));
HAnimJoint1030.setDEF(std::string("hanim_l_metacarpophalangeal_4"));
HAnimJoint1030.setCenter(new float[]{0.18369,0.63405,-0.02144025});
HAnimSegment& HAnimSegment1031 =  HAnimSegment();
HAnimSegment1031.X3DNode::setName(std::string("l_carpal_proximal_phalanx_4"));
...
Shape1032.setGeometry(&IndexedFaceSet1036);

HAnimSegment1031.addChild(&Shape1032);

HAnimJoint1030.addChildren(&HAnimSegment1031);

HAnimJoint& HAnimJoint1039 =  HAnimJoint();
HAnimJoint1039.X3DNode::setName(std::string("l_carpal_proximal_interphalangeal_4"));
HAnimJoint1039.setDEF(std::string("hanim_l_carpal_proximal_interphalangeal_4"));
HAnimJoint1039.setCenter(new float[]{0.18171,0.6066,-0.020646});
HAnimSegment& HAnimSegment1040 =  HAnimSegment();
HAnimSegment1040.X3DNode::setName(std::string("l_carpal_middle_phalanx_4"));
...
Shape1041.setGeometry(&IndexedFaceSet1045);

HAnimSegment1040.addChild(&Shape1041);

HAnimJoint1039.addChildren(&HAnimSegment1040);

HAnimJoint& HAnimJoint1048 =  HAnimJoint();
HAnimJoint1048.X3DNode::setName(std::string("l_carpal_distal_interphalangeal_4"));
HAnimJoint1048.setDEF(std::string("hanim_l_carpal_distal_interphalangeal_4"));
HAnimJoint1048.setCenter(new float[]{0.180675,0.580725,-0.019777501});
HAnimSegment& HAnimSegment1049 =  HAnimSegment();
HAnimSegment1049.X3DNode::setName(std::string("l_carpal_distal_phalanx_4"));
...
Shape1050.setGeometry(&IndexedFaceSet1054);
...
HAnimJoint1030.addChildren(&HAnimJoint1039);

HAnimJoint1021.addChildren(&HAnimJoint1030);

HAnimJoint1012.addChildren(&HAnimJoint1021);

HAnimJoint877.addChildren(&HAnimJoint1012);

HAnimJoint& HAnimJoint1057 =  HAnimJoint();
HAnimJoint1057.X3DNode::setName(std::string("l_carpometacarpal_5"));
HAnimJoint1057.setDEF(std::string("hanim_l_carpometacarpal_5"));
HAnimJoint1057.setCenter(new float[]{0.1816425,0.68827504,-0.032782502});
HAnimSegment& HAnimSegment1058 =  HAnimSegment();
HAnimSegment1058.X3DNode::setName(std::string("l_metacarpal_5"));
...
HAnimSegment1058.addChild(&Shape1059);

HAnimJoint1057.addChildren(&HAnimSegment1058);

HAnimJoint& HAnimJoint1066 =  HAnimJoint();
HAnimJoint1066.X3DNode::setName(std::string("l_metacarpophalangeal_5"));
HAnimJoint1066.setDEF(std::string("hanim_l_metacarpophalangeal_5"));
HAnimJoint1066.setCenter(new float[]{0.18333,0.6381,-0.0370575});
HAnimSegment& HAnimSegment1067 =  HAnimSegment();
HAnimSegment1067.X3DNode::setName(std::string("l_carpal_proximal_phalanx_5"));
...
Shape1068.addChild(&Appearance1069);
...
Shape1068.setGeometry(&IndexedFaceSet1072);

HAnimSegment1067.addChild(&Shape1068);

HAnimJoint1066.addChildren(&HAnimSegment1067);

HAnimJoint& HAnimJoint1075 =  HAnimJoint();
HAnimJoint1075.X3DNode::setName(std::string("l_carpal_proximal_interphalangeal_5"));
HAnimJoint1075.setDEF(std::string("hanim_l_carpal_proximal_interphalangeal_5"));
HAnimJoint1075.setCenter(new float[]{0.18166502,0.62100005,-0.037147503});
HAnimSegment& HAnimSegment1076 =  HAnimSegment();
HAnimSegment1076.X3DNode::setName(std::string("l_carpal_middle_phalanx_5"));
...
Shape1077.setGeometry(&IndexedFaceSet1081);

HAnimSegment1076.addChild(&Shape1077);

HAnimJoint1075.addChildren(&HAnimSegment1076);

HAnimJoint& HAnimJoint1084 =  HAnimJoint();
HAnimJoint1084.X3DNode::setName(std::string("l_carpal_distal_interphalangeal_5"));
HAnimJoint1084.setDEF(std::string("hanim_l_carpal_distal_interphalangeal_5"));
HAnimJoint1084.setCenter(new float[]{0.18081002,0.602325,-0.0369675});
HAnimSegment& HAnimSegment1085 =  HAnimSegment();
HAnimSegment1085.X3DNode::setName(std::string("l_carpal_distal_phalanx_5"));
...
Shape1086.setGeometry(&IndexedFaceSet1090);
...
HAnimJoint1066.addChildren(&HAnimJoint1075);

HAnimJoint1057.addChildren(&HAnimJoint1066);

HAnimJoint877.addChildren(&HAnimJoint1057);

HAnimJoint868.addChildren(&HAnimJoint877);

HAnimJoint859.addChildren(&HAnimJoint868);

HAnimJoint850.addChildren(&HAnimJoint859);

HAnimJoint841.addChildren(&HAnimJoint850);

HAnimJoint697.addChildren(&HAnimJoint841);

HAnimJoint& HAnimJoint1093 =  HAnimJoint();
HAnimJoint1093.X3DNode::setName(std::string("r_sternoclavicular"));
HAnimJoint1093.setDEF(std::string("hanim_r_sternoclavicular"));
HAnimJoint1093.setCenter(new float[]{-0.038475003,1.2087001,-0.013785751});
HAnimSegment& HAnimSegment1094 =  HAnimSegment();
HAnimSegment1094.X3DNode::setName(std::string("r_clavicle"));
...
IndexedFaceSet1099.setCoordIndex(new int32_t[]{9,0,1,-1,1,6,9,-1,6,1,2,-1,2,5,6,-1,8,5,2,-1,2,3,8,-1,8,3,4,-1,4,7,8,-1,9,7,4,-1,4,0,9,-1,4,3,2,-1,0,4,2,-1,1,0,2,-1,10,14,13,-1,10,13,12,-1,11,10,12,-1,6,10,11,-1,11,9,6,-1,9,11,12,-1,12,7,9,-1,7,12,13,-1,13,8,7,-1,8,13,14,-1,14,5,8,-1,5,14,10,-1,10,6,5,-1}, 104);
IndexedFaceSet1099.setCreaseAngle(3.14159);
IndexedFaceSet1099.setTexCoordIndex(new int32_t[]{9,0,1,-1,1,6,9,-1,6,1,2,-1,2,5,6,-1,8,5,2,-1,2,3,8,-1,8,3,4,-1,4,7,8,-1,9,7,4,-1,4,0,9,-1,4,3,2,-1,0,4,2,-1,1,0,2,-1,10,14,13,-1,10,13,12,-1,11,10,12,-1,6,10,11,-1,11,9,6,-1,9,11,12,-1,12,7,9,-1,7,12,13,-1,13,8,7,-1,8,13,14,-1,14,5,8,-1,5,14,10,-1,10,6,5,-1}, 104);
Coordinate& Coordinate1100 =  Coordinate();
Coordinate1100.setPoint(new float[]{-0.15075,1.21104,-0.033234753,-0.1526175,1.2199343,-0.012728251,-0.14436,1.2125138,0.0131692495,-0.14267251,1.1677725,0.01105425,-0.14166,1.1716201,-0.01659375,-0.114435,1.217439,0.026061753,-0.1260225,1.2309526,-0.014994,-0.1328175,1.152675,-0.026640002,-0.137205,1.152675,0.018366752,-0.1230975,1.2159855,-0.051855754,-0.035691753,1.222902,-0.0180225,-0.035691753,1.2154658,-0.034994252,-0.035691753,1.1767951,-0.019584,-0.035691753,1.1773801,0.0003082502,-0.035691753,1.2145185,0.0046170005}, 45);
...
HAnimSegment1094.addChild(&Shape1095);

HAnimJoint1093.addChildren(&HAnimSegment1094);

HAnimJoint& HAnimJoint1102 =  HAnimJoint();
HAnimJoint1102.X3DNode::setName(std::string("r_acromioclavicular"));
HAnimJoint1102.setDEF(std::string("hanim_r_acromioclavicular"));
HAnimJoint1102.setCenter(new float[]{-0.12294001,1.191825,-0.012897001});
HAnimSegment& HAnimSegment1103 =  HAnimSegment();
HAnimSegment1103.X3DNode::setName(std::string("r_scapula"));
...
Coordinate1109.setPoint(new float[]{-0.16647752,1.2248101,-0.014994,-0.15702751,1.2064321,-0.051867,-0.15745501,1.2078114,0.0235305,-0.11443051,1.2174525,0.026073001,-0.1260315,1.230975,-0.014994,-0.12311101,1.2159901,-0.0518445,-0.14170726,1.156455,0.018378,-0.13281976,1.152675,-0.02664225,-0.14155877,1.156275,-0.0266175,-0.1372095,1.152675,0.018355502,-0.09510751,1.2234826,-0.014499,-0.08813251,1.2109839,-0.038592,-0.10600876,1.1557575,-0.023571001,-0.10604026,1.1559376,0.013203,-0.088965006,1.21509,0.016263,-0.087165006,1.1914089,-0.00985725}, 48);
...
HAnimJoint1111.X3DNode::setName(std::string("r_shoulder"));
HAnimJoint1111.setDEF(std::string("hanim_r_shoulder"));
HAnimJoint1111.setCenter(new float[]{-0.16470002,1.1785501,-0.0032670002});
HAnimSegment& HAnimSegment1112 =  HAnimSegment();
HAnimSegment1112.X3DNode::setName(std::string("r_upperarm"));
...
HAnimSegment1112.addChild(&Shape1113);

HAnimJoint1111.addChildren(&HAnimSegment1112);

HAnimJoint& HAnimJoint1120 =  HAnimJoint();
HAnimJoint1120.X3DNode::setName(std::string("r_elbow"));
HAnimJoint1120.setDEF(std::string("hanim_r_elbow"));
HAnimJoint1120.setCenter(new float[]{-0.1817325,0.9288,-0.0056295004});
HAnimSegment& HAnimSegment1121 =  HAnimSegment();
HAnimSegment1121.X3DNode::setName(std::string("r_forearm"));
...
Shape1122.setGeometry(&IndexedFaceSet1126);
...
HAnimJoint1129.X3DNode::setName(std::string("r_radiocarpal"));
HAnimJoint1129.setDEF(std::string("hanim_r_radiocarpal"));
HAnimJoint1129.setCenter(new float[]{-0.181575,0.724275,-0.005022});
HAnimSegment& HAnimSegment1130 =  HAnimSegment();
HAnimSegment1130.X3DNode::setName(std::string("r_carpal"));
...
Shape1131.setGeometry(&IndexedFaceSet1135);

HAnimSegment1130.addChild(&Shape1131);

HAnimJoint1129.addChildren(&HAnimSegment1130);

HAnimJoint& HAnimJoint1138 =  HAnimJoint();
HAnimJoint1138.X3DNode::setName(std::string("r_midcarpal_1"));
HAnimJoint1138.setDEF(std::string("hanim_r_midcarpal_1"));
HAnimJoint1138.setCenter(new float[]{-0.18096751,0.70605004,0.0193275});
HAnimSegment& HAnimSegment1139 =  HAnimSegment();
HAnimSegment1139.X3DNode::setName(std::string("r_trapezium"));
...
Shape1140.addChild(&Appearance1141);

IndexedFaceSet& IndexedFaceSet1144 =  IndexedFaceSet();
...
Shape1140.setGeometry(&IndexedFaceSet1144);

HAnimSegment1139.addChild(&Shape1140);

HAnimJoint1138.addChildren(&HAnimSegment1139);

HAnimJoint& HAnimJoint1147 =  HAnimJoint();
HAnimJoint1147.X3DNode::setName(std::string("r_carpometacarpal_1"));
HAnimJoint1147.setDEF(std::string("hanim_r_carpometacarpal_1"));
HAnimJoint1147.setCenter(new float[]{-0.180135,0.69255006,0.0259875});
HAnimSegment& HAnimSegment1148 =  HAnimSegment();
HAnimSegment1148.X3DNode::setName(std::string("r_metacarpal_1"));
...
HAnimSegment1148.addChild(&Shape1149);

HAnimJoint1147.addChildren(&HAnimSegment1148);

HAnimJoint& HAnimJoint1156 =  HAnimJoint();
HAnimJoint1156.X3DNode::setName(std::string("r_metacarpophalangeal_1"));
HAnimJoint1156.setDEF(std::string("hanim_r_metacarpophalangeal_1"));
HAnimJoint1156.setCenter(new float[]{-0.18065251,0.67275,0.035775002});
HAnimSegment& HAnimSegment1157 =  HAnimSegment();
HAnimSegment1157.X3DNode::setName(std::string("r_carpal_proximal_phalanx_1"));
...
Shape1158.setGeometry(&IndexedFaceSet1162);

HAnimSegment1157.addChild(&Shape1158);

HAnimJoint1156.addChildren(&HAnimSegment1157);

HAnimJoint& HAnimJoint1165 =  HAnimJoint();
HAnimJoint1165.X3DNode::setName(std::string("r_carpal_interphalangeal_1"));
HAnimJoint1165.setDEF(std::string("hanim_r_carpal_interphalangeal_1"));
HAnimJoint1165.setCenter(new float[]{-0.18227251,0.654075,0.0496575});
HAnimSegment& HAnimSegment1166 =  HAnimSegment();
HAnimSegment1166.X3DNode::setName(std::string("r_carpal_distal_phalanx_1"));
...
Shape1167.setGeometry(&IndexedFaceSet1171);

HAnimSegment1166.addChild(&Shape1167);

HAnimJoint1165.addChildren(&HAnimSegment1166);

HAnimJoint1156.addChildren(&HAnimJoint1165);

HAnimJoint1147.addChildren(&HAnimJoint1156);
...
HAnimJoint1174.X3DNode::setName(std::string("r_midcarpal_2"));
HAnimJoint1174.setDEF(std::string("hanim_r_midcarpal_2"));
HAnimJoint1174.setCenter(new float[]{-0.18096751,0.70695,0.008417251});
HAnimSegment& HAnimSegment1175 =  HAnimSegment();
HAnimSegment1175.X3DNode::setName(std::string("r_trapezoid"));
...
Shape1176.setGeometry(&IndexedFaceSet1180);

HAnimSegment1175.addChild(&Shape1176);

HAnimJoint1174.addChildren(&HAnimSegment1175);

HAnimJoint& HAnimJoint1183 =  HAnimJoint();
HAnimJoint1183.X3DNode::setName(std::string("r_carpometacarpal_2"));
HAnimJoint1183.setDEF(std::string("hanim_r_carpometacarpal_2"));
HAnimJoint1183.setCenter(new float[]{-0.18090001,0.6876,0.009729});
HAnimSegment& HAnimSegment1184 =  HAnimSegment();
HAnimSegment1184.X3DNode::setName(std::string("r_metacarpal_2"));
...
HAnimSegment1184.addChild(&Shape1185);

HAnimJoint1183.addChildren(&HAnimSegment1184);

HAnimJoint& HAnimJoint1192 =  HAnimJoint();
HAnimJoint1192.X3DNode::setName(std::string("r_metacarpophalangeal_2"));
HAnimJoint1192.setDEF(std::string("hanim_r_metacarpophalangeal_2"));
HAnimJoint1192.setCenter(new float[]{-0.18335252,0.6372,0.015075001});
HAnimSegment& HAnimSegment1193 =  HAnimSegment();
HAnimSegment1193.X3DNode::setName(std::string("r_carpal_proximal_phalanx_2"));
...
HAnimJoint1201.X3DNode::setName(std::string("r_carpal_proximal_interphalangeal_2"));
HAnimJoint1201.setDEF(std::string("hanim_r_carpal_proximal_interphalangeal_2"));
HAnimJoint1201.setCenter(new float[]{-0.1813275,0.606825,0.014184001});
HAnimSegment& HAnimSegment1202 =  HAnimSegment();
HAnimSegment1202.X3DNode::setName(std::string("r_carpal_middle_phalanx_2"));
...
HAnimSegment1202.addChild(&Shape1203);

HAnimJoint1201.addChildren(&HAnimSegment1202);

HAnimJoint& HAnimJoint1210 =  HAnimJoint();
HAnimJoint1210.X3DNode::setName(std::string("r_carpal_distal_interphalangeal_2"));
HAnimJoint1210.setDEF(std::string("hanim_r_carpal_distal_interphalangeal_2"));
HAnimJoint1210.setCenter(new float[]{-0.1802925,0.58162504,0.013385251});
HAnimSegment& HAnimSegment1211 =  HAnimSegment();
HAnimSegment1211.X3DNode::setName(std::string("r_carpal_distal_phalanx_2"));
...
Shape1212.setGeometry(&IndexedFaceSet1216);

HAnimSegment1211.addChild(&Shape1212);

HAnimJoint1210.addChildren(&HAnimSegment1211);

HAnimJoint1201.addChildren(&HAnimJoint1210);

HAnimJoint1192.addChildren(&HAnimJoint1201);

HAnimJoint1183.addChildren(&HAnimJoint1192);

HAnimJoint1174.addChildren(&HAnimJoint1183);

HAnimJoint1129.addChildren(&HAnimJoint1174);

HAnimJoint& HAnimJoint1219 =  HAnimJoint();
HAnimJoint1219.X3DNode::setName(std::string("r_midcarpal_3"));
HAnimJoint1219.setDEF(std::string("hanim_r_midcarpal_3"));
HAnimJoint1219.setCenter(new float[]{-0.18072,0.708525,-0.0047970004});
HAnimSegment& HAnimSegment1220 =  HAnimSegment();
HAnimSegment1220.X3DNode::setName(std::string("r_capitate"));
...
Shape1221.setGeometry(&IndexedFaceSet1225);

HAnimSegment1220.addChild(&Shape1221);

HAnimJoint1219.addChildren(&HAnimSegment1220);

HAnimJoint& HAnimJoint1228 =  HAnimJoint();
HAnimJoint1228.X3DNode::setName(std::string("r_carpometacarpal_3"));
HAnimJoint1228.setDEF(std::string("hanim_r_carpometacarpal_3"));
HAnimJoint1228.setCenter(new float[]{-0.18072,0.6858,-0.0062527503});
HAnimSegment& HAnimSegment1229 =  HAnimSegment();
HAnimSegment1229.X3DNode::setName(std::string("r_metacarpal_3"));
...
Shape1230.setGeometry(&IndexedFaceSet1234);
...
HAnimJoint1237.X3DNode::setName(std::string("r_metacarpophalangeal_3"));
HAnimJoint1237.setDEF(std::string("hanim_r_metacarpophalangeal_3"));
HAnimJoint1237.setCenter(new float[]{-0.18330751,0.63495,-0.00391725});
HAnimSegment& HAnimSegment1238 =  HAnimSegment();
HAnimSegment1238.X3DNode::setName(std::string("r_carpal_proximal_phalanx_3"));
...
HAnimSegment1238.addChild(&Shape1239);

HAnimJoint1237.addChildren(&HAnimSegment1238);

HAnimJoint& HAnimJoint1246 =  HAnimJoint();
HAnimJoint1246.X3DNode::setName(std::string("r_carpal_proximal_interphalangeal_3"));
HAnimJoint1246.setDEF(std::string("hanim_r_carpal_proximal_interphalangeal_3"));
HAnimJoint1246.setCenter(new float[]{-0.1813275,0.603225,-0.003537});
HAnimSegment& HAnimSegment1247 =  HAnimSegment();
HAnimSegment1247.X3DNode::setName(std::string("r_carpal_middle_phalanx_3"));
...
Shape1248.setGeometry(&IndexedFaceSet1252);

HAnimSegment1247.addChild(&Shape1248);

HAnimJoint1246.addChildren(&HAnimSegment1247);

HAnimJoint& HAnimJoint1255 =  HAnimJoint();
HAnimJoint1255.X3DNode::setName(std::string("r_carpal_distal_interphalangeal_3"));
HAnimJoint1255.setDEF(std::string("hanim_r_carpal_distal_interphalangeal_3"));
HAnimJoint1255.setCenter(new float[]{-0.1802925,0.575325,-0.0037597502});
HAnimSegment& HAnimSegment1256 =  HAnimSegment();
HAnimSegment1256.X3DNode::setName(std::string("r_carpal_distal_phalanx_3"));
...
Shape1257.setGeometry(&IndexedFaceSet1261);

HAnimSegment1256.addChild(&Shape1257);

HAnimJoint1255.addChildren(&HAnimSegment1256);

HAnimJoint1246.addChildren(&HAnimJoint1255);

HAnimJoint1237.addChildren(&HAnimJoint1246);

HAnimJoint1228.addChildren(&HAnimJoint1237);

HAnimJoint1219.addChildren(&HAnimJoint1228);

HAnimJoint1129.addChildren(&HAnimJoint1219);

HAnimJoint& HAnimJoint1264 =  HAnimJoint();
HAnimJoint1264.X3DNode::setName(std::string("r_midcarpal_4_5"));
HAnimJoint1264.setDEF(std::string("hanim_r_midcarpal_4_5"));
HAnimJoint1264.setCenter(new float[]{-0.18072,0.70582503,-0.025740001});
HAnimSegment& HAnimSegment1265 =  HAnimSegment();
HAnimSegment1265.X3DNode::setName(std::string("r_hamate"));
...
Shape1266.setGeometry(&IndexedFaceSet1270);

HAnimSegment1265.addChild(&Shape1266);

HAnimJoint1264.addChildren(&HAnimSegment1265);

HAnimJoint& HAnimJoint1273 =  HAnimJoint();
HAnimJoint1273.X3DNode::setName(std::string("r_carpometacarpal_4"));
HAnimJoint1273.setDEF(std::string("hanim_r_carpometacarpal_4"));
HAnimJoint1273.setCenter(new float[]{-0.18072,0.68625003,-0.01991925});
HAnimSegment& HAnimSegment1274 =  HAnimSegment();
HAnimSegment1274.X3DNode::setName(std::string("r_metacarpal_4"));
...
HAnimSegment1274.addChild(&Shape1275);

HAnimJoint1273.addChildren(&HAnimSegment1274);

HAnimJoint& HAnimJoint1282 =  HAnimJoint();
HAnimJoint1282.X3DNode::setName(std::string("r_metacarpophalangeal_4"));
HAnimJoint1282.setDEF(std::string("hanim_r_metacarpophalangeal_4"));
HAnimJoint1282.setCenter(new float[]{-0.18330751,0.63405,-0.02144025});
HAnimSegment& HAnimSegment1283 =  HAnimSegment();
HAnimSegment1283.X3DNode::setName(std::string("r_carpal_proximal_phalanx_4"));
...
HAnimSegment1283.addChild(&Shape1284);

HAnimJoint1282.addChildren(&HAnimSegment1283);

HAnimJoint& HAnimJoint1291 =  HAnimJoint();
HAnimJoint1291.X3DNode::setName(std::string("r_carpal_proximal_interphalangeal_4"));
HAnimJoint1291.setDEF(std::string("hanim_r_carpal_proximal_interphalangeal_4"));
HAnimJoint1291.setCenter(new float[]{-0.1813275,0.6066,-0.020646});
HAnimSegment& HAnimSegment1292 =  HAnimSegment();
HAnimSegment1292.X3DNode::setName(std::string("r_carpal_middle_phalanx_4"));
...
Shape1293.addChild(&Appearance1294);
...
HAnimSegment1292.addChild(&Shape1293);

HAnimJoint1291.addChildren(&HAnimSegment1292);

HAnimJoint& HAnimJoint1300 =  HAnimJoint();
HAnimJoint1300.X3DNode::setName(std::string("r_carpal_distal_interphalangeal_4"));
HAnimJoint1300.setDEF(std::string("hanim_r_carpal_distal_interphalangeal_4"));
HAnimJoint1300.setCenter(new float[]{-0.1802925,0.580725,-0.019777501});
HAnimSegment& HAnimSegment1301 =  HAnimSegment();
HAnimSegment1301.X3DNode::setName(std::string("r_carpal_distal_phalanx_4"));
...
Shape1302.setGeometry(&IndexedFaceSet1306);

HAnimSegment1301.addChild(&Shape1302);

HAnimJoint1300.addChildren(&HAnimSegment1301);

HAnimJoint1291.addChildren(&HAnimJoint1300);
...
HAnimJoint1129.addChildren(&HAnimJoint1264);

HAnimJoint& HAnimJoint1309 =  HAnimJoint();
HAnimJoint1309.X3DNode::setName(std::string("r_carpometacarpal_5"));
HAnimJoint1309.setDEF(std::string("hanim_r_carpometacarpal_5"));
HAnimJoint1309.setCenter(new float[]{-0.18126,0.68827504,-0.032782502});
HAnimSegment& HAnimSegment1310 =  HAnimSegment();
HAnimSegment1310.X3DNode::setName(std::string("r_metacarpal_5"));
...
Shape1311.setGeometry(&IndexedFaceSet1315);

HAnimSegment1310.addChild(&Shape1311);

HAnimJoint1309.addChildren(&HAnimSegment1310);

HAnimJoint& HAnimJoint1318 =  HAnimJoint();
HAnimJoint1318.X3DNode::setName(std::string("r_metacarpophalangeal_5"));
HAnimJoint1318.setDEF(std::string("hanim_r_metacarpophalangeal_5"));
HAnimJoint1318.setCenter(new float[]{-0.18297,0.6381,-0.0370575});
HAnimSegment& HAnimSegment1319 =  HAnimSegment();
HAnimSegment1319.X3DNode::setName(std::string("r_carpal_proximal_phalanx_5"));
...
Shape1320.setGeometry(&IndexedFaceSet1324);

HAnimSegment1319.addChild(&Shape1320);

HAnimJoint1318.addChildren(&HAnimSegment1319);

HAnimJoint& HAnimJoint1327 =  HAnimJoint();
HAnimJoint1327.X3DNode::setName(std::string("r_carpal_proximal_interphalangeal_5"));
HAnimJoint1327.setDEF(std::string("hanim_r_carpal_proximal_interphalangeal_5"));
HAnimJoint1327.setCenter(new float[]{-0.18130499,0.62100005,-0.037147503});
HAnimSegment& HAnimSegment1328 =  HAnimSegment();
HAnimSegment1328.X3DNode::setName(std::string("r_carpal_middle_phalanx_5"));
...
HAnimSegment1328.addChild(&Shape1329);

HAnimJoint1327.addChildren(&HAnimSegment1328);

HAnimJoint& HAnimJoint1336 =  HAnimJoint();
HAnimJoint1336.X3DNode::setName(std::string("r_carpal_distal_interphalangeal_5"));
HAnimJoint1336.setDEF(std::string("hanim_r_carpal_distal_interphalangeal_5"));
HAnimJoint1336.setCenter(new float[]{-0.18045002,0.602325,-0.0369675});
HAnimSegment& HAnimSegment1337 =  HAnimSegment();
HAnimSegment1337.X3DNode::setName(std::string("r_carpal_distal_phalanx_5"));
...
Shape1338.setGeometry(&IndexedFaceSet1342);

HAnimSegment1337.addChild(&Shape1338);

HAnimJoint1336.addChildren(&HAnimSegment1337);

HAnimJoint1327.addChildren(&HAnimJoint1336);

HAnimJoint1318.addChildren(&HAnimJoint1327);

HAnimJoint1309.addChildren(&HAnimJoint1318);

HAnimJoint1129.addChildren(&HAnimJoint1309);

HAnimJoint1120.addChildren(&HAnimJoint1129);

HAnimJoint1111.addChildren(&HAnimJoint1120);

HAnimJoint1102.addChildren(&HAnimJoint1111);

HAnimJoint1093.addChildren(&HAnimJoint1102);

HAnimJoint697.addChildren(&HAnimJoint1093);
...
HAnimJoint643.addChildren(&HAnimJoint652);

HAnimJoint634.addChildren(&HAnimJoint643);

HAnimJoint625.addChildren(&HAnimJoint634);

HAnimJoint616.addChildren(&HAnimJoint625);

HAnimJoint607.addChildren(&HAnimJoint616);

HAnimJoint598.addChildren(&HAnimJoint607);
...
HAnimJoint40.addChildren(&HAnimJoint553);
...
Group& Group1491 =  Group();
Group1491.setDEF(std::string("StopAnimation"));
Scene19.addChild(&Group1491);

Group& Group1492 =  Group();
Group1492.setDEF(std::string("StandAnimation"));
Scene19.addChild(&Group1492);

Group& Group1493 =  Group();
Group1493.setDEF(std::string("PitchesAnimation"));
Scene19.addChild(&Group1493);

Group& Group1494 =  Group();
Group1494.setDEF(std::string("YawsAnimation"));
Scene19.addChild(&Group1494);

Group& Group1495 =  Group();
Group1495.setDEF(std::string("RollsAnimation"));
Scene19.addChild(&Group1495);

Group& Group1496 =  Group();
Group1496.setDEF(std::string("WalkAnimation"));
Scene19.addChild(&Group1496);

Group& Group1497 =  Group();
Group1497.setDEF(std::string("RunAnimation"));
Scene19.addChild(&Group1497);

Group& Group1498 =  Group();
Group1498.setDEF(std::string("JumpAnimation"));
Scene19.addChild(&Group1498);

Group& Group1499 =  Group();
Group1499.setDEF(std::string("KickAnimation"));
Scene19.addChild(&Group1499);
