...
#include <string>
#include "X3DLib.h"
int KoreanCharacter10Mi(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
ImageTexture39.setUrl((std::string[]){"images/Mi.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Mi.png"}, 2);
