...
meta2.setContent(std::string("CoordinateAxes.x3d"));
head1.addMeta(&meta2);

meta& meta3 =  meta();
meta3.setName(std::string("creator"));
meta3.setContent(std::string("Don Brutzman, Byounghyun Yoo"));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(std::string("created"));
meta4.setContent(std::string("14 July 2000"));
head1.addMeta(&meta4);
...
meta6.setContent(std::string("X Y Z axis arrows and labels in X3D coordinate system. See CoordinateAxesExample for use as an Inline coordinate-system reference frame."));
head1.addMeta(&meta6);

meta& meta7 =  meta();
meta7.setName(std::string("reference"));
meta7.setContent(std::string("https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/CoordinateAxes.x3d"));
head1.addMeta(&meta7);

meta& meta8 =  meta();
meta8.setName(std::string("reference"));
meta8.setContent(std::string("https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/CoordinateAxesNSEW.x3d"));
head1.addMeta(&meta8);

meta& meta9 =  meta();
meta9.setName(std::string("reference"));
meta9.setContent(std::string("https://savage.nps.edu/Savage/Tools/Authoring/CoordinateAxes.x3d"));
head1.addMeta(&meta9);

meta& meta10 =  meta();
meta10.setName(std::string("reference"));
meta10.setContent(std::string("https://savage.nps.edu/Savage/Tools/Authoring/CoordinateAxesNSEW.x3d"));
head1.addMeta(&meta10);

meta& meta11 =  meta();
meta11.setName(std::string("identifier"));
meta11.setContent(std::string("https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/CoordinateAxes.x3d"));
head1.addMeta(&meta11);

meta& meta12 =  meta();
meta12.setName(std::string("generator"));
meta12.setContent(std::string("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"));
...
WorldInfo15.setTitle(std::string("CoordinateAxes.x3d"));
Scene14.addChild(&WorldInfo15);

Collision& Collision16 =  Collision();
Collision16.setDEF(std::string("DoNotCollideWithVisualizationWidget"));
...
Group& Group18 =  Group();
Group18.setDEF(std::string("ArrowGreen"));
Shape& Shape19 =  Shape();
Cylinder& Cylinder20 =  Cylinder();
Cylinder20.setDEF(std::string("ArrowCylinder"));
...
Shape& Shape24 =  Shape();
Cone& Cone25 =  Cone();
Cone25.setDEF(std::string("ArrowCone"));
...
Group& Group35 =  Group();
Group& Group36 =  Group();
Group36.setDEF(std::string("ArrowRed"));
Shape& Shape37 =  Shape();
Cylinder& Cylinder38 =  Cylinder();
Cylinder38.setUSE(std::string("ArrowCylinder"));
...
Shape& Shape42 =  Shape();
Cone& Cone43 =  Cone();
Cone43.setUSE(std::string("ArrowCone"));
...
Group& Group52 =  Group();
Group& Group53 =  Group();
Group53.setDEF(std::string("ArrowBlue"));
Shape& Shape54 =  Shape();
Cylinder& Cylinder55 =  Cylinder();
Cylinder55.setUSE(std::string("ArrowCylinder"));
...
Shape& Shape59 =  Shape();
Cone& Cone60 =  Cone();
Cone60.setUSE(std::string("ArrowCone"));
