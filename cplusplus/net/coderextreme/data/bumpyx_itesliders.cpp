...
//#include "glut.h"
//#include "X3DLib.h"
int bumpyx_itesliders(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
DirectionalLight20.setDirection(new float[]{0,-1,0});
...
DirectionalLight21.setDirection(new float[]{-1,-0.1,-1});
...
Viewpoint22.setPosition(new float[]{0,1.75,60});
...
Transform24.setTranslation(new float[]{25,0,0});
Transform24.setRotation(new float[]{0,0,-1,1.57});
Shape& Shape25 =  Shape();
...
Material28.setEmissiveColor(new float[]{1,0,0});
...
Transform29.setTranslation(new float[]{50,0,0});
Transform29.setRotation(new float[]{0,0,-1,1.57});
Shape& Shape30 =  Shape();
Cone& Cone31 =  Cone();
...
Transform34.setTranslation(new float[]{0,25,0});
Shape& Shape35 =  Shape();
...
Material38.setDiffuseColor(new float[]{0,1,0});
Material38.setEmissiveColor(new float[]{0,1,0});
...
Transform39.setTranslation(new float[]{0,50,0});
Shape& Shape40 =  Shape();
Cone& Cone41 =  Cone();
...
Transform44.setTranslation(new float[]{0,0,25});
Transform44.setRotation(new float[]{1,0,0,1.57});
Shape& Shape45 =  Shape();
...
Material48.setDiffuseColor(new float[]{0,0,1});
Material48.setEmissiveColor(new float[]{0,0,1});
...
Transform49.setTranslation(new float[]{0,0,50});
Transform49.setRotation(new float[]{1,0,0,1.57});
Shape& Shape50 =  Shape();
Cone& Cone51 =  Cone();
...
Viewport97.setClipBoundary(new float[]{0,1,0,1}, 4);
LayoutLayer95.setViewport(Viewport97);

Transform& Transform98 =  Transform();
Transform98.setTranslation(new float[]{0,0,-3});
Shape& Shape99 =  Shape();
Appearance& Appearance100 =  Appearance();
Material& Material101 =  Material();
Material101.setDiffuseColor(new float[]{0,0,0});
...
Box& Box102 =  Box();
Box102.setSize(new float[]{100,100,0.02});
...
Transform104.setTranslation(new float[]{0,0,-20});
...
Material109.setDiffuseColor(new float[]{1,1,0});
...
Transform122.setTranslation(new float[]{0,0.7,0});
IS& IS123 =  IS();
...
Transform125.setTranslation(new float[]{0,0,0.1});
IS& IS126 =  IS();
...
PlaneSensor128.setMaxPosition(new float[]{1,0});
Transform125.addChild(&PlaneSensor128);

Transform& Transform129 =  Transform();
Transform129.setTranslation(new float[]{0,0,0});
...
Viewpoint216.setPosition(new float[]{0,1.75,80});
