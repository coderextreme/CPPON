...
meta2.setContent(std::string("arc4.x3d"));
head1.addMeta(&meta2);
...
ROUTE& ROUTE58 =  ROUTE();
ROUTE58.setFromNode(std::string("DECLpoint_G1_node"));
ROUTE58.setFromField(std::string("translation_changed"));
ROUTE58.setToNode(std::string("DECLx3dconnector_connector1_S1"));
ROUTE58.setToField(std::string("set_startpoint"));
Scene7.addChild(&ROUTE58);

ROUTE& ROUTE59 =  ROUTE();
ROUTE59.setFromNode(std::string("DECLpoint_G2_node"));
ROUTE59.setFromField(std::string("translation_changed"));
ROUTE59.setToNode(std::string("DECLx3dconnector_connector1_S1"));
ROUTE59.setToField(std::string("set_endpoint"));
