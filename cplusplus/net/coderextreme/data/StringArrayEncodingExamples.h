...
meta2.setContent(std::string("StringArrayEncodingExamples.x3d"));
head1.addMeta(&meta2);

meta& meta3 =  meta();
meta3.setName(std::string("description"));
meta3.setContent(std::string("Demonstrate simple X3D MFString (string array) encoding."));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(std::string("created"));
meta4.setContent(std::string("27 May 2017"));
head1.addMeta(&meta4);

meta& meta5 =  meta();
meta5.setName(std::string("modified"));
meta5.setContent(std::string("27 May 2017"));
head1.addMeta(&meta5);
...
meta7.setContent(std::string("X3dHeaderPrototypeSyntaxExamples.x3d"));
head1.addMeta(&meta7);

meta& meta8 =  meta();
meta8.setName(std::string("specificationSection"));
meta8.setContent(std::string("X3D encodings, ISO/IEC 19775-1, Part 1: Architecture and base components, 5 Field type reference, 5.3.14 SFString and MFString"));
head1.addMeta(&meta8);

meta& meta9 =  meta();
meta9.setName(std::string("specificationUrl"));
meta9.setContent(std::string("https://www.web3d.org/documents/specifications/19775-1/V3.3/Part01/fieldsDef.html#SFStringAndMFString"));
head1.addMeta(&meta9);

meta& meta10 =  meta();
meta10.setName(std::string("specificationSection"));
meta10.setContent(std::string("X3D encodings, ISO/IEC 19776-1.3, Part 1: XML encoding, 5.3.14 SFString and MFString"));
head1.addMeta(&meta10);

meta& meta11 =  meta();
meta11.setName(std::string("specificationUrl"));
meta11.setContent(std::string("https://www.web3d.org/documents/specifications/19776-1/V3.3/Part01/EncodingOfFields.html#SFString"));
head1.addMeta(&meta11);

meta& meta12 =  meta();
meta12.setName(std::string("specificationSection"));
meta12.setContent(std::string("X3D encodings, ISO/IEC 19776-2 v3.3, Part 2: Classic VRML encoding, 5.15 SFString and MFString"));
head1.addMeta(&meta12);

meta& meta13 =  meta();
meta13.setName(std::string("specificationUrl"));
meta13.setContent(std::string("https://www.web3d.org/documents/specifications/19776-2/V3.3/Part02/EncodingOfFields.html#SFString"));
head1.addMeta(&meta13);

meta& meta14 =  meta();
meta14.setName(std::string("identifier"));
meta14.setContent(std::string("https://www.web3d.org/x3d/content/examples/Basic/X3dSpecifications/StringArrayEncodingExamples.x3d"));
...
Viewpoint18.setDEF(std::string("EntryView"));
Viewpoint18.setDescription(std::string("Hello MFString syntax"));
