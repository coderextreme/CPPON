...
Switch7.setDEF(std::string("SceneSwitcher"));
Switch7.setWhichChoice(0);
Group& Group8 =  Group();
Script& Script9 =  Script();
Script9.setDEF(std::string("Choice0"));
field& field10 =  field();
field10.setName(std::string("touchTime"));
field10.setType(std::string("SFTime"));
field10.setAccessType(std::string("inputOnly"));
Script9.addChild(&field10);

field& field11 =  field();
field11.setName(std::string("choice"));
field11.setType(std::string("SFInt32"));
field11.setAccessType(std::string("outputOnly"));
...
Script14.setDEF(std::string("Choice1"));
field& field15 =  field();
field15.setName(std::string("touchTime"));
field15.setType(std::string("SFTime"));
field15.setAccessType(std::string("inputOnly"));
Script14.addChild(&field15);

field& field16 =  field();
field16.setName(std::string("choice"));
field16.setType(std::string("SFInt32"));
...
Script19.setDEF(std::string("Choice2"));
field& field20 =  field();
field20.setName(std::string("touchTime"));
field20.setType(std::string("SFTime"));
field20.setAccessType(std::string("inputOnly"));
Script19.addChild(&field20);

field& field21 =  field();
field21.setName(std::string("choice"));
field21.setType(std::string("SFInt32"));
...
Script24.setDEF(std::string("Choice3"));
field& field25 =  field();
field25.setName(std::string("touchTime"));
field25.setType(std::string("SFTime"));
field25.setAccessType(std::string("inputOnly"));
Script24.addChild(&field25);

field& field26 =  field();
field26.setName(std::string("choice"));
field26.setType(std::string("SFInt32"));
...
Script29.setDEF(std::string("Choice4"));
field& field30 =  field();
field30.setName(std::string("touchTime"));
field30.setType(std::string("SFTime"));
field30.setAccessType(std::string("inputOnly"));
Script29.addChild(&field30);

field& field31 =  field();
field31.setName(std::string("choice"));
...
Script34.setDEF(std::string("Choice5"));
field& field35 =  field();
field35.setName(std::string("touchTime"));
field35.setType(std::string("SFTime"));
field35.setAccessType(std::string("inputOnly"));
Script34.addChild(&field35);

field& field36 =  field();
field36.setName(std::string("choice"));
field36.setType(std::string("SFInt32"));
field36.setAccessType(std::string("outputOnly"));
Script34.addChild(&field36);


//Script34.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 5;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script39.setDEF(std::string("Choice6"));
field& field40 =  field();
field40.setName(std::string("touchTime"));
field40.setType(std::string("SFTime"));
field40.setAccessType(std::string("inputOnly"));
Script39.addChild(&field40);

field& field41 =  field();
field41.setName(std::string("choice"));
field41.setType(std::string("SFInt32"));
...
Script44.setDEF(std::string("Choice7"));
field& field45 =  field();
field45.setName(std::string("touchTime"));
field45.setType(std::string("SFTime"));
field45.setAccessType(std::string("inputOnly"));
Script44.addChild(&field45);

field& field46 =  field();
field46.setName(std::string("choice"));
...
Script49.setDEF(std::string("Choice8"));
field& field50 =  field();
field50.setName(std::string("touchTime"));
field50.setType(std::string("SFTime"));
field50.setAccessType(std::string("inputOnly"));
Script49.addChild(&field50);

field& field51 =  field();
field51.setName(std::string("choice"));
field51.setType(std::string("SFInt32"));
field51.setAccessType(std::string("outputOnly"));
...
Script54.setDEF(std::string("Choice9"));
field& field55 =  field();
field55.setName(std::string("touchTime"));
field55.setType(std::string("SFTime"));
field55.setAccessType(std::string("inputOnly"));
Script54.addChild(&field55);

field& field56 =  field();
field56.setName(std::string("choice"));
field56.setType(std::string("SFInt32"));
field56.setAccessType(std::string("outputOnly"));
Script54.addChild(&field56);


//Script54.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 9;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script59.setDEF(std::string("Choice10"));
field& field60 =  field();
field60.setName(std::string("touchTime"));
field60.setType(std::string("SFTime"));
field60.setAccessType(std::string("inputOnly"));
Script59.addChild(&field60);

field& field61 =  field();
field61.setName(std::string("choice"));
field61.setType(std::string("SFInt32"));
...
Script64.setDEF(std::string("Choice11"));
field& field65 =  field();
field65.setName(std::string("touchTime"));
field65.setType(std::string("SFTime"));
field65.setAccessType(std::string("inputOnly"));
Script64.addChild(&field65);

field& field66 =  field();
field66.setName(std::string("choice"));
field66.setType(std::string("SFInt32"));
field66.setAccessType(std::string("outputOnly"));
Script64.addChild(&field66);


//Script64.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 11;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script69.setDEF(std::string("Choice12"));
field& field70 =  field();
field70.setName(std::string("touchTime"));
field70.setType(std::string("SFTime"));
field70.setAccessType(std::string("inputOnly"));
Script69.addChild(&field70);

field& field71 =  field();
field71.setName(std::string("choice"));
...
Script74.setDEF(std::string("Choice13"));
field& field75 =  field();
field75.setName(std::string("touchTime"));
field75.setType(std::string("SFTime"));
field75.setAccessType(std::string("inputOnly"));
Script74.addChild(&field75);

field& field76 =  field();
field76.setName(std::string("choice"));
field76.setType(std::string("SFInt32"));
field76.setAccessType(std::string("outputOnly"));
Script74.addChild(&field76);


//Script74.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 13;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script79.setDEF(std::string("Choice14"));
field& field80 =  field();
field80.setName(std::string("touchTime"));
field80.setType(std::string("SFTime"));
field80.setAccessType(std::string("inputOnly"));
Script79.addChild(&field80);

field& field81 =  field();
field81.setName(std::string("choice"));
field81.setType(std::string("SFInt32"));
field81.setAccessType(std::string("outputOnly"));
...
Script84.setDEF(std::string("Choice15"));
field& field85 =  field();
field85.setName(std::string("touchTime"));
field85.setType(std::string("SFTime"));
field85.setAccessType(std::string("inputOnly"));
Script84.addChild(&field85);

field& field86 =  field();
field86.setName(std::string("choice"));
...
Script89.setDEF(std::string("Choice16"));
field& field90 =  field();
field90.setName(std::string("touchTime"));
field90.setType(std::string("SFTime"));
field90.setAccessType(std::string("inputOnly"));
Script89.addChild(&field90);

field& field91 =  field();
field91.setName(std::string("choice"));
field91.setType(std::string("SFInt32"));
field91.setAccessType(std::string("outputOnly"));
Script89.addChild(&field91);


//Script89.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 16;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script94.setDEF(std::string("Choice17"));
field& field95 =  field();
field95.setName(std::string("touchTime"));
field95.setType(std::string("SFTime"));
field95.setAccessType(std::string("inputOnly"));
Script94.addChild(&field95);

field& field96 =  field();
field96.setName(std::string("choice"));
field96.setType(std::string("SFInt32"));
field96.setAccessType(std::string("outputOnly"));
Script94.addChild(&field96);


//Script94.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 17;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script99.setDEF(std::string("Choice18"));
field& field100 =  field();
field100.setName(std::string("touchTime"));
field100.setType(std::string("SFTime"));
field100.setAccessType(std::string("inputOnly"));
Script99.addChild(&field100);

field& field101 =  field();
field101.setName(std::string("choice"));
field101.setType(std::string("SFInt32"));
field101.setAccessType(std::string("outputOnly"));
Script99.addChild(&field101);


//Script99.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 18;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script104.setDEF(std::string("Choice19"));
field& field105 =  field();
field105.setName(std::string("touchTime"));
field105.setType(std::string("SFTime"));
field105.setAccessType(std::string("inputOnly"));
Script104.addChild(&field105);

field& field106 =  field();
field106.setName(std::string("choice"));
field106.setType(std::string("SFInt32"));
field106.setAccessType(std::string("outputOnly"));
Script104.addChild(&field106);


//Script104.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 19;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script109.setDEF(std::string("Choice20"));
field& field110 =  field();
field110.setName(std::string("touchTime"));
field110.setType(std::string("SFTime"));
field110.setAccessType(std::string("inputOnly"));
Script109.addChild(&field110);

field& field111 =  field();
field111.setName(std::string("choice"));
field111.setType(std::string("SFInt32"));
field111.setAccessType(std::string("outputOnly"));
Script109.addChild(&field111);


//Script109.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 20;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script114.setDEF(std::string("Choice21"));
field& field115 =  field();
field115.setName(std::string("touchTime"));
field115.setType(std::string("SFTime"));
field115.setAccessType(std::string("inputOnly"));
Script114.addChild(&field115);

field& field116 =  field();
field116.setName(std::string("choice"));
field116.setType(std::string("SFInt32"));
field116.setAccessType(std::string("outputOnly"));
Script114.addChild(&field116);


//Script114.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 21;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script119.setDEF(std::string("Choice22"));
field& field120 =  field();
field120.setName(std::string("touchTime"));
field120.setType(std::string("SFTime"));
field120.setAccessType(std::string("inputOnly"));
Script119.addChild(&field120);

field& field121 =  field();
field121.setName(std::string("choice"));
field121.setType(std::string("SFInt32"));
field121.setAccessType(std::string("outputOnly"));
Script119.addChild(&field121);


//Script119.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 22;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script124.setDEF(std::string("Choice23"));
field& field125 =  field();
field125.setName(std::string("touchTime"));
field125.setType(std::string("SFTime"));
field125.setAccessType(std::string("inputOnly"));
Script124.addChild(&field125);

field& field126 =  field();
field126.setName(std::string("choice"));
field126.setType(std::string("SFInt32"));
field126.setAccessType(std::string("outputOnly"));
Script124.addChild(&field126);


//Script124.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 23;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script129.setDEF(std::string("Choice24"));
field& field130 =  field();
field130.setName(std::string("touchTime"));
field130.setType(std::string("SFTime"));
field130.setAccessType(std::string("inputOnly"));
Script129.addChild(&field130);

field& field131 =  field();
field131.setName(std::string("choice"));
field131.setType(std::string("SFInt32"));
field131.setAccessType(std::string("outputOnly"));
Script129.addChild(&field131);


//Script129.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 24;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script134.setDEF(std::string("Choice25"));
field& field135 =  field();
field135.setName(std::string("touchTime"));
field135.setType(std::string("SFTime"));
field135.setAccessType(std::string("inputOnly"));
Script134.addChild(&field135);

field& field136 =  field();
field136.setName(std::string("choice"));
field136.setType(std::string("SFInt32"));
field136.setAccessType(std::string("outputOnly"));
Script134.addChild(&field136);


//Script134.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 25;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script139.setDEF(std::string("Choice26"));
field& field140 =  field();
field140.setName(std::string("touchTime"));
field140.setType(std::string("SFTime"));
field140.setAccessType(std::string("inputOnly"));
Script139.addChild(&field140);

field& field141 =  field();
field141.setName(std::string("choice"));
field141.setType(std::string("SFInt32"));
field141.setAccessType(std::string("outputOnly"));
Script139.addChild(&field141);


//Script139.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 26;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script144.setDEF(std::string("Choice27"));
field& field145 =  field();
field145.setName(std::string("touchTime"));
field145.setType(std::string("SFTime"));
field145.setAccessType(std::string("inputOnly"));
Script144.addChild(&field145);

field& field146 =  field();
field146.setName(std::string("choice"));
field146.setType(std::string("SFInt32"));
field146.setAccessType(std::string("outputOnly"));
Script144.addChild(&field146);


//Script144.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 27;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script149.setDEF(std::string("Choice28"));
field& field150 =  field();
field150.setName(std::string("touchTime"));
field150.setType(std::string("SFTime"));
field150.setAccessType(std::string("inputOnly"));
Script149.addChild(&field150);

field& field151 =  field();
field151.setName(std::string("choice"));
field151.setType(std::string("SFInt32"));
field151.setAccessType(std::string("outputOnly"));
Script149.addChild(&field151);


//Script149.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 28;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
Script154.setDEF(std::string("Choice29"));
field& field155 =  field();
field155.setName(std::string("touchTime"));
field155.setType(std::string("SFTime"));
field155.setAccessType(std::string("inputOnly"));
Script154.addChild(&field155);

field& field156 =  field();
field156.setName(std::string("choice"));
field156.setType(std::string("SFInt32"));
field156.setAccessType(std::string("outputOnly"));
Script154.addChild(&field156);


//Script154.setSourceCode(std::string("ecmascript:")+
//_T("      function set_touchTime(value) {")+
//_T("          choice = 29;")+
//_T("      }")+
//_T("      function touchTime(value) {")+
...
TouchSensor159.setDescription(std::string("TSJinBlink"));
TouchSensor159.setDEF(std::string("JinBlink_Sensor"));
...
ROUTE170.setFromNode(std::string("JinBlink_Sensor"));
ROUTE170.setFromField(std::string("touchTime"));
ROUTE170.setToNode(std::string("Choice0"));
ROUTE170.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE170);

ROUTE& ROUTE171 =  ROUTE();
ROUTE171.setFromNode(std::string("Choice0"));
ROUTE171.setFromField(std::string("choice"));
ROUTE171.setToNode(std::string("SceneSwitcher"));
ROUTE171.setToField(std::string("whichChoice"));
...
TouchSensor173.setDescription(std::string("TSJinBrowLowerer"));
TouchSensor173.setDEF(std::string("JinBrowLowerer_Sensor"));
...
ROUTE184.setFromNode(std::string("JinBrowLowerer_Sensor"));
ROUTE184.setFromField(std::string("touchTime"));
ROUTE184.setToNode(std::string("Choice1"));
ROUTE184.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE184);

ROUTE& ROUTE185 =  ROUTE();
ROUTE185.setFromNode(std::string("Choice1"));
ROUTE185.setFromField(std::string("choice"));
ROUTE185.setToNode(std::string("SceneSwitcher"));
ROUTE185.setToField(std::string("whichChoice"));
...
TouchSensor187.setDescription(std::string("TSJinCheekPuffer"));
TouchSensor187.setDEF(std::string("JinCheekPuffer_Sensor"));
...
ROUTE198.setFromNode(std::string("JinCheekPuffer_Sensor"));
ROUTE198.setFromField(std::string("touchTime"));
ROUTE198.setToNode(std::string("Choice2"));
ROUTE198.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE198);

ROUTE& ROUTE199 =  ROUTE();
ROUTE199.setFromNode(std::string("Choice2"));
ROUTE199.setFromField(std::string("choice"));
ROUTE199.setToNode(std::string("SceneSwitcher"));
ROUTE199.setToField(std::string("whichChoice"));
...
TouchSensor201.setDescription(std::string("TSJinCheekRaiser"));
TouchSensor201.setDEF(std::string("JinCheekRaiser_Sensor"));
...
ROUTE212.setFromNode(std::string("JinCheekRaiser_Sensor"));
ROUTE212.setFromField(std::string("touchTime"));
ROUTE212.setToNode(std::string("Choice3"));
ROUTE212.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE212);

ROUTE& ROUTE213 =  ROUTE();
ROUTE213.setFromNode(std::string("Choice3"));
ROUTE213.setFromField(std::string("choice"));
ROUTE213.setToNode(std::string("SceneSwitcher"));
ROUTE213.setToField(std::string("whichChoice"));
...
TouchSensor215.setDescription(std::string("TSJinChinRaiser"));
TouchSensor215.setDEF(std::string("JinChinRaiser_Sensor"));
...
ROUTE226.setFromNode(std::string("JinChinRaiser_Sensor"));
ROUTE226.setFromField(std::string("touchTime"));
ROUTE226.setToNode(std::string("Choice4"));
ROUTE226.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE226);

ROUTE& ROUTE227 =  ROUTE();
ROUTE227.setFromNode(std::string("Choice4"));
ROUTE227.setFromField(std::string("choice"));
ROUTE227.setToNode(std::string("SceneSwitcher"));
ROUTE227.setToField(std::string("whichChoice"));
...
TouchSensor229.setDescription(std::string("TSJinDimpler"));
TouchSensor229.setDEF(std::string("JinDimpler_Sensor"));
...
ROUTE240.setFromNode(std::string("JinDimpler_Sensor"));
ROUTE240.setFromField(std::string("touchTime"));
ROUTE240.setToNode(std::string("Choice5"));
ROUTE240.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE240);

ROUTE& ROUTE241 =  ROUTE();
ROUTE241.setFromNode(std::string("Choice5"));
ROUTE241.setFromField(std::string("choice"));
ROUTE241.setToNode(std::string("SceneSwitcher"));
ROUTE241.setToField(std::string("whichChoice"));
...
TouchSensor243.setDescription(std::string("TSJinEyesClosed"));
TouchSensor243.setDEF(std::string("JinEyesClosed_Sensor"));
...
ROUTE254.setFromNode(std::string("JinEyesClosed_Sensor"));
ROUTE254.setFromField(std::string("touchTime"));
ROUTE254.setToNode(std::string("Choice6"));
ROUTE254.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE254);

ROUTE& ROUTE255 =  ROUTE();
ROUTE255.setFromNode(std::string("Choice6"));
ROUTE255.setFromField(std::string("choice"));
ROUTE255.setToNode(std::string("SceneSwitcher"));
ROUTE255.setToField(std::string("whichChoice"));
...
TouchSensor257.setDescription(std::string("TSJinInnerBrowRaiser"));
TouchSensor257.setDEF(std::string("JinInnerBrowRaiser_Sensor"));
...
ROUTE268.setFromNode(std::string("JinInnerBrowRaiser_Sensor"));
ROUTE268.setFromField(std::string("touchTime"));
ROUTE268.setToNode(std::string("Choice7"));
ROUTE268.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE268);

ROUTE& ROUTE269 =  ROUTE();
ROUTE269.setFromNode(std::string("Choice7"));
ROUTE269.setFromField(std::string("choice"));
ROUTE269.setToNode(std::string("SceneSwitcher"));
ROUTE269.setToField(std::string("whichChoice"));
...
TouchSensor271.setDescription(std::string("TSJinJawDrop"));
TouchSensor271.setDEF(std::string("JinJawDrop_Sensor"));
...
ROUTE282.setFromNode(std::string("JinJawDrop_Sensor"));
ROUTE282.setFromField(std::string("touchTime"));
ROUTE282.setToNode(std::string("Choice8"));
ROUTE282.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE282);

ROUTE& ROUTE283 =  ROUTE();
ROUTE283.setFromNode(std::string("Choice8"));
ROUTE283.setFromField(std::string("choice"));
ROUTE283.setToNode(std::string("SceneSwitcher"));
ROUTE283.setToField(std::string("whichChoice"));
...
TouchSensor285.setDescription(std::string("TSJinLidDroop"));
TouchSensor285.setDEF(std::string("JinLidDroop_Sensor"));
...
ROUTE296.setFromNode(std::string("JinLidDroop_Sensor"));
ROUTE296.setFromField(std::string("touchTime"));
ROUTE296.setToNode(std::string("Choice9"));
ROUTE296.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE296);

ROUTE& ROUTE297 =  ROUTE();
ROUTE297.setFromNode(std::string("Choice9"));
ROUTE297.setFromField(std::string("choice"));
ROUTE297.setToNode(std::string("SceneSwitcher"));
ROUTE297.setToField(std::string("whichChoice"));
...
TouchSensor299.setDescription(std::string("TSJinLidTightener"));
TouchSensor299.setDEF(std::string("JinLidTightener_Sensor"));
...
ROUTE310.setFromNode(std::string("JinLidTightener_Sensor"));
ROUTE310.setFromField(std::string("touchTime"));
ROUTE310.setToNode(std::string("Choice10"));
ROUTE310.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE310);

ROUTE& ROUTE311 =  ROUTE();
ROUTE311.setFromNode(std::string("Choice10"));
ROUTE311.setFromField(std::string("choice"));
ROUTE311.setToNode(std::string("SceneSwitcher"));
ROUTE311.setToField(std::string("whichChoice"));
...
TouchSensor313.setDescription(std::string("TSJinLipCornerDepressor"));
TouchSensor313.setDEF(std::string("JinLipCornerDepressor_Sensor"));
...
ROUTE324.setFromNode(std::string("JinLipCornerDepressor_Sensor"));
ROUTE324.setFromField(std::string("touchTime"));
ROUTE324.setToNode(std::string("Choice11"));
ROUTE324.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE324);

ROUTE& ROUTE325 =  ROUTE();
ROUTE325.setFromNode(std::string("Choice11"));
ROUTE325.setFromField(std::string("choice"));
ROUTE325.setToNode(std::string("SceneSwitcher"));
ROUTE325.setToField(std::string("whichChoice"));
...
TouchSensor327.setDescription(std::string("TSJinLipCornerPuller"));
TouchSensor327.setDEF(std::string("JinLipCornerPuller_Sensor"));
...
ROUTE338.setFromNode(std::string("JinLipCornerPuller_Sensor"));
ROUTE338.setFromField(std::string("touchTime"));
ROUTE338.setToNode(std::string("Choice12"));
ROUTE338.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE338);

ROUTE& ROUTE339 =  ROUTE();
ROUTE339.setFromNode(std::string("Choice12"));
ROUTE339.setFromField(std::string("choice"));
ROUTE339.setToNode(std::string("SceneSwitcher"));
ROUTE339.setToField(std::string("whichChoice"));
...
TouchSensor341.setDescription(std::string("TSJinLipFunneler"));
TouchSensor341.setDEF(std::string("JinLipFunneler_Sensor"));
...
ROUTE352.setFromNode(std::string("JinLipFunneler_Sensor"));
ROUTE352.setFromField(std::string("touchTime"));
ROUTE352.setToNode(std::string("Choice13"));
ROUTE352.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE352);

ROUTE& ROUTE353 =  ROUTE();
ROUTE353.setFromNode(std::string("Choice13"));
ROUTE353.setFromField(std::string("choice"));
ROUTE353.setToNode(std::string("SceneSwitcher"));
ROUTE353.setToField(std::string("whichChoice"));
...
TouchSensor355.setDescription(std::string("TSJinLipPressor"));
TouchSensor355.setDEF(std::string("JinLipPressor_Sensor"));
...
ROUTE366.setFromNode(std::string("JinLipPressor_Sensor"));
ROUTE366.setFromField(std::string("touchTime"));
ROUTE366.setToNode(std::string("Choice14"));
ROUTE366.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE366);

ROUTE& ROUTE367 =  ROUTE();
ROUTE367.setFromNode(std::string("Choice14"));
ROUTE367.setFromField(std::string("choice"));
ROUTE367.setToNode(std::string("SceneSwitcher"));
ROUTE367.setToField(std::string("whichChoice"));
...
TouchSensor369.setDescription(std::string("TSJinLipPuckerer"));
TouchSensor369.setDEF(std::string("JinLipPuckerer_Sensor"));
...
ROUTE380.setFromNode(std::string("JinLipPuckerer_Sensor"));
ROUTE380.setFromField(std::string("touchTime"));
ROUTE380.setToNode(std::string("Choice15"));
ROUTE380.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE380);

ROUTE& ROUTE381 =  ROUTE();
ROUTE381.setFromNode(std::string("Choice15"));
ROUTE381.setFromField(std::string("choice"));
ROUTE381.setToNode(std::string("SceneSwitcher"));
ROUTE381.setToField(std::string("whichChoice"));
...
TouchSensor383.setDescription(std::string("TSJinLipsPart"));
TouchSensor383.setDEF(std::string("JinLipsPart_Sensor"));
...
ROUTE394.setFromNode(std::string("JinLipsPart_Sensor"));
ROUTE394.setFromField(std::string("touchTime"));
ROUTE394.setToNode(std::string("Choice16"));
ROUTE394.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE394);

ROUTE& ROUTE395 =  ROUTE();
ROUTE395.setFromNode(std::string("Choice16"));
ROUTE395.setFromField(std::string("choice"));
ROUTE395.setToNode(std::string("SceneSwitcher"));
ROUTE395.setToField(std::string("whichChoice"));
...
TouchSensor397.setDescription(std::string("TSJinLipStretcher"));
TouchSensor397.setDEF(std::string("JinLipStretcher_Sensor"));
...
ROUTE408.setFromNode(std::string("JinLipStretcher_Sensor"));
ROUTE408.setFromField(std::string("touchTime"));
ROUTE408.setToNode(std::string("Choice17"));
ROUTE408.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE408);

ROUTE& ROUTE409 =  ROUTE();
ROUTE409.setFromNode(std::string("Choice17"));
ROUTE409.setFromField(std::string("choice"));
ROUTE409.setToNode(std::string("SceneSwitcher"));
ROUTE409.setToField(std::string("whichChoice"));
...
TouchSensor411.setDescription(std::string("TSJinLipSuck"));
TouchSensor411.setDEF(std::string("JinLipSuck_Sensor"));
...
ROUTE422.setFromNode(std::string("JinLipSuck_Sensor"));
ROUTE422.setFromField(std::string("touchTime"));
ROUTE422.setToNode(std::string("Choice18"));
ROUTE422.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE422);

ROUTE& ROUTE423 =  ROUTE();
ROUTE423.setFromNode(std::string("Choice18"));
ROUTE423.setFromField(std::string("choice"));
ROUTE423.setToNode(std::string("SceneSwitcher"));
ROUTE423.setToField(std::string("whichChoice"));
...
TouchSensor425.setDescription(std::string("TSJinLipTightener"));
TouchSensor425.setDEF(std::string("JinLipTightener_Sensor"));
...
ROUTE436.setFromNode(std::string("JinLipTightener_Sensor"));
ROUTE436.setFromField(std::string("touchTime"));
ROUTE436.setToNode(std::string("Choice19"));
ROUTE436.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE436);

ROUTE& ROUTE437 =  ROUTE();
ROUTE437.setFromNode(std::string("Choice19"));
ROUTE437.setFromField(std::string("choice"));
ROUTE437.setToNode(std::string("SceneSwitcher"));
ROUTE437.setToField(std::string("whichChoice"));
...
TouchSensor439.setDescription(std::string("TSJinLowerLipDepressor"));
TouchSensor439.setDEF(std::string("JinLowerLipDepressor_Sensor"));
...
ROUTE450.setFromNode(std::string("JinLowerLipDepressor_Sensor"));
ROUTE450.setFromField(std::string("touchTime"));
ROUTE450.setToNode(std::string("Choice20"));
ROUTE450.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE450);

ROUTE& ROUTE451 =  ROUTE();
ROUTE451.setFromNode(std::string("Choice20"));
ROUTE451.setFromField(std::string("choice"));
ROUTE451.setToNode(std::string("SceneSwitcher"));
ROUTE451.setToField(std::string("whichChoice"));
...
TouchSensor453.setDescription(std::string("TSJinMouthStretch"));
TouchSensor453.setDEF(std::string("JinMouthStretch_Sensor"));
...
ROUTE464.setFromNode(std::string("JinMouthStretch_Sensor"));
ROUTE464.setFromField(std::string("touchTime"));
ROUTE464.setToNode(std::string("Choice21"));
ROUTE464.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE464);

ROUTE& ROUTE465 =  ROUTE();
ROUTE465.setFromNode(std::string("Choice21"));
ROUTE465.setFromField(std::string("choice"));
ROUTE465.setToNode(std::string("SceneSwitcher"));
ROUTE465.setToField(std::string("whichChoice"));
...
TouchSensor467.setDescription(std::string("TSJinNasolabialDeepener"));
TouchSensor467.setDEF(std::string("JinNasolabialDeepener_Sensor"));
...
ROUTE478.setFromNode(std::string("JinNasolabialDeepener_Sensor"));
ROUTE478.setFromField(std::string("touchTime"));
ROUTE478.setToNode(std::string("Choice22"));
ROUTE478.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE478);

ROUTE& ROUTE479 =  ROUTE();
ROUTE479.setFromNode(std::string("Choice22"));
ROUTE479.setFromField(std::string("choice"));
ROUTE479.setToNode(std::string("SceneSwitcher"));
ROUTE479.setToField(std::string("whichChoice"));
...
TouchSensor481.setDescription(std::string("TSJinNoseWrinkler"));
TouchSensor481.setDEF(std::string("JinNoseWrinkler_Sensor"));
...
ROUTE492.setFromNode(std::string("JinNoseWrinkler_Sensor"));
ROUTE492.setFromField(std::string("touchTime"));
ROUTE492.setToNode(std::string("Choice23"));
ROUTE492.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE492);

ROUTE& ROUTE493 =  ROUTE();
ROUTE493.setFromNode(std::string("Choice23"));
ROUTE493.setFromField(std::string("choice"));
ROUTE493.setToNode(std::string("SceneSwitcher"));
ROUTE493.setToField(std::string("whichChoice"));
...
TouchSensor495.setDescription(std::string("TSJinOuterBrowRaiser"));
TouchSensor495.setDEF(std::string("JinOuterBrowRaiser_Sensor"));
...
ROUTE506.setFromNode(std::string("JinOuterBrowRaiser_Sensor"));
ROUTE506.setFromField(std::string("touchTime"));
ROUTE506.setToNode(std::string("Choice24"));
ROUTE506.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE506);

ROUTE& ROUTE507 =  ROUTE();
ROUTE507.setFromNode(std::string("Choice24"));
ROUTE507.setFromField(std::string("choice"));
ROUTE507.setToNode(std::string("SceneSwitcher"));
ROUTE507.setToField(std::string("whichChoice"));
...
TouchSensor509.setDescription(std::string("TSJinSlit"));
TouchSensor509.setDEF(std::string("JinSlit_Sensor"));
...
ROUTE520.setFromNode(std::string("JinSlit_Sensor"));
ROUTE520.setFromField(std::string("touchTime"));
ROUTE520.setToNode(std::string("Choice25"));
ROUTE520.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE520);

ROUTE& ROUTE521 =  ROUTE();
ROUTE521.setFromNode(std::string("Choice25"));
ROUTE521.setFromField(std::string("choice"));
ROUTE521.setToNode(std::string("SceneSwitcher"));
ROUTE521.setToField(std::string("whichChoice"));
...
TouchSensor523.setDescription(std::string("TSJinSquint"));
TouchSensor523.setDEF(std::string("JinSquint_Sensor"));
...
ROUTE534.setFromNode(std::string("JinSquint_Sensor"));
ROUTE534.setFromField(std::string("touchTime"));
ROUTE534.setToNode(std::string("Choice26"));
ROUTE534.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE534);

ROUTE& ROUTE535 =  ROUTE();
ROUTE535.setFromNode(std::string("Choice26"));
ROUTE535.setFromField(std::string("choice"));
ROUTE535.setToNode(std::string("SceneSwitcher"));
ROUTE535.setToField(std::string("whichChoice"));
...
TouchSensor537.setDescription(std::string("TSJinUpperLidRaiser"));
TouchSensor537.setDEF(std::string("JinUpperLidRaiser_Sensor"));
...
ROUTE548.setFromNode(std::string("JinUpperLidRaiser_Sensor"));
ROUTE548.setFromField(std::string("touchTime"));
ROUTE548.setToNode(std::string("Choice27"));
ROUTE548.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE548);

ROUTE& ROUTE549 =  ROUTE();
ROUTE549.setFromNode(std::string("Choice27"));
ROUTE549.setFromField(std::string("choice"));
ROUTE549.setToNode(std::string("SceneSwitcher"));
ROUTE549.setToField(std::string("whichChoice"));
...
TouchSensor551.setDescription(std::string("TSJinUpperLipRaiser"));
TouchSensor551.setDEF(std::string("JinUpperLipRaiser_Sensor"));
...
ROUTE562.setFromNode(std::string("JinUpperLipRaiser_Sensor"));
ROUTE562.setFromField(std::string("touchTime"));
ROUTE562.setToNode(std::string("Choice28"));
ROUTE562.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE562);

ROUTE& ROUTE563 =  ROUTE();
ROUTE563.setFromNode(std::string("Choice28"));
ROUTE563.setFromField(std::string("choice"));
ROUTE563.setToNode(std::string("SceneSwitcher"));
ROUTE563.setToField(std::string("whichChoice"));
...
TouchSensor565.setDescription(std::string("TSJinWink"));
TouchSensor565.setDEF(std::string("JinWink_Sensor"));
...
ROUTE576.setFromNode(std::string("JinWink_Sensor"));
ROUTE576.setFromField(std::string("touchTime"));
ROUTE576.setToNode(std::string("Choice29"));
ROUTE576.setToField(std::string("touchTime"));
Group6.addChild(&ROUTE576);

ROUTE& ROUTE577 =  ROUTE();
ROUTE577.setFromNode(std::string("Choice29"));
ROUTE577.setFromField(std::string("choice"));
ROUTE577.setToNode(std::string("SceneSwitcher"));
ROUTE577.setToField(std::string("whichChoice"));
