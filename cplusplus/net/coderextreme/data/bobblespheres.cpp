...
component2.setName(std::string("X_ITE"));
component2.setLevel(1);
head1.addChild(&component2);

meta& meta3 =  meta();
meta3.setName(std::string("title"));
meta3.setContent(std::string("Bobble Spheres Full Animation (Final Working)"));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(std::string("description"));
meta4.setContent(std::string("Full scene with corrected Script nodes that use the initialize() function to safely reference nodes and prevent race conditions."));
head1.addMeta(&meta4);

meta& meta5 =  meta();
meta5.setName(std::string("creator"));
meta5.setContent(std::string("Generated from Python script"));
head1.addMeta(&meta5);
...
WorldInfo7.setTitle(std::string("Bobble Spheres (PBR Full Animation)"));
...
Viewpoint10.setDescription(std::string("Initial Camera"));
...
Transform32.setDEF(std::string("T_0"));
...
TimeSensor37.setDEF(std::string("C_0"));
...
ROUTE& ROUTE46 =  ROUTE();
ROUTE46.setFromNode(std::string("C_0"));
ROUTE46.setFromField(std::string("fraction_changed"));
ROUTE46.setToNode(std::string("PI_0"));
ROUTE46.setToField(std::string("set_fraction"));
Scene6.addChild(&ROUTE46);

ROUTE& ROUTE47 =  ROUTE();
ROUTE47.setFromNode(std::string("PI_0"));
ROUTE47.setFromField(std::string("value_changed"));
ROUTE47.setToNode(std::string("T_0"));
ROUTE47.setToField(std::string("set_translation"));
Scene6.addChild(&ROUTE47);

ROUTE& ROUTE48 =  ROUTE();
ROUTE48.setFromNode(std::string("C_0"));
ROUTE48.setFromField(std::string("fraction_changed"));
ROUTE48.setToNode(std::string("CI_0"));
ROUTE48.setToField(std::string("set_fraction"));
Scene6.addChild(&ROUTE48);

ROUTE& ROUTE49 =  ROUTE();
ROUTE49.setFromNode(std::string("CI_0"));
ROUTE49.setFromField(std::string("value_changed"));
ROUTE49.setToNode(std::string("Animator_0"));
ROUTE49.setToField(std::string("set_color"));
Scene6.addChild(&ROUTE49);

ROUTE& ROUTE50 =  ROUTE();
ROUTE50.setFromNode(std::string("C_0"));
ROUTE50.setFromField(std::string("fraction_changed"));
ROUTE50.setToNode(std::string("SI_0"));
ROUTE50.setToField(std::string("set_fraction"));
Scene6.addChild(&ROUTE50);

ROUTE& ROUTE51 =  ROUTE();
ROUTE51.setFromNode(std::string("SI_0"));
ROUTE51.setFromField(std::string("value_changed"));
ROUTE51.setToNode(std::string("Animator_0"));
ROUTE51.setToField(std::string("set_roughness"));
Scene6.addChild(&ROUTE51);

//Example: Metal Sphere with animated roughness (Using initialize())
Transform& Transform52 =  Transform();
Transform52.setDEF(std::string("T_1"));
...
TimeSensor57.setDEF(std::string("C_1"));
...
Script60.setDEF(std::string("Animator_1"));
field& field61 =  field();
field61.setName(std::string("set_roughness"));
field61.setType(std::string("SFFloat"));
field61.setAccessType(std::string("inputOnly"));
Script60.addChild(&field61);

field& field62 =  field();
field62.setName(std::string("targetMaterial"));
...
PhysicalMaterial63.setUSE(std::string("M_1"));
...
ROUTE& ROUTE64 =  ROUTE();
ROUTE64.setFromNode(std::string("C_1"));
ROUTE64.setFromField(std::string("fraction_changed"));
ROUTE64.setToNode(std::string("PI_1"));
ROUTE64.setToField(std::string("set_fraction"));
Scene6.addChild(&ROUTE64);

ROUTE& ROUTE65 =  ROUTE();
ROUTE65.setFromNode(std::string("PI_1"));
ROUTE65.setFromField(std::string("value_changed"));
ROUTE65.setToNode(std::string("T_1"));
ROUTE65.setToField(std::string("set_translation"));
Scene6.addChild(&ROUTE65);

ROUTE& ROUTE66 =  ROUTE();
ROUTE66.setFromNode(std::string("C_1"));
ROUTE66.setFromField(std::string("fraction_changed"));
ROUTE66.setToNode(std::string("SI_1"));
ROUTE66.setToField(std::string("set_fraction"));
Scene6.addChild(&ROUTE66);

ROUTE& ROUTE67 =  ROUTE();
ROUTE67.setFromNode(std::string("SI_1"));
ROUTE67.setFromField(std::string("value_changed"));
ROUTE67.setToNode(std::string("Animator_1"));
ROUTE67.setToField(std::string("set_roughness"));
...
Transform68.setDEF(std::string("T_2"));
...
TimeSensor74.setDEF(std::string("C_2"));
...
ROUTE& ROUTE77 =  ROUTE();
ROUTE77.setFromNode(std::string("C_2"));
ROUTE77.setFromField(std::string("fraction_changed"));
ROUTE77.setToNode(std::string("PI_2"));
ROUTE77.setToField(std::string("set_fraction"));
Scene6.addChild(&ROUTE77);

ROUTE& ROUTE78 =  ROUTE();
ROUTE78.setFromNode(std::string("PI_2"));
ROUTE78.setFromField(std::string("value_changed"));
ROUTE78.setToNode(std::string("T_2"));
ROUTE78.setToField(std::string("set_translation"));
Scene6.addChild(&ROUTE78);

ROUTE& ROUTE79 =  ROUTE();
ROUTE79.setFromNode(std::string("C_2"));
ROUTE79.setFromField(std::string("fraction_changed"));
ROUTE79.setToNode(std::string("SI_2"));
ROUTE79.setToField(std::string("set_fraction"));
Scene6.addChild(&ROUTE79);

ROUTE& ROUTE80 =  ROUTE();
ROUTE80.setFromNode(std::string("SI_2"));
ROUTE80.setFromField(std::string("value_changed"));
ROUTE80.setToNode(std::string("IOR_2"));
ROUTE80.setToField(std::string("set_indexOfRefraction"));
Scene6.addChild(&ROUTE80);

Transform& Transform81 =  Transform();
Transform81.setDEF(std::string("T_3"));
...
TimeSensor87.setDEF(std::string("C_3"));
...
ROUTE& ROUTE90 =  ROUTE();
ROUTE90.setFromNode(std::string("C_3"));
ROUTE90.setFromField(std::string("fraction_changed"));
ROUTE90.setToNode(std::string("PI_3"));
ROUTE90.setToField(std::string("set_fraction"));
Scene6.addChild(&ROUTE90);

ROUTE& ROUTE91 =  ROUTE();
ROUTE91.setFromNode(std::string("PI_3"));
ROUTE91.setFromField(std::string("value_changed"));
ROUTE91.setToNode(std::string("T_3"));
ROUTE91.setToField(std::string("set_translation"));
Scene6.addChild(&ROUTE91);

ROUTE& ROUTE92 =  ROUTE();
ROUTE92.setFromNode(std::string("C_3"));
ROUTE92.setFromField(std::string("fraction_changed"));
ROUTE92.setToNode(std::string("SI_3"));
ROUTE92.setToField(std::string("set_fraction"));
Scene6.addChild(&ROUTE92);

ROUTE& ROUTE93 =  ROUTE();
ROUTE93.setFromNode(std::string("SI_3"));
ROUTE93.setFromField(std::string("value_changed"));
ROUTE93.setToNode(std::string("IRI_3"));
ROUTE93.setToField(std::string("set_iridescenceThicknessMaximum"));
