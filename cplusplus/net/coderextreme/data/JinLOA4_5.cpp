...
#include <string>
#include "X3DLib.h"
void JinLOA4_5(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
ImageTexture37.setUrl(new std::string[]{"images/Jin.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Jin.png"}, 2);
