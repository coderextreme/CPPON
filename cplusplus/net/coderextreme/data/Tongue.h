...
meta3.setContent(std::string("Tongue.x3d"));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(std::string("description"));
meta4.setContent(std::string("Facial Action Coding System (FACS) example for Action Unit (AU) 27, Mouth Stretch Morpher, Tongue Derivated."));
head1.addMeta(&meta4);

meta& meta5 =  meta();
meta5.setName(std::string("creator"));
meta5.setContent(std::string("Yujin Jung"));
head1.addMeta(&meta5);

meta& meta6 =  meta();
meta6.setName(std::string("translator"));
meta6.setContent(std::string("Chul Hee Jung"));
head1.addMeta(&meta6);

meta& meta7 =  meta();
meta7.setName(std::string("translator"));
meta7.setContent(std::string("Myeong Won Lee"));
head1.addMeta(&meta7);

meta& meta8 =  meta();
meta8.setName(std::string("created"));
meta8.setContent(std::string("25 April 2022"));
head1.addMeta(&meta8);

meta& meta9 =  meta();
meta9.setName(std::string("modified"));
meta9.setContent(std::string("27 October 2024"));
head1.addMeta(&meta9);

meta& meta10 =  meta();
meta10.setName(std::string("translator"));
meta10.setContent(std::string("Don Brutzman"));
...
meta12.setContent(std::string("https://en.wikipedia.org/wiki/Facial_Action_Coding_System"));
head1.addMeta(&meta12);

meta& meta13 =  meta();
meta13.setName(std::string("reference"));
meta13.setContent(std::string("https://web.cs.wpi.edu/~matt/courses/cs563/talks/face_anim/ekman.html"));
head1.addMeta(&meta13);

meta& meta14 =  meta();
meta14.setName(std::string("reference"));
meta14.setContent(std::string("Bryn Farnsworth, FACS Visual Guidebook https://imotions.com/blog/learning/research-fundamentals/facial-action-coding-system"));
head1.addMeta(&meta14);

meta& meta15 =  meta();
meta15.setName(std::string("generator"));
meta15.setContent(std::string("Suwon VRLAB X3D Converter"));
head1.addMeta(&meta15);

meta& meta16 =  meta();
meta16.setName(std::string("MovingImage"));
meta16.setContent(std::string("originals/SuwonHAnimFacialMotionConverter.mp4"));
head1.addMeta(&meta16);

meta& meta17 =  meta();
meta17.setName(std::string("generator"));
meta17.setContent(std::string("X3D-Edit 4.0, https://savage.nps.edu/X3D-Edit"));
head1.addMeta(&meta17);

meta& meta18 =  meta();
meta18.setName(std::string("identifier"));
meta18.setContent(std::string("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/FacialAnimation/Tongue.x3d"));
...
Viewpoint21.setDEF(std::string("HelloJin"));
Viewpoint21.setDescription(std::string("Hello Jin! 안녕하세요 진!"));
Viewpoint21.setPosition(new float[]{0.0,20.0,60.0});
Scene20.addChild(&Viewpoint21);

TimeSensor& TimeSensor22 =  TimeSensor();
TimeSensor22.setDEF(std::string("JinMouthStretch_Clock"));
...
WorldInfo28.setTitle(std::string("Tongue.x3d"));
...
HAnimJoint31.X3DNode::setName(std::string("skullbase"));
HAnimJoint31.setDEF(std::string("hanim_skullbase"));
HAnimSegment& HAnimSegment32 =  HAnimSegment();
HAnimSegment32.X3DNode::setName(std::string("tongue"));
HAnimSegment32.setDEF(std::string("hanim_Tongue"));
Transform& Transform33 =  Transform();
Transform33.setDEF(std::string("Tongue"));
...
IndexedFaceSet38.setDEF(std::string("Tongue-FACES"));
...
Coordinate40.setDEF(std::string("Tongue_COORD"));
...
HAnimDisplacer42.setDEF(std::string("Tongue_MorphInterpolator_JinMouthStretch"));
...
ROUTE& ROUTE45 =  ROUTE();
ROUTE45.setFromField(std::string("value_changed"));
ROUTE45.setFromNode(std::string("AnimationAdapter_JinMouthStretch"));
ROUTE45.setToField(std::string("weight"));
ROUTE45.setToNode(std::string("Tongue_MorphInterpolator_JinMouthStretch"));
Scene20.addChild(&ROUTE45);

ROUTE& ROUTE46 =  ROUTE();
ROUTE46.setFromNode(std::string("JinMouthStretch_Clock"));
ROUTE46.setFromField(std::string("fraction_changed"));
ROUTE46.setToNode(std::string("AnimationAdapter_JinMouthStretch"));
