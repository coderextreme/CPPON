...
//#include "glut.h"
//#include "X3DLib.h"
int bumpyfreewrljsonverse(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
NavigationInfo32.setType((std::string[]){"EXAMINE"}, 1);
...
Layer37.setObjectType((std::string[]){"ALL"}, 1);
...
Background70.setBackUrl((std::string[]){"../resources/images/all_probes/stpeters_cross/stpeters_back.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"}, 2);
Background70.setBottomUrl((std::string[]){"../resources/images/all_probes/stpeters_cross/stpeters_bottom.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"}, 2);
Background70.setFrontUrl((std::string[]){"../resources/images/all_probes/stpeters_cross/stpeters_front.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"}, 2);
Background70.setLeftUrl((std::string[]){"../resources/images/all_probes/stpeters_cross/stpeters_left.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"}, 2);
Background70.setRightUrl((std::string[]){"../resources/images/all_probes/stpeters_cross/stpeters_right.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"}, 2);
Background70.setTopUrl((std::string[]){"../resources/images/all_probes/stpeters_cross/stpeters_top.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"}, 2);
...
ImageTexture78.setUrl((std::string[]){"../resources/images/all_probes/stpeters_cross/stpeters_back.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"}, 2);
ComposedCubeMapTexture77.setBack(ImageTexture78);

ImageTexture& ImageTexture79 =  ImageTexture();
ImageTexture79.setUrl((std::string[]){"../resources/images/all_probes/stpeters_cross/stpeters_bottom.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"}, 2);
ComposedCubeMapTexture77.setBottom(ImageTexture79);

ImageTexture& ImageTexture80 =  ImageTexture();
ImageTexture80.setUrl((std::string[]){"../resources/images/all_probes/stpeters_cross/stpeters_front.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"}, 2);
ComposedCubeMapTexture77.setFront(ImageTexture80);

ImageTexture& ImageTexture81 =  ImageTexture();
ImageTexture81.setUrl((std::string[]){"../resources/images/all_probes/stpeters_cross/stpeters_left.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"}, 2);
ComposedCubeMapTexture77.setLeft(ImageTexture81);

ImageTexture& ImageTexture82 =  ImageTexture();
ImageTexture82.setUrl((std::string[]){"../resources/images/all_probes/stpeters_cross/stpeters_right.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"}, 2);
ComposedCubeMapTexture77.setRight(ImageTexture82);

ImageTexture& ImageTexture83 =  ImageTexture();
ImageTexture83.setUrl((std::string[]){"../resources/images/all_probes/stpeters_cross/stpeters_top.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"}, 2);
...
ShaderPart96.setUrl((std::string[]){"../shaders/freewrl_flowers_chromatic.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_flowers_chromatic.vs"}, 2);
ShaderPart96.setType(std::string("VERTEX"));
ComposedShader84.setParts(&ShaderPart96);

ShaderPart& ShaderPart97 =  ShaderPart();
ShaderPart97.setUrl((std::string[]){"../shaders/freewrl.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_bubbles.fs"}, 2);
...
DISEntityTypeMapping110.setUrl((std::string[]){"../data/Gramps8Final.x3d", "https://coderextreme.net/X3DJSONLD/src/main/data/Gramps8Final.x3d"}, 2);
...
DISEntityTypeMapping111.setUrl((std::string[]){"../data/Leif8Final.x3d", "https://coderextreme.net/X3DJSONLD/src/main/data/Leif8Final.x3d"}, 2);
...
DISEntityTypeMapping112.setUrl((std::string[]){"../data/Lily8Final.x3d", "https://coderextreme.net/X3DJSONLD/src/main/data/Lily8Final.x3d"}, 2);
...
DISEntityTypeMapping113.setUrl((std::string[]){"../data/Tufani8Final.x3d", "https://coderextreme.net/X3DJSONLD/src/main/data/Tufani8Final.x3d"}, 2);
...
LayoutLayer118.setObjectType((std::string[]){"ALL"}, 1);
...
Text127.setString((std::string[]){"r = a + b * cos(c * theta + tdelta) * cos (d * phi + pdelta)"}, 1);
...
Text153.setString((std::string[]){"a="}, 1);
IS& IS154 =  IS();
...
Layout227.setAlign((std::string[]){"LEFT", "BOTTOM"}, 2);
Layout227.setOffset(new float[]{-0.2,0.19}, 2);
Layout227.setOffsetUnits((std::string[]){"WORLD", "WORLD"}, 2);
Layout227.setScaleMode((std::string[]){"NONE", "NONE"}, 2);
Layout227.setSize(new float[]{0.4,0.6}, 2);
Layout227.setSizeUnits((std::string[]){"WORLD", "WORLD"}, 2);
