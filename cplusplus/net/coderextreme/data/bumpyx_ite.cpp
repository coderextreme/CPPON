...
#include <string>
#include "X3DLib.h"
void bumpyx_ite(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
meta14.setContent(std::string("https://coderextreme.net/X3DJSONLD/src/main/data/bumpyx_ite.x3d"));
...
ComposedShader32.setDEF(std::string("x_iteShader"));
...
field39.setValue(std::string("15"));
...
ShaderPart45.setUrl(new std::string[]{"../shaders/x_ite_flowers_chromatic.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite_flowers_chromatic.vs"}, 2);
ShaderPart45.setType(std::string("VERTEX"));
ComposedShader32.setParts(&ShaderPart45);

ShaderPart& ShaderPart46 =  ShaderPart();
ShaderPart46.setUrl(new std::string[]{"../shaders/x_ite.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.fs"}, 2);
