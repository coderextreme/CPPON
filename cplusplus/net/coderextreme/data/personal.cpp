...
meta2.setContent(std::string("personal.x3d"));
head1.addMeta(&meta2);

meta& meta3 =  meta();
meta3.setName(std::string("identifier"));
meta3.setContent(std::string("https://someAddress/somePath/personal.x3d"));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(std::string("description"));
meta4.setContent(std::string("John's Portfolio"));
head1.addMeta(&meta4);

meta& meta5 =  meta();
meta5.setName(std::string("generator"));
meta5.setContent(std::string("vim and X3D-Edit, https://savage.nps.edu/X3D-Edit"));
head1.addMeta(&meta5);

X3D0.setHead(&head1);

Scene& Scene6 =  Scene();
Viewpoint& Viewpoint7 =  Viewpoint();
Viewpoint7.setDescription(std::string("Tour Views"));
Viewpoint7.setPosition(new float[]{0.0,0.0,12.0});
Scene6.addChild(&Viewpoint7);

Switch& Switch8 =  Switch();
Switch8.setDEF(std::string("SceneSwitcher"));
