...
meta2.setContent(std::string("rubik.x3d"));
head1.addMeta(&meta2);
...
meta5.setContent(std::string("https://coderextreme.net/X3DJSONLD/src/main/data/rubik.x3d"));
head1.addMeta(&meta5);

meta& meta6 =  meta();
meta6.setName(std::string("description"));
meta6.setContent(std::string("a kind of rubik cube with spheres"));
head1.addMeta(&meta6);
