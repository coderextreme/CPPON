...
#include <string>
#include "X3DLib.h"
void ballx_ite(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
meta10.setContent(std::string("ballx_ite.x3d"));
...
meta13.setContent(std::string("https://coderextreme.net/X3DJSONLD/src/main/data/ballx_ite.x3d"));
...
ShaderPart39.setUrl(new std::string[]{"../shaders/x_ite.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.vs"}, 2);
ShaderPart39.setType(std::string("VERTEX"));
ComposedShader32.setParts(&ShaderPart39);

ShaderPart& ShaderPart40 =  ShaderPart();
ShaderPart40.setUrl(new std::string[]{"../shaders/x_itebubbles.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itebubbles.fs"}, 2);
