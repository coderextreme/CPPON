...
#include <string>
#include "X3DLib.h"
int ballx_ite(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
ShaderPart39.setUrl((std::string[]){"../shaders/x_ite.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.vs"}, 2);
ShaderPart39.setType(std::string("VERTEX"));
ComposedShader32.setParts(&ShaderPart39);

ShaderPart& ShaderPart40 =  ShaderPart();
ShaderPart40.setUrl((std::string[]){"../shaders/x_itebubbles.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itebubbles.fs"}, 2);
