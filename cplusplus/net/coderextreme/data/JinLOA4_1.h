...
#include <string>
#include "X3DLib.h"
int JinLOA4_1(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
meta3.setContent(std::string("JinLOA4_1.x3d"));
head1.addMeta(&meta3);
...
meta8.setContent(std::string("13 March 2021"));
head1.addMeta(&meta8);
...
WorldInfo20.setTitle(std::string("JinLOA4_1.x3d"));
