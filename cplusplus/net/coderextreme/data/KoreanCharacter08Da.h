...
#include <string>
#include "X3DLib.h"
//void KoreanCharacter08Da(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
meta3.setContent(std::string("KoreanCharacter08Da.x3d"));
head1.addMeta(&meta3);
...
meta11.setContent(std::string("../Poses/images/HAnimPoseExampleKoreanCharacter08Da.png"));
...
meta15.setContent(std::string("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter08Da.x3d"));
...
WorldInfo22.setTitle(std::string("KoreanCharacter08Da.x3d"));
...
Viewpoint24.setDescription(std::string("Da"));
Viewpoint24.setPosition(new float[]{0.0,1.0,3.0});
Scene21.addChild(&Viewpoint24);

HAnimHumanoid& HAnimHumanoid25 =  HAnimHumanoid();
HAnimHumanoid25.X3DNode::setName(std::string("Da"));
HAnimHumanoid25.setDEF(std::string("hanim_Da"));
...
ImageTexture39.setUrl(new std::string[]{"images/Da.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Da.png"}, 2);
...
EXPORT231.setAS(new std::string("KoreanCharacter08Da"));
