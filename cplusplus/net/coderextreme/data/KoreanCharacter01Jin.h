...
#include <string>
#include "X3DLib.h"
//void KoreanCharacter01Jin(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
meta3.setContent(std::string("KoreanCharacter01Jin.x3d"));
head1.addMeta(&meta3);
...
meta10.setContent(std::string("../Poses/images/HAnimPoseExampleKoreanCharacter01Jin.png"));
...
meta14.setContent(std::string("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter01Jin.x3d"));
...
WorldInfo21.setTitle(std::string("KoreanCharacter01Jin.x3d"));
...
Viewpoint23.setDescription(std::string("Jin"));
Viewpoint23.setPosition(new float[]{0.0,1.0,3.0});
Scene20.addChild(&Viewpoint23);

HAnimHumanoid& HAnimHumanoid24 =  HAnimHumanoid();
HAnimHumanoid24.X3DNode::setName(std::string("Jin"));
HAnimHumanoid24.setDEF(std::string("hanim_Jin"));
...
HAnimJoint32.setCenter(new float[]{0.0,35.799999,-0.7076});
...
Transform34.setTranslation(new float[]{0.0,35.799999,-0.7076});
Shape& Shape35 =  Shape();
...
ImageTexture38.setDEF(std::string("JinTextureAtlas"));
ImageTexture38.setUrl(new std::string[]{"images/Jin.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Jin.png"}, 2);
...
Coordinate40.setPoint(new float[]{0.0,1.053,0.0273,0.0,0.9123,-0.5414,-0.4375,0.9123,-0.4652,-0.7578,0.9123,-0.3733,-0.875,0.9123,0.0273,-0.7578,0.9123,0.4279,-0.4375,0.9123,0.5198,0.0,0.9123,0.596,0.4375,0.9123,0.5198,0.7578,0.9123,0.4279,0.875,0.9123,0.0273,0.7578,0.9123,-0.3733,0.4375,0.9123,-0.4652,0.0,0.5267,-0.8842,-0.5658,0.5267,-0.7621,-0.98,0.5267,-0.4285,-1.132,0.5267,0.0273,-0.98,0.5267,0.483,-0.5658,0.5267,0.6985,0.0,0.5267,0.8206,0.5658,0.5267,0.6985,0.98,0.5267,0.483,1.132,0.5267,0.0273,0.98,0.5267,-0.4285,0.5658,0.5267,-0.7621,0.0,0.0,-0.9616,-0.6534,0.0,-0.8206,-1.132,0.0,-0.4353,-1.307,0.0,0.0273,-1.132,0.0,0.5536,-0.6534,0.0,0.8206,0.0,0.0,0.9616,0.6534,0.0,0.8206,1.132,0.0,0.5536,1.307,0.0,0.0273,1.132,0.0,-0.4353,0.6534,0.0,-0.8206,0.0,-0.5267,-0.8206,-0.5658,-0.5267,-0.6985,-0.98,-0.5267,-0.3648,-1.132,-0.5267,0.0273,-0.98,-0.5267,0.483,-0.5658,-0.5267,0.6985,0.0,-0.5267,0.8206,0.5658,-0.5267,0.6985,0.98,-0.5267,0.483,1.132,-0.5267,0.0273,0.98,-0.5267,-0.3648,0.5658,-0.5267,-0.6985,0.0,-0.9123,-0.4353,-0.3267,-0.9123,-0.3648,-0.5658,-0.9123,-0.2358,-0.6534,-0.9123,0.0273,-0.5658,-0.9123,0.2904,-0.3267,-0.9123,0.483,0.0,-0.9123,0.5536,0.3267,-0.9123,0.483,0.5658,-0.9123,0.2904,0.6534,-0.9123,0.0273,0.5658,-0.9123,-0.2358,0.3267,-0.9123,-0.3648,0.0,-1.053,0.0273}, 186);
...
ImageTexture48.setUSE(std::string("JinTextureAtlas"));
...
ImageTex
Coordinate110.setPoint(new float[]{-0.9768,-0.0192,-1.681,-1.657,-0.0192,0.4309,0.0,-0.0192,-1.681,-1.403,0.7316,0.354,-0.8174,0.7316,-1.463,0.0,0.7316,-1.463,0.0,0.7316,1.471,1.657,-0.0192,0.4309,1.403,0.7316,0.354,0.8174,0.7316,-1.463,0.9768,-0.0192,-1.681,0.0,-0.0192,1.75,-1.109,-0.6007,-2.046,-2.045,-0.6007,0.4309,-1.695,-0.296,1.429,0.0,-0.6007,-2.046,1.109,-0.6007,-2.046,2.045,-0.6007,0.4309,1.695,-0.296,1.429,0.0,-1.207,-1.841,-1.023,-1.207,-1.841,-1.913,-1.223,0.5161,-1.601,-0.9325,1.406,0.0,-0.6582,1.708,1.601,-0.9325,1.406,1.913,-1.223,0.5161,1.023,-1.207,-1.841,-1.409,-1.925,-2.878,-1.409,-3.947,-1.681,0.0,-3.947,-1.681,-1.109,-0.6007,-2.046,0.0,-0.6007,-2.046,1.409,-1.925,-2.878,0.0,-1.925,-2.878,1.109,-0.6007,-2.046,1.409,-3.947,-1.681,-2.927,-1.925,0.4309,-2.089,-3.947,0.4309,-2.045,-0.6007,0.4309,2.927,-1.925,0.4309,2.045,-0.6007,0.4309,2.089,-3.947,0.4309,0.0,-3.947,0.4309,-0.9442,-0.3153,-1.692,0.0,-0.3153,-1.692,0.9442,-0.3153,-1.692,1.7,-0.3153,0.3093,-1.7,-0.3153,0.3093,-1.86,-3.793,1.364,-2.541,-1.963,1.364,-1.861,-0.9431,1.364,1.861,-0.9431,1.364,2.541,-1.963,1.364,1.86,-3.793,1.364,0.0,-3.793,1.364}, 165);
...
ImageTexture118.setUSE(std::string("JinTextureAtlas"));
...
HAnimJoint122.setCenter(new float[]{0.0,30.530001,-0.7076});
...
Transform124.setTranslation(new float[]{0.0,30.530001,-0.7076});
...
ImageTexture128.setUSE(std::string("JinTextureAtlas"));
...
HAnimJoint132.setCenter(new float[]{5.975,52.0,-0.1452});
...
Transform134.setTranslation(new float[]{5.975,52.0,-0.1452});
...
ImageTexture138.setUSE(std::string("JinTextureAtlas"));
...
ImageTexture148.setUSE(std::string("JinTextureAtlas"));
...
ImageTexture158.setUSE(std::string("JinTextureAtlas"));
...
HAnimJoint162.setCenter(new float[]{-5.975,52.0,-0.1452});
...
Transform164.setTranslation(new float[]{-5.975,52.0,-0.1452});
...
ImageTexture168.setUSE(std::string("JinTextureAtlas"));
...
ImageTexture178.setUSE(std::string("JinTextureAtlas"));
...
ImageTexture188.setUSE(std::string("JinTextureAtlas"));
...
HAnimJoint192.setCenter(new float[]{0.0,40.23,-0.8527});
...
Transform194.setTranslation(new float[]{0.0,40.23,-0.8527});
...
ImageTexture198.setUSE(std::string("JinTextureAtlas"));
...
HAnimJoint202.setCenter(new float[]{0.0,57.43,-0.6863});
...
Transform204.setTranslation(new float[]{0.0,57.43,-0.6863});
...
ImageTexture208.setUSE(std::string("JinTextureAtlas"));
...
EXPORT230.setAS(new std::string("KoreanCharacter01Jin"));
EXPORT230.setLocalDEF(std::string("hanim_Jin"));
