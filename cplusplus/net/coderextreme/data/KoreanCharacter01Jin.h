...
#include <string>
#include "X3DLib.h"
int KoreanCharacter01Jin(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
ImageTexture38.setUrl((std::string[]){"images/Jin.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Jin.png"}, 2);
