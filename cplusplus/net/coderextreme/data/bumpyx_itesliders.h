...
#include <string>
#include "X3DLib.h"
//void bumpyx_itesliders(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
Layer18.setObjectType(new std::string[]{"ALL"}, 1);
//basic nodes, which might be present in any scene
NavigationInfo& NavigationInfo19 =  NavigationInfo();
NavigationInfo19.setType(new std::string[]{"EXAMINE"}, 1);
...
Background55.setBackUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_back.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"}, 2);
Background55.setBottomUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_bottom.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"}, 2);
Background55.setFrontUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_front.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"}, 2);
Background55.setLeftUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_left.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"}, 2);
Background55.setRightUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_right.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"}, 2);
Background55.setTopUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_top.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"}, 2);
...
ComposedCubeMapTexture62.setContainerField("texture");
ComposedCubeMapTexture62.setDEF(std::string("texture"));
ImageTexture& ImageTexture63 =  ImageTexture();
ImageTexture63.setContainerField("backTexture");
ImageTexture63.setUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_back.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"}, 2);
ComposedCubeMapTexture62.setBack(ImageTexture63);

ImageTexture& ImageTexture64 =  ImageTexture();
ImageTexture64.setContainerField("bottomTexture");
ImageTexture64.setUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_bottom.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"}, 2);
ComposedCubeMapTexture62.setBottom(ImageTexture64);

ImageTexture& ImageTexture65 =  ImageTexture();
ImageTexture65.setContainerField("frontTexture");
ImageTexture65.setUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_front.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"}, 2);
ComposedCubeMapTexture62.setFront(ImageTexture65);

ImageTexture& ImageTexture66 =  ImageTexture();
ImageTexture66.setContainerField("leftTexture");
ImageTexture66.setUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_left.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"}, 2);
ComposedCubeMapTexture62.setLeft(ImageTexture66);

ImageTexture& ImageTexture67 =  ImageTexture();
ImageTexture67.setContainerField("rightTexture");
ImageTexture67.setUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_right.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"}, 2);
ComposedCubeMapTexture62.setRight(ImageTexture67);

ImageTexture& ImageTexture68 =  ImageTexture();
ImageTexture68.setContainerField("topTexture");
ImageTexture68.setUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_top.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"}, 2);
...
ShaderPart82.setUrl(new std::string[]{"../shaders/x_ite_flowers_chromatic.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite_flowers_chromatic.vs"}, 2);
ShaderPart82.setType(std::string("VERTEX"));
ComposedShader69.setParts(&ShaderPart82);

ShaderPart& ShaderPart83 =  ShaderPart();
ShaderPart83.setUrl(new std::string[]{"../shaders/x_ite.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.fs"}, 2);
...
LayoutLayer95.setObjectType(new std::string[]{"ALL"}, 1);
Layout& Layout96 =  Layout();
Layout96.setContainerField("layout");
Layout96.setAlign(new std::string[]{"LEFT", "BOTTOM"}, 2);
...
Viewport97.setContainerField("viewport");
...
Appearance100.setContainerField("appearance");
Material& Material101 =  Material();
Material101.setContainerField("material");
...
Text106.setString(new std::string[]{"r = a + b * cos(c * theta + tdelta) * cos (d * phi + pdelta)"}, 1);
...
Text133.setString(new std::string[]{"a="}, 1);
IS& IS134 =  IS();
...
Script139.setUrl(new std::string[]{"../javascripts/X3DUser.js", "https://raw.githubusercontent.com/coderextreme/JSONverse/refs/heads/main/public/javascripts/X3DUser.js"}, 2);
...
Layer215.setObjectType(new std::string[]{"ALL"}, 1);
...
Script217.setUrl(new std::string[]{"../javascripts/X3DAvatar.js", "https://raw.githubusercontent.com/coderextreme/JSONverse/refs/heads/main/public/javascripts/X3DAvatar.js"}, 2);
