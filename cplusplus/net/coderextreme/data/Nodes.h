...
meta2.setContent(std::string("Holger Seelig"));
head1.addMeta(&meta2);

meta& meta3 =  meta();
meta3.setName(std::string("created"));
meta3.setContent(std::string("Tue, 10 Feb 2026 12:09:57 GMT"));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(std::string("modified"));
meta4.setContent(std::string("Tue, 10 Feb 2026 12:34:21 GMT"));
head1.addMeta(&meta4);

meta& meta5 =  meta();
meta5.setName(std::string("generator"));
meta5.setContent(std::string("x3d-tidy V3.0.2, https://www.npmjs.com/package/x3d-tidy"));
head1.addMeta(&meta5);

meta& meta6 =  meta();
meta6.setName(std::string("generator"));
meta6.setContent(std::string("Sunrize X3D Editor V2.0.2, https://create3000.github.io/sunrize/"));
head1.addMeta(&meta6);
...
BiquadFilter70.setType(std::string("LOWPASS"));
...
TextureProjector107.setColor(new float[]{1.0,1.0,1.0});
TextureProjector107.setFieldOfView(0.7854);
TextureProjector107.setIntensity(0.7854);
TextureProjector107.setUpVector(new float[]{0.0,1.0,0.0});
...
HAnimHumanoid109.setVersion(std::string("2.0"));
