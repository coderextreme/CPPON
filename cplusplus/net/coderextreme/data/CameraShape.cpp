...
meta2.setContent(std::string("CameraShape.x3d"));
head1.addMeta(&meta2);

meta& meta3 =  meta();
meta3.setName(std::string("description"));
meta3.setContent(std::string("Simple video camera shape"));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(std::string("creator"));
meta4.setContent(std::string("Jeff Weekley and Don Brutzman"));
head1.addMeta(&meta4);

meta& meta5 =  meta();
meta5.setName(std::string("created"));
meta5.setContent(std::string("2 June 2009"));
head1.addMeta(&meta5);

meta& meta6 =  meta();
meta6.setName(std::string("translated"));
meta6.setContent(std::string("2 June 2009"));
head1.addMeta(&meta6);

meta& meta7 =  meta();
meta7.setName(std::string("modified"));
meta7.setContent(std::string("13 January 2014"));
head1.addMeta(&meta7);

meta& meta8 =  meta();
meta8.setName(std::string("reference"));
meta8.setContent(std::string("CameraExamples.x3d"));
head1.addMeta(&meta8);

meta& meta9 =  meta();
meta9.setName(std::string("identifier"));
meta9.setContent(std::string("https://www.web3d.org/x3d/content/examples/Basic/development/SimpleCamera.x3d"));
head1.addMeta(&meta9);

meta& meta10 =  meta();
meta10.setName(std::string("generator"));
meta10.setContent(std::string("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"));
...
Viewpoint15.setDEF(std::string("CameraShapeView"));
Viewpoint15.setDescription(std::string("Camera view, over the shoulder"));
Viewpoint15.setPosition(new float[]{0.0,0.75,3.0});
Scene13.addChild(&Viewpoint15);

Viewpoint& Viewpoint16 =  Viewpoint();
Viewpoint16.setDescription(std::string("Camera view through lens"));
Viewpoint16.setPosition(new float[]{0.0,0.0,0.0});
Scene13.addChild(&Viewpoint16);

Viewpoint& Viewpoint17 =  Viewpoint();
Viewpoint17.setDescription(std::string("Camera view from right side"));
...
Viewpoint18.setDescription(std::string("Camera view from above"));
...
Viewpoint19.setDescription(std::string("Camera view from left side"));
...
IndexedFaceSet26.setDEF(std::string("pCylinder1_0Geo"));
...
Coordinate27.setDEF(std::string("pCylinder1GeoPoints"));
...
IndexedFaceSet30.setDEF(std::string("pCube1_0Geo"));
...
Coordinate31.setDEF(std::string("pCube1GeoPoints"));
...
IndexedFaceSet34.setDEF(std::string("pPipe1_0Geo"));
...
Coordinate35.setDEF(std::string("pPipe1GeoPoints"));
...
IndexedFaceSet38.setDEF(std::string("pSphere1_0Geo"));
...
Coordinate39.setDEF(std::string("pSphere1GeoPoints"));
...
Transform42.setDEF(std::string("pCylinder1"));
...
IndexedFaceSet45.setUSE(std::string("pCylinder1_0Geo"));
...
Transform46.setDEF(std::string("pCube1"));
...
IndexedFaceSet49.setUSE(std::string("pCube1_0Geo"));
...
Transform50.setDEF(std::string("pPipe1"));
...
IndexedFaceSet53.setUSE(std::string("pPipe1_0Geo"));
...
Transform54.setDEF(std::string("pSphere1"));
...
IndexedFaceSet57.setUSE(std::string("pSphere1_0Geo"));
