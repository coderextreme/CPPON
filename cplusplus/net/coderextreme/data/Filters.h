...
meta11.setContent(std::string("https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/Filters.x3d"));
...
WorldInfo15.setTitle(std::string("Filters.x3d"));
...
Viewpoint18.setDescription(std::string("View entire audio model"));
...
Transform19.setDEF(std::string("TransformAudio1"));
...
Transform24.setDEF(std::string("TransformAudio2"));
...
Transform29.setDEF(std::string("TransformAudio3"));
...
SpatialSound49.setDEF(std::string("Audio1"));
Gain& Gain50 =  Gain();
...
BiquadFilter52.setType(std::string("ALLPASS"));
...
SpatialSound54.setDEF(std::string("Audio2"));
Gain& Gain55 =  Gain();
...
BiquadFilter57.setType(std::string("ALLPASS"));
...
SpatialSound59.setDEF(std::string("Audio3"));
Gain& Gain60 =  Gain();
...
BiquadFilter62.setType(std::string("ALLPASS"));
