...
#include <string>
#include "X3DLib.h"
//void KoreanCharacter12Sun(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
meta3.setContent(std::string("KoreanCharacter12Sun.x3d"));
head1.addMeta(&meta3);
...
meta11.setContent(std::string("../Poses/images/HAnimPoseExampleKoreanCharacter12Sun.png"));
...
meta15.setContent(std::string("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter12Sun.x3d"));
...
WorldInfo22.setTitle(std::string("KoreanCharacter12Sun.x3d"));
...
Viewpoint24.setDescription(std::string("Sun"));
Viewpoint24.setPosition(new float[]{0.0,1.0,3.0});
Scene21.addChild(&Viewpoint24);

HAnimHumanoid& HAnimHumanoid25 =  HAnimHumanoid();
HAnimHumanoid25.X3DNode::setName(std::string("Sun"));
HAnimHumanoid25.setDEF(std::string("hanim_Sun"));
...
HAnimJoint33.setCenter(new float[]{0.0,29.860001,-0.4567});
...
Transform35.setTranslation(new float[]{0.0,29.860001,-0.4567});
Shape& Shape36 =  Shape();
...
ImageTexture39.setDEF(std::string("SunTextureAtlas"));
ImageTexture39.setUrl(new std::string[]{"images/Sun.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Sun.png"}, 2);
...
ImageTexture49.setUSE(std::string("SunTextureAtlas"));
...
ImageTexture59.setUSE(std::string("SunTextureAtlas"));
...
ImageTexture69.setUSE(std::string("SunTextureAtlas"));
...
ImageTexture79.setUSE(std::string("SunTextureAtlas"));
...
ImageTexture89.setUSE(std::string("SunTextureAtlas"));
...
ImageTexture99.setUSE(std::string("SunTextureAtlas"));
...
ImageTexture109.setUSE(std::string("SunTextureAtlas"));
...
ImageTexture119.setUSE(std::string("SunTextureAtlas"));
...
Coordinate121.setPoint(new float[]{-1.388,-0.7441,0.9353,0.0,-0.5418,1.142,0.0,-1.042,2.002,-1.356,-1.234,1.823,-1.286,-1.394,3.004,0.0,-1.212,3.154,0.0,-1.708,3.962,-1.162,-1.8,3.64,-1.65,-1.868,2.671,-1.806,-1.859,1.688,-1.217,-2.657,3.79,0.0,-2.605,4.159,-1.729,-2.767,2.676,-1.984,-2.747,-0.4534,-1.847,-1.879,-0.4111,-1.91,-1.914,0.8074,-2.006,-2.83,0.7644,-1.895,-2.791,1.697,1.388,-0.7441,0.9353,1.356,-1.234,1.823,1.286,-1.394,3.004,1.162,-1.8,3.64,1.91,-1.914,0.8074,1.806,-1.859,1.688,1.217,-2.657,3.79,1.729,-2.767,2.676,2.006,-2.83,0.7644,1.847,-1.879,-0.4111,1.984,-2.747,-0.4534,1.65,-1.868,2.671,1.895,-2.791,1.697,0.0,-3.18,0.7644,-2.006,-3.18,0.7644,-1.729,-3.137,2.71,-1.217,-3.069,3.793,0.0,-2.997,4.162,0.0,-3.18,-0.4554,-1.99,-3.18,-0.4554,1.729,-3.137,2.71,2.006,-3.18,0.7644,1.217,-3.069,3.793,1.99,-3.18,-0.4554,0.0,-3.141,2.71,-1.895,-3.164,1.686,1.895,-3.164,1.686,0.0,-3.164,1.686,-1.486,-0.5175,-1.502,-1.788,-1.797,-1.502,-1.928,-2.585,-1.502,0.0009,0.1637,0.361,-1.326,-0.0186,0.0033,1.486,-0.5175,-1.502,1.788,-1.797,-1.502,1.928,-2.585,-1.502,1.331,-0.0112,0.0089,0.0,-3.164,-1.502,-1.935,-3.164,-1.502,1.934,-3.164,-1.502,-1.153,-0.3082,-2.015,-1.192,-1.388,-2.379,-1.307,-1.876,-2.363,-1.307,-2.129,-2.356,-0.0004,-2.129,-2.356,1.306,-2.129,-2.356,1.306,-1.876,-2.362,1.191,-1.388,-2.378,1.152,-0.3071,-2.014,1.027,0.2573,-1.173,0.0025,0.3479,-0.8576,-1.023,0.2519,-1.179}, 210);
...
HAnimJoint123.setCenter(new float[]{0.0,29.860001,-0.4567});
...
Transform125.setTranslation(new float[]{0.0,29.860001,-0.4567});
...
ImageTexture129.setUSE(std::string("SunTextureAtlas"));
...
ImageTexture139.setUSE(std::string("SunTextureAtlas"));
...
ImageTexture149.setUSE(std::string("SunTextureAtlas"));
...
ImageTexture159.setUSE(std::string("SunTextureAtlas"));
...
ImageTexture169.setUSE(std::string("SunTextureAtlas"));
...
ImageTexture179.setUSE(std::string("SunTextureAtlas"));
...
ImageTexture189.setUSE(std::string("SunTextureAtlas"));
...
ImageTexture199.setUSE(std::string("SunTextureAtlas"));
...
HAnimJoint203.setCenter(new float[]{0.0,51.25,-1.124});
...
Transform205.setTranslation(new float[]{0.0,51.25,-1.124});
...
ImageTexture209.setUSE(std::string("SunTextureAtlas"));
...
EXPORT231.setAS(new std::string("KoreanCharacter12Sun"));
EXPORT231.setLocalDEF(std::string("hanim_Sun"));
