...
#include <string>
#include "X3DLib.h"
int KoreanCharacter12Sun(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
ImageTexture39.setUrl((std::string[]){"images/Sun.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Sun.png"}, 2);
