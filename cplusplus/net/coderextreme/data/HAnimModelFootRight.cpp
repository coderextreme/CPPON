...
meta3.setContent(std::string("HAnimModelFootRight.x3d"));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(std::string("description"));
meta4.setContent(std::string("Right foot, using high-fidelity definitions for HAnim version 2.0"));
head1.addMeta(&meta4);
...
meta9.setContent(std::string("Update all values to match HAnim2 A.7 Level of articulation four LOA-4"));
head1.addMeta(&meta9);

meta& meta10 =  meta();
meta10.setName(std::string("TODO"));
meta10.setContent(std::string("Add links to figures"));
head1.addMeta(&meta10);

meta& meta11 =  meta();
meta11.setName(std::string("TODO"));
meta11.setContent(std::string("Add Viewpoints to enable inspection"));
...
meta& meta13 =  meta();
meta13.setName(std::string("warning"));
meta13.setContent(std::string("TODO will X3D HAnim component add a new level to support LOA-4 functionality?"));
head1.addMeta(&meta13);

meta& meta14 =  meta();
meta14.setName(std::string("reference"));
meta14.setContent(std::string("https://www.web3d.org/working-groups/humanoid-animation-HAnim"));
head1.addMeta(&meta14);

meta& meta15 =  meta();
meta15.setName(std::string("reference"));
meta15.setContent(std::string("https://www.web3d.org/documents/specifications/19774/V2.0"));
head1.addMeta(&meta15);

meta& meta16 =  meta();
meta16.setName(std::string("reference"));
meta16.setContent(std::string("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/concepts.html#TheFeet"));
head1.addMeta(&meta16);

meta& meta17 =  meta();
meta17.setName(std::string("reference"));
meta17.setContent(std::string("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/concepts.html#f-FootJoints"));
head1.addMeta(&meta17);

meta& meta18 =  meta();
meta18.setName(std::string("reference"));
meta18.setContent(std::string("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/concepts.html#Hierarchy4"));
head1.addMeta(&meta18);

meta& meta19 =  meta();
meta19.setName(std::string("reference"));
meta19.setContent(std::string("https://www.web3d.org/specifications/X3Dv4Draft/ISO-IEC19775-1v4-WD2/Part01/components/hanim.html"));
head1.addMeta(&meta19);

meta& meta20 =  meta();
meta20.setName(std::string("subject"));
meta20.setContent(std::string("X3D HAnim humanoid animation"));
head1.addMeta(&meta20);

meta& meta21 =  meta();
meta21.setName(std::string("TODO"));
meta21.setContent(std::string("Integrate and confirm Segment/Joint names, Viewpoints."));
head1.addMeta(&meta21);

meta& meta22 =  meta();
meta22.setName(std::string("identifier"));
meta22.setContent(std::string("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelFootRight.x3d"));
head1.addMeta(&meta22);

meta& meta23 =  meta();
meta23.setName(std::string("generator"));
meta23.setContent(std::string("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"));
head1.addMeta(&meta23);

meta& meta24 =  meta();
meta24.setName(std::string("license"));
meta24.setContent(std::string("../license.html"));
...
WorldInfo26.setTitle(std::string("HAnimModelFootRight.x3d"));
Scene25.addChild(&WorldInfo26);

HAnimHumanoid& HAnimHumanoid27 =  HAnimHumanoid();
HAnimHumanoid27.X3DNode::setName(std::string("Foot_Right"));
HAnimHumanoid27.setDEF(std::string("hanim_Foot_Right"));
...
HAnimJoint31.setDescription(std::string("connection joint of foot to leg above"));
HAnimSegment& HAnimSegment32 =  HAnimSegment();
HAnimSegment32.X3DNode::setName(std::string("r_talus"));
HAnimSegment32.setDEF(std::string("hanim_r_talus"));
Transform& Transform33 =  Transform();
Shape& Shape34 =  Shape();
Shape34.setDEF(std::string("HAnimJointShape"));
...
IndexedLineSet41.setDEF(std::string("TCtoTCN"));
...
IndexedLineSet46.setDEF(std::string("TCtoCC"));
...
HAnimJoint48.X3DNode::setName(std::string("r_talocalcaneonavicular"));
HAnimJoint48.setDEF(std::string("hanim_r_talocalcaneonavicular"));
HAnimJoint48.setCenter(new float[]{0.0,-0.3,0.0});
HAnimSegment& HAnimSegment49 =  HAnimSegment();
HAnimSegment49.X3DNode::setName(std::string("r_navicular"));
HAnimSegment49.setDEF(std::string("hanim_r_navicular"));
...
IndexedLineSet55.setDEF(std::string("TCNtoCN1"));
...
IndexedLineSet60.setDEF(std::string("TCNtoCN2"));
...
IndexedLineSet65.setDEF(std::string("TCNtoCN3"));
...
HAnimJoint67.X3DNode::setName(std::string("r_cuneonavicular_1"));
HAnimJoint67.setDEF(std::string("hanim_r_cuneonavicular_1"));
HAnimJoint67.setCenter(new float[]{0.1,-0.45,0.0});
HAnimSegment& HAnimSegment68 =  HAnimSegment();
HAnimSegment68.X3DNode::setName(std::string("r_cuneiform_1"));
HAnimSegment68.setDEF(std::string("hanim_r_cuneiform_1"));
Transform& Transform69 =  Transform();
Transform69.setTranslation(new float[]{0.1,-0.45,0.0});
Shape& Shape70 =  Shape();
Shape70.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet74.setDEF(std::string("CN1toTMT1"));
...
HAnimJoint76.X3DNode::setName(std::string("r_tarsometatarsal_1"));
HAnimJoint76.setDEF(std::string("hanim_r_tarsometatarsal_1"));
HAnimJoint76.setCenter(new float[]{0.1,-0.6,0.0});
HAnimSegment& HAnimSegment77 =  HAnimSegment();
HAnimSegment77.X3DNode::setName(std::string("r_metatarsal_1"));
HAnimSegment77.setDEF(std::string("hanim_r_metatarsal_1"));
Transform& Transform78 =  Transform();
Transform78.setTranslation(new float[]{0.1,-0.6,0.0});
Shape& Shape79 =  Shape();
Shape79.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet83.setDEF(std::string("TMT1toMTP1"));
...
HAnimJoint85.X3DNode::setName(std::string("r_metatarsophalangeal_1"));
HAnimJoint85.setDEF(std::string("hanim_r_metatarsophalangeal_1"));
HAnimJoint85.setCenter(new float[]{0.1,-0.9,0.0});
HAnimSegment& HAnimSegment86 =  HAnimSegment();
HAnimSegment86.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_1"));
HAnimSegment86.setDEF(std::string("hanim_r_tarsal_proximal_phalanx_1"));
Transform& Transform87 =  Transform();
Transform87.setTranslation(new float[]{0.1,-0.9,0.0});
Shape& Shape88 =  Shape();
Shape88.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet92.setDEF(std::string("MTP1toIP1"));
...
HAnimJoint94.X3DNode::setName(std::string("r_tarsal_interphalangeal_1"));
HAnimJoint94.setDEF(std::string("hanim_r_tarsal_interphalangeal_1"));
HAnimJoint94.setCenter(new float[]{0.1,-1.05,0.0});
HAnimSegment& HAnimSegment95 =  HAnimSegment();
HAnimSegment95.X3DNode::setName(std::string("r_tarsal_distal_phalanx_1"));
HAnimSegment95.setDEF(std::string("hanim_r_tarsal_distal_phalanx_1"));
Transform& Transform96 =  Transform();
Transform96.setTranslation(new float[]{0.1,-1.05,0.0});
Shape& Shape97 =  Shape();
Shape97.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet101.setDEF(std::string("tiptoe_r_interphalangeal_"));
...
HAnimJoint103.X3DNode::setName(std::string("r_cuneonavicular_2"));
HAnimJoint103.setDEF(std::string("hanim_r_cuneonavicular_2"));
HAnimJoint103.setCenter(new float[]{0.0,-0.45,0.0});
HAnimSegment& HAnimSegment104 =  HAnimSegment();
HAnimSegment104.X3DNode::setName(std::string("r_cuneiform_2"));
HAnimSegment104.setDEF(std::string("hanim_r_cuneiform_2"));
Transform& Transform105 =  Transform();
Transform105.setTranslation(new float[]{0.0,-0.45,0.0});
Shape& Shape106 =  Shape();
Shape106.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet110.setDEF(std::string("CN2toTMT2"));
...
HAnimJoint112.X3DNode::setName(std::string("r_tarsometatarsal_2"));
HAnimJoint112.setDEF(std::string("hanim_r_tarsometatarsal_2"));
HAnimJoint112.setCenter(new float[]{-0.05,-0.6,0.0});
HAnimSegment& HAnimSegment113 =  HAnimSegment();
HAnimSegment113.X3DNode::setName(std::string("r_metatarsal_2"));
HAnimSegment113.setDEF(std::string("hanim_r_metatarsal_2"));
Transform& Transform114 =  Transform();
Transform114.setTranslation(new float[]{-0.05,-0.6,0.0});
Shape& Shape115 =  Shape();
Shape115.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet119.setDEF(std::string("TMT2toMTP2"));
...
HAnimJoint121.X3DNode::setName(std::string("r_metatarsophalangeal_2"));
HAnimJoint121.setDEF(std::string("hanim_r_metatarsophalangeal_2"));
HAnimJoint121.setCenter(new float[]{-0.05,-0.9,0.0});
HAnimSegment& HAnimSegment122 =  HAnimSegment();
HAnimSegment122.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_2"));
HAnimSegment122.setDEF(std::string("hanim_r_tarsal_proximal_phalanx_2"));
Transform& Transform123 =  Transform();
Transform123.setTranslation(new float[]{-0.05,-0.9,0.0});
Shape& Shape124 =  Shape();
Shape124.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet128.setDEF(std::string("MTP2toPIP2"));
...
HAnimJoint130.X3DNode::setName(std::string("r_tarsal_proximal_interphalangeal_2"));
HAnimJoint130.setDEF(std::string("hanim_r_tarsal_proximal_interphalangeal_2"));
HAnimJoint130.setCenter(new float[]{-0.05,-1.05,0.0});
HAnimSegment& HAnimSegment131 =  HAnimSegment();
HAnimSegment131.X3DNode::setName(std::string("r_tarsal_middle_phalanx_2"));
HAnimSegment131.setDEF(std::string("hanim_r_tarsal_middle_phalanx_2"));
Transform& Transform132 =  Transform();
Transform132.setTranslation(new float[]{-0.05,-1.05,0.0});
Shape& Shape133 =  Shape();
Shape133.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet137.setDEF(std::string("PIP2toDIP2"));
...
HAnimJoint139.X3DNode::setName(std::string("r_tarsal_distal_interphalangeal_2"));
HAnimJoint139.setDEF(std::string("hanim_r_tarsal_distal_interphalangeal_2"));
HAnimJoint139.setCenter(new float[]{-0.05,-1.12,0.0});
HAnimSegment& HAnimSegment140 =  HAnimSegment();
HAnimSegment140.X3DNode::setName(std::string("r_tarsal_distal_phalanx_2"));
HAnimSegment140.setDEF(std::string("hanim_r_tarsal_distal_phalanx_2"));
Transform& Transform141 =  Transform();
Transform141.setTranslation(new float[]{-0.05,-1.12,0.0});
Shape& Shape142 =  Shape();
Shape142.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet146.setDEF(std::string("tiptoe_r_tarsal_distal_interphalangeal_2"));
...
HAnimJoint148.X3DNode::setName(std::string("r_cuneonavicular_3"));
HAnimJoint148.setDEF(std::string("hanim_r_cuneonavicular_3"));
HAnimJoint148.setCenter(new float[]{-0.1,-0.4,0.0});
HAnimSegment& HAnimSegment149 =  HAnimSegment();
HAnimSegment149.X3DNode::setName(std::string("r_cuneiform_3"));
HAnimSegment149.setDEF(std::string("hanim_r_cuneiform_3"));
Transform& Transform150 =  Transform();
Transform150.setTranslation(new float[]{-0.1,-0.4,0.0});
Shape& Shape151 =  Shape();
Shape151.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet155.setDEF(std::string("CN3toTMT3"));
...
HAnimJoint157.X3DNode::setName(std::string("r_tarsometatarsal_3"));
HAnimJoint157.setDEF(std::string("hanim_r_tarsometatarsal_3"));
HAnimJoint157.setCenter(new float[]{-0.15,-0.6,0.0});
HAnimSegment& HAnimSegment158 =  HAnimSegment();
HAnimSegment158.X3DNode::setName(std::string("r_metatarsal_3"));
HAnimSegment158.setDEF(std::string("hanim_r_metatarsal_3"));
Transform& Transform159 =  Transform();
Transform159.setTranslation(new float[]{-0.15,-0.6,0.0});
Shape& Shape160 =  Shape();
Shape160.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet164.setDEF(std::string("TMT3toMTP3"));
...
HAnimJoint166.X3DNode::setName(std::string("r_metatarsophalangeal_3"));
HAnimJoint166.setDEF(std::string("hanim_r_metatarsophalangeal_3"));
HAnimJoint166.setCenter(new float[]{-0.15,-0.9,0.0});
HAnimSegment& HAnimSegment167 =  HAnimSegment();
HAnimSegment167.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_3"));
HAnimSegment167.setDEF(std::string("hanim_r_tarsal_proximal_phalanx_3"));
Transform& Transform168 =  Transform();
Transform168.setTranslation(new float[]{-0.15,-0.9,0.0});
Shape& Shape169 =  Shape();
Shape169.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet173.setDEF(std::string("MTP3toPIP3"));
...
HAnimJoint175.X3DNode::setName(std::string("r_tarsal_proximal_interphalangeal_3"));
HAnimJoint175.setDEF(std::string("hanim_r_tarsal_proximal_interphalangeal_3"));
HAnimJoint175.setCenter(new float[]{-0.15,-1.05,0.0});
HAnimSegment& HAnimSegment176 =  HAnimSegment();
HAnimSegment176.X3DNode::setName(std::string("r_tarsal_middle_phalanx_3"));
HAnimSegment176.setDEF(std::string("hanim_r_tarsal_middle_phalanx_3"));
Transform& Transform177 =  Transform();
Transform177.setTranslation(new float[]{-0.15,-1.05,0.0});
Shape& Shape178 =  Shape();
Shape178.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet182.setDEF(std::string("PIP3toDIP3"));
...
HAnimJoint184.X3DNode::setName(std::string("r_tarsal_distal_interphalangeal_3"));
HAnimJoint184.setDEF(std::string("hanim_r_tarsal_distal_interphalangeal_3"));
HAnimJoint184.setCenter(new float[]{-0.15,-1.13,0.0});
HAnimSegment& HAnimSegment185 =  HAnimSegment();
HAnimSegment185.X3DNode::setName(std::string("r_tarsal_distal_phalanx_3"));
HAnimSegment185.setDEF(std::string("hanim_r_tarsal_distal_phalanx_3"));
Transform& Transform186 =  Transform();
Transform186.setTranslation(new float[]{-0.15,-1.13,0.0});
Shape& Shape187 =  Shape();
Shape187.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet191.setDEF(std::string("tiptoe_r_tarsal_distal_interphalangeal_3"));
...
HAnimJoint193.X3DNode::setName(std::string("r_calcaneocuboid"));
HAnimJoint193.setDEF(std::string("hanim_r_calcaneocuboid"));
HAnimJoint193.setCenter(new float[]{-0.2,0.3,0.0});
HAnimSegment& HAnimSegment194 =  HAnimSegment();
HAnimSegment194.X3DNode::setName(std::string("r_calcaneus"));
HAnimSegment194.setDEF(std::string("hanim_r_calcaneus"));
Transform& Transform195 =  Transform();
Transform195.setTranslation(new float[]{-0.2,0.3,0.0});
Shape& Shape196 =  Shape();
Shape196.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet200.setDEF(std::string("CCtoTT"));
...
HAnimJoint202.X3DNode::setName(std::string("r_transversetarsal"));
HAnimJoint202.setDEF(std::string("hanim_r_transversetarsal"));
HAnimJoint202.setCenter(new float[]{-0.21,-0.3,0.0});
HAnimSegment& HAnimSegment203 =  HAnimSegment();
HAnimSegment203.X3DNode::setName(std::string("r_cuboid"));
HAnimSegment203.setDEF(std::string("hanim_r_cuboid"));
Transform& Transform204 =  Transform();
Transform204.setTranslation(new float[]{-0.21,-0.3,0.0});
Shape& Shape205 =  Shape();
Shape205.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet209.setDEF(std::string("TTtoTMT4"));
...
IndexedLineSet214.setDEF(std::string("TTtoTMT5"));
...
HAnimJoint216.X3DNode::setName(std::string("r_tarsometatarsal_4"));
HAnimJoint216.setDEF(std::string("hanim_r_tarsometatarsal_4"));
HAnimJoint216.setCenter(new float[]{-0.25,-0.58,0.0});
HAnimSegment& HAnimSegment217 =  HAnimSegment();
HAnimSegment217.X3DNode::setName(std::string("r_metatarsal_4"));
HAnimSegment217.setDEF(std::string("hanim_r_metatarsal_4"));
Transform& Transform218 =  Transform();
Transform218.setTranslation(new float[]{-0.25,-0.58,0.0});
Shape& Shape219 =  Shape();
Shape219.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet223.setDEF(std::string("TMT4toMTP4"));
...
HAnimJoint225.X3DNode::setName(std::string("r_metatarsophalangeal_4"));
HAnimJoint225.setDEF(std::string("hanim_r_metatarsophalangeal_4"));
HAnimJoint225.setCenter(new float[]{-0.25,-0.87,0.0});
HAnimSegment& HAnimSegment226 =  HAnimSegment();
HAnimSegment226.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_4"));
HAnimSegment226.setDEF(std::string("hanim_r_tarsal_proximal_phalanx_4"));
Transform& Transform227 =  Transform();
Transform227.setTranslation(new float[]{-0.25,-0.87,0.0});
Shape& Shape228 =  Shape();
Shape228.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet232.setDEF(std::string("MTP4toPIP4"));
...
HAnimJoint234.X3DNode::setName(std::string("r_tarsal_proximal_interphalangeal_4"));
HAnimJoint234.setDEF(std::string("hanim_r_tarsal_proximal_interphalangeal_4"));
HAnimJoint234.setCenter(new float[]{-0.25,-1.0,0.0});
HAnimSegment& HAnimSegment235 =  HAnimSegment();
HAnimSegment235.X3DNode::setName(std::string("r_tarsal_middle_phalanx_4"));
HAnimSegment235.setDEF(std::string("hanim_r_tarsal_middle_phalanx_4"));
...
IndexedLineSet241.setDEF(std::string("PIP4toDIP4"));
...
HAnimJoint243.X3DNode::setName(std::string("r_tarsal_distal_interphalangeal_4"));
HAnimJoint243.setDEF(std::string("hanim_r_tarsal_distal_interphalangeal_4"));
HAnimJoint243.setCenter(new float[]{-0.25,-1.1,0.0});
HAnimSegment& HAnimSegment244 =  HAnimSegment();
HAnimSegment244.X3DNode::setName(std::string("r_tarsal_distal_phalanx_4"));
HAnimSegment244.setDEF(std::string("hanim_r_tarsal_distal_phalanx_4"));
...
IndexedLineSet250.setDEF(std::string("tiptoe_r_tarsal_distal_interphalangeal_4"));
...
HAnimJoint252.X3DNode::setName(std::string("r_tarsometatarsal_5"));
HAnimJoint252.setDEF(std::string("hanim_r_tarsometatarsal_5"));
HAnimJoint252.setCenter(new float[]{-0.33,-0.52,0.0});
HAnimSegment& HAnimSegment253 =  HAnimSegment();
HAnimSegment253.X3DNode::setName(std::string("r_metatarsal_5"));
HAnimSegment253.setDEF(std::string("hanim_r_metatarsal_5"));
Transform& Transform254 =  Transform();
Transform254.setTranslation(new float[]{-0.33,-0.52,0.0});
Shape& Shape255 =  Shape();
Shape255.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet259.setDEF(std::string("TMT5toMTP5"));
...
HAnimJoint261.X3DNode::setName(std::string("r_metatarsophalangeal_5"));
HAnimJoint261.setDEF(std::string("hanim_r_metatarsophalangeal_5"));
HAnimJoint261.setCenter(new float[]{-0.34,-0.8,0.0});
HAnimSegment& HAnimSegment262 =  HAnimSegment();
HAnimSegment262.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_5"));
HAnimSegment262.setDEF(std::string("hanim_r_tarsal_proximal_phalanx_5"));
Transform& Transform263 =  Transform();
Transform263.setTranslation(new float[]{-0.34,-0.8,0.0});
Shape& Shape264 =  Shape();
Shape264.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet268.setDEF(std::string("MTP5toPIP5"));
...
HAnimJoint270.X3DNode::setName(std::string("r_tarsal_proximal_interphalangeal_5"));
HAnimJoint270.setDEF(std::string("hanim_r_tarsal_proximal_interphalangeal_5"));
HAnimJoint270.setCenter(new float[]{-0.34,-0.95,0.0});
HAnimSegment& HAnimSegment271 =  HAnimSegment();
HAnimSegment271.X3DNode::setName(std::string("r_tarsal_middle_phalanx_5"));
HAnimSegment271.setDEF(std::string("hanim_r_tarsal_middle_phalanx_5"));
Transform& Transform272 =  Transform();
Transform272.setTranslation(new float[]{-0.34,-0.95,0.0});
Shape& Shape273 =  Shape();
Shape273.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet277.setDEF(std::string("PIP5toDIP5"));
...
HAnimJoint279.X3DNode::setName(std::string("r_tarsal_distal_interphalangeal_5"));
HAnimJoint279.setDEF(std::string("hanim_r_tarsal_distal_interphalangeal_5"));
HAnimJoint279.setCenter(new float[]{-0.34,-1.05,0.0});
HAnimSegment& HAnimSegment280 =  HAnimSegment();
HAnimSegment280.X3DNode::setName(std::string("r_tarsal_distal_phalanx_5"));
HAnimSegment280.setDEF(std::string("hanim_r_tarsal_distal_phalanx_5"));
Transform& Transform281 =  Transform();
Transform281.setTranslation(new float[]{-0.34,-1.05,0.0});
Shape& Shape282 =  Shape();
Shape282.setUSE(std::string("HAnimJointShape"));
...
IndexedLineSet286.setDEF(std::string("tiptoe_r_tarsal_distal_interphalangeal_5"));
