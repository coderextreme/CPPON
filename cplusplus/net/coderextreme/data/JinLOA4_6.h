...
#include <string>
#include "X3DLib.h"
int JinLOA4_6(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
meta3.setContent(std::string("JinLOA4_6.x3d"));
head1.addMeta(&meta3);
...
WorldInfo20.setTitle(std::string("JinLOA4_6.x3d"));
...
HAnimJoint931.X3DNode::setName(std::string("l_sternoclavicular"));
HAnimJoint931.setDEF(std::string("hanim_l_sternoclavicular"));
...
HAnimJoint941.X3DNode::setName(std::string("l_acromioclavicular"));
HAnimJoint941.setDEF(std::string("hanim_l_acromioclavicular"));
...
HAnimJoint1211.X3DNode::setName(std::string("r_sternoclavicular"));
HAnimJoint1211.setDEF(std::string("hanim_r_sternoclavicular"));
...
HAnimJoint1221.X3DNode::setName(std::string("r_acromioclavicular"));
HAnimJoint1221.setDEF(std::string("hanim_r_acromioclavicular"));
