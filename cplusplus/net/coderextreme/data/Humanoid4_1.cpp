...
//#include "glut.h"
//#include "X3DLib.h"
int Humanoid4_1(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
meta3.setContent(std::string("Humanoid4_1.x3d"));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(std::string("identifier"));
meta4.setContent(std::string("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Humanoid4_1.x3d"));
head1.addMeta(&meta4);

meta& meta5 =  meta();
meta5.setName(std::string("description"));
meta5.setContent(std::string("An attempt at a standard LOA-4 skeleton"));
head1.addMeta(&meta5);

meta& meta6 =  meta();
meta6.setName(std::string("generator"));
meta6.setContent(std::string("h2.pl"));
head1.addMeta(&meta6);

meta& meta7 =  meta();
meta7.setName(std::string("modified"));
meta7.setContent(std::string("14 Jan 2023"));
head1.addMeta(&meta7);

meta& meta8 =  meta();
meta8.setName(std::string("creator"));
meta8.setContent(std::string("John Carlson"));
head1.addMeta(&meta8);

meta& meta9 =  meta();
meta9.setName(std::string("created"));
meta9.setContent(std::string("9 November 2020"));
head1.addMeta(&meta9);

meta& meta10 =  meta();
meta10.setName(std::string("license"));
meta10.setContent(std::string("../license.html"));
...
Shape& Shape13 =  Shape();
Shape13.setDEF(std::string("AxisLinesShape"));
...
Shape& Shape20 =  Shape();
Shape20.setDEF(std::string("HAnimRootShape"));
...
Material23.setDEF(std::string("HAnimRootMaterial"));
...
Shape& Shape25 =  Shape();
Shape25.setDEF(std::string("HAnimJointShape"));
...
Material28.setDEF(std::string("HAnimJointMaterial"));
...
Shape& Shape30 =  Shape();
Shape30.setDEF(std::string("HAnimSegmentLine"));
LineSet& LineSet31 =  LineSet();
LineSet31.setVertexCount(new int32_t[]{2}, 1);
ColorRGBA& ColorRGBA32 =  ColorRGBA();
ColorRGBA32.setDEF(std::string("HAnimSegmentLineColorRGBA"));
...
Shape& Shape35 =  Shape();
Shape35.setDEF(std::string("HAnimSiteShape"));
IndexedFaceSet& IndexedFaceSet36 =  IndexedFaceSet();
IndexedFaceSet36.setDEF(std::string("DiamondIFS"));
...
ColorRGBA37.setDEF(std::string("HAnimSiteColorRGBA"));
...
Viewpoint42.setDescription(std::string("default"));
Scene11.addChild(&Viewpoint42);

HAnimHumanoid& HAnimHumanoid43 =  HAnimHumanoid();
HAnimHumanoid43.X3DNode::setName(std::string("HAnim"));
HAnimHumanoid43.setDEF(std::string("hanim_HAnim"));
HAnimHumanoid43.setInfo((std::string[]){"humanoidVersion=2.0"}, 1);
HAnimHumanoid43.setVersion(std::string("2.0"));
//</LOD>
...
HAnimJoint45.setDEF(std::string("hanim_humanoid_root"));
...
ColorRGBA53.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite54.X3DNode::setName(std::string("buttocks_standing_wall_contact_point_pt"));
HAnimSite54.setDEF(std::string("hanim_buttocks_standing_wall_contact_point_pt"));
TouchSensor& TouchSensor55 =  TouchSensor();
TouchSensor55.setDescription(std::string("HAnimSite buttocks_standing_wall_contact_point_pt"));
HAnimSite54.addChild(&TouchSensor55);

Shape& Shape56 =  Shape();
Shape56.setUSE(std::string("HAnimSiteShape"));
HAnimSite54.addChild(&Shape56);

HAnimSegment46.addChild(&HAnimSite54);

HAnimSite& HAnimSite57 =  HAnimSite();
HAnimSite57.X3DNode::setName(std::string("crotch_pt"));
HAnimSite57.setDEF(std::string("hanim_crotch_pt"));
HAnimSite57.setTranslation(new float[]{0.0034,0.8266,0.0257});
TouchSensor& TouchSensor58 =  TouchSensor();
TouchSensor58.setDescription(std::string("HAnimSite crotch_pt"));
HAnimSite57.addChild(&TouchSensor58);

Shape& Shape59 =  Shape();
Shape59.setUSE(std::string("HAnimSiteShape"));
HAnimSite57.addChild(&Shape59);

HAnimSegment46.addChild(&HAnimSite57);

HAnimSite& HAnimSite60 =  HAnimSite();
HAnimSite60.X3DNode::setName(std::string("l_asis_pt"));
HAnimSite60.setDEF(std::string("hanim_l_asis_pt"));
HAnimSite60.setTranslation(new float[]{0.0925,0.9983,0.1052});
TouchSensor& TouchSensor61 =  TouchSensor();
TouchSensor61.setDescription(std::string("HAnimSite l_asis_pt"));
HAnimSite60.addChild(&TouchSensor61);

Shape& Shape62 =  Shape();
Shape62.setUSE(std::string("HAnimSiteShape"));
HAnimSite60.addChild(&Shape62);

HAnimSegment46.addChild(&HAnimSite60);

HAnimSite& HAnimSite63 =  HAnimSite();
HAnimSite63.X3DNode::setName(std::string("l_iliocristale_pt"));
HAnimSite63.setDEF(std::string("hanim_l_iliocristale_pt"));
HAnimSite63.setTranslation(new float[]{0.1612,1.0537,0.0008});
TouchSensor& TouchSensor64 =  TouchSensor();
TouchSensor64.setDescription(std::string("HAnimSite l_iliocristale_pt"));
HAnimSite63.addChild(&TouchSensor64);

Shape& Shape65 =  Shape();
Shape65.setUSE(std::string("HAnimSiteShape"));
HAnimSite63.addChild(&Shape65);

HAnimSegment46.addChild(&HAnimSite63);

HAnimSite& HAnimSite66 =  HAnimSite();
HAnimSite66.X3DNode::setName(std::string("l_psis_pt"));
HAnimSite66.setDEF(std::string("hanim_l_psis_pt"));
HAnimSite66.setTranslation(new float[]{0.0774,1.019,-0.1151});
TouchSensor& TouchSensor67 =  TouchSensor();
TouchSensor67.setDescription(std::string("HAnimSite l_psis_pt"));
HAnimSite66.addChild(&TouchSensor67);

Shape& Shape68 =  Shape();
Shape68.setUSE(std::string("HAnimSiteShape"));
HAnimSite66.addChild(&Shape68);

HAnimSegment46.addChild(&HAnimSite66);

HAnimSite& HAnimSite69 =  HAnimSite();
HAnimSite69.X3DNode::setName(std::string("l_trochanterion_pt"));
HAnimSite69.setDEF(std::string("hanim_l_trochanterion_pt"));
HAnimSite69.setTranslation(new float[]{0.1677,0.8336,0.0303});
TouchSensor& TouchSensor70 =  TouchSensor();
TouchSensor70.setDescription(std::string("HAnimSite l_trochanterion_pt"));
HAnimSite69.addChild(&TouchSensor70);

Shape& Shape71 =  Shape();
Shape71.setUSE(std::string("HAnimSiteShape"));
HAnimSite69.addChild(&Shape71);

HAnimSegment46.addChild(&HAnimSite69);

HAnimSite& HAnimSite72 =  HAnimSite();
HAnimSite72.X3DNode::setName(std::string("r_asis_pt"));
HAnimSite72.setDEF(std::string("hanim_r_asis_pt"));
HAnimSite72.setTranslation(new float[]{-0.0887,1.0021,0.1112});
TouchSensor& TouchSensor73 =  TouchSensor();
TouchSensor73.setDescription(std::string("HAnimSite r_asis_pt"));
HAnimSite72.addChild(&TouchSensor73);

Shape& Shape74 =  Shape();
Shape74.setUSE(std::string("HAnimSiteShape"));
HAnimSite72.addChild(&Shape74);

HAnimSegment46.addChild(&HAnimSite72);

HAnimSite& HAnimSite75 =  HAnimSite();
HAnimSite75.X3DNode::setName(std::string("r_iliocristale_pt"));
HAnimSite75.setDEF(std::string("hanim_r_iliocristale_pt"));
HAnimSite75.setTranslation(new float[]{-0.1525,1.0628,0.0035});
TouchSensor& TouchSensor76 =  TouchSensor();
TouchSensor76.setDescription(std::string("HAnimSite r_iliocristale_pt"));
HAnimSite75.addChild(&TouchSensor76);

Shape& Shape77 =  Shape();
Shape77.setUSE(std::string("HAnimSiteShape"));
HAnimSite75.addChild(&Shape77);

HAnimSegment46.addChild(&HAnimSite75);

HAnimSite& HAnimSite78 =  HAnimSite();
HAnimSite78.X3DNode::setName(std::string("r_psis_pt"));
HAnimSite78.setDEF(std::string("hanim_r_psis_pt"));
HAnimSite78.setTranslation(new float[]{-0.0716,1.019,-0.1138});
TouchSensor& TouchSensor79 =  TouchSensor();
TouchSensor79.setDescription(std::string("HAnimSite r_psis_pt"));
HAnimSite78.addChild(&TouchSensor79);

Shape& Shape80 =  Shape();
Shape80.setUSE(std::string("HAnimSiteShape"));
HAnimSite78.addChild(&Shape80);

HAnimSegment46.addChild(&HAnimSite78);

HAnimSite& HAnimSite81 =  HAnimSite();
HAnimSite81.X3DNode::setName(std::string("r_trochanterion_pt"));
HAnimSite81.setDEF(std::string("hanim_r_trochanterion_pt"));
HAnimSite81.setTranslation(new float[]{-0.1689,0.8419,0.0352});
TouchSensor& TouchSensor82 =  TouchSensor();
TouchSensor82.setDescription(std::string("HAnimSite r_trochanterion_pt"));
HAnimSite81.addChild(&TouchSensor82);

Shape& Shape83 =  Shape();
Shape83.setUSE(std::string("HAnimSiteShape"));
...
ColorRGBA87.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite88.X3DNode::setName(std::string("navel_pt"));
HAnimSite88.setDEF(std::string("hanim_navel_pt"));
HAnimSite88.setTranslation(new float[]{0.0069,1.0966,0.1017});
TouchSensor& TouchSensor89 =  TouchSensor();
TouchSensor89.setDescription(std::string("HAnimSite navel_pt"));
HAnimSite88.addChild(&TouchSensor89);

Shape& Shape90 =  Shape();
Shape90.setUSE(std::string("HAnimSiteShape"));
HAnimSite88.addChild(&Shape90);

HAnimSegment46.addChild(&HAnimSite88);

HAnimSite& HAnimSite91 =  HAnimSite();
HAnimSite91.X3DNode::setName(std::string("waist_preferred_anterior_pt"));
HAnimSite91.setDEF(std::string("hanim_waist_preferred_anterior_pt"));
TouchSensor& TouchSensor92 =  TouchSensor();
TouchSensor92.setDescription(std::string("HAnimSite waist_preferred_anterior_pt"));
HAnimSite91.addChild(&TouchSensor92);

Shape& Shape93 =  Shape();
Shape93.setUSE(std::string("HAnimSiteShape"));
HAnimSite91.addChild(&Shape93);

HAnimSegment46.addChild(&HAnimSite91);

HAnimSite& HAnimSite94 =  HAnimSite();
HAnimSite94.X3DNode::setName(std::string("waist_preferred_posterior_pt"));
HAnimSite94.setDEF(std::string("hanim_waist_preferred_posterior_pt"));
HAnimSite94.setTranslation(new float[]{0.29,1.0915,-0.1091});
TouchSensor& TouchSensor95 =  TouchSensor();
TouchSensor95.setDescription(std::string("HAnimSite waist_preferred_posterior_pt"));
HAnimSite94.addChild(&TouchSensor95);

Shape& Shape96 =  Shape();
Shape96.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint97.X3DNode::setName(std::string("sacroiliac"));
HAnimJoint97.setDEF(std::string("hanim_sacroiliac"));
...
HAnimSegment98.X3DNode::setName(std::string("pelvis"));
HAnimSegment98.setDEF(std::string("hanim_pelvis"));
...
Shape101.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA105.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite106.X3DNode::setName(std::string("l_femoral_lateral_epicondyles_pt"));
HAnimSite106.setDEF(std::string("hanim_l_femoral_lateral_epicondyles_pt"));
HAnimSite106.setTranslation(new float[]{0.1598,0.4967,0.0297});
TouchSensor& TouchSensor107 =  TouchSensor();
TouchSensor107.setDescription(std::string("HAnimSite l_femoral_lateral_epicondyles_pt"));
HAnimSite106.addChild(&TouchSensor107);

Shape& Shape108 =  Shape();
Shape108.setUSE(std::string("HAnimSiteShape"));
HAnimSite106.addChild(&Shape108);

HAnimSegment98.addChild(&HAnimSite106);

HAnimSite& HAnimSite109 =  HAnimSite();
HAnimSite109.X3DNode::setName(std::string("l_femoral_medial_epicondyles_pt"));
HAnimSite109.setDEF(std::string("hanim_l_femoral_medial_epicondyles_pt"));
HAnimSite109.setTranslation(new float[]{0.0398,0.4946,0.0303});
TouchSensor& TouchSensor110 =  TouchSensor();
TouchSensor110.setDescription(std::string("HAnimSite l_femoral_medial_epicondyles_pt"));
HAnimSite109.addChild(&TouchSensor110);

Shape& Shape111 =  Shape();
Shape111.setUSE(std::string("HAnimSiteShape"));
HAnimSite109.addChild(&Shape111);

HAnimSegment98.addChild(&HAnimSite109);

HAnimSite& HAnimSite112 =  HAnimSite();
HAnimSite112.X3DNode::setName(std::string("l_knee_crease_pt"));
HAnimSite112.setDEF(std::string("hanim_l_knee_crease_pt"));
HAnimSite112.setTranslation(new float[]{0.0993,0.4881,-0.0309});
TouchSensor& TouchSensor113 =  TouchSensor();
TouchSensor113.setDescription(std::string("HAnimSite l_knee_crease_pt"));
HAnimSite112.addChild(&TouchSensor113);

Shape& Shape114 =  Shape();
Shape114.setUSE(std::string("HAnimSiteShape"));
HAnimSite112.addChild(&Shape114);

HAnimSegment98.addChild(&HAnimSite112);

HAnimSite& HAnimSite115 =  HAnimSite();
HAnimSite115.X3DNode::setName(std::string("l_suprapatella_pt"));
HAnimSite115.setDEF(std::string("hanim_l_suprapatella_pt"));
TouchSensor& TouchSensor116 =  TouchSensor();
TouchSensor116.setDescription(std::string("HAnimSite l_suprapatella_pt"));
HAnimSite115.addChild(&TouchSensor116);

Shape& Shape117 =  Shape();
Shape117.setUSE(std::string("HAnimSiteShape"));
...
ColorRGBA121.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite122.X3DNode::setName(std::string("r_femoral_lateral_epicondyles_pt"));
HAnimSite122.setDEF(std::string("hanim_r_femoral_lateral_epicondyles_pt"));
HAnimSite122.setTranslation(new float[]{-0.1421,0.4992,0.031});
TouchSensor& TouchSensor123 =  TouchSensor();
TouchSensor123.setDescription(std::string("HAnimSite r_femoral_lateral_epicondyles_pt"));
HAnimSite122.addChild(&TouchSensor123);

Shape& Shape124 =  Shape();
Shape124.setUSE(std::string("HAnimSiteShape"));
HAnimSite122.addChild(&Shape124);

HAnimSegment98.addChild(&HAnimSite122);

HAnimSite& HAnimSite125 =  HAnimSite();
HAnimSite125.X3DNode::setName(std::string("r_femoral_medial_epicondyles_pt"));
HAnimSite125.setDEF(std::string("hanim_r_femoral_medial_epicondyles_pt"));
HAnimSite125.setTranslation(new float[]{-0.0221,0.5014,0.0289});
TouchSensor& TouchSensor126 =  TouchSensor();
TouchSensor126.setDescription(std::string("HAnimSite r_femoral_medial_epicondyles_pt"));
HAnimSite125.addChild(&TouchSensor126);

Shape& Shape127 =  Shape();
Shape127.setUSE(std::string("HAnimSiteShape"));
HAnimSite125.addChild(&Shape127);

HAnimSegment98.addChild(&HAnimSite125);

HAnimSite& HAnimSite128 =  HAnimSite();
HAnimSite128.X3DNode::setName(std::string("r_knee_crease_pt"));
HAnimSite128.setDEF(std::string("hanim_r_knee_crease_pt"));
HAnimSite128.setTranslation(new float[]{-0.0825,0.4932,-0.0326});
TouchSensor& TouchSensor129 =  TouchSensor();
TouchSensor129.setDescription(std::string("HAnimSite r_knee_crease_pt"));
HAnimSite128.addChild(&TouchSensor129);

Shape& Shape130 =  Shape();
Shape130.setUSE(std::string("HAnimSiteShape"));
HAnimSite128.addChild(&Shape130);

HAnimSegment98.addChild(&HAnimSite128);

HAnimSite& HAnimSite131 =  HAnimSite();
HAnimSite131.X3DNode::setName(std::string("r_suprapatella_pt"));
HAnimSite131.setDEF(std::string("hanim_r_suprapatella_pt"));
TouchSensor& TouchSensor132 =  TouchSensor();
TouchSensor132.setDescription(std::string("HAnimSite r_suprapatella_pt"));
HAnimSite131.addChild(&TouchSensor132);

Shape& Shape133 =  Shape();
Shape133.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint134.X3DNode::setName(std::string("l_hip"));
HAnimJoint134.setDEF(std::string("hanim_l_hip"));
...
HAnimSegment135.X3DNode::setName(std::string("l_thigh"));
HAnimSegment135.setDEF(std::string("hanim_l_thigh"));
...
Shape138.setUSE(std::string("HAnimJointShape"));
...
HAnimSite143.X3DNode::setName(std::string("l_lateral_malleolus_pt"));
HAnimSite143.setDEF(std::string("hanim_l_lateral_malleolus_pt"));
HAnimSite143.setTranslation(new float[]{0.1308,0.0597,-0.1032});
TouchSensor& TouchSensor144 =  TouchSensor();
TouchSensor144.setDescription(std::string("HAnimSite l_lateral_malleolus_pt"));
HAnimSite143.addChild(&TouchSensor144);

Shape& Shape145 =  Shape();
Shape145.setUSE(std::string("HAnimSiteShape"));
HAnimSite143.addChild(&Shape145);

HAnimSegment135.addChild(&HAnimSite143);

HAnimSite& HAnimSite146 =  HAnimSite();
HAnimSite146.X3DNode::setName(std::string("l_medial_malleolus_pt"));
HAnimSite146.setDEF(std::string("hanim_l_medial_malleolus_pt"));
HAnimSite146.setTranslation(new float[]{0.089,0.0716,-0.0881});
TouchSensor& TouchSensor147 =  TouchSensor();
TouchSensor147.setDescription(std::string("HAnimSite l_medial_malleolus_pt"));
HAnimSite146.addChild(&TouchSensor147);

Shape& Shape148 =  Shape();
Shape148.setUSE(std::string("HAnimSiteShape"));
HAnimSite146.addChild(&Shape148);

HAnimSegment135.addChild(&HAnimSite146);

HAnimSite& HAnimSite149 =  HAnimSite();
HAnimSite149.X3DNode::setName(std::string("l_tibiale_pt"));
HAnimSite149.setDEF(std::string("hanim_l_tibiale_pt"));
TouchSensor& TouchSensor150 =  TouchSensor();
TouchSensor150.setDescription(std::string("HAnimSite l_tibiale_pt"));
HAnimSite149.addChild(&TouchSensor150);

Shape& Shape151 =  Shape();
Shape151.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint152.X3DNode::setName(std::string("l_knee"));
HAnimJoint152.setDEF(std::string("hanim_l_knee"));
...
HAnimSegment153.X3DNode::setName(std::string("l_calf"));
HAnimSegment153.setDEF(std::string("hanim_l_calf"));
...
Shape156.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA160.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite161.X3DNode::setName(std::string("l_calcaneus_posterior_pt"));
HAnimSite161.setDEF(std::string("hanim_l_calcaneus_posterior_pt"));
HAnimSite161.setTranslation(new float[]{0.0974,0.0259,-0.1171});
TouchSensor& TouchSensor162 =  TouchSensor();
TouchSensor162.setDescription(std::string("HAnimSite l_calcaneus_posterior_pt"));
HAnimSite161.addChild(&TouchSensor162);

Shape& Shape163 =  Shape();
Shape163.setUSE(std::string("HAnimSiteShape"));
HAnimSite161.addChild(&Shape163);

HAnimSegment153.addChild(&HAnimSite161);

HAnimSite& HAnimSite164 =  HAnimSite();
HAnimSite164.X3DNode::setName(std::string("l_sphyrion_pt"));
HAnimSite164.setDEF(std::string("hanim_l_sphyrion_pt"));
HAnimSite164.setTranslation(new float[]{0.089,0.0575,-0.0943});
TouchSensor& TouchSensor165 =  TouchSensor();
TouchSensor165.setDescription(std::string("HAnimSite l_sphyrion_pt"));
HAnimSite164.addChild(&TouchSensor165);

Shape& Shape166 =  Shape();
Shape166.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint167.X3DNode::setName(std::string("l_talocrural"));
HAnimJoint167.setDEF(std::string("hanim_l_talocrural"));
...
HAnimSegment168.X3DNode::setName(std::string("l_talus"));
HAnimSegment168.setDEF(std::string("hanim_l_talus"));
...
ColorRGBA175.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA179.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint180.X3DNode::setName(std::string("l_talocalcaneonavicular"));
HAnimJoint180.setDEF(std::string("hanim_l_talocalcaneonavicular"));
...
HAnimSegment181.X3DNode::setName(std::string("l_navicular"));
HAnimSegment181.setDEF(std::string("hanim_l_navicular"));
...
ColorRGBA192.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA196.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint197.X3DNode::setName(std::string("l_cuneonavicular_1"));
HAnimJoint197.setDEF(std::string("hanim_l_cuneonavicular_1"));
...
HAnimSegment198.X3DNode::setName(std::string("l_cuneiform_1"));
HAnimSegment198.setDEF(std::string("hanim_l_cuneiform_1"));
...
Shape201.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA205.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint206.X3DNode::setName(std::string("l_tarsometatarsal_1"));
HAnimJoint206.setDEF(std::string("hanim_l_tarsometatarsal_1"));
...
HAnimSegment207.X3DNode::setName(std::string("l_metatarsal_1"));
HAnimSegment207.setDEF(std::string("hanim_l_metatarsal_1"));
...
Shape210.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA214.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite215.X3DNode::setName(std::string("l_metatarsal_phalanx_1_pt"));
HAnimSite215.setDEF(std::string("hanim_l_metatarsal_phalanx_1_pt"));
TouchSensor& TouchSensor216 =  TouchSensor();
TouchSensor216.setDescription(std::string("HAnimSite l_metatarsal_phalanx_1_pt"));
HAnimSite215.addChild(&TouchSensor216);

Shape& Shape217 =  Shape();
Shape217.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint218.X3DNode::setName(std::string("l_metatarsophalangeal_1"));
HAnimJoint218.setDEF(std::string("hanim_l_metatarsophalangeal_1"));
...
HAnimSegment219.X3DNode::setName(std::string("l_tarsal_proximal_phalanx_1"));
HAnimSegment219.setDEF(std::string("hanim_l_tarsal_proximal_phalanx_1"));
...
Shape222.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA226.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite227.X3DNode::setName(std::string("l_tarsal_distal_phalanx_1_tip"));
HAnimSite227.setDEF(std::string("hanim_l_tarsal_distal_phalanx_1_tip"));
TouchSensor& TouchSensor228 =  TouchSensor();
TouchSensor228.setDescription(std::string("HAnimSite l_tarsal_distal_phalanx_1_tip"));
HAnimSite227.addChild(&TouchSensor228);

Shape& Shape229 =  Shape();
Shape229.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint230.X3DNode::setName(std::string("l_tarsal_interphalangeal_1"));
HAnimJoint230.setDEF(std::string("hanim_l_tarsal_interphalangeal_1"));
...
HAnimJoint231.X3DNode::setName(std::string("l_cuneonavicular_2"));
HAnimJoint231.setDEF(std::string("hanim_l_cuneonavicular_2"));
...
HAnimSegment232.X3DNode::setName(std::string("l_cuneiform_2"));
HAnimSegment232.setDEF(std::string("hanim_l_cuneiform_2"));
...
Shape235.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA239.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint240.X3DNode::setName(std::string("l_tarsometatarsal_2"));
HAnimJoint240.setDEF(std::string("hanim_l_tarsometatarsal_2"));
...
HAnimSegment241.X3DNode::setName(std::string("l_metatarsal_2"));
HAnimSegment241.setDEF(std::string("hanim_l_metatarsal_2"));
...
Shape244.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA248.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint249.X3DNode::setName(std::string("l_metatarsophalangeal_2"));
HAnimJoint249.setDEF(std::string("hanim_l_metatarsophalangeal_2"));
...
HAnimSegment250.X3DNode::setName(std::string("l_tarsal_proximal_phalanx_2"));
HAnimSegment250.setDEF(std::string("hanim_l_tarsal_proximal_phalanx_2"));
...
Shape253.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA257.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint258.X3DNode::setName(std::string("l_tarsal_proximal_interphalangeal_2"));
HAnimJoint258.setDEF(std::string("hanim_l_tarsal_proximal_interphalangeal_2"));
...
HAnimSegment259.X3DNode::setName(std::string("l_tarsal_middle_phalanx_2"));
HAnimSegment259.setDEF(std::string("hanim_l_tarsal_middle_phalanx_2"));
...
Shape262.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA266.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite267.X3DNode::setName(std::string("l_tarsal_distal_phalanx_2_tip"));
HAnimSite267.setDEF(std::string("hanim_l_tarsal_distal_phalanx_2_tip"));
HAnimSite267.setTranslation(new float[]{0.1195,0.0079,0.1433});
TouchSensor& TouchSensor268 =  TouchSensor();
TouchSensor268.setDescription(std::string("HAnimSite l_tarsal_distal_phalanx_2_tip"));
HAnimSite267.addChild(&TouchSensor268);

Shape& Shape269 =  Shape();
Shape269.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint270.X3DNode::setName(std::string("l_tarsal_distal_interphalangeal_2"));
HAnimJoint270.setDEF(std::string("hanim_l_tarsal_distal_interphalangeal_2"));
...
HAnimJoint271.X3DNode::setName(std::string("l_cuneonavicular_3"));
HAnimJoint271.setDEF(std::string("hanim_l_cuneonavicular_3"));
...
HAnimSegment272.X3DNode::setName(std::string("l_cuneiform_3"));
HAnimSegment272.setDEF(std::string("hanim_l_cuneiform_3"));
...
Shape275.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA279.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint280.X3DNode::setName(std::string("l_tarsometatarsal_3"));
HAnimJoint280.setDEF(std::string("hanim_l_tarsometatarsal_3"));
...
HAnimSegment281.X3DNode::setName(std::string("l_metatarsal_3"));
HAnimSegment281.setDEF(std::string("hanim_l_metatarsal_3"));
...
Shape284.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA288.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint289.X3DNode::setName(std::string("l_metatarsophalangeal_3"));
HAnimJoint289.setDEF(std::string("hanim_l_metatarsophalangeal_3"));
...
HAnimSegment290.X3DNode::setName(std::string("l_tarsal_proximal_phalanx_3"));
HAnimSegment290.setDEF(std::string("hanim_l_tarsal_proximal_phalanx_3"));
...
Shape293.setUSE(std::string("HAnimJointShape"));
...
HAnimJoint298.X3DNode::setName(std::string("l_tarsal_proximal_interphalangeal_3"));
HAnimJoint298.setDEF(std::string("hanim_l_tarsal_proximal_interphalangeal_3"));
...
HAnimSegment299.X3DNode::setName(std::string("l_tarsal_middle_phalanx_3"));
HAnimSegment299.setDEF(std::string("hanim_l_tarsal_middle_phalanx_3"));
...
Shape302.setUSE(std::string("HAnimJointShape"));
...
HAnimSite307.X3DNode::setName(std::string("l_tarsal_distal_phalanx_3_tip"));
HAnimSite307.setDEF(std::string("hanim_l_tarsal_distal_phalanx_3_tip"));
TouchSensor& TouchSensor308 =  TouchSensor();
TouchSensor308.setDescription(std::string("HAnimSite l_tarsal_distal_phalanx_3_tip"));
HAnimSite307.addChild(&TouchSensor308);

Shape& Shape309 =  Shape();
Shape309.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint310.X3DNode::setName(std::string("l_tarsal_distal_interphalangeal_3"));
HAnimJoint310.setDEF(std::string("hanim_l_tarsal_distal_interphalangeal_3"));
...
HAnimJoint311.X3DNode::setName(std::string("l_calcaneocuboid"));
HAnimJoint311.setDEF(std::string("hanim_l_calcaneocuboid"));
...
HAnimSegment312.X3DNode::setName(std::string("l_calcaneus"));
HAnimSegment312.setDEF(std::string("hanim_l_calcaneus"));
...
Shape315.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA319.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint320.X3DNode::setName(std::string("l_transversetarsal"));
HAnimJoint320.setDEF(std::string("hanim_l_transversetarsal"));
...
HAnimSegment321.X3DNode::setName(std::string("l_cuboid"));
HAnimSegment321.setDEF(std::string("hanim_l_cuboid"));
...
Shape324.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA328.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA332.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint333.X3DNode::setName(std::string("l_tarsometatarsal_4"));
HAnimJoint333.setDEF(std::string("hanim_l_tarsometatarsal_4"));
...
HAnimSegment334.X3DNode::setName(std::string("l_metatarsal_4"));
HAnimSegment334.setDEF(std::string("hanim_l_metatarsal_4"));
...
Shape337.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA341.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint342.X3DNode::setName(std::string("l_metatarsophalangeal_4"));
HAnimJoint342.setDEF(std::string("hanim_l_metatarsophalangeal_4"));
...
HAnimSegment343.X3DNode::setName(std::string("l_tarsal_proximal_phalanx_4"));
HAnimSegment343.setDEF(std::string("hanim_l_tarsal_proximal_phalanx_4"));
...
Shape346.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA350.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint351.X3DNode::setName(std::string("l_tarsal_proximal_interphalangeal_4"));
HAnimJoint351.setDEF(std::string("hanim_l_tarsal_proximal_interphalangeal_4"));
...
HAnimSegment352.X3DNode::setName(std::string("l_tarsal_middle_phalanx_4"));
HAnimSegment352.setDEF(std::string("hanim_l_tarsal_middle_phalanx_4"));
...
Shape355.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA359.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite360.X3DNode::setName(std::string("l_tarsal_distal_phalanx_4_tip"));
HAnimSite360.setDEF(std::string("hanim_l_tarsal_distal_phalanx_4_tip"));
TouchSensor& TouchSensor361 =  TouchSensor();
TouchSensor361.setDescription(std::string("HAnimSite l_tarsal_distal_phalanx_4_tip"));
HAnimSite360.addChild(&TouchSensor361);

Shape& Shape362 =  Shape();
Shape362.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint363.X3DNode::setName(std::string("l_tarsal_distal_interphalangeal_4"));
HAnimJoint363.setDEF(std::string("hanim_l_tarsal_distal_interphalangeal_4"));
...
HAnimJoint364.X3DNode::setName(std::string("l_tarsometatarsal_5"));
HAnimJoint364.setDEF(std::string("hanim_l_tarsometatarsal_5"));
...
HAnimSegment365.X3DNode::setName(std::string("l_metatarsal_5"));
HAnimSegment365.setDEF(std::string("hanim_l_metatarsal_5"));
...
Shape368.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA372.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite373.X3DNode::setName(std::string("l_metatarsal_phalanx_5_pt"));
HAnimSite373.setDEF(std::string("hanim_l_metatarsal_phalanx_5_pt"));
TouchSensor& TouchSensor374 =  TouchSensor();
TouchSensor374.setDescription(std::string("HAnimSite l_metatarsal_phalanx_5_pt"));
HAnimSite373.addChild(&TouchSensor374);

Shape& Shape375 =  Shape();
Shape375.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint376.X3DNode::setName(std::string("l_metatarsophalangeal_5"));
HAnimJoint376.setDEF(std::string("hanim_l_metatarsophalangeal_5"));
...
HAnimSegment377.X3DNode::setName(std::string("l_tarsal_proximal_phalanx_5"));
HAnimSegment377.setDEF(std::string("hanim_l_tarsal_proximal_phalanx_5"));
...
Shape380.setUSE(std::string("HAnimJointShape"));
...
HAnimJoint385.X3DNode::setName(std::string("l_tarsal_proximal_interphalangeal_5"));
HAnimJoint385.setDEF(std::string("hanim_l_tarsal_proximal_interphalangeal_5"));
...
HAnimSegment386.X3DNode::setName(std::string("l_tarsal_middle_phalanx_5"));
HAnimSegment386.setDEF(std::string("hanim_l_tarsal_middle_phalanx_5"));
...
Shape389.setUSE(std::string("HAnimJointShape"));
...
HAnimSite394.X3DNode::setName(std::string("l_tarsal_distal_phalanx_5_tip"));
HAnimSite394.setDEF(std::string("hanim_l_tarsal_distal_phalanx_5_tip"));
TouchSensor& TouchSensor395 =  TouchSensor();
TouchSensor395.setDescription(std::string("HAnimSite l_tarsal_distal_phalanx_5_tip"));
HAnimSite394.addChild(&TouchSensor395);

Shape& Shape396 =  Shape();
Shape396.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint397.X3DNode::setName(std::string("l_tarsal_distal_interphalangeal_5"));
HAnimJoint397.setDEF(std::string("hanim_l_tarsal_distal_interphalangeal_5"));
...
HAnimJoint398.X3DNode::setName(std::string("r_hip"));
HAnimJoint398.setDEF(std::string("hanim_r_hip"));
...
HAnimSegment399.X3DNode::setName(std::string("r_thigh"));
HAnimSegment399.setDEF(std::string("hanim_r_thigh"));
...
Shape402.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA406.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite407.X3DNode::setName(std::string("r_lateral_malleolus_pt"));
HAnimSite407.setDEF(std::string("hanim_r_lateral_malleolus_pt"));
HAnimSite407.setTranslation(new float[]{-0.1006,0.0658,-0.1075});
TouchSensor& TouchSensor408 =  TouchSensor();
TouchSensor408.setDescription(std::string("HAnimSite r_lateral_malleolus_pt"));
HAnimSite407.addChild(&TouchSensor408);

Shape& Shape409 =  Shape();
Shape409.setUSE(std::string("HAnimSiteShape"));
HAnimSite407.addChild(&Shape409);

HAnimSegment399.addChild(&HAnimSite407);

HAnimSite& HAnimSite410 =  HAnimSite();
HAnimSite410.X3DNode::setName(std::string("r_medial_malleolus_pt"));
HAnimSite410.setDEF(std::string("hanim_r_medial_malleolus_pt"));
HAnimSite410.setTranslation(new float[]{-0.0591,0.076,-0.0928});
TouchSensor& TouchSensor411 =  TouchSensor();
TouchSensor411.setDescription(std::string("HAnimSite r_medial_malleolus_pt"));
HAnimSite410.addChild(&TouchSensor411);

Shape& Shape412 =  Shape();
Shape412.setUSE(std::string("HAnimSiteShape"));
HAnimSite410.addChild(&Shape412);

HAnimSegment399.addChild(&HAnimSite410);

HAnimSite& HAnimSite413 =  HAnimSite();
HAnimSite413.X3DNode::setName(std::string("r_tibiale_pt"));
HAnimSite413.setDEF(std::string("hanim_r_tibiale_pt"));
TouchSensor& TouchSensor414 =  TouchSensor();
TouchSensor414.setDescription(std::string("HAnimSite r_tibiale_pt"));
HAnimSite413.addChild(&TouchSensor414);

Shape& Shape415 =  Shape();
Shape415.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint416.X3DNode::setName(std::string("r_knee"));
HAnimJoint416.setDEF(std::string("hanim_r_knee"));
...
HAnimSegment417.X3DNode::setName(std::string("r_calf"));
HAnimSegment417.setDEF(std::string("hanim_r_calf"));
...
Shape420.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA424.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite425.X3DNode::setName(std::string("r_calcaneus_posterior_pt"));
HAnimSite425.setDEF(std::string("hanim_r_calcaneus_posterior_pt"));
HAnimSite425.setTranslation(new float[]{-0.0692,0.0297,-0.1221});
TouchSensor& TouchSensor426 =  TouchSensor();
TouchSensor426.setDescription(std::string("HAnimSite r_calcaneus_posterior_pt"));
HAnimSite425.addChild(&TouchSensor426);

Shape& Shape427 =  Shape();
Shape427.setUSE(std::string("HAnimSiteShape"));
HAnimSite425.addChild(&Shape427);

HAnimSegment417.addChild(&HAnimSite425);

HAnimSite& HAnimSite428 =  HAnimSite();
HAnimSite428.X3DNode::setName(std::string("r_sphyrion_pt"));
HAnimSite428.setDEF(std::string("hanim_r_sphyrion_pt"));
HAnimSite428.setTranslation(new float[]{-0.0603,0.061,-0.1002});
TouchSensor& TouchSensor429 =  TouchSensor();
TouchSensor429.setDescription(std::string("HAnimSite r_sphyrion_pt"));
HAnimSite428.addChild(&TouchSensor429);

Shape& Shape430 =  Shape();
Shape430.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint431.X3DNode::setName(std::string("r_talocrural"));
HAnimJoint431.setDEF(std::string("hanim_r_talocrural"));
...
HAnimSegment432.X3DNode::setName(std::string("r_talus"));
HAnimSegment432.setDEF(std::string("hanim_r_talus"));
...
Shape435.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA439.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA443.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint444.X3DNode::setName(std::string("r_talocalcaneonavicular"));
HAnimJoint444.setDEF(std::string("hanim_r_talocalcaneonavicular"));
...
HAnimSegment445.X3DNode::setName(std::string("r_navicular"));
HAnimSegment445.setDEF(std::string("hanim_r_navicular"));
...
Shape448.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA452.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA460.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint461.X3DNode::setName(std::string("r_cuneonavicular_1"));
HAnimJoint461.setDEF(std::string("hanim_r_cuneonavicular_1"));
...
HAnimSegment462.X3DNode::setName(std::string("r_cuneiform_1"));
HAnimSegment462.setDEF(std::string("hanim_r_cuneiform_1"));
...
Shape465.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA469.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint470.X3DNode::setName(std::string("r_tarsometatarsal_1"));
HAnimJoint470.setDEF(std::string("hanim_r_tarsometatarsal_1"));
...
HAnimSegment471.X3DNode::setName(std::string("r_metatarsal_1"));
HAnimSegment471.setDEF(std::string("hanim_r_metatarsal_1"));
...
Shape474.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA478.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite479.X3DNode::setName(std::string("r_metatarsal_phalanx_1_pt"));
HAnimSite479.setDEF(std::string("hanim_r_metatarsal_phalanx_1_pt"));
TouchSensor& TouchSensor480 =  TouchSensor();
TouchSensor480.setDescription(std::string("HAnimSite r_metatarsal_phalanx_1_pt"));
HAnimSite479.addChild(&TouchSensor480);

Shape& Shape481 =  Shape();
Shape481.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint482.X3DNode::setName(std::string("r_metatarsophalangeal_1"));
HAnimJoint482.setDEF(std::string("hanim_r_metatarsophalangeal_1"));
...
HAnimSegment483.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_1"));
HAnimSegment483.setDEF(std::string("hanim_r_tarsal_proximal_phalanx_1"));
...
Shape486.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA490.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite491.X3DNode::setName(std::string("r_tarsal_distal_phalanx_1_tip"));
HAnimSite491.setDEF(std::string("hanim_r_tarsal_distal_phalanx_1_tip"));
TouchSensor& TouchSensor492 =  TouchSensor();
TouchSensor492.setDescription(std::string("HAnimSite r_tarsal_distal_phalanx_1_tip"));
HAnimSite491.addChild(&TouchSensor492);

Shape& Shape493 =  Shape();
Shape493.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint494.X3DNode::setName(std::string("r_tarsal_interphalangeal_1"));
HAnimJoint494.setDEF(std::string("hanim_r_tarsal_interphalangeal_1"));
...
HAnimJoint495.X3DNode::setName(std::string("r_cuneonavicular_2"));
HAnimJoint495.setDEF(std::string("hanim_r_cuneonavicular_2"));
...
HAnimSegment496.X3DNode::setName(std::string("r_cuneiform_2"));
HAnimSegment496.setDEF(std::string("hanim_r_cuneiform_2"));
...
Shape499.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA503.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint504.X3DNode::setName(std::string("r_tarsometatarsal_2"));
HAnimJoint504.setDEF(std::string("hanim_r_tarsometatarsal_2"));
...
HAnimSegment505.X3DNode::setName(std::string("r_metatarsal_2"));
HAnimSegment505.setDEF(std::string("hanim_r_metatarsal_2"));
...
Shape508.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA512.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint513.X3DNode::setName(std::string("r_metatarsophalangeal_2"));
HAnimJoint513.setDEF(std::string("hanim_r_metatarsophalangeal_2"));
...
HAnimSegment514.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_2"));
HAnimSegment514.setDEF(std::string("hanim_r_tarsal_proximal_phalanx_2"));
...
Shape517.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA521.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint522.X3DNode::setName(std::string("r_tarsal_proximal_interphalangeal_2"));
HAnimJoint522.setDEF(std::string("hanim_r_tarsal_proximal_interphalangeal_2"));
...
HAnimSegment523.X3DNode::setName(std::string("r_tarsal_middle_phalanx_2"));
HAnimSegment523.setDEF(std::string("hanim_r_tarsal_middle_phalanx_2"));
...
Shape526.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA530.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite531.X3DNode::setName(std::string("r_tarsal_distal_phalanx_2_tip"));
HAnimSite531.setDEF(std::string("hanim_r_tarsal_distal_phalanx_2_tip"));
HAnimSite531.setTranslation(new float[]{-0.0883,0.0134,0.1383});
TouchSensor& TouchSensor532 =  TouchSensor();
TouchSensor532.setDescription(std::string("HAnimSite r_tarsal_distal_phalanx_2_tip"));
HAnimSite531.addChild(&TouchSensor532);

Shape& Shape533 =  Shape();
Shape533.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint534.X3DNode::setName(std::string("r_tarsal_distal_interphalangeal_2"));
HAnimJoint534.setDEF(std::string("hanim_r_tarsal_distal_interphalangeal_2"));
...
HAnimJoint535.X3DNode::setName(std::string("r_cuneonavicular_3"));
HAnimJoint535.setDEF(std::string("hanim_r_cuneonavicular_3"));
...
HAnimSegment536.X3DNode::setName(std::string("r_cuneiform_3"));
HAnimSegment536.setDEF(std::string("hanim_r_cuneiform_3"));
...
Shape539.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA543.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint544.X3DNode::setName(std::string("r_tarsometatarsal_3"));
HAnimJoint544.setDEF(std::string("hanim_r_tarsometatarsal_3"));
...
HAnimSegment545.X3DNode::setName(std::string("r_metatarsal_3"));
HAnimSegment545.setDEF(std::string("hanim_r_metatarsal_3"));
...
Shape548.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA552.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint553.X3DNode::setName(std::string("r_metatarsophalangeal_3"));
HAnimJoint553.setDEF(std::string("hanim_r_metatarsophalangeal_3"));
...
HAnimSegment554.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_3"));
HAnimSegment554.setDEF(std::string("hanim_r_tarsal_proximal_phalanx_3"));
...
Shape557.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA561.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint562.X3DNode::setName(std::string("r_tarsal_proximal_interphalangeal_3"));
HAnimJoint562.setDEF(std::string("hanim_r_tarsal_proximal_interphalangeal_3"));
...
HAnimSegment563.X3DNode::setName(std::string("r_tarsal_middle_phalanx_3"));
HAnimSegment563.setDEF(std::string("hanim_r_tarsal_middle_phalanx_3"));
...
Shape566.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA570.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite571.X3DNode::setName(std::string("r_tarsal_distal_phalanx_3_tip"));
HAnimSite571.setDEF(std::string("hanim_r_tarsal_distal_phalanx_3_tip"));
TouchSensor& TouchSensor572 =  TouchSensor();
TouchSensor572.setDescription(std::string("HAnimSite r_tarsal_distal_phalanx_3_tip"));
HAnimSite571.addChild(&TouchSensor572);

Shape& Shape573 =  Shape();
Shape573.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint574.X3DNode::setName(std::string("r_tarsal_distal_interphalangeal_3"));
HAnimJoint574.setDEF(std::string("hanim_r_tarsal_distal_interphalangeal_3"));
...
HAnimJoint575.X3DNode::setName(std::string("r_calcaneocuboid"));
HAnimJoint575.setDEF(std::string("hanim_r_calcaneocuboid"));
...
HAnimSegment576.X3DNode::setName(std::string("r_calcaneus"));
HAnimSegment576.setDEF(std::string("hanim_r_calcaneus"));
...
Shape579.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA583.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint584.X3DNode::setName(std::string("r_transversetarsal"));
HAnimJoint584.setDEF(std::string("hanim_r_transversetarsal"));
...
HAnimSegment585.X3DNode::setName(std::string("r_cuboid"));
HAnimSegment585.setDEF(std::string("hanim_r_cuboid"));
...
Shape588.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA592.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA596.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint597.X3DNode::setName(std::string("r_tarsometatarsal_4"));
HAnimJoint597.setDEF(std::string("hanim_r_tarsometatarsal_4"));
...
HAnimSegment598.X3DNode::setName(std::string("r_metatarsal_4"));
HAnimSegment598.setDEF(std::string("hanim_r_metatarsal_4"));
...
Shape601.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA605.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint606.X3DNode::setName(std::string("r_metatarsophalangeal_4"));
HAnimJoint606.setDEF(std::string("hanim_r_metatarsophalangeal_4"));
...
HAnimSegment607.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_4"));
HAnimSegment607.setDEF(std::string("hanim_r_tarsal_proximal_phalanx_4"));
...
Shape610.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA614.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint615.X3DNode::setName(std::string("r_tarsal_proximal_interphalangeal_4"));
HAnimJoint615.setDEF(std::string("hanim_r_tarsal_proximal_interphalangeal_4"));
...
HAnimSegment616.X3DNode::setName(std::string("r_tarsal_middle_phalanx_4"));
HAnimSegment616.setDEF(std::string("hanim_r_tarsal_middle_phalanx_4"));
...
Shape619.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA623.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite624.X3DNode::setName(std::string("r_tarsal_distal_phalanx_4_tip"));
HAnimSite624.setDEF(std::string("hanim_r_tarsal_distal_phalanx_4_tip"));
TouchSensor& TouchSensor625 =  TouchSensor();
TouchSensor625.setDescription(std::string("HAnimSite r_tarsal_distal_phalanx_4_tip"));
HAnimSite624.addChild(&TouchSensor625);

Shape& Shape626 =  Shape();
Shape626.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint627.X3DNode::setName(std::string("r_tarsal_distal_interphalangeal_4"));
HAnimJoint627.setDEF(std::string("hanim_r_tarsal_distal_interphalangeal_4"));
...
HAnimJoint628.X3DNode::setName(std::string("r_tarsometatarsal_5"));
HAnimJoint628.setDEF(std::string("hanim_r_tarsometatarsal_5"));
...
HAnimSegment629.X3DNode::setName(std::string("r_metatarsal_5"));
HAnimSegment629.setDEF(std::string("hanim_r_metatarsal_5"));
...
Shape632.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA636.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite637.X3DNode::setName(std::string("r_metatarsal_phalanx_5_pt"));
HAnimSite637.setDEF(std::string("hanim_r_metatarsal_phalanx_5_pt"));
TouchSensor& TouchSensor638 =  TouchSensor();
TouchSensor638.setDescription(std::string("HAnimSite r_metatarsal_phalanx_5_pt"));
HAnimSite637.addChild(&TouchSensor638);

Shape& Shape639 =  Shape();
Shape639.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint640.X3DNode::setName(std::string("r_metatarsophalangeal_5"));
HAnimJoint640.setDEF(std::string("hanim_r_metatarsophalangeal_5"));
...
HAnimSegment641.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_5"));
HAnimSegment641.setDEF(std::string("hanim_r_tarsal_proximal_phalanx_5"));
...
Shape644.setUSE(std::string("HAnimJointShape"));
...
HAnimJoint649.X3DNode::setName(std::string("r_tarsal_proximal_interphalangeal_5"));
HAnimJoint649.setDEF(std::string("hanim_r_tarsal_proximal_interphalangeal_5"));
...
HAnimSegment650.X3DNode::setName(std::string("r_tarsal_middle_phalanx_5"));
HAnimSegment650.setDEF(std::string("hanim_r_tarsal_middle_phalanx_5"));
...
Shape653.setUSE(std::string("HAnimJointShape"));
...
HAnimSite658.X3DNode::setName(std::string("r_tarsal_distal_phalanx_5_tip"));
HAnimSite658.setDEF(std::string("hanim_r_tarsal_distal_phalanx_5_tip"));
TouchSensor& TouchSensor659 =  TouchSensor();
TouchSensor659.setDescription(std::string("HAnimSite r_tarsal_distal_phalanx_5_tip"));
HAnimSite658.addChild(&TouchSensor659);

Shape& Shape660 =  Shape();
Shape660.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint661.X3DNode::setName(std::string("r_tarsal_distal_interphalangeal_5"));
HAnimJoint661.setDEF(std::string("hanim_r_tarsal_distal_interphalangeal_5"));
...
HAnimJoint662.X3DNode::setName(std::string("vl5"));
HAnimJoint662.setDEF(std::string("hanim_vl5"));
...
HAnimSegment663.X3DNode::setName(std::string("l5"));
HAnimSegment663.setDEF(std::string("hanim_l5"));
...
Shape666.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA670.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint671.X3DNode::setName(std::string("vl4"));
HAnimJoint671.setDEF(std::string("hanim_vl4"));
...
HAnimSegment672.X3DNode::setName(std::string("l4"));
HAnimSegment672.setDEF(std::string("hanim_l4"));
...
Shape675.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA679.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint680.X3DNode::setName(std::string("vl3"));
HAnimJoint680.setDEF(std::string("hanim_vl3"));
...
HAnimSegment681.X3DNode::setName(std::string("l3"));
HAnimSegment681.setDEF(std::string("hanim_l3"));
...
Shape684.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA688.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite689.X3DNode::setName(std::string("l_rib10_pt"));
HAnimSite689.setDEF(std::string("hanim_l_rib10_pt"));
HAnimSite689.setTranslation(new float[]{0.0871,1.1925,0.0992});
TouchSensor& TouchSensor690 =  TouchSensor();
TouchSensor690.setDescription(std::string("HAnimSite l_rib10_pt"));
HAnimSite689.addChild(&TouchSensor690);

Shape& Shape691 =  Shape();
Shape691.setUSE(std::string("HAnimSiteShape"));
HAnimSite689.addChild(&Shape691);

HAnimSegment681.addChild(&HAnimSite689);

HAnimSite& HAnimSite692 =  HAnimSite();
HAnimSite692.X3DNode::setName(std::string("r_rib10_pt"));
HAnimSite692.setDEF(std::string("hanim_r_rib10_pt"));
HAnimSite692.setTranslation(new float[]{-0.0711,1.1941,0.1016});
TouchSensor& TouchSensor693 =  TouchSensor();
TouchSensor693.setDescription(std::string("HAnimSite r_rib10_pt"));
HAnimSite692.addChild(&TouchSensor693);

Shape& Shape694 =  Shape();
Shape694.setUSE(std::string("HAnimSiteShape"));
HAnimSite692.addChild(&Shape694);

HAnimSegment681.addChild(&HAnimSite692);

HAnimSite& HAnimSite695 =  HAnimSite();
HAnimSite695.X3DNode::setName(std::string("spine_2_middle_back_pt"));
HAnimSite695.setDEF(std::string("hanim_spine_2_middle_back_pt"));
TouchSensor& TouchSensor696 =  TouchSensor();
TouchSensor696.setDescription(std::string("HAnimSite spine_2_middle_back_pt"));
HAnimSite695.addChild(&TouchSensor696);

Shape& Shape697 =  Shape();
Shape697.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint698.X3DNode::setName(std::string("vl2"));
HAnimJoint698.setDEF(std::string("hanim_vl2"));
...
HAnimSegment699.X3DNode::setName(std::string("l2"));
HAnimSegment699.setDEF(std::string("hanim_l2"));
...
Shape702.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA706.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint707.X3DNode::setName(std::string("vl1"));
HAnimJoint707.setDEF(std::string("hanim_vl1"));
...
HAnimSegment708.X3DNode::setName(std::string("l1"));
HAnimSegment708.setDEF(std::string("hanim_l1"));
...
Shape711.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA715.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint716.X3DNode::setName(std::string("vt12"));
HAnimJoint716.setDEF(std::string("hanim_vt12"));
...
HAnimSegment717.X3DNode::setName(std::string("t12"));
HAnimSegment717.setDEF(std::string("hanim_t12"));
...
Shape720.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA724.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint725.X3DNode::setName(std::string("vt11"));
HAnimJoint725.setDEF(std::string("hanim_vt11"));
...
HAnimSegment726.X3DNode::setName(std::string("t11"));
HAnimSegment726.setDEF(std::string("hanim_t11"));
...
Shape729.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA733.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite734.X3DNode::setName(std::string("substernale_pt"));
HAnimSite734.setDEF(std::string("hanim_substernale_pt"));
HAnimSite734.setTranslation(new float[]{0.0085,1.2995,0.1147});
TouchSensor& TouchSensor735 =  TouchSensor();
TouchSensor735.setDescription(std::string("HAnimSite substernale_pt"));
HAnimSite734.addChild(&TouchSensor735);

Shape& Shape736 =  Shape();
Shape736.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint737.X3DNode::setName(std::string("vt10"));
HAnimJoint737.setDEF(std::string("hanim_vt10"));
...
HAnimSegment738.X3DNode::setName(std::string("t10"));
HAnimSegment738.setDEF(std::string("hanim_t10"));
...
Shape741.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA745.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite746.X3DNode::setName(std::string("l_thelion_pt"));
HAnimSite746.setDEF(std::string("hanim_l_thelion_pt"));
HAnimSite746.setTranslation(new float[]{0.0918,1.3382,0.1192});
TouchSensor& TouchSensor747 =  TouchSensor();
TouchSensor747.setDescription(std::string("HAnimSite l_thelion_pt"));
HAnimSite746.addChild(&TouchSensor747);

Shape& Shape748 =  Shape();
Shape748.setUSE(std::string("HAnimSiteShape"));
HAnimSite746.addChild(&Shape748);

HAnimSegment738.addChild(&HAnimSite746);

HAnimSite& HAnimSite749 =  HAnimSite();
HAnimSite749.X3DNode::setName(std::string("r_thelion_pt"));
HAnimSite749.setDEF(std::string("hanim_r_thelion_pt"));
HAnimSite749.setTranslation(new float[]{-0.0736,1.3385,0.1217});
TouchSensor& TouchSensor750 =  TouchSensor();
TouchSensor750.setDescription(std::string("HAnimSite r_thelion_pt"));
HAnimSite749.addChild(&TouchSensor750);

Shape& Shape751 =  Shape();
Shape751.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint752.X3DNode::setName(std::string("vt9"));
HAnimJoint752.setDEF(std::string("hanim_vt9"));
...
HAnimSegment753.X3DNode::setName(std::string("t9"));
HAnimSegment753.setDEF(std::string("hanim_t9"));
...
Shape756.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA760.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint761.X3DNode::setName(std::string("vt8"));
HAnimJoint761.setDEF(std::string("hanim_vt8"));
...
HAnimSegment762.X3DNode::setName(std::string("t8"));
HAnimSegment762.setDEF(std::string("hanim_t8"));
...
Shape765.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA769.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint770.X3DNode::setName(std::string("vt7"));
HAnimJoint770.setDEF(std::string("hanim_vt7"));
...
HAnimSegment771.X3DNode::setName(std::string("t7"));
HAnimSegment771.setDEF(std::string("hanim_t7"));
...
Shape774.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA778.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite779.X3DNode::setName(std::string("l_chest_midsagittal_plane_pt"));
HAnimSite779.setDEF(std::string("hanim_l_chest_midsagittal_plane_pt"));
TouchSensor& TouchSensor780 =  TouchSensor();
TouchSensor780.setDescription(std::string("HAnimSite l_chest_midsagittal_plane_pt"));
HAnimSite779.addChild(&TouchSensor780);

Shape& Shape781 =  Shape();
Shape781.setUSE(std::string("HAnimSiteShape"));
HAnimSite779.addChild(&Shape781);

HAnimSegment771.addChild(&HAnimSite779);

HAnimSite& HAnimSite782 =  HAnimSite();
HAnimSite782.X3DNode::setName(std::string("mesosternale_pt"));
HAnimSite782.setDEF(std::string("hanim_mesosternale_pt"));
TouchSensor& TouchSensor783 =  TouchSensor();
TouchSensor783.setDescription(std::string("HAnimSite mesosternale_pt"));
HAnimSite782.addChild(&TouchSensor783);

Shape& Shape784 =  Shape();
Shape784.setUSE(std::string("HAnimSiteShape"));
HAnimSite782.addChild(&Shape784);

HAnimSegment771.addChild(&HAnimSite782);

HAnimSite& HAnimSite785 =  HAnimSite();
HAnimSite785.X3DNode::setName(std::string("r_chest_midsagittal_plane_pt"));
HAnimSite785.setDEF(std::string("hanim_r_chest_midsagittal_plane_pt"));
TouchSensor& TouchSensor786 =  TouchSensor();
TouchSensor786.setDescription(std::string("HAnimSite r_chest_midsagittal_plane_pt"));
HAnimSite785.addChild(&TouchSensor786);

Shape& Shape787 =  Shape();
Shape787.setUSE(std::string("HAnimSiteShape"));
HAnimSite785.addChild(&Shape787);

HAnimSegment771.addChild(&HAnimSite785);

HAnimSite& HAnimSite788 =  HAnimSite();
HAnimSite788.X3DNode::setName(std::string("rear_center_midsagittal_plane_pt"));
HAnimSite788.setDEF(std::string("hanim_rear_center_midsagittal_plane_pt"));
TouchSensor& TouchSensor789 =  TouchSensor();
TouchSensor789.setDescription(std::string("HAnimSite rear_center_midsagittal_plane_pt"));
HAnimSite788.addChild(&TouchSensor789);

Shape& Shape790 =  Shape();
Shape790.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint791.X3DNode::setName(std::string("vt6"));
HAnimJoint791.setDEF(std::string("hanim_vt6"));
...
HAnimSegment792.X3DNode::setName(std::string("t6"));
HAnimSegment792.setDEF(std::string("hanim_t6"));
...
Shape795.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA799.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite800.X3DNode::setName(std::string("spine_1_middle_back_pt"));
HAnimSite800.setDEF(std::string("hanim_spine_1_middle_back_pt"));
TouchSensor& TouchSensor801 =  TouchSensor();
TouchSensor801.setDescription(std::string("HAnimSite spine_1_middle_back_pt"));
HAnimSite800.addChild(&TouchSensor801);

Shape& Shape802 =  Shape();
Shape802.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint803.X3DNode::setName(std::string("vt5"));
HAnimJoint803.setDEF(std::string("hanim_vt5"));
...
HAnimSegment804.X3DNode::setName(std::string("t5"));
HAnimSegment804.setDEF(std::string("hanim_t5"));
...
Shape807.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA811.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint812.X3DNode::setName(std::string("vt4"));
HAnimJoint812.setDEF(std::string("hanim_vt4"));
...
HAnimSegment813.X3DNode::setName(std::string("t4"));
HAnimSegment813.setDEF(std::string("hanim_t4"));
...
Shape816.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA820.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint821.X3DNode::setName(std::string("vt3"));
HAnimJoint821.setDEF(std::string("hanim_vt3"));
...
HAnimSegment822.X3DNode::setName(std::string("t3"));
HAnimSegment822.setDEF(std::string("hanim_t3"));
...
Shape825.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA829.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint830.X3DNode::setName(std::string("vt2"));
HAnimJoint830.setDEF(std::string("hanim_vt2"));
...
HAnimSegment831.X3DNode::setName(std::string("t2"));
HAnimSegment831.setDEF(std::string("hanim_t2"));
...
Shape834.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA838.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite839.X3DNode::setName(std::string("cervicale_pt"));
HAnimSite839.setDEF(std::string("hanim_cervicale_pt"));
HAnimSite839.setTranslation(new float[]{0.0064,1.52,-0.0815});
TouchSensor& TouchSensor840 =  TouchSensor();
TouchSensor840.setDescription(std::string("HAnimSite cervicale_pt"));
HAnimSite839.addChild(&TouchSensor840);

Shape& Shape841 =  Shape();
Shape841.setUSE(std::string("HAnimSiteShape"));
HAnimSite839.addChild(&Shape841);

HAnimSegment831.addChild(&HAnimSite839);

HAnimSite& HAnimSite842 =  HAnimSite();
HAnimSite842.X3DNode::setName(std::string("suprasternale_pt"));
HAnimSite842.setDEF(std::string("hanim_suprasternale_pt"));
HAnimSite842.setTranslation(new float[]{0.0084,1.4714,0.0551});
TouchSensor& TouchSensor843 =  TouchSensor();
TouchSensor843.setDescription(std::string("HAnimSite suprasternale_pt"));
HAnimSite842.addChild(&TouchSensor843);

Shape& Shape844 =  Shape();
Shape844.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint845.X3DNode::setName(std::string("vt1"));
HAnimJoint845.setDEF(std::string("hanim_vt1"));
...
HAnimSegment846.X3DNode::setName(std::string("t1"));
HAnimSegment846.setDEF(std::string("hanim_t1"));
...
Shape849.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA853.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite854.X3DNode::setName(std::string("l_neck_base_pt"));
HAnimSite854.setDEF(std::string("hanim_l_neck_base_pt"));
HAnimSite854.setTranslation(new float[]{0.0646,1.5141,-0.038});
TouchSensor& TouchSensor855 =  TouchSensor();
TouchSensor855.setDescription(std::string("HAnimSite l_neck_base_pt"));
HAnimSite854.addChild(&TouchSensor855);

Shape& Shape856 =  Shape();
Shape856.setUSE(std::string("HAnimSiteShape"));
HAnimSite854.addChild(&Shape856);

HAnimSegment846.addChild(&HAnimSite854);

HAnimSite& HAnimSite857 =  HAnimSite();
HAnimSite857.X3DNode::setName(std::string("r_neck_base_pt"));
HAnimSite857.setDEF(std::string("hanim_r_neck_base_pt"));
HAnimSite857.setTranslation(new float[]{-0.0419,1.5149,-0.022});
TouchSensor& TouchSensor858 =  TouchSensor();
TouchSensor858.setDescription(std::string("HAnimSite r_neck_base_pt"));
HAnimSite857.addChild(&TouchSensor858);

Shape& Shape859 =  Shape();
Shape859.setUSE(std::string("HAnimSiteShape"));
...
ColorRGBA863.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite864.X3DNode::setName(std::string("l_acromion_pt"));
HAnimSite864.setDEF(std::string("hanim_l_acromion_pt"));
HAnimSite864.setTranslation(new float[]{0.2032,1.476,-0.049});
TouchSensor& TouchSensor865 =  TouchSensor();
TouchSensor865.setDescription(std::string("HAnimSite l_acromion_pt"));
HAnimSite864.addChild(&TouchSensor865);

Shape& Shape866 =  Shape();
Shape866.setUSE(std::string("HAnimSiteShape"));
HAnimSite864.addChild(&Shape866);

HAnimSegment846.addChild(&HAnimSite864);

HAnimSite& HAnimSite867 =  HAnimSite();
HAnimSite867.X3DNode::setName(std::string("l_axilla_distal_pt"));
HAnimSite867.setDEF(std::string("hanim_l_axilla_distal_pt"));
HAnimSite867.setTranslation(new float[]{0.1706,1.4072,-0.0875});
TouchSensor& TouchSensor868 =  TouchSensor();
TouchSensor868.setDescription(std::string("HAnimSite l_axilla_distal_pt"));
HAnimSite867.addChild(&TouchSensor868);

Shape& Shape869 =  Shape();
Shape869.setUSE(std::string("HAnimSiteShape"));
HAnimSite867.addChild(&Shape869);

HAnimSegment846.addChild(&HAnimSite867);

HAnimSite& HAnimSite870 =  HAnimSite();
HAnimSite870.X3DNode::setName(std::string("l_axilla_posterior_folds_pt"));
HAnimSite870.setDEF(std::string("hanim_l_axilla_posterior_folds_pt"));
TouchSensor& TouchSensor871 =  TouchSensor();
TouchSensor871.setDescription(std::string("HAnimSite l_axilla_posterior_folds_pt"));
HAnimSite870.addChild(&TouchSensor871);

Shape& Shape872 =  Shape();
Shape872.setUSE(std::string("HAnimSiteShape"));
HAnimSite870.addChild(&Shape872);

HAnimSegment846.addChild(&HAnimSite870);

HAnimSite& HAnimSite873 =  HAnimSite();
HAnimSite873.X3DNode::setName(std::string("l_axilla_proximal_pt"));
HAnimSite873.setDEF(std::string("hanim_l_axilla_proximal_pt"));
HAnimSite873.setTranslation(new float[]{0.1777,1.4065,-0.0075});
TouchSensor& TouchSensor874 =  TouchSensor();
TouchSensor874.setDescription(std::string("HAnimSite l_axilla_proximal_pt"));
HAnimSite873.addChild(&TouchSensor874);

Shape& Shape875 =  Shape();
Shape875.setUSE(std::string("HAnimSiteShape"));
HAnimSite873.addChild(&Shape875);

HAnimSegment846.addChild(&HAnimSite873);

HAnimSite& HAnimSite876 =  HAnimSite();
HAnimSite876.X3DNode::setName(std::string("l_clavicale_pt"));
HAnimSite876.setDEF(std::string("hanim_l_clavicale_pt"));
HAnimSite876.setTranslation(new float[]{0.0271,1.4943,0.0394});
TouchSensor& TouchSensor877 =  TouchSensor();
TouchSensor877.setDescription(std::string("HAnimSite l_clavicale_pt"));
HAnimSite876.addChild(&TouchSensor877);

Shape& Shape878 =  Shape();
Shape878.setUSE(std::string("HAnimSiteShape"));
...
HAnimSite883.X3DNode::setName(std::string("r_acromion_pt"));
HAnimSite883.setDEF(std::string("hanim_r_acromion_pt"));
HAnimSite883.setTranslation(new float[]{-0.1905,1.4791,-0.0431});
TouchSensor& TouchSensor884 =  TouchSensor();
TouchSensor884.setDescription(std::string("HAnimSite r_acromion_pt"));
HAnimSite883.addChild(&TouchSensor884);

Shape& Shape885 =  Shape();
Shape885.setUSE(std::string("HAnimSiteShape"));
HAnimSite883.addChild(&Shape885);

HAnimSegment846.addChild(&HAnimSite883);

HAnimSite& HAnimSite886 =  HAnimSite();
HAnimSite886.X3DNode::setName(std::string("r_axilla_distal_pt"));
HAnimSite886.setDEF(std::string("hanim_r_axilla_distal_pt"));
HAnimSite886.setTranslation(new float[]{-0.1603,1.4098,-0.0826});
TouchSensor& TouchSensor887 =  TouchSensor();
TouchSensor887.setDescription(std::string("HAnimSite r_axilla_distal_pt"));
HAnimSite886.addChild(&TouchSensor887);

Shape& Shape888 =  Shape();
Shape888.setUSE(std::string("HAnimSiteShape"));
HAnimSite886.addChild(&Shape888);

HAnimSegment846.addChild(&HAnimSite886);

HAnimSite& HAnimSite889 =  HAnimSite();
HAnimSite889.X3DNode::setName(std::string("r_axilla_posterior_folds_pt"));
HAnimSite889.setDEF(std::string("hanim_r_axilla_posterior_folds_pt"));
TouchSensor& TouchSensor890 =  TouchSensor();
TouchSensor890.setDescription(std::string("HAnimSite r_axilla_posterior_folds_pt"));
HAnimSite889.addChild(&TouchSensor890);

Shape& Shape891 =  Shape();
Shape891.setUSE(std::string("HAnimSiteShape"));
HAnimSite889.addChild(&Shape891);

HAnimSegment846.addChild(&HAnimSite889);

HAnimSite& HAnimSite892 =  HAnimSite();
HAnimSite892.X3DNode::setName(std::string("r_axilla_proximal_pt"));
HAnimSite892.setDEF(std::string("hanim_r_axilla_proximal_pt"));
HAnimSite892.setTranslation(new float[]{-0.1626,1.4072,-0.0031});
TouchSensor& TouchSensor893 =  TouchSensor();
TouchSensor893.setDescription(std::string("HAnimSite r_axilla_proximal_pt"));
HAnimSite892.addChild(&TouchSensor893);

Shape& Shape894 =  Shape();
Shape894.setUSE(std::string("HAnimSiteShape"));
HAnimSite892.addChild(&Shape894);

HAnimSegment846.addChild(&HAnimSite892);

HAnimSite& HAnimSite895 =  HAnimSite();
HAnimSite895.X3DNode::setName(std::string("r_clavicale_pt"));
HAnimSite895.setDEF(std::string("hanim_r_clavicale_pt"));
HAnimSite895.setTranslation(new float[]{-0.0115,1.4943,0.04});
TouchSensor& TouchSensor896 =  TouchSensor();
TouchSensor896.setDescription(std::string("HAnimSite r_clavicale_pt"));
HAnimSite895.addChild(&TouchSensor896);

Shape& Shape897 =  Shape();
Shape897.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint898.X3DNode::setName(std::string("vc7"));
HAnimJoint898.setDEF(std::string("hanim_vc7"));
...
HAnimSegment899.X3DNode::setName(std::string("c7"));
HAnimSegment899.setDEF(std::string("hanim_c7"));
...
Shape902.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA906.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint907.X3DNode::setName(std::string("vc6"));
HAnimJoint907.setDEF(std::string("hanim_vc6"));
...
HAnimSegment908.X3DNode::setName(std::string("c6"));
HAnimSegment908.setDEF(std::string("hanim_c6"));
...
Shape911.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA915.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint916.X3DNode::setName(std::string("vc5"));
HAnimJoint916.setDEF(std::string("hanim_vc5"));
...
HAnimSegment917.X3DNode::setName(std::string("c5"));
HAnimSegment917.setDEF(std::string("hanim_c5"));
...
Shape920.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA924.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint925.X3DNode::setName(std::string("vc4"));
HAnimJoint925.setDEF(std::string("hanim_vc4"));
...
HAnimSegment926.X3DNode::setName(std::string("c4"));
HAnimSegment926.setDEF(std::string("hanim_c4"));
...
Shape929.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA933.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint934.X3DNode::setName(std::string("vc3"));
HAnimJoint934.setDEF(std::string("hanim_vc3"));
...
HAnimSegment935.X3DNode::setName(std::string("c3"));
HAnimSegment935.setDEF(std::string("hanim_c3"));
...
Shape938.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA942.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite943.X3DNode::setName(std::string("adams_apple_pt"));
HAnimSite943.setDEF(std::string("hanim_adams_apple_pt"));
TouchSensor& TouchSensor944 =  TouchSensor();
TouchSensor944.setDescription(std::string("HAnimSite adams_apple_pt"));
HAnimSite943.addChild(&TouchSensor944);

Shape& Shape945 =  Shape();
Shape945.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint946.X3DNode::setName(std::string("vc2"));
HAnimJoint946.setDEF(std::string("hanim_vc2"));
...
HAnimSegment947.X3DNode::setName(std::string("c2"));
HAnimSegment947.setDEF(std::string("hanim_c2"));
...
Shape950.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA954.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint955.X3DNode::setName(std::string("vc1"));
HAnimJoint955.setDEF(std::string("hanim_vc1"));
...
HAnimSegment956.X3DNode::setName(std::string("c1"));
HAnimSegment956.setDEF(std::string("hanim_c1"));
...
Shape959.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA963.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint997.X3DNode::setName(std::string("skullbase"));
HAnimJoint997.setDEF(std::string("hanim_skullbase"));
...
HAnimSegment998.X3DNode::setName(std::string("skull"));
HAnimSegment998.setDEF(std::string("hanim_skull"));
...
Shape1001.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1005.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA1009.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA1013.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA1017.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA1029.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1042.X3DNode::setName(std::string("l_eyelid_joint"));
HAnimJoint1042.setDEF(std::string("hanim_l_eyelid_joint"));
...
HAnimJoint1043.X3DNode::setName(std::string("r_eyelid_joint"));
HAnimJoint1043.setDEF(std::string("hanim_r_eyelid_joint"));
...
HAnimJoint1044.X3DNode::setName(std::string("l_eyeball_joint"));
HAnimJoint1044.setDEF(std::string("hanim_l_eyeball_joint"));
...
HAnimJoint1045.X3DNode::setName(std::string("r_eyeball_joint"));
HAnimJoint1045.setDEF(std::string("hanim_r_eyeball_joint"));
...
HAnimJoint1046.X3DNode::setName(std::string("l_eyebrow_joint"));
HAnimJoint1046.setDEF(std::string("hanim_l_eyebrow_joint"));
...
HAnimJoint1047.X3DNode::setName(std::string("r_eyebrow_joint"));
HAnimJoint1047.setDEF(std::string("hanim_r_eyebrow_joint"));
...
HAnimJoint1048.X3DNode::setName(std::string("temporomandibular"));
HAnimJoint1048.setDEF(std::string("hanim_temporomandibular"));
...
HAnimJoint1049.X3DNode::setName(std::string("l_sternoclavicular"));
HAnimJoint1049.setDEF(std::string("hanim_l_sternoclavicular"));
...
HAnimSegment1050.X3DNode::setName(std::string("l_clavicle"));
HAnimSegment1050.setDEF(std::string("hanim_l_clavicle"));
...
Shape1053.setUSE(std::string("HAnimJointShape"));
...
HAnimJoint1058.X3DNode::setName(std::string("l_acromioclavicular"));
HAnimJoint1058.setDEF(std::string("hanim_l_acromioclavicular"));
...
HAnimSegment1059.X3DNode::setName(std::string("l_scapula"));
HAnimSegment1059.setDEF(std::string("hanim_l_scapula"));
...
Shape1062.setUSE(std::string("HAnimJointShape"));
...
HAnimSite1067.X3DNode::setName(std::string("l_bideltoid_pt"));
HAnimSite1067.setDEF(std::string("hanim_l_bideltoid_pt"));
TouchSensor& TouchSensor1068 =  TouchSensor();
TouchSensor1068.setDescription(std::string("HAnimSite l_bideltoid_pt"));
HAnimSite1067.addChild(&TouchSensor1068);

Shape& Shape1069 =  Shape();
Shape1069.setUSE(std::string("HAnimSiteShape"));
HAnimSite1067.addChild(&Shape1069);

HAnimSegment1059.addChild(&HAnimSite1067);

HAnimSite& HAnimSite1070 =  HAnimSite();
HAnimSite1070.X3DNode::setName(std::string("l_humeral_lateral_epicondyles_pt"));
HAnimSite1070.setDEF(std::string("hanim_l_humeral_lateral_epicondyles_pt"));
HAnimSite1070.setTranslation(new float[]{0.228,1.1482,-0.11});
TouchSensor& TouchSensor1071 =  TouchSensor();
TouchSensor1071.setDescription(std::string("HAnimSite l_humeral_lateral_epicondyles_pt"));
HAnimSite1070.addChild(&TouchSensor1071);

Shape& Shape1072 =  Shape();
Shape1072.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1073.X3DNode::setName(std::string("l_shoulder"));
HAnimJoint1073.setDEF(std::string("hanim_l_shoulder"));
...
HAnimSegment1074.X3DNode::setName(std::string("l_upperarm"));
HAnimSegment1074.setDEF(std::string("hanim_l_upperarm"));
...
Shape1077.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1081.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1094.X3DNode::setName(std::string("l_elbow"));
HAnimJoint1094.setDEF(std::string("hanim_l_elbow"));
...
HAnimSegment1095.X3DNode::setName(std::string("l_forearm"));
HAnimSegment1095.setDEF(std::string("hanim_l_forearm"));
...
Shape1098.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1102.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1103.X3DNode::setName(std::string("l_ulnar_styloid_pt"));
HAnimSite1103.setDEF(std::string("hanim_l_ulnar_styloid_pt"));
HAnimSite1103.setTranslation(new float[]{-0.2142,0.8529,-0.0648});
TouchSensor& TouchSensor1104 =  TouchSensor();
TouchSensor1104.setDescription(std::string("HAnimSite l_ulnar_styloid_pt"));
HAnimSite1103.addChild(&TouchSensor1104);

Shape& Shape1105 =  Shape();
Shape1105.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1106.X3DNode::setName(std::string("l_radiocarpal"));
HAnimJoint1106.setDEF(std::string("hanim_l_radiocarpal"));
...
HAnimSegment1107.X3DNode::setName(std::string("l_carpal"));
HAnimSegment1107.setDEF(std::string("hanim_l_carpal"));
...
Shape1110.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1114.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA1122.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA1126.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1127.X3DNode::setName(std::string("l_midcarpal_1"));
HAnimJoint1127.setDEF(std::string("hanim_l_midcarpal_1"));
...
HAnimSegment1128.X3DNode::setName(std::string("l_trapezium"));
HAnimSegment1128.setDEF(std::string("hanim_l_trapezium"));
...
Shape1131.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1135.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1136.X3DNode::setName(std::string("l_carpometacarpal_1"));
HAnimJoint1136.setDEF(std::string("hanim_l_carpometacarpal_1"));
...
HAnimSegment1137.X3DNode::setName(std::string("l_metacarpal_1"));
HAnimSegment1137.setDEF(std::string("hanim_l_metacarpal_1"));
...
Shape1140.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1144.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1145.X3DNode::setName(std::string("l_metacarpophalangeal_1"));
HAnimJoint1145.setDEF(std::string("hanim_l_metacarpophalangeal_1"));
...
HAnimSegment1146.X3DNode::setName(std::string("l_carpal_proximal_phalanx_1"));
HAnimSegment1146.setDEF(std::string("hanim_l_carpal_proximal_phalanx_1"));
...
Shape1149.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1153.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1154.X3DNode::setName(std::string("l_carpal_distal_phalanx_1_tip"));
HAnimSite1154.setDEF(std::string("hanim_l_carpal_distal_phalanx_1_tip"));
TouchSensor& TouchSensor1155 =  TouchSensor();
TouchSensor1155.setDescription(std::string("HAnimSite l_carpal_distal_phalanx_1_tip"));
HAnimSite1154.addChild(&TouchSensor1155);

Shape& Shape1156 =  Shape();
Shape1156.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1157.X3DNode::setName(std::string("l_carpal_interphalangeal_1"));
HAnimJoint1157.setDEF(std::string("hanim_l_carpal_interphalangeal_1"));
...
HAnimJoint1158.X3DNode::setName(std::string("l_midcarpal_2"));
HAnimJoint1158.setDEF(std::string("hanim_l_midcarpal_2"));
...
HAnimSegment1159.X3DNode::setName(std::string("l_trapezoid"));
HAnimSegment1159.setDEF(std::string("hanim_l_trapezoid"));
...
Shape1162.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1166.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1167.X3DNode::setName(std::string("l_metacarpal_phalanx_2_pt"));
HAnimSite1167.setDEF(std::string("hanim_l_metacarpal_phalanx_2_pt"));
HAnimSite1167.setTranslation(new float[]{0.2009,0.8139,-0.0237});
TouchSensor& TouchSensor1168 =  TouchSensor();
TouchSensor1168.setDescription(std::string("HAnimSite l_metacarpal_phalanx_2_pt"));
HAnimSite1167.addChild(&TouchSensor1168);

Shape& Shape1169 =  Shape();
Shape1169.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1170.X3DNode::setName(std::string("l_carpometacarpal_2"));
HAnimJoint1170.setDEF(std::string("hanim_l_carpometacarpal_2"));
...
HAnimSegment1171.X3DNode::setName(std::string("l_metacarpal_2"));
HAnimSegment1171.setDEF(std::string("hanim_l_metacarpal_2"));
...
Shape1174.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1178.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1179.X3DNode::setName(std::string("l_metacarpophalangeal_2"));
HAnimJoint1179.setDEF(std::string("hanim_l_metacarpophalangeal_2"));
...
HAnimSegment1180.X3DNode::setName(std::string("l_carpal_proximal_phalanx_2"));
HAnimSegment1180.setDEF(std::string("hanim_l_carpal_proximal_phalanx_2"));
...
Shape1183.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1187.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1188.X3DNode::setName(std::string("l_carpal_proximal_interphalangeal_2"));
HAnimJoint1188.setDEF(std::string("hanim_l_carpal_proximal_interphalangeal_2"));
...
HAnimSegment1189.X3DNode::setName(std::string("l_carpal_middle_phalanx_2"));
HAnimSegment1189.setDEF(std::string("hanim_l_carpal_middle_phalanx_2"));
...
Shape1192.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1196.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1197.X3DNode::setName(std::string("l_carpal_distal_phalanx_2_tip"));
HAnimSite1197.setDEF(std::string("hanim_l_carpal_distal_phalanx_2_tip"));
TouchSensor& TouchSensor1198 =  TouchSensor();
TouchSensor1198.setDescription(std::string("HAnimSite l_carpal_distal_phalanx_2_tip"));
HAnimSite1197.addChild(&TouchSensor1198);

Shape& Shape1199 =  Shape();
Shape1199.setUSE(std::string("HAnimSiteShape"));
HAnimSite1197.addChild(&Shape1199);

HAnimSegment1189.addChild(&HAnimSite1197);

HAnimSite& HAnimSite1200 =  HAnimSite();
HAnimSite1200.X3DNode::setName(std::string("l_dactylion_pt"));
HAnimSite1200.setDEF(std::string("hanim_l_dactylion_pt"));
HAnimSite1200.setTranslation(new float[]{0.2056,0.6743,-0.0482});
TouchSensor& TouchSensor1201 =  TouchSensor();
TouchSensor1201.setDescription(std::string("HAnimSite l_dactylion_pt"));
HAnimSite1200.addChild(&TouchSensor1201);

Shape& Shape1202 =  Shape();
Shape1202.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1203.X3DNode::setName(std::string("l_carpal_distal_interphalangeal_2"));
HAnimJoint1203.setDEF(std::string("hanim_l_carpal_distal_interphalangeal_2"));
...
HAnimJoint1204.X3DNode::setName(std::string("l_midcarpal_3"));
HAnimJoint1204.setDEF(std::string("hanim_l_midcarpal_3"));
...
HAnimSegment1205.X3DNode::setName(std::string("l_capitate"));
HAnimSegment1205.setDEF(std::string("hanim_l_capitate"));
...
Shape1208.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1212.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1213.X3DNode::setName(std::string("l_metacarpal_phalanx_3_pt"));
HAnimSite1213.setDEF(std::string("hanim_l_metacarpal_phalanx_3_pt"));
TouchSensor& TouchSensor1214 =  TouchSensor();
TouchSensor1214.setDescription(std::string("HAnimSite l_metacarpal_phalanx_3_pt"));
HAnimSite1213.addChild(&TouchSensor1214);

Shape& Shape1215 =  Shape();
Shape1215.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1216.X3DNode::setName(std::string("l_carpometacarpal_3"));
HAnimJoint1216.setDEF(std::string("hanim_l_carpometacarpal_3"));
...
HAnimSegment1217.X3DNode::setName(std::string("l_metacarpal_3"));
HAnimSegment1217.setDEF(std::string("hanim_l_metacarpal_3"));
...
Shape1220.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1224.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1225.X3DNode::setName(std::string("l_metacarpophalangeal_3"));
HAnimJoint1225.setDEF(std::string("hanim_l_metacarpophalangeal_3"));
...
HAnimSegment1226.X3DNode::setName(std::string("l_carpal_proximal_phalanx_3"));
HAnimSegment1226.setDEF(std::string("hanim_l_carpal_proximal_phalanx_3"));
...
Shape1229.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1233.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1234.X3DNode::setName(std::string("l_carpal_proximal_interphalangeal_3"));
HAnimJoint1234.setDEF(std::string("hanim_l_carpal_proximal_interphalangeal_3"));
...
HAnimSegment1235.X3DNode::setName(std::string("l_carpal_middle_phalanx_3"));
HAnimSegment1235.setDEF(std::string("hanim_l_carpal_middle_phalanx_3"));
...
Shape1238.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1242.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1243.X3DNode::setName(std::string("l_carpal_distal_phalanx_3_tip"));
HAnimSite1243.setDEF(std::string("hanim_l_carpal_distal_phalanx_3_tip"));
TouchSensor& TouchSensor1244 =  TouchSensor();
TouchSensor1244.setDescription(std::string("HAnimSite l_carpal_distal_phalanx_3_tip"));
HAnimSite1243.addChild(&TouchSensor1244);

Shape& Shape1245 =  Shape();
Shape1245.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1246.X3DNode::setName(std::string("l_carpal_distal_interphalangeal_3"));
HAnimJoint1246.setDEF(std::string("hanim_l_carpal_distal_interphalangeal_3"));
...
HAnimJoint1247.X3DNode::setName(std::string("l_midcarpal_4_5"));
HAnimJoint1247.setDEF(std::string("hanim_l_midcarpal_4_5"));
...
HAnimSegment1248.X3DNode::setName(std::string("l_hamate"));
HAnimSegment1248.setDEF(std::string("hanim_l_hamate"));
...
Shape1251.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1255.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA1259.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1260.X3DNode::setName(std::string("l_metacarpal_phalanx_5_pt"));
HAnimSite1260.setDEF(std::string("hanim_l_metacarpal_phalanx_5_pt"));
HAnimSite1260.setTranslation(new float[]{0.1929,0.786,-0.1122});
TouchSensor& TouchSensor1261 =  TouchSensor();
TouchSensor1261.setDescription(std::string("HAnimSite l_metacarpal_phalanx_5_pt"));
HAnimSite1260.addChild(&TouchSensor1261);

Shape& Shape1262 =  Shape();
Shape1262.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1263.X3DNode::setName(std::string("l_carpometacarpal_4"));
HAnimJoint1263.setDEF(std::string("hanim_l_carpometacarpal_4"));
...
HAnimSegment1264.X3DNode::setName(std::string("l_metacarpal_4"));
HAnimSegment1264.setDEF(std::string("hanim_l_metacarpal_4"));
...
Shape1267.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1271.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1272.X3DNode::setName(std::string("l_metacarpophalangeal_4"));
HAnimJoint1272.setDEF(std::string("hanim_l_metacarpophalangeal_4"));
...
HAnimSegment1273.X3DNode::setName(std::string("l_carpal_proximal_phalanx_4"));
HAnimSegment1273.setDEF(std::string("hanim_l_carpal_proximal_phalanx_4"));
...
Shape1276.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1280.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1281.X3DNode::setName(std::string("l_carpal_proximal_interphalangeal_4"));
HAnimJoint1281.setDEF(std::string("hanim_l_carpal_proximal_interphalangeal_4"));
...
HAnimSegment1282.X3DNode::setName(std::string("l_carpal_middle_phalanx_4"));
HAnimSegment1282.setDEF(std::string("hanim_l_carpal_middle_phalanx_4"));
...
Shape1285.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1289.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1290.X3DNode::setName(std::string("l_carpal_distal_phalanx_4_tip"));
HAnimSite1290.setDEF(std::string("hanim_l_carpal_distal_phalanx_4_tip"));
TouchSensor& TouchSensor1291 =  TouchSensor();
TouchSensor1291.setDescription(std::string("HAnimSite l_carpal_distal_phalanx_4_tip"));
HAnimSite1290.addChild(&TouchSensor1291);

Shape& Shape1292 =  Shape();
Shape1292.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1293.X3DNode::setName(std::string("l_carpal_distal_interphalangeal_4"));
HAnimJoint1293.setDEF(std::string("hanim_l_carpal_distal_interphalangeal_4"));
...
HAnimJoint1294.X3DNode::setName(std::string("l_carpometacarpal_5"));
HAnimJoint1294.setDEF(std::string("hanim_l_carpometacarpal_5"));
...
HAnimSegment1295.X3DNode::setName(std::string("l_metacarpal_5"));
HAnimSegment1295.setDEF(std::string("hanim_l_metacarpal_5"));
...
Shape1298.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1302.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1303.X3DNode::setName(std::string("l_metacarpophalangeal_5"));
HAnimJoint1303.setDEF(std::string("hanim_l_metacarpophalangeal_5"));
...
HAnimSegment1304.X3DNode::setName(std::string("l_carpal_proximal_phalanx_5"));
HAnimSegment1304.setDEF(std::string("hanim_l_carpal_proximal_phalanx_5"));
...
Shape1307.setUSE(std::string("HAnimJointShape"));
...
HAnimJoint1312.X3DNode::setName(std::string("l_carpal_proximal_interphalangeal_5"));
HAnimJoint1312.setDEF(std::string("hanim_l_carpal_proximal_interphalangeal_5"));
...
HAnimSegment1313.X3DNode::setName(std::string("l_carpal_middle_phalanx_5"));
HAnimSegment1313.setDEF(std::string("hanim_l_carpal_middle_phalanx_5"));
...
Shape1316.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1320.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1321.X3DNode::setName(std::string("l_carpal_distal_phalanx_5_tip"));
HAnimSite1321.setDEF(std::string("hanim_l_carpal_distal_phalanx_5_tip"));
TouchSensor& TouchSensor1322 =  TouchSensor();
TouchSensor1322.setDescription(std::string("HAnimSite l_carpal_distal_phalanx_5_tip"));
HAnimSite1321.addChild(&TouchSensor1322);

Shape& Shape1323 =  Shape();
Shape1323.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1324.X3DNode::setName(std::string("l_carpal_distal_interphalangeal_5"));
HAnimJoint1324.setDEF(std::string("hanim_l_carpal_distal_interphalangeal_5"));
...
HAnimJoint1325.X3DNode::setName(std::string("r_sternoclavicular"));
HAnimJoint1325.setDEF(std::string("hanim_r_sternoclavicular"));
...
HAnimSegment1326.X3DNode::setName(std::string("r_clavicle"));
HAnimSegment1326.setDEF(std::string("hanim_r_clavicle"));
...
Shape1329.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1333.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1334.X3DNode::setName(std::string("r_acromioclavicular"));
HAnimJoint1334.setDEF(std::string("hanim_r_acromioclavicular"));
...
HAnimSegment1335.X3DNode::setName(std::string("r_scapula"));
HAnimSegment1335.setDEF(std::string("hanim_r_scapula"));
...
Shape1338.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1342.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1343.X3DNode::setName(std::string("r_bideltoid_pt"));
HAnimSite1343.setDEF(std::string("hanim_r_bideltoid_pt"));
TouchSensor& TouchSensor1344 =  TouchSensor();
TouchSensor1344.setDescription(std::string("HAnimSite r_bideltoid_pt"));
HAnimSite1343.addChild(&TouchSensor1344);

Shape& Shape1345 =  Shape();
Shape1345.setUSE(std::string("HAnimSiteShape"));
HAnimSite1343.addChild(&Shape1345);

HAnimSegment1335.addChild(&HAnimSite1343);

HAnimSite& HAnimSite1346 =  HAnimSite();
HAnimSite1346.X3DNode::setName(std::string("r_humeral_lateral_epicondyles_pt"));
HAnimSite1346.setDEF(std::string("hanim_r_humeral_lateral_epicondyles_pt"));
HAnimSite1346.setTranslation(new float[]{-0.2224,1.1517,-0.1033});
TouchSensor& TouchSensor1347 =  TouchSensor();
TouchSensor1347.setDescription(std::string("HAnimSite r_humeral_lateral_epicondyles_pt"));
HAnimSite1346.addChild(&TouchSensor1347);

Shape& Shape1348 =  Shape();
Shape1348.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1349.X3DNode::setName(std::string("r_shoulder"));
HAnimJoint1349.setDEF(std::string("hanim_r_shoulder"));
...
HAnimSegment1350.X3DNode::setName(std::string("r_upperarm"));
HAnimSegment1350.setDEF(std::string("hanim_r_upperarm"));
...
Shape1353.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1357.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1370.X3DNode::setName(std::string("r_elbow"));
HAnimJoint1370.setDEF(std::string("hanim_r_elbow"));
...
HAnimSegment1371.X3DNode::setName(std::string("r_forearm"));
HAnimSegment1371.setDEF(std::string("hanim_r_forearm"));
...
Shape1374.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1378.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1379.X3DNode::setName(std::string("r_ulnar_styloid_pt"));
HAnimSite1379.setDEF(std::string("hanim_r_ulnar_styloid_pt"));
HAnimSite1379.setTranslation(new float[]{-0.2117,0.8562,-0.0584});
TouchSensor& TouchSensor1380 =  TouchSensor();
TouchSensor1380.setDescription(std::string("HAnimSite r_ulnar_styloid_pt"));
HAnimSite1379.addChild(&TouchSensor1380);

Shape& Shape1381 =  Shape();
Shape1381.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1382.X3DNode::setName(std::string("r_radiocarpal"));
HAnimJoint1382.setDEF(std::string("hanim_r_radiocarpal"));
...
HAnimSegment1383.X3DNode::setName(std::string("r_carpal"));
HAnimSegment1383.setDEF(std::string("hanim_r_carpal"));
...
Shape1386.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1390.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA1398.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA1402.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1403.X3DNode::setName(std::string("r_midcarpal_1"));
HAnimJoint1403.setDEF(std::string("hanim_r_midcarpal_1"));
...
HAnimSegment1404.X3DNode::setName(std::string("r_trapezium"));
HAnimSegment1404.setDEF(std::string("hanim_r_trapezium"));
...
Shape1407.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1411.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1412.X3DNode::setName(std::string("r_carpometacarpal_1"));
HAnimJoint1412.setDEF(std::string("hanim_r_carpometacarpal_1"));
...
HAnimSegment1413.X3DNode::setName(std::string("r_metacarpal_1"));
HAnimSegment1413.setDEF(std::string("hanim_r_metacarpal_1"));
...
Shape1416.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1420.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1421.X3DNode::setName(std::string("r_metacarpophalangeal_1"));
HAnimJoint1421.setDEF(std::string("hanim_r_metacarpophalangeal_1"));
...
HAnimSegment1422.X3DNode::setName(std::string("r_carpal_proximal_phalanx_1"));
HAnimSegment1422.setDEF(std::string("hanim_r_carpal_proximal_phalanx_1"));
...
Shape1425.setUSE(std::string("HAnimJointShape"));
...
HAnimSite1430.X3DNode::setName(std::string("r_carpal_distal_phalanx_1_tip"));
HAnimSite1430.setDEF(std::string("hanim_r_carpal_distal_phalanx_1_tip"));
TouchSensor& TouchSensor1431 =  TouchSensor();
TouchSensor1431.setDescription(std::string("HAnimSite r_carpal_distal_phalanx_1_tip"));
HAnimSite1430.addChild(&TouchSensor1431);

Shape& Shape1432 =  Shape();
Shape1432.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1433.X3DNode::setName(std::string("r_carpal_interphalangeal_1"));
HAnimJoint1433.setDEF(std::string("hanim_r_carpal_interphalangeal_1"));
...
HAnimJoint1434.X3DNode::setName(std::string("r_midcarpal_2"));
HAnimJoint1434.setDEF(std::string("hanim_r_midcarpal_2"));
...
HAnimSegment1435.X3DNode::setName(std::string("r_trapezoid"));
HAnimSegment1435.setDEF(std::string("hanim_r_trapezoid"));
...
Shape1438.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1442.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1443.X3DNode::setName(std::string("r_metacarpal_phalanx_2_pt"));
HAnimSite1443.setDEF(std::string("hanim_r_metacarpal_phalanx_2_pt"));
HAnimSite1443.setTranslation(new float[]{-0.1977,0.8169,-0.0177});
TouchSensor& TouchSensor1444 =  TouchSensor();
TouchSensor1444.setDescription(std::string("HAnimSite r_metacarpal_phalanx_2_pt"));
HAnimSite1443.addChild(&TouchSensor1444);

Shape& Shape1445 =  Shape();
Shape1445.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1446.X3DNode::setName(std::string("r_carpometacarpal_2"));
HAnimJoint1446.setDEF(std::string("hanim_r_carpometacarpal_2"));
...
HAnimSegment1447.X3DNode::setName(std::string("r_metacarpal_2"));
HAnimSegment1447.setDEF(std::string("hanim_r_metacarpal_2"));
...
Shape1450.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1454.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1455.X3DNode::setName(std::string("r_metacarpophalangeal_2"));
HAnimJoint1455.setDEF(std::string("hanim_r_metacarpophalangeal_2"));
...
HAnimSegment1456.X3DNode::setName(std::string("r_carpal_proximal_phalanx_2"));
HAnimSegment1456.setDEF(std::string("hanim_r_carpal_proximal_phalanx_2"));
...
Shape1459.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1463.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1464.X3DNode::setName(std::string("r_carpal_proximal_interphalangeal_2"));
HAnimJoint1464.setDEF(std::string("hanim_r_carpal_proximal_interphalangeal_2"));
...
HAnimSegment1465.X3DNode::setName(std::string("r_carpal_middle_phalanx_2"));
HAnimSegment1465.setDEF(std::string("hanim_r_carpal_middle_phalanx_2"));
...
Shape1468.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1472.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1473.X3DNode::setName(std::string("r_carpal_distal_phalanx_2_tip"));
HAnimSite1473.setDEF(std::string("hanim_r_carpal_distal_phalanx_2_tip"));
TouchSensor& TouchSensor1474 =  TouchSensor();
TouchSensor1474.setDescription(std::string("HAnimSite r_carpal_distal_phalanx_2_tip"));
HAnimSite1473.addChild(&TouchSensor1474);

Shape& Shape1475 =  Shape();
Shape1475.setUSE(std::string("HAnimSiteShape"));
HAnimSite1473.addChild(&Shape1475);

HAnimSegment1465.addChild(&HAnimSite1473);

HAnimSite& HAnimSite1476 =  HAnimSite();
HAnimSite1476.X3DNode::setName(std::string("r_dactylion_pt"));
HAnimSite1476.setDEF(std::string("hanim_r_dactylion_pt"));
HAnimSite1476.setTranslation(new float[]{-0.1941,0.6772,-0.0423});
TouchSensor& TouchSensor1477 =  TouchSensor();
TouchSensor1477.setDescription(std::string("HAnimSite r_dactylion_pt"));
HAnimSite1476.addChild(&TouchSensor1477);

Shape& Shape1478 =  Shape();
Shape1478.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1479.X3DNode::setName(std::string("r_carpal_distal_interphalangeal_2"));
HAnimJoint1479.setDEF(std::string("hanim_r_carpal_distal_interphalangeal_2"));
...
HAnimJoint1480.X3DNode::setName(std::string("r_midcarpal_3"));
HAnimJoint1480.setDEF(std::string("hanim_r_midcarpal_3"));
...
HAnimSegment1481.X3DNode::setName(std::string("r_capitate"));
HAnimSegment1481.setDEF(std::string("hanim_r_capitate"));
...
Shape1484.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1488.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1489.X3DNode::setName(std::string("r_metacarpal_phalanx_3_pt"));
HAnimSite1489.setDEF(std::string("hanim_r_metacarpal_phalanx_3_pt"));
TouchSensor& TouchSensor1490 =  TouchSensor();
TouchSensor1490.setDescription(std::string("HAnimSite r_metacarpal_phalanx_3_pt"));
HAnimSite1489.addChild(&TouchSensor1490);

Shape& Shape1491 =  Shape();
Shape1491.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1492.X3DNode::setName(std::string("r_carpometacarpal_3"));
HAnimJoint1492.setDEF(std::string("hanim_r_carpometacarpal_3"));
...
HAnimSegment1493.X3DNode::setName(std::string("r_metacarpal_3"));
HAnimSegment1493.setDEF(std::string("hanim_r_metacarpal_3"));
...
Shape1496.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1500.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1501.X3DNode::setName(std::string("r_metacarpophalangeal_3"));
HAnimJoint1501.setDEF(std::string("hanim_r_metacarpophalangeal_3"));
...
HAnimSegment1502.X3DNode::setName(std::string("r_carpal_proximal_phalanx_3"));
HAnimSegment1502.setDEF(std::string("hanim_r_carpal_proximal_phalanx_3"));
...
Shape1505.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1509.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1510.X3DNode::setName(std::string("r_carpal_proximal_interphalangeal_3"));
HAnimJoint1510.setDEF(std::string("hanim_r_carpal_proximal_interphalangeal_3"));
...
HAnimSegment1511.X3DNode::setName(std::string("r_carpal_middle_phalanx_3"));
HAnimSegment1511.setDEF(std::string("hanim_r_carpal_middle_phalanx_3"));
...
Shape1514.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1518.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1519.X3DNode::setName(std::string("r_carpal_distal_phalanx_3_tip"));
HAnimSite1519.setDEF(std::string("hanim_r_carpal_distal_phalanx_3_tip"));
TouchSensor& TouchSensor1520 =  TouchSensor();
TouchSensor1520.setDescription(std::string("HAnimSite r_carpal_distal_phalanx_3_tip"));
HAnimSite1519.addChild(&TouchSensor1520);

Shape& Shape1521 =  Shape();
Shape1521.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1522.X3DNode::setName(std::string("r_carpal_distal_interphalangeal_3"));
HAnimJoint1522.setDEF(std::string("hanim_r_carpal_distal_interphalangeal_3"));
...
HAnimJoint1523.X3DNode::setName(std::string("r_midcarpal_4_5"));
HAnimJoint1523.setDEF(std::string("hanim_r_midcarpal_4_5"));
...
HAnimSegment1524.X3DNode::setName(std::string("r_hamate"));
HAnimSegment1524.setDEF(std::string("hanim_r_hamate"));
...
Shape1527.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1531.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
ColorRGBA1535.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1536.X3DNode::setName(std::string("r_metacarpal_phalanx_5_pt"));
HAnimSite1536.setDEF(std::string("hanim_r_metacarpal_phalanx_5_pt"));
HAnimSite1536.setTranslation(new float[]{-0.1929,0.789,-0.1064});
TouchSensor& TouchSensor1537 =  TouchSensor();
TouchSensor1537.setDescription(std::string("HAnimSite r_metacarpal_phalanx_5_pt"));
HAnimSite1536.addChild(&TouchSensor1537);

Shape& Shape1538 =  Shape();
Shape1538.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1539.X3DNode::setName(std::string("r_carpometacarpal_4"));
HAnimJoint1539.setDEF(std::string("hanim_r_carpometacarpal_4"));
...
HAnimSegment1540.X3DNode::setName(std::string("r_metacarpal_4"));
HAnimSegment1540.setDEF(std::string("hanim_r_metacarpal_4"));
...
Shape1543.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1547.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1548.X3DNode::setName(std::string("r_metacarpophalangeal_4"));
HAnimJoint1548.setDEF(std::string("hanim_r_metacarpophalangeal_4"));
...
HAnimSegment1549.X3DNode::setName(std::string("r_carpal_proximal_phalanx_4"));
HAnimSegment1549.setDEF(std::string("hanim_r_carpal_proximal_phalanx_4"));
...
Shape1552.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1556.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1557.X3DNode::setName(std::string("r_carpal_proximal_interphalangeal_4"));
HAnimJoint1557.setDEF(std::string("hanim_r_carpal_proximal_interphalangeal_4"));
...
HAnimSegment1558.X3DNode::setName(std::string("r_carpal_middle_phalanx_4"));
HAnimSegment1558.setDEF(std::string("hanim_r_carpal_middle_phalanx_4"));
...
Shape1561.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1565.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1566.X3DNode::setName(std::string("r_carpal_distal_phalanx_4_tip"));
HAnimSite1566.setDEF(std::string("hanim_r_carpal_distal_phalanx_4_tip"));
TouchSensor& TouchSensor1567 =  TouchSensor();
TouchSensor1567.setDescription(std::string("HAnimSite r_carpal_distal_phalanx_4_tip"));
HAnimSite1566.addChild(&TouchSensor1567);

Shape& Shape1568 =  Shape();
Shape1568.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1569.X3DNode::setName(std::string("r_carpal_distal_interphalangeal_4"));
HAnimJoint1569.setDEF(std::string("hanim_r_carpal_distal_interphalangeal_4"));
...
HAnimJoint1570.X3DNode::setName(std::string("r_carpometacarpal_5"));
HAnimJoint1570.setDEF(std::string("hanim_r_carpometacarpal_5"));
...
HAnimSegment1571.X3DNode::setName(std::string("r_metacarpal_5"));
HAnimSegment1571.setDEF(std::string("hanim_r_metacarpal_5"));
...
Shape1574.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1578.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1579.X3DNode::setName(std::string("r_metacarpophalangeal_5"));
HAnimJoint1579.setDEF(std::string("hanim_r_metacarpophalangeal_5"));
...
HAnimSegment1580.X3DNode::setName(std::string("r_carpal_proximal_phalanx_5"));
HAnimSegment1580.setDEF(std::string("hanim_r_carpal_proximal_phalanx_5"));
...
Shape1583.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1587.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimJoint1588.X3DNode::setName(std::string("r_carpal_proximal_interphalangeal_5"));
HAnimJoint1588.setDEF(std::string("hanim_r_carpal_proximal_interphalangeal_5"));
...
HAnimSegment1589.X3DNode::setName(std::string("r_carpal_middle_phalanx_5"));
HAnimSegment1589.setDEF(std::string("hanim_r_carpal_middle_phalanx_5"));
...
Shape1592.setUSE(std::string("HAnimJointShape"));
...
ColorRGBA1596.setUSE(std::string("HAnimSegmentLineColorRGBA"));
...
HAnimSite1597.X3DNode::setName(std::string("r_carpal_distal_phalanx_5_tip"));
HAnimSite1597.setDEF(std::string("hanim_r_carpal_distal_phalanx_5_tip"));
TouchSensor& TouchSensor1598 =  TouchSensor();
TouchSensor1598.setDescription(std::string("HAnimSite r_carpal_distal_phalanx_5_tip"));
HAnimSite1597.addChild(&TouchSensor1598);

Shape& Shape1599 =  Shape();
Shape1599.setUSE(std::string("HAnimSiteShape"));
...
HAnimJoint1600.X3DNode::setName(std::string("r_carpal_distal_interphalangeal_5"));
HAnimJoint1600.setDEF(std::string("hanim_r_carpal_distal_interphalangeal_5"));
