...
#include <string>
#include "X3DLib.h"
//void KoreanCharacter09Ru(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
meta3.setContent(std::string("KoreanCharacter09Ru.x3d"));
head1.addMeta(&meta3);
...
meta10.setContent(std::string("check connectivity of geometry between upper left arm and shoulder"));
head1.addMeta(&meta10);

meta& meta11 =  meta();
meta11.setName(std::string("Image"));
meta11.setContent(std::string("../Poses/images/HAnimPoseExampleKoreanCharacter09Ru.png"));
...
meta15.setContent(std::string("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter09Ru.x3d"));
...
WorldInfo22.setTitle(std::string("KoreanCharacter09Ru.x3d"));
...
Viewpoint24.setDescription(std::string("Ru"));
Viewpoint24.setPosition(new float[]{0.0,1.0,3.0});
Scene21.addChild(&Viewpoint24);

HAnimHumanoid& HAnimHumanoid25 =  HAnimHumanoid();
HAnimHumanoid25.X3DNode::setName(std::string("Ru"));
HAnimHumanoid25.setDEF(std::string("hanim_Ru"));
...
MetadataString30.setValue(new std::string[]{"male"}, 1);
...
ImageTexture39.setDEF(std::string("RuTextureAtlas"));
ImageTexture39.setUrl(new std::string[]{"images/Ru.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Ru.png"}, 2);
...
ImageTexture49.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture59.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture69.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture79.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture89.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture99.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture109.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture119.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture129.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture139.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture149.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture159.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture169.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture179.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture189.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture199.setUSE(std::string("RuTextureAtlas"));
...
ImageTexture209.setUSE(std::string("RuTextureAtlas"));
...
EXPORT231.setAS(new std::string("KoreanCharacter09Ru"));
EXPORT231.setLocalDEF(std::string("hanim_Ru"));
