...
#include <string>
#include "X3DLib.h"
int bumpyx_ite(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
ShaderPart45.setUrl((std::string[]){"../shaders/x_ite_flowers_chromatic.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite_flowers_chromatic.vs"}, 2);
ShaderPart45.setType(std::string("VERTEX"));
ComposedShader32.setParts(&ShaderPart45);

ShaderPart& ShaderPart46 =  ShaderPart();
ShaderPart46.setUrl((std::string[]){"../shaders/x_ite.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.fs"}, 2);
