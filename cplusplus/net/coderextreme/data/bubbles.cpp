...
meta2.setContent(std::string("Bubbles.x3d"));
head1.addMeta(&meta2);

meta& meta3 =  meta();
meta3.setName(std::string("description"));
meta3.setContent(std::string("Bubble animation used by Nancy Diving example."));
head1.addMeta(&meta3);
...
meta7.setContent(std::string("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/Bubbles.x3d"));
head1.addMeta(&meta7);
...
WorldInfo11.setTitle(std::string("Bubbles.x3d"));
Scene10.addChild(&WorldInfo11);

Transform& Transform12 =  Transform();
Transform12.setDEF(std::string("Bubbles"));
Group& Group13 =  Group();
Group13.setDEF(std::string("Bubble"));
TimeSensor& TimeSensor14 =  TimeSensor();
TimeSensor14.setDEF(std::string("BubbleClock"));
...
ROUTE& ROUTE76 =  ROUTE();
ROUTE76.setFromField(std::string("fraction_changed"));
ROUTE76.setFromNode(std::string("BubbleClock"));
ROUTE76.setToField(std::string("set_fraction"));
ROUTE76.setToNode(std::string("BubblePath1"));
Transform25.addChild(&ROUTE76);

ROUTE& ROUTE77 =  ROUTE();
ROUTE77.setFromField(std::string("fraction_changed"));
ROUTE77.setFromNode(std::string("BubbleClock"));
ROUTE77.setToField(std::string("set_fraction"));
ROUTE77.setToNode(std::string("BubblePath2"));
Transform25.addChild(&ROUTE77);

ROUTE& ROUTE78 =  ROUTE();
ROUTE78.setFromField(std::string("fraction_changed"));
ROUTE78.setFromNode(std::string("BubbleClock"));
ROUTE78.setToField(std::string("set_fraction"));
ROUTE78.setToNode(std::string("BubblePath3"));
Transform25.addChild(&ROUTE78);

ROUTE& ROUTE79 =  ROUTE();
ROUTE79.setFromField(std::string("fraction_changed"));
ROUTE79.setFromNode(std::string("BubbleClock"));
ROUTE79.setToField(std::string("set_fraction"));
ROUTE79.setToNode(std::string("BubblePath4"));
Transform25.addChild(&ROUTE79);

ROUTE& ROUTE80 =  ROUTE();
ROUTE80.setFromField(std::string("fraction_changed"));
ROUTE80.setFromNode(std::string("BubbleClock"));
ROUTE80.setToField(std::string("set_fraction"));
ROUTE80.setToNode(std::string("BubblePath5"));
Transform25.addChild(&ROUTE80);

ROUTE& ROUTE81 =  ROUTE();
ROUTE81.setFromField(std::string("fraction_changed"));
ROUTE81.setFromNode(std::string("BubbleClock"));
ROUTE81.setToField(std::string("set_fraction"));
ROUTE81.setToNode(std::string("BubblePath6"));
Transform25.addChild(&ROUTE81);

ROUTE& ROUTE82 =  ROUTE();
ROUTE82.setFromField(std::string("fraction_changed"));
ROUTE82.setFromNode(std::string("BubbleClock"));
ROUTE82.setToField(std::string("set_fraction"));
ROUTE82.setToNode(std::string("BubblePath7"));
Transform25.addChild(&ROUTE82);

ROUTE& ROUTE83 =  ROUTE();
ROUTE83.setFromField(std::string("fraction_changed"));
ROUTE83.setFromNode(std::string("BubbleClock"));
ROUTE83.setToField(std::string("set_fraction"));
ROUTE83.setToNode(std::string("BubblePath8"));
Transform25.addChild(&ROUTE83);

ROUTE& ROUTE84 =  ROUTE();
ROUTE84.setFromField(std::string("fraction_changed"));
ROUTE84.setFromNode(std::string("BubbleClock"));
ROUTE84.setToField(std::string("set_fraction"));
ROUTE84.setToNode(std::string("BubblePath9"));
Transform25.addChild(&ROUTE84);

ROUTE& ROUTE85 =  ROUTE();
ROUTE85.setFromField(std::string("fraction_changed"));
ROUTE85.setFromNode(std::string("BubbleClock"));
ROUTE85.setToField(std::string("set_fraction"));
ROUTE85.setToNode(std::string("BubblePath10"));
Transform25.addChild(&ROUTE85);

ROUTE& ROUTE86 =  ROUTE();
ROUTE86.setFromField(std::string("value_changed"));
ROUTE86.setFromNode(std::string("BubblePath1"));
ROUTE86.setToField(std::string("set_translation"));
ROUTE86.setToNode(std::string("bubble1"));
Transform25.addChild(&ROUTE86);

ROUTE& ROUTE87 =  ROUTE();
ROUTE87.setFromField(std::string("value_changed"));
ROUTE87.setFromNode(std::string("BubblePath2"));
ROUTE87.setToField(std::string("set_translation"));
ROUTE87.setToNode(std::string("bubble2"));
Transform25.addChild(&ROUTE87);

ROUTE& ROUTE88 =  ROUTE();
ROUTE88.setFromField(std::string("value_changed"));
ROUTE88.setFromNode(std::string("BubblePath3"));
ROUTE88.setToField(std::string("set_translation"));
ROUTE88.setToNode(std::string("bubble3"));
Transform25.addChild(&ROUTE88);

ROUTE& ROUTE89 =  ROUTE();
ROUTE89.setFromField(std::string("value_changed"));
ROUTE89.setFromNode(std::string("BubblePath4"));
ROUTE89.setToField(std::string("set_translation"));
ROUTE89.setToNode(std::string("bubble4"));
Transform25.addChild(&ROUTE89);

ROUTE& ROUTE90 =  ROUTE();
ROUTE90.setFromField(std::string("value_changed"));
ROUTE90.setFromNode(std::string("BubblePath5"));
ROUTE90.setToField(std::string("set_translation"));
ROUTE90.setToNode(std::string("bubble5"));
Transform25.addChild(&ROUTE90);

ROUTE& ROUTE91 =  ROUTE();
ROUTE91.setFromField(std::string("value_changed"));
ROUTE91.setFromNode(std::string("BubblePath6"));
ROUTE91.setToField(std::string("set_translation"));
ROUTE91.setToNode(std::string("bubble6"));
Transform25.addChild(&ROUTE91);

ROUTE& ROUTE92 =  ROUTE();
ROUTE92.setFromField(std::string("value_changed"));
ROUTE92.setFromNode(std::string("BubblePath7"));
ROUTE92.setToField(std::string("set_translation"));
ROUTE92.setToNode(std::string("bubble7"));
Transform25.addChild(&ROUTE92);

ROUTE& ROUTE93 =  ROUTE();
ROUTE93.setFromField(std::string("value_changed"));
ROUTE93.setFromNode(std::string("BubblePath8"));
ROUTE93.setToField(std::string("set_translation"));
ROUTE93.setToNode(std::string("bubble8"));
Transform25.addChild(&ROUTE93);

ROUTE& ROUTE94 =  ROUTE();
ROUTE94.setFromField(std::string("value_changed"));
ROUTE94.setFromNode(std::string("BubblePath9"));
ROUTE94.setToField(std::string("set_translation"));
ROUTE94.setToNode(std::string("bubble9"));
Transform25.addChild(&ROUTE94);

ROUTE& ROUTE95 =  ROUTE();
ROUTE95.setFromField(std::string("value_changed"));
ROUTE95.setFromNode(std::string("BubblePath10"));
ROUTE95.setToField(std::string("set_translation"));
ROUTE95.setToNode(std::string("bubble10"));
