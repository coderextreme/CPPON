...
ComposedShader34.setDEF(std::string("fw"));
...
Script49.setDEF(std::string("Animate"));
field& field50 =  field();
field50.setName(std::string("translation"));
...
field& field51 =  field();
field51.setName(std::string("velocity"));
...
field& field52 =  field();
field52.setName(std::string("set_fraction"));
...
TimeSensor59.setDEF(std::string("TourTime"));
TimeSensor59.setCycleInterval(5);
TimeSensor59.setLoop(true);
Transform19.addChild(&TimeSensor59);

ROUTE& ROUTE60 =  ROUTE();
ROUTE60.setFromNode(std::string("TourTime"));
ROUTE60.setFromField(std::string("fraction_changed"));
ROUTE60.setToNode(std::string("Animate"));
ROUTE60.setToField(std::string("set_fraction"));
Transform19.addChild(&ROUTE60);

ROUTE& ROUTE61 =  ROUTE();
ROUTE61.setFromNode(std::string("Animate"));
ROUTE61.setFromField(std::string("a"));
ROUTE61.setToNode(std::string("fw"));
...
ROUTE62.setToNode(std::string("fw"));
...
ROUTE63.setToNode(std::string("fw"));
...
ROUTE64.setToNode(std::string("fw"));
...
ROUTE65.setToNode(std::string("fw"));
...
ROUTE66.setToNode(std::string("fw"));
