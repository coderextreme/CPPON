...
meta7.setContent(std::string("ArchModelingDiagrams.pdf"));
head1.addMeta(&meta7);

meta& meta8 =  meta();
meta8.setName(std::string("reference"));
meta8.setContent(std::string("https://en.wikipedia.org/wiki/Arch"));
head1.addMeta(&meta8);

meta& meta9 =  meta();
meta9.setName(std::string("identifier"));
meta9.setContent(std::string("https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/Buildings/ArchHalf.x3d"));
head1.addMeta(&meta9);
...
WorldInfo13.setTitle(std::string("ArchHalf.x3d"));
Scene12.addChild(&WorldInfo13);

Shape& Shape14 =  Shape();
Shape14.setDEF(std::string("Arch"));
//note that convex='false' (meaning concave geometry) is crucial for this IFS of a geometric chord to render properly
IndexedFaceSet& IndexedFaceSet15 =  IndexedFaceSet();
IndexedFaceSet15.setDEF(std::string("ArchIndex"));
