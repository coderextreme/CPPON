...
meta3.setContent(std::string("IFS.x3d"));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(std::string("identifier"));
meta4.setContent(std::string("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/IFS.x3d"));
head1.addMeta(&meta4);
...
meta7.setContent(std::string("18 Jan 2023"));
head1.addMeta(&meta7);
...
Shape& Shape14 =  Shape();
Shape14.setDEF(std::string("HAnimSiteShape"));
IndexedFaceSet& IndexedFaceSet15 =  IndexedFaceSet();
IndexedFaceSet15.setDEF(std::string("DiamondIFS"));
...
Viewpoint21.setDescription(std::string("default"));
