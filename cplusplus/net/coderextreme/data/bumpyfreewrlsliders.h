...
#include <string>
#include "X3DLib.h"
//void bumpyfreewrlsliders(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
Layer19.setObjectType(new std::string[]{"ALL"}, 1);
//basic nodes, which might be present in any scene
NavigationInfo& NavigationInfo20 =  NavigationInfo();
NavigationInfo20.setType(new std::string[]{"EXAMINE", "FLY", "LOOKAT", "ANY"}, 4);
...
Background56.setBackUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_back.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"}, 2);
Background56.setBottomUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_bottom.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"}, 2);
Background56.setFrontUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_front.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"}, 2);
Background56.setLeftUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_left.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"}, 2);
Background56.setRightUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_right.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"}, 2);
Background56.setTopUrl(new std::string[]{"../resources/images/all_probes/stpeters_cross/stpeters_top.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"}, 2);
...
ShaderPart81.X3DBaseNode::addChild(&IS82);
...
ShaderPart84.X3DBaseNode::addChild(&IS85);
...
DISEntityTypeMapping88.setUrl(new std::string[]{"../data/Leif8Final.x3d", "https://coderextreme.net/X3DJSONLD/src/main/data/Leif8Final.x3d"}, 2);
...
DISEntityTypeMapping89.setUrl(new std::string[]{"../data/Lily8Final.x3d", "https://coderextreme.net/X3DJSONLD/src/main/data/Lily8Final.x3d"}, 2);
...
DISEntityTypeMapping90.setUrl(new std::string[]{"../data/Tufani8Final.x3d", "https://coderextreme.net/X3DJSONLD/src/main/data/Tufani8Final.x3d"}, 2);
...
DISEntityTypeMapping91.setUrl(new std::string[]{"../data/Gramps8Final.x3d", "https://coderextreme.net/X3DJSONLD/src/main/data/Gramps8Final.x3d"}, 2);
...
LayoutLayer96.setObjectType(new std::string[]{"ALL"}, 1);
...
Text105.setString(new std::string[]{"r = a + b * cos(c * theta + tdelta) * cos (d * phi + pdelta)"}, 1);
...
Text132.setString(new std::string[]{"a="}, 1);
IS& IS133 =  IS();
...
FontStyle135.setContainerField("fontStyle");
...
Text142.setString(new std::string[]{"0"}, 1);
...
Layout220.setContainerField("layout");
Layout220.setAlign(new std::string[]{"LEFT", "BOTTOM"}, 2);
Layout220.setOffset(new float[]{-0.5,0.0}, 2);
LayoutLayer96.setLayout(Layout220);

Viewport& Viewport221 =  Viewport();
Viewport221.setContainerField("viewport");
