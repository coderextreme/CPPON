...
meta3.setContent(std::string("MainStage.x3d"));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(std::string("description"));
meta4.setContent(std::string("Main stage for HAnim scene Winter and Spring."));
head1.addMeta(&meta4);

meta& meta5 =  meta();
meta5.setName(std::string("creator"));
meta5.setContent(std::string("Joe Williams"));
head1.addMeta(&meta5);

meta& meta6 =  meta();
meta6.setName(std::string("translator"));
meta6.setContent(std::string("Joe Williams and Don Brutzman"));
head1.addMeta(&meta6);

meta& meta7 =  meta();
meta7.setName(std::string("created"));
meta7.setContent(std::string("25 May 2023"));
head1.addMeta(&meta7);

meta& meta8 =  meta();
meta8.setName(std::string("modified"));
meta8.setContent(std::string("27 May 2023"));
head1.addMeta(&meta8);

meta& meta9 =  meta();
meta9.setName(std::string("reference"));
meta9.setContent(std::string("originals/0MainStageScene0525.x3dv"));
head1.addMeta(&meta9);

meta& meta10 =  meta();
meta10.setName(std::string("identifier"));
meta10.setContent(std::string("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/MainStage.x3d"));
head1.addMeta(&meta10);

meta& meta11 =  meta();
meta11.setName(std::string("generator"));
meta11.setContent(std::string("X3D-Edit 4.0, https://savage.nps.edu/X3D-Edit"));
...
WorldInfo14.setTitle(std::string("MainStage.x3d"));
...
Viewpoint19.setDEF(std::string("Scene_StageFrontViewFar"));
Viewpoint19.setDescription(std::string("hanim_Stage Front View"));
...
Viewpoint20.setDEF(std::string("Scene_InclinedView"));
Viewpoint20.setDescription(std::string("hanim_Inclined View"));
...
Viewpoint21.setDEF(std::string("Scene_StageFrontView"));
Viewpoint21.setDescription(std::string("hanim_Stage Front View"));
Viewpoint21.setPosition(new float[]{0.0,1.0,5.0});
Scene13.addChild(&Viewpoint21);

Viewpoint& Viewpoint22 =  Viewpoint();
Viewpoint22.setDEF(std::string("Scene_FeetStageBottomView"));
Viewpoint22.setDescription(std::string("hanim_feet View"));
...
Viewpoint23.setDEF(std::string("Scene_HeadTopView"));
Viewpoint23.setDescription(std::string("hanim_Head Top View"));
...
Viewpoint24.setDEF(std::string("Scene_TopFrontCloseView"));
Viewpoint24.setDescription(std::string("hanim_Head Top View"));
...
Group& Group25 =  Group();
Group25.setDEF(std::string("HAnimStage"));
...
Transform28.setDEF(std::string("StageGeometry"));
...
IndexedLineSet37.setDEF(std::string("Orbit1"));
...
Transform39.setDEF(std::string("Circle1"));
...
IndexedLineSet42.setUSE(std::string("Orbit1"));
...
Transform43.setDEF(std::string("Circle2"));
...
IndexedLineSet46.setUSE(std::string("Orbit1"));
...
Transform47.setDEF(std::string("Circle3"));
...
IndexedLineSet50.setUSE(std::string("Orbit1"));
...
Transform51.setDEF(std::string("Circle4"));
...
IndexedLineSet54.setUSE(std::string("Orbit1"));
