...
MetadataString29.setValue((std::string[]){"2.0"}, 1);
...
MetadataString252.setValue((std::string[]){"2.0"}, 1);
...
CollisionCollection253.setAppliedParameters((std::string[]){"FRICTION_COEFFICIENT_1", "SLIP_COEFFICIENTS"}, 2);
...
EXPORT473.setAS(std::string("JinLOA1"));
