...
#include <string>
#include "X3DLib.h"
//void JinLOA1RigidBody(int argc, char ** argv) {
X3D& X3D0 =  X3D();
X3D0.setProfile(std::string("Immersive"));
X3D0.setVersion(std::string("4.1"));
head& head1 =  head();
component& component2 =  component();
component2.setName(std::string("RigidBodyPhysics"));
component2.setLevel(2);
head1.addChild(&component2);

component& component3 =  component();
component3.setName(std::string("HAnim"));
component3.setLevel(1);
head1.addChild(&component3);

meta& meta4 =  meta();
meta4.setName(std::string("title"));
meta4.setContent(std::string("JinLOA1.x3d"));
head1.addMeta(&meta4);

meta& meta5 =  meta();
meta5.setName(std::string("creator"));
meta5.setContent(std::string("Jin Hoon Lee and Min Joo Lee"));
head1.addMeta(&meta5);

meta& meta6 =  meta();
meta6.setName(std::string("translator"));
meta6.setContent(std::string("Chul Hee Jung and Myeong Won Lee"));
head1.addMeta(&meta6);

meta& meta7 =  meta();
meta7.setName(std::string("contributor"));
meta7.setContent(std::string("Don Brutzman"));
head1.addMeta(&meta7);

meta& meta8 =  meta();
meta8.setName(std::string("created"));
meta8.setContent(std::string("31 March 2011"));
head1.addMeta(&meta8);

meta& meta9 =  meta();
meta9.setName(std::string("translated"));
meta9.setContent(std::string("1 November 2014"));
head1.addMeta(&meta9);

meta& meta10 =  meta();
meta10.setName(std::string("modified"));
meta10.setContent(std::string("16 February 2026"));
head1.addMeta(&meta10);

meta& meta11 =  meta();
meta11.setName(std::string("description"));
meta11.setContent(std::string("Articulated 3D game character designed with a general graphics tool, then converted into an X3D HAnim model."));
head1.addMeta(&meta11);

meta& meta12 =  meta();
meta12.setName(std::string("info"));
meta12.setContent(std::string("This scene includes an EXPORT statement to simplify reuse of a large, complex HAnimHumanoid model by other X3D scenes."));
head1.addMeta(&meta12);

meta& meta13 =  meta();
meta13.setName(std::string("TODO"));
meta13.setContent(std::string("rescale all contained length values from inches to meters"));
head1.addMeta(&meta13);

meta& meta14 =  meta();
meta14.setName(std::string("reference"));
meta14.setContent(std::string("KoreanCharacter00ReadMe.txt"));
head1.addMeta(&meta14);

meta& meta15 =  meta();
meta15.setName(std::string("reference"));
meta15.setContent(std::string("../KoreanCharacterHumanMotion_Infotech2014_140706.pdf"));
head1.addMeta(&meta15);

meta& meta16 =  meta();
meta16.setName(std::string("reference"));
meta16.setContent(std::string("KoreanCharactersIllustrated.pdf"));
head1.addMeta(&meta16);

meta& meta17 =  meta();
meta17.setName(std::string("reference"));
meta17.setContent(std::string("JinOriginalLOA1.x3d"));
head1.addMeta(&meta17);

meta& meta18 =  meta();
meta18.setName(std::string("identifier"));
meta18.setContent(std::string("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinLOA1.x3d"));
head1.addMeta(&meta18);

meta& meta19 =  meta();
meta19.setName(std::string("generator"));
meta19.setContent(std::string("3DS MAX, http://www.autodesk.com/products/atodesk-3ds-max/overview"));
head1.addMeta(&meta19);

meta& meta20 =  meta();
meta20.setName(std::string("generator"));
meta20.setContent(std::string("Suwon HAnim Converter"));
head1.addMeta(&meta20);

meta& meta21 =  meta();
meta21.setName(std::string("generator"));
meta21.setContent(std::string("Gnu Image Manipulation Program, http://www.gimp.org"));
head1.addMeta(&meta21);

meta& meta22 =  meta();
meta22.setName(std::string("generator"));
meta22.setContent(std::string("X3dTidy, https://www.web3d.org/x3d/stylesheets/X3dTidy.html"));
head1.addMeta(&meta22);

meta& meta23 =  meta();
meta23.setName(std::string("generator"));
meta23.setContent(std::string("X3D-Edit 4.0, https://www.web3d.org/x3d/tools/X3D-Edit"));
head1.addMeta(&meta23);

meta& meta24 =  meta();
meta24.setName(std::string("generator"));
meta24.setContent(std::string("X3DJSAIL https://www.web3d.org/specifications/java/X3DJSAIL.html"));
head1.addMeta(&meta24);

meta& meta25 =  meta();
meta25.setName(std::string("license"));
meta25.setContent(std::string("../license.html"));
...
HAnimHumanoid27.X3DNode::setName(std::string("JinLOA1"));
HAnimHumanoid27.setDEF(std::string("hanim_JinLOA1"));
...
MetadataString29.X3DNode::setName(std::string("humanoidVersion"));
MetadataString29.X3DNode::setReference(std::string("validation testing"));
MetadataString29.setValue(new std::string[]{"2.0"}, 1);
...
HAnimJoint30.setCenter(new float[]{0.0,30.53,-0.7076});
HAnimJoint30.setContainerField("skeleton");
HAnimSegment& HAnimSegment31 =  HAnimSegment();
HAnimSegment31.X3DNode::setName(std::string("sacrum"));
HAnimSegment31.setDEF(std::string("hanim_sacrum"));
Transform& Transform32 =  Transform();
Transform32.setTranslation(new float[]{0.0,30.53,-0.7076});
Shape& Shape33 =  Shape();
...
ImageTexture36.setDEF(std::string("JinLOA1TextureAtlas"));
...
HAnimJoint40.X3DNode::setName(std::string("sacroiliac"));
HAnimJoint40.setDEF(std::string("hanim_sacroiliac"));
HAnimJoint40.setCenter(new float[]{0.0,35.8,-0.7076});
HAnimSegment& HAnimSegment41 =  HAnimSegment();
HAnimSegment41.X3DNode::setName(std::string("pelvis"));
HAnimSegment41.setDEF(std::string("hanim_pelvis"));
Transform& Transform42 =  Transform();
Transform42.setTranslation(new float[]{0.0,35.8,-0.7076});
Shape& Shape43 =  Shape();
...
ImageTexture46.setContainerField("texture");
ImageTexture46.setUSE(std::string("JinLOA1TextureAtlas"));
...
Coordinate48.setPoint(new float[]{0.0,1.053,0.0273,0.0,0.9123,-0.5414,-0.4375,0.9123,-0.4652,-0.7578,0.9123,-0.3733,-0.875,0.9123,0.0273,-0.7578,0.9123,0.4279,-0.4375,0.9123,0.5198,0.0,0.9123,0.596,0.4375,0.9123,0.5198,0.7578,0.9123,0.4279,0.875,0.9123,0.0273,0.7578,0.9123,-0.3733,0.4375,0.9123,-0.4652,0.0,0.5267,-0.8842,-0.5658,0.5267,-0.7621,-0.98,0.5267,-0.4285,-1.132,0.5267,0.0273,-0.98,0.5267,0.483,-0.5658,0.5267,0.6985,0.0,0.5267,0.8206,0.5658,0.5267,0.6985,0.98,0.5267,0.483,1.132,0.5267,0.0273,0.98,0.5267,-0.4285,0.5658,0.5267,-0.7621,0.0,0.0,-0.9616,-0.6534,0.0,-0.8206,-1.132,0.0,-0.4353,-1.307,0.0,0.0273,-1.132,0.0,0.5536,-0.6534,0.0,0.8206,0.0,0.0,0.9616,0.6534,0.0,0.8206,1.132,0.0,0.5536,1.307,0.0,0.0273,1.132,0.0,-0.4353,0.6534,0.0,-0.8206,0.0,-0.5267,-0.8206,-0.5658,-0.5267,-0.6985,-0.98,-0.5267,-0.3648,-1.132,-0.5267,0.0273,-0.98,-0.5267,0.483,-0.5658,-0.5267,0.6985,0.0,-0.5267,0.8206,0.5658,-0.5267,0.6985,0.98,-0.5267,0.483,1.132,-0.5267,0.0273,0.98,-0.5267,-0.3648,0.5658,-0.5267,-0.6985,0.0,-0.9123,-0.4353,-0.3267,-0.9123,-0.3648,-0.5658,-0.9123,-0.2358,-0.6534,-0.9123,0.0273,-0.5658,-0.9123,0.2904,-0.3267,-0.9123,0.483,0.0,-0.9123,0.5536,0.3267,-0.9123,0.483,0.5658,-0.9123,0.2904,0.6534,-0.9123,0.0273,0.5658,-0.9123,-0.2358,0.3267,-0.9123,-0.3648,0.0,-1.053,0.0273}, 186);
IndexedFaceSet47.setCoord(&Coordinate48);

TextureCoordinate& TextureCoordinate49 =  TextureCoordinate();
TextureCoordinate49.setContainerField("texCoord");
...
HAnimJoint50.X3DNode::setName(std::string("l_hip"));
HAnimJoint50.setDEF(std::string("hanim_l_hip"));
HAnimJoint50.setCenter(new float[]{4.207,32.02,-0.8155});
HAnimSegment& HAnimSegment51 =  HAnimSegment();
HAnimSegment51.X3DNode::setName(std::string("l_thigh"));
HAnimSegment51.setDEF(std::string("hanim_l_thigh"));
...
ImageTexture56.setContainerField("texture");
ImageTexture56.setUSE(std::string("JinLOA1TextureAtlas"));
...
HAnimJoint60.X3DNode::setName(std::string("l_knee"));
HAnimJoint60.setDEF(std::string("hanim_l_knee"));
HAnimJoint60.setCenter(new float[]{4.116,17.26,-0.8639});
HAnimSegment& HAnimSegment61 =  HAnimSegment();
HAnimSegment61.X3DNode::setName(std::string("l_calf"));
HAnimSegment61.setDEF(std::string("hanim_l_calf"));
...
ImageTexture66.setContainerField("texture");
ImageTexture66.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate69.setContainerField("texCoord");
...
HAnimJoint70.X3DNode::setName(std::string("l_talocrural"));
HAnimJoint70.setDEF(std::string("hanim_l_talocrural"));
HAnimJoint70.setCenter(new float[]{3.854,3.939,-0.7038});
HAnimSegment& HAnimSegment71 =  HAnimSegment();
HAnimSegment71.X3DNode::setName(std::string("l_talus"));
HAnimSegment71.setDEF(std::string("hanim_l_talus"));
...
ImageTexture76.setContainerField("texture");
ImageTexture76.setUSE(std::string("JinLOA1TextureAtlas"));
...
HAnimJoint80.X3DNode::setName(std::string("l_metatarsophalangeal_2"));
HAnimJoint80.setDEF(std::string("hanim_l_metatarsophalangeal_2"));
HAnimJoint80.setCenter(new float[]{3.854,3.64,0.7402});
HAnimSegment& HAnimSegment81 =  HAnimSegment();
HAnimSegment81.X3DNode::setName(std::string("l_tarsal_proximal_phalanx_2"));
HAnimSegment81.setDEF(std::string("hanim_l_tarsal_proximal_phalanx_2"));
Transform& Transform82 =  Transform();
Transform82.setTranslation(new float[]{3.854,3.64,0.7402});
Shape& Shape83 =  Shape();
Appearance& Appearance84 =  Appearance();
Appearance84.setContainerField("appearance");
Material& Material85 =  Material();
Material85.setContainerField("material");
...
ImageTexture86.setContainerField("texture");
ImageTexture86.setUSE(std::string("JinLOA1TextureAtlas"));
...
HAnimJoint90.X3DNode::setName(std::string("r_hip"));
HAnimJoint90.setDEF(std::string("hanim_r_hip"));
HAnimJoint90.setCenter(new float[]{-4.207,32.02,-0.8155});
HAnimSegment& HAnimSegment91 =  HAnimSegment();
HAnimSegment91.X3DNode::setName(std::string("r_thigh"));
HAnimSegment91.setDEF(std::string("hanim_r_thigh"));
Transform& Transform92 =  Transform();
Transform92.setTranslation(new float[]{-4.207,32.02,-0.8155});
Shape& Shape93 =  Shape();
Appearance& Appearance94 =  Appearance();
Appearance94.setContainerField("appearance");
Material& Material95 =  Material();
Material95.setContainerField("material");
...
ImageTexture96.setContainerField("texture");
ImageTexture96.setUSE(std::string("JinLOA1TextureAtlas"));
...
Coordinate98.setPoint(new float[]{-2.96,3.738,0.0,-1.643,3.738,3.209,1.316,3.738,4.002,3.367,3.738,1.781,3.367,3.738,-1.781,1.316,3.738,-4.002,-1.643,3.738,-3.209,-2.96,-0.0114,0.0,-1.643,-0.0114,3.209,1.316,-0.0114,4.002,3.367,-0.0114,1.781,3.367,-0.0114,-1.781,1.316,-0.0114,-4.002,-1.643,-0.0114,-3.209,-2.96,-6.507,0.0,-1.643,-6.507,3.209,1.316,-6.507,4.002,3.367,-6.507,1.781,3.367,-6.507,-1.781,1.316,-6.507,-4.002,-1.643,-6.507,-3.209,-3.367,-13.13,0.0,-1.897,-13.13,3.582,1.407,-13.13,4.467,3.355,-13.13,1.988,3.355,-13.13,-1.988,1.407,-13.13,-4.467,-1.897,-13.13,-3.582,-2.146,-4.985,0.0,-1.136,-4.985,2.462,1.135,-4.985,3.07,2.633,-4.985,1.366,2.633,-4.985,-1.366,1.135,-4.985,-3.07,-1.136,-4.985,-2.462,-2.156,-11.45,0.0,-1.225,-11.45,1.956,0.8662,-11.45,2.439,2.543,-11.45,1.085,2.543,-11.45,-1.085,0.8662,-11.45,-2.439,-1.225,-11.45,-1.956,-2.051,5.729,0.0,-1.076,5.729,2.375,1.114,5.729,2.961,2.87,5.729,1.318,2.87,5.729,-1.318,1.114,5.729,-2.961,-1.076,5.729,-2.375,-1.842,-15.12,0.0,-1.03,-15.12,1.873,0.7965,-15.12,2.295,2.261,-15.12,1.113,2.261,-15.12,-0.9478,0.7965,-15.12,-2.13,-1.03,-15.12,-1.708,-0.6277,-16.1,0.0,-0.2723,-16.1,0.912,0.5262,-16.1,1.096,1.167,-16.1,0.5796,1.167,-16.1,-0.4145,0.5262,-16.1,-0.9313,-0.2723,-16.1,-0.7469}, 189);
IndexedFaceSet97.setCoord(&Coordinate98);

TextureCoordinate& TextureCoordinate99 =  TextureCoordinate();
TextureCoordinate99.setContainerField("texCoord");
...
HAnimJoint100.X3DNode::setName(std::string("r_knee"));
HAnimJoint100.setDEF(std::string("hanim_r_knee"));
HAnimJoint100.setCenter(new float[]{-4.116,17.26,-0.8639});
HAnimSegment& HAnimSegment101 =  HAnimSegment();
HAnimSegment101.X3DNode::setName(std::string("r_calf"));
HAnimSegment101.setDEF(std::string("hanim_r_calf"));
...
Appearance104.setContainerField("appearance");
Material& Material105 =  Material();
Material105.setContainerField("material");
...
ImageTexture106.setContainerField("texture");
ImageTexture106.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate109.setContainerField("texCoord");
...
HAnimJoint110.X3DNode::setName(std::string("r_talocrural"));
HAnimJoint110.setDEF(std::string("hanim_r_talocrural"));
HAnimJoint110.setCenter(new float[]{-3.854,3.939,-0.7038});
HAnimSegment& HAnimSegment111 =  HAnimSegment();
HAnimSegment111.X3DNode::setName(std::string("r_talus"));
HAnimSegment111.setDEF(std::string("hanim_r_talus"));
...
ImageTexture116.setContainerField("texture");
ImageTexture116.setUSE(std::string("JinLOA1TextureAtlas"));
...
Coordinate118.setPoint(new float[]{-0.9768,-0.0192,-1.681,-1.657,-0.0192,0.4309,0.0,-0.0192,-1.681,-1.403,0.7316,0.354,-0.8174,0.7316,-1.463,0.0,0.7316,-1.463,0.0,0.7316,1.471,1.657,-0.0192,0.4309,1.403,0.7316,0.354,0.8174,0.7316,-1.463,0.9768,-0.0192,-1.681,0.0,-0.0192,1.75,-1.109,-0.6007,-2.046,-2.045,-0.6007,0.4309,-1.695,-0.296,1.429,0.0,-0.6007,-2.046,1.109,-0.6007,-2.046,2.045,-0.6007,0.4309,1.695,-0.296,1.429,0.0,-1.207,-1.841,-1.023,-1.207,-1.841,-1.913,-1.223,0.5161,-1.601,-0.9325,1.406,0.0,-0.6582,1.708,1.601,-0.9325,1.406,1.913,-1.223,0.5161,1.023,-1.207,-1.841,-1.409,-1.925,-2.878,-1.409,-3.947,-1.681,0.0,-3.947,-1.681,-1.109,-0.6007,-2.046,0.0,-0.6007,-2.046,1.409,-1.925,-2.878,0.0,-1.925,-2.878,1.109,-0.6007,-2.046,1.409,-3.947,-1.681,-2.927,-1.925,0.4309,-2.089,-3.947,0.4309,-2.045,-0.6007,0.4309,2.927,-1.925,0.4309,2.045,-0.6007,0.4309,2.089,-3.947,0.4309,0.0,-3.947,0.4309,-0.9442,-0.3153,-1.692,0.0,-0.3153,-1.692,0.9442,-0.3153,-1.692,1.7,-0.3153,0.3093,-1.7,-0.3153,0.3093,-1.86,-3.793,1.364,-2.541,-1.963,1.364,-1.861,-0.9431,1.364,1.861,-0.9431,1.364,2.541,-1.963,1.364,1.86,-3.793,1.364,0.0,-3.793,1.364}, 165);
IndexedFaceSet117.setCoord(&Coordinate118);

TextureCoordinate& TextureCoordinate119 =  TextureCoordinate();
TextureCoordinate119.setContainerField("texCoord");
...
HAnimJoint120.X3DNode::setName(std::string("r_metatarsophalangeal_2"));
HAnimJoint120.setDEF(std::string("hanim_r_metatarsophalangeal_2"));
HAnimJoint120.setCenter(new float[]{-3.854,3.64,0.7402});
HAnimSegment& HAnimSegment121 =  HAnimSegment();
HAnimSegment121.X3DNode::setName(std::string("r_tarsal_proximal_phalanx_2"));
HAnimSegment121.setDEF(std::string("hanim_r_tarsal_proximal_phalanx_2"));
...
ImageTexture126.setUSE(std::string("JinLOA1TextureAtlas"));
...
Coordinate128.setPoint(new float[]{-2.927,-1.627,-1.013,-2.089,-3.648,-1.013,0.0,0.2797,0.3064,-2.045,-0.3017,-1.013,-1.695,0.0029,-0.0151,2.927,-1.627,-1.013,2.045,-0.3017,-1.013,2.089,-3.648,-1.013,1.695,0.0029,-0.0151,0.0,-3.648,-1.013,-1.74,-0.3226,1.158,-2.661,-1.866,0.9192,-2.14,-3.648,0.9192,1.74,-0.3226,1.158,2.661,-1.866,0.9192,2.14,-3.648,0.9192,0.0,-3.648,0.9192,0.0,-0.0274,1.661,-2.405,-1.656,-1.915,-1.75,-2.942,-1.915,0.0,-2.942,-1.915,1.75,-2.942,-1.915,2.405,-1.656,-1.915,1.742,-0.5681,-1.915,-1.742,-0.5681,-1.915,-1.784,-0.648,2.332,-2.216,-2.267,4.144,-2.216,-3.648,3.776,0.0,-2.267,5.463,0.0,-0.5463,3.95,-1.74,-0.3226,1.158,-2.661,-1.866,0.9192,-2.14,-3.648,0.9192,2.216,-2.267,4.144,1.784,-0.648,2.332,0.0,-3.648,5.096,2.216,-3.648,3.776,1.74,-0.3226,1.158,2.661,-1.866,0.9192,2.14,-3.648,0.9192,0.0,-3.648,3.776,0.0,-3.648,0.9192,0.0,-0.0274,1.661}, 129);
...
HAnimJoint130.X3DNode::setName(std::string("vl5"));
HAnimJoint130.setDEF(std::string("hanim_vl5"));
HAnimJoint130.setCenter(new float[]{0.0,40.07,-0.8527});
HAnimSegment& HAnimSegment131 =  HAnimSegment();
HAnimSegment131.X3DNode::setName(std::string("l5"));
HAnimSegment131.setDEF(std::string("hanim_l5"));
Transform& Transform132 =  Transform();
Transform132.setTranslation(new float[]{0.0,40.07,-0.8527});
...
ImageTexture136.setContainerField("texture");
ImageTexture136.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate139.setContainerField("texCoord");
...
HAnimJoint140.X3DNode::setName(std::string("skullbase"));
HAnimJoint140.setDEF(std::string("hanim_skullbase"));
HAnimJoint140.setCenter(new float[]{0.0,57.43,-0.6863});
HAnimSegment& HAnimSegment141 =  HAnimSegment();
HAnimSegment141.X3DNode::setName(std::string("skull"));
HAnimSegment141.setDEF(std::string("hanim_skull"));
Transform& Transform142 =  Transform();
Transform142.setTranslation(new float[]{0.0,57.43,-0.6863});
...
ImageTexture146.setUSE(std::string("JinLOA1TextureAtlas"));
...
HAnimJoint150.X3DNode::setName(std::string("l_shoulder"));
HAnimJoint150.setDEF(std::string("hanim_l_shoulder"));
HAnimJoint150.setCenter(new float[]{5.975,52.0,-0.1452});
HAnimSegment& HAnimSegment151 =  HAnimSegment();
HAnimSegment151.X3DNode::setName(std::string("l_upperarm"));
HAnimSegment151.setDEF(std::string("hanim_l_upperarm"));
Transform& Transform152 =  Transform();
Transform152.setTranslation(new float[]{5.975,52.0,-0.1452});
...
Material155.setContainerField("material");
...
ImageTexture156.setContainerField("texture");
ImageTexture156.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate159.setContainerField("texCoord");
...
HAnimJoint160.X3DNode::setName(std::string("l_elbow"));
HAnimJoint160.setDEF(std::string("hanim_l_elbow"));
HAnimJoint160.setCenter(new float[]{8.093,40.38,-0.2502});
HAnimSegment& HAnimSegment161 =  HAnimSegment();
HAnimSegment161.X3DNode::setName(std::string("l_forearm"));
HAnimSegment161.setDEF(std::string("hanim_l_forearm"));
...
ImageTexture166.setContainerField("texture");
ImageTexture166.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate169.setContainerField("texCoord");
...
HAnimJoint170.X3DNode::setName(std::string("l_radiocarpal"));
HAnimJoint170.setDEF(std::string("hanim_l_radiocarpal"));
HAnimJoint170.setCenter(new float[]{7.808,31.46,-0.0585});
HAnimSegment& HAnimSegment171 =  HAnimSegment();
HAnimSegment171.X3DNode::setName(std::string("l_carpal"));
HAnimSegment171.setDEF(std::string("hanim_l_carpal"));
...
Appearance174.setContainerField("appearance");
Material& Material175 =  Material();
Material175.setContainerField("material");
...
ImageTexture176.setContainerField("texture");
ImageTexture176.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate179.setContainerField("texCoord");
...
HAnimJoint180.X3DNode::setName(std::string("r_shoulder"));
HAnimJoint180.setDEF(std::string("hanim_r_shoulder"));
HAnimJoint180.setCenter(new float[]{-5.975,52.0,-0.1452});
HAnimSegment& HAnimSegment181 =  HAnimSegment();
HAnimSegment181.X3DNode::setName(std::string("r_upperarm"));
HAnimSegment181.setDEF(std::string("hanim_r_upperarm"));
Transform& Transform182 =  Transform();
Transform182.setTranslation(new float[]{-5.975,52.0,-0.1452});
...
Material185.setContainerField("material");
...
ImageTexture186.setContainerField("texture");
ImageTexture186.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate189.setContainerField("texCoord");
...
HAnimJoint190.X3DNode::setName(std::string("r_elbow"));
HAnimJoint190.setDEF(std::string("hanim_r_elbow"));
HAnimJoint190.setCenter(new float[]{-8.093,40.38,-0.2502});
HAnimSegment& HAnimSegment191 =  HAnimSegment();
HAnimSegment191.X3DNode::setName(std::string("r_forearm"));
HAnimSegment191.setDEF(std::string("hanim_r_forearm"));
...
ImageTexture196.setContainerField("texture");
ImageTexture196.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate199.setContainerField("texCoord");
...
HAnimJoint200.X3DNode::setName(std::string("r_radiocarpal"));
HAnimJoint200.setDEF(std::string("hanim_r_radiocarpal"));
HAnimJoint200.setCenter(new float[]{-7.808,31.46,-0.0585});
HAnimSegment& HAnimSegment201 =  HAnimSegment();
HAnimSegment201.X3DNode::setName(std::string("r_carpal"));
HAnimSegment201.setDEF(std::string("hanim_r_carpal"));
...
ImageTexture206.setContainerField("texture");
ImageTexture206.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate209.setContainerField("texCoord");
...
HAnimSegment239.setUSE(std::string("hanim_r_talus"));
HAnimHumanoid27.setSegments(&HAnimSegment239);

HAnimSegment& HAnimSegment240 =  HAnimSegment();
HAnimSegment240.setContainerField("segments");
HAnimSegment240.setUSE(std::string("hanim_l_tarsal_proximal_phalanx_2"));
HAnimHumanoid27.setSegments(&HAnimSegment240);

HAnimSegment& HAnimSegment241 =  HAnimSegment();
HAnimSegment241.setContainerField("segments");
HAnimSegment241.setUSE(std::string("hanim_r_tarsal_proximal_phalanx_2"));
HAnimHumanoid27.setSegments(&HAnimSegment241);

HAnimSegment& HAnimSegment242 =  HAnimSegment();
HAnimSegment242.setContainerField("segments");
HAnimSegment242.setUSE(std::string("hanim_l_thigh"));
...
Viewpoint249.setCenterOfRotation(new float[]{0.0,1.0,0.0});
Viewpoint249.setDescription(std::string("JinLOA1"));
Viewpoint249.setPosition(new float[]{0.0,1.0,3.0});
Scene26.addChild(&Viewpoint249);

RigidBodyCollection& RigidBodyCollection250 =  RigidBodyCollection();
RigidBodyCollection250.setDEF(std::string("hanim_JinLOA1_rbc"));
RigidBodyCollection250.setIterations(3);
MetadataSet& MetadataSet251 =  MetadataSet();
MetadataSet251.setContainerField("metadata");
MetadataSet251.X3DNode::setName(std::string("HAnimHumanoid.info"));
MetadataSet251.X3DNode::setReference(std::string("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid"));
MetadataString& MetadataString252 =  MetadataString();
MetadataString252.X3DNode::setName(std::string("humanoidVersion"));
MetadataString252.X3DNode::setReference(std::string("validation testing"));
MetadataString252.setValue(new std::string[]{"2.0"}, 1);
MetadataString252.setContainerField("value");
...
CollisionCollection253.setContainerField("collider");
CollisionCollection253.setAppliedParameters(new std::string[]{"FRICTION_COEFFICIENT_2", "SLIP_1"}, 2);
RigidBodyCollection250.setCollider(CollisionCollection253);

RigidBody& RigidBody254 =  RigidBody();
RigidBody254.setDEF(std::string("sphere_rb"));
RigidBody254.setMass(0);
CollidableShape& CollidableShape255 =  CollidableShape();
CollidableShape255.setDEF(std::string("sphere_cs"));
Shape& Shape256 =  Shape();
Shape256.setContainerField("shape");
Shape256.setDEF(std::string("box"));
...
RigidBody260.setDEF(std::string("hanim_r_radiocarpal_rb"));
...
CollidableShape261.setDEF(std::string("hanim_r_carpal_cs"));
Shape& Shape262 =  Shape();
Shape262.setContainerField("shape");
...
ImageTexture265.setContainerField("texture");
ImageTexture265.setUSE(std::string("JinLOA1TextureAtlas"));
...
RigidBody269.setDEF(std::string("hanim_r_elbow_rb"));
...
CollidableShape270.setDEF(std::string("hanim_r_forearm_cs"));
Shape& Shape271 =  Shape();
Shape271.setContainerField("shape");
...
ImageTexture274.setContainerField("texture");
ImageTexture274.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate277.setContainerField("texCoord");
...
RigidBody278.setDEF(std::string("hanim_l_radiocarpal_rb"));
...
CollidableShape279.setDEF(std::string("hanim_l_carpal_cs"));
Shape& Shape280 =  Shape();
Shape280.setContainerField("shape");
...
ImageTexture283.setContainerField("texture");
ImageTexture283.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate286.setContainerField("texCoord");
...
RigidBody287.setDEF(std::string("hanim_l_elbow_rb"));
...
ImageTexture292.setContainerField("texture");
ImageTexture292.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate295.setContainerField("texCoord");
...
RigidBody296.setDEF(std::string("hanim_r_shoulder_rb"));
RigidBody296.setPosition(new float[]{-5.975,52.0,-0.1452});
RigidBody296.setMass(0.5);
CollidableShape& CollidableShape297 =  CollidableShape();
CollidableShape297.setDEF(std::string("hanim_r_upperarm_cs"));
Shape& Shape298 =  Shape();
Shape298.setContainerField("shape");
...
ImageTexture301.setUSE(std::string("JinLOA1TextureAtlas"));
...
RigidBody305.setDEF(std::string("hanim_l_shoulder_rb"));
RigidBody305.setPosition(new float[]{5.975,52.0,-0.1452});
RigidBody305.setMass(0.5);
CollidableShape& CollidableShape306 =  CollidableShape();
CollidableShape306.setDEF(std::string("hanim_l_upperarm_cs"));
Shape& Shape307 =  Shape();
Shape307.setContainerField("shape");
...
ImageTexture310.setContainerField("texture");
ImageTexture310.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate313.setContainerField("texCoord");
...
RigidBody314.setDEF(std::string("hanim_skullbase_rb"));
RigidBody314.setPosition(new float[]{0.0,57.43,-0.6863});
RigidBody314.setMass(0.5);
CollidableShape& CollidableShape315 =  CollidableShape();
CollidableShape315.setDEF(std::string("hanim_skull_cs"));
Shape& Shape316 =  Shape();
Shape316.setContainerField("shape");
Appearance& Appearance317 =  Appearance();
Appearance317.setContainerField("appearance");
Material& Material318 =  Material();
Material318.setContainerField("material");
...
ImageTexture319.setContainerField("texture");
ImageTexture319.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate322.setContainerField("texCoord");
...
RigidBody323.setDEF(std::string("hanim_r_metatarsophalangeal_2_rb"));
...
CollidableShape324.setDEF(std::string("hanim_r_tarsal_proximal_phalanx_2_cs"));
Shape& Shape325 =  Shape();
Shape325.setContainerField("shape");
Appearance& Appearance326 =  Appearance();
Appearance326.setContainerField("appearance");
Material& Material327 =  Material();
Material327.setContainerField("material");
...
ImageTexture328.setContainerField("texture");
ImageTexture328.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate331.setContainerField("texCoord");
...
RigidBody332.setDEF(std::string("hanim_r_talocrural_rb"));
...
ImageTexture337.setContainerField("texture");
ImageTexture337.setUSE(std::string("JinLOA1TextureAtlas"));
...
Coordinate339.setPoint(new float[]{-0.9768,-0.0192,-1.681,-1.657,-0.0192,0.4309,0.0,-0.0192,-1.681,-1.403,0.7316,0.354,-0.8174,0.7316,-1.463,0.0,0.7316,-1.463,0.0,0.7316,1.471,1.657,-0.0192,0.4309,1.403,0.7316,0.354,0.8174,0.7316,-1.463,0.9768,-0.0192,-1.681,0.0,-0.0192,1.75,-1.109,-0.6007,-2.046,-2.045,-0.6007,0.4309,-1.695,-0.296,1.429,0.0,-0.6007,-2.046,1.109,-0.6007,-2.046,2.045,-0.6007,0.4309,1.695,-0.296,1.429,0.0,-1.207,-1.841,-1.023,-1.207,-1.841,-1.913,-1.223,0.5161,-1.601,-0.9325,1.406,0.0,-0.6582,1.708,1.601,-0.9325,1.406,1.913,-1.223,0.5161,1.023,-1.207,-1.841,-1.409,-1.925,-2.878,-1.409,-3.947,-1.681,0.0,-3.947,-1.681,-1.109,-0.6007,-2.046,0.0,-0.6007,-2.046,1.409,-1.925,-2.878,0.0,-1.925,-2.878,1.109,-0.6007,-2.046,1.409,-3.947,-1.681,-2.927,-1.925,0.4309,-2.089,-3.947,0.4309,-2.045,-0.6007,0.4309,2.927,-1.925,0.4309,2.045,-0.6007,0.4309,2.089,-3.947,0.4309,0.0,-3.947,0.4309,-0.9442,-0.3153,-1.692,0.0,-0.3153,-1.692,0.9442,-0.3153,-1.692,1.7,-0.3153,0.3093,-1.7,-0.3153,0.3093,-1.86,-3.793,1.364,-2.541,-1.963,1.364,-1.861,-0.9431,1.364,1.861,-0.9431,1.364,2.541,-1.963,1.364,1.86,-3.793,1.364,0.0,-3.793,1.364}, 165);
IndexedFaceSet338.setCoord(&Coordinate339);

TextureCoordinate& TextureCoordinate340 =  TextureCoordinate();
TextureCoordinate340.setContainerField("texCoord");
...
RigidBody341.setDEF(std::string("hanim_r_knee_rb"));
...
CollidableShape342.setDEF(std::string("hanim_r_calf_cs"));
Shape& Shape343 =  Shape();
Shape343.setContainerField("shape");
Appearance& Appearance344 =  Appearance();
Appearance344.setContainerField("appearance");
Material& Material345 =  Material();
Material345.setContainerField("material");
...
ImageTexture346.setContainerField("texture");
ImageTexture346.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate349.setContainerField("texCoord");
...
RigidBody350.setDEF(std::string("hanim_l_metatarsophalangeal_2_rb"));
...
CollidableShape351.setDEF(std::string("hanim_l_tarsal_proximal_phalanx_2_cs"));
Shape& Shape352 =  Shape();
Shape352.setContainerField("shape");
...
ImageTexture355.setContainerField("texture");
ImageTexture355.setUSE(std::string("JinLOA1TextureAtlas"));
...
Coordinate357.setPoint(new float[]{2.927,-1.627,-1.013,2.089,-3.648,-1.013,0.0,0.2797,0.3064,2.045,-0.3017,-1.013,1.695,0.0029,-0.0151,-2.927,-1.627,-1.013,-2.045,-0.3017,-1.013,-2.089,-3.648,-1.013,-1.695,0.0029,-0.0151,0.0,-3.648,-1.013,1.74,-0.3226,1.158,2.661,-1.866,0.9192,2.14,-3.648,0.9192,-1.74,-0.3226,1.158,-2.661,-1.866,0.9192,-2.14,-3.648,0.9192,0.0,-3.648,0.9192,0.0,-0.0274,1.661,2.405,-1.656,-1.915,1.75,-2.942,-1.915,0.0,-2.942,-1.915,-1.75,-2.942,-1.915,-2.405,-1.656,-1.915,-1.742,-0.5681,-1.915,1.742,-0.5681,-1.915,1.784,-0.648,2.332,2.216,-2.267,4.144,2.216,-3.648,3.776,0.0,-2.267,5.463,0.0,-0.5463,3.95,1.74,-0.3226,1.158,2.661,-1.866,0.9192,2.14,-3.648,0.9192,-2.216,-2.267,4.144,-1.784,-0.648,2.332,0.0,-3.648,5.096,-2.216,-3.648,3.776,-1.74,-0.3226,1.158,-2.661,-1.866,0.9192,-2.14,-3.648,0.9192,0.0,-3.648,3.776,0.0,-3.648,0.9192,0.0,-0.0274,1.661}, 129);
IndexedFaceSet356.setCoord(&Coordinate357);

TextureCoordinate& TextureCoordinate358 =  TextureCoordinate();
TextureCoordinate358.setContainerField("texCoord");
...
RigidBody359.setDEF(std::string("hanim_l_talocrural_rb"));
...
CollidableShape360.setDEF(std::string("hanim_l_talus_cs"));
Shape& Shape361 =  Shape();
Shape361.setContainerField("shape");
...
ImageTexture364.setContainerField("texture");
ImageTexture364.setUSE(std::string("JinLOA1TextureAtlas"));
...
Coordinate366.setPoint(new float[]{0.9768,-0.0192,-1.681,1.657,-0.0192,0.4309,0.0,-0.0192,-1.681,1.403,0.7316,0.354,0.8174,0.7316,-1.463,0.0,0.7316,-1.463,0.0,0.7316,1.471,-1.657,-0.0192,0.4309,-1.403,0.7316,0.354,-0.8174,0.7316,-1.463,-0.9768,-0.0192,-1.681,0.0,-0.0192,1.75,1.109,-0.6007,-2.046,2.045,-0.6007,0.4309,1.695,-0.296,1.429,0.0,-0.6007,-2.046,-1.109,-0.6007,-2.046,-2.045,-0.6007,0.4309,-1.695,-0.296,1.429,0.0,-1.207,-1.841,1.023,-1.207,-1.841,1.913,-1.223,0.5161,1.601,-0.9325,1.406,0.0,-0.6582,1.708,-1.601,-0.9325,1.406,-1.913,-1.223,0.5161,-1.023,-1.207,-1.841,1.409,-1.925,-2.878,1.409,-3.947,-1.681,0.0,-3.947,-1.681,1.109,-0.6007,-2.046,0.0,-0.6007,-2.046,-1.409,-1.925,-2.878,0.0,-1.925,-2.878,-1.109,-0.6007,-2.046,-1.409,-3.947,-1.681,2.927,-1.925,0.4309,2.089,-3.947,0.4309,2.045,-0.6007,0.4309,-2.927,-1.925,0.4309,-2.045,-0.6007,0.4309,-2.089,-3.947,0.4309,0.0,-3.947,0.4309,0.9442,-0.3153,-1.692,0.0,-0.3153,-1.692,-0.9442,-0.3153,-1.692,-1.7,-0.3153,0.3093,1.7,-0.3153,0.3093,1.86,-3.793,1.364,2.541,-1.963,1.364,1.861,-0.9431,1.364,-1.861,-0.9431,1.364,-2.541,-1.963,1.364,-1.86,-3.793,1.364,0.0,-3.793,1.364}, 165);
IndexedFaceSet365.setCoord(&Coordinate366);

TextureCoordinate& TextureCoordinate367 =  TextureCoordinate();
TextureCoordinate367.setContainerField("texCoord");
...
RigidBody368.setDEF(std::string("hanim_l_knee_rb"));
...
CollidableShape369.setDEF(std::string("hanim_l_calf_cs"));
Shape& Shape370 =  Shape();
Shape370.setContainerField("shape");
...
ImageTexture373.setContainerField("texture");
ImageTexture373.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate376.setContainerField("texCoord");
...
RigidBody377.setDEF(std::string("hanim_r_hip_rb"));
...
CollidableShape378.setDEF(std::string("hanim_r_thigh_cs"));
Shape& Shape379 =  Shape();
Shape379.setContainerField("shape");
Appearance& Appearance380 =  Appearance();
Appearance380.setContainerField("appearance");
Material& Material381 =  Material();
Material381.setContainerField("material");
...
ImageTexture382.setContainerField("texture");
ImageTexture382.setUSE(std::string("JinLOA1TextureAtlas"));
...
RigidBody386.setDEF(std::string("hanim_l_hip_rb"));
...
CollidableShape387.setDEF(std::string("hanim_l_thigh_cs"));
Shape& Shape388 =  Shape();
Shape388.setContainerField("shape");
...
ImageTexture391.setUSE(std::string("JinLOA1TextureAtlas"));
...
Coordinate393.setPoint(new float[]{2.96,3.738,0.0,1.643,3.738,3.209,-1.316,3.738,4.002,-3.367,3.738,1.781,-3.367,3.738,-1.781,-1.316,3.738,-4.002,1.643,3.738,-3.209,2.96,-0.0114,0.0,1.643,-0.0114,3.209,-1.316,-0.0114,4.002,-3.367,-0.0114,1.781,-3.367,-0.0114,-1.781,-1.316,-0.0114,-4.002,1.643,-0.0114,-3.209,2.96,-6.507,0.0,1.643,-6.507,3.209,-1.316,-6.507,4.002,-3.367,-6.507,1.781,-3.367,-6.507,-1.781,-1.316,-6.507,-4.002,1.643,-6.507,-3.209,3.367,-13.13,0.0,1.897,-13.13,3.582,-1.407,-13.13,4.467,-3.355,-13.13,1.988,-3.355,-13.13,-1.988,-1.407,-13.13,-4.467,1.897,-13.13,-3.582,2.146,-4.985,0.0,1.136,-4.985,2.462,-1.135,-4.985,3.07,-2.633,-4.985,1.366,-2.633,-4.985,-1.366,-1.135,-4.985,-3.07,1.136,-4.985,-2.462,2.156,-11.45,0.0,1.225,-11.45,1.956,-0.8662,-11.45,2.439,-2.543,-11.45,1.085,-2.543,-11.45,-1.085,-0.8662,-11.45,-2.439,1.225,-11.45,-1.956,2.051,5.729,0.0,1.076,5.729,2.375,-1.114,5.729,2.961,-2.87,5.729,1.318,-2.87,5.729,-1.318,-1.114,5.729,-2.961,1.076,5.729,-2.375,1.842,-15.12,0.0,1.03,-15.12,1.873,-0.7965,-15.12,2.295,-2.261,-15.12,1.113,-2.261,-15.12,-0.9478,-0.7965,-15.12,-2.13,1.03,-15.12,-1.708,0.6277,-16.1,0.0,0.2723,-16.1,0.912,-0.5262,-16.1,1.096,-1.167,-16.1,0.5796,-1.167,-16.1,-0.4145,-0.5262,-16.1,-0.9313,0.2723,-16.1,-0.7469}, 189);
...
RigidBody395.setDEF(std::string("hanim_vl5_rb"));
RigidBody395.setPosition(new float[]{0.0,40.07,-0.8527});
RigidBody395.setMass(0.5);
CollidableShape& CollidableShape396 =  CollidableShape();
CollidableShape396.setDEF(std::string("hanim_l5_cs"));
Shape& Shape397 =  Shape();
Shape397.setContainerField("shape");
...
ImageTexture400.setContainerField("texture");
ImageTexture400.setUSE(std::string("JinLOA1TextureAtlas"));
...
Coordinate402.setPoint(new float[]{0.6928,14.72,-1.263,0.0,14.77,-1.355,1.47,14.93,-0.9099,2.016,14.91,0.2814,1.573,14.61,1.11,2.914,14.46,0.3331,2.599,15.36,-1.406,3.187,13.6,1.543,2.239,13.38,3.23,0.9629,15.39,-3.152,0.0,15.36,-3.317,2.035,15.41,-2.815,3.316,12.32,2.97,5.086,13.13,2.011,2.982,14.24,2.181,2.245,13.38,3.821,3.131,12.64,3.9,4.42,13.94,2.105,5.602,13.73,0.1863,5.472,13.06,-1.452,3.439,15.3,0.3672,3.953,14.44,-2.227,5.073,14.77,0.3672,4.655,13.49,-1.78,1.811,9.837,-2.43,0.0,9.533,-2.564,4.241,10.8,-2.043,1.032,12.54,-4.427,0.0,12.54,-4.562,2.39,12.92,-3.914,1.677,9.192,-3.147,0.0,8.87,-3.266,4.12,10.71,-3.032,4.272,8.132,4.186,6.354,8.764,1.543,2.14,8.582,-2.362,4.3,8.685,-1.848,3.695,5.585,2.768,5.081,5.622,1.505,6.096,10.26,1.67,5.904,10.25,-0.3303,5.533,8.718,-0.7796,1.419,5.473,-2.22,3.58,5.528,-1.434,4.793,5.578,-0.2489,3.682,3.592,2.824,5.077,3.631,1.527,1.282,3.303,-2.365,3.586,3.501,-1.437,4.792,3.575,-0.2999,4.178,1.262,3.951,5.76,1.298,1.994,1.52,1.105,-3.678,3.95,1.115,-2.536,5.309,1.22,-0.7397,3.789,0.1874,3.209,5.166,0.2191,1.685,1.593,0.068,-2.676,3.6,0.0905,-1.847,4.841,0.1375,-0.4441,7.399,13.46,0.1863,6.979,12.64,-1.452,6.998,12.7,1.899,6.298,10.42,1.67,6.292,10.41,-0.3303,0.0,14.34,1.73,0.7806,14.35,1.608,0.0,12.15,3.901,1.373,12.69,3.668,0.0,11.05,3.845,1.713,11.8,3.668,1.38,12.69,4.137,0.0,11.45,4.361,1.593,12.12,4.338,1.579,8.737,4.081,1.292,5.554,3.228,1.281,3.386,3.336,1.635,1.231,4.562,1.595,0.1486,3.645,0.0,12.21,4.06,-0.6928,14.72,-1.263,-1.47,14.93,-0.9099,-2.016,14.91,0.2814,-1.573,14.61,1.11,-2.914,14.46,0.3331,-2.599,15.36,-1.406,-3.187,13.6,1.543,-2.239,13.38,3.23,-0.9629,15.39,-3.152,-2.035,15.41,-2.815,-3.316,12.32,2.97,-5.086,13.13,2.011,-2.982,14.24,2.181,-2.245,13.38,3.821,-3.131,12.64,3.9,-4.42,13.94,2.105,-5.602,13.73,0.1863,-5.472,13.06,-1.452,-3.439,15.3,0.3672,-3.953,14.44,-2.227,-5.073,14.77,0.3672,-4.655,13.49,-1.78,-1.811,9.837,-2.43,-4.241,10.8,-2.043,-1.032,12.54,-4.427,-2.39,12.92,-3.914,-1.677,9.192,-3.147,-4.12,10.71,-3.032,-4.272,8.132,4.186,-6.354,8.764,1.543,-2.14,8.582,-2.362,-4.3,8.685,-1.848,-3.695,5.585,2.768,-5.081,5.622,1.505,-6.096,10.26,1.67,-5.904,10.25,-0.3303,-5.533,8.718,-0.7796,-1.419,5.473,-2.22,-3.58,5.528,-1.434,-4.793,5.578,-0.2489,-3.682,3.592,2.824,-5.077,3.631,1.527,-1.282,3.303,-2.365,-3.586,3.501,-1.437,-4.792,3.575,-0.2999,-4.178,1.262,3.951,-5.76,1.298,1.994,-1.52,1.105,-3.678,-3.95,1.115,-2.536,-5.309,1.22,-0.7397,-3.789,0.1874,3.209,-5.166,0.2191,1.685,-1.593,0.068,-2.676,-3.6,0.0905,-1.847,-4.841,0.1375,-0.4441,-7.399,13.46,0.1863,-6.979,12.64,-1.452,-6.998,12.7,1.899,-6.298,10.42,1.67,-6.292,10.41,-0.3303,-0.7806,14.35,1.608,-1.373,12.69,3.668,-1.713,11.8,3.668,-1.38,12.69,4.137,-1.593,12.12,4.338,-1.579,8.737,4.081,-1.292,5.554,3.228,-1.281,3.386,3.336,-1.635,1.231,4.562,-1.595,0.1486,3.645,0.5369,17.77,-0.941,0.0,17.77,-1.012,1.139,17.77,-0.6672,1.562,17.77,0.2561,1.219,17.77,0.8985,0.5424,14.72,-0.9523,0.0,14.77,-1.024,1.151,14.93,-0.6757,1.578,14.91,0.257,1.232,14.61,0.9059,0.605,17.9,1.285,0.0,17.34,1.379,0.0,14.34,1.391,0.6111,14.35,1.296,-0.5369,17.77,-0.941,-1.139,17.77,-0.6672,-1.562,17.77,0.2561,-1.219,17.77,0.8985,-0.5424,14.72,-0.9523,-1.151,14.93,-0.6757,-1.578,14.91,0.257,-1.232,14.61,0.9059,-0.605,17.9,1.285,-0.6111,14.35,1.296}, 522);
IndexedFaceSet401.setCoord(&Coordinate402);

TextureCoordinate& TextureCoordinate403 =  TextureCoordinate();
TextureCoordinate403.setContainerField("texCoord");
...
RigidBody404.setDEF(std::string("hanim_sacroiliac_rb"));
RigidBody404.setPosition(new float[]{0.0,35.8,-0.7076});
RigidBody404.setMass(0.5);
CollidableShape& CollidableShape405 =  CollidableShape();
CollidableShape405.setDEF(std::string("hanim_pelvis_cs"));
Shape& Shape406 =  Shape();
Shape406.setContainerField("shape");
Appearance& Appearance407 =  Appearance();
Appearance407.setContainerField("appearance");
Material& Material408 =  Material();
Material408.setContainerField("material");
...
ImageTexture409.setContainerField("texture");
ImageTexture409.setUSE(std::string("JinLOA1TextureAtlas"));
...
Coordinate411.setPoint(new float[]{0.0,1.053,0.0273,0.0,0.9123,-0.5414,-0.4375,0.9123,-0.4652,-0.7578,0.9123,-0.3733,-0.875,0.9123,0.0273,-0.7578,0.9123,0.4279,-0.4375,0.9123,0.5198,0.0,0.9123,0.596,0.4375,0.9123,0.5198,0.7578,0.9123,0.4279,0.875,0.9123,0.0273,0.7578,0.9123,-0.3733,0.4375,0.9123,-0.4652,0.0,0.5267,-0.8842,-0.5658,0.5267,-0.7621,-0.98,0.5267,-0.4285,-1.132,0.5267,0.0273,-0.98,0.5267,0.483,-0.5658,0.5267,0.6985,0.0,0.5267,0.8206,0.5658,0.5267,0.6985,0.98,0.5267,0.483,1.132,0.5267,0.0273,0.98,0.5267,-0.4285,0.5658,0.5267,-0.7621,0.0,0.0,-0.9616,-0.6534,0.0,-0.8206,-1.132,0.0,-0.4353,-1.307,0.0,0.0273,-1.132,0.0,0.5536,-0.6534,0.0,0.8206,0.0,0.0,0.9616,0.6534,0.0,0.8206,1.132,0.0,0.5536,1.307,0.0,0.0273,1.132,0.0,-0.4353,0.6534,0.0,-0.8206,0.0,-0.5267,-0.8206,-0.5658,-0.5267,-0.6985,-0.98,-0.5267,-0.3648,-1.132,-0.5267,0.0273,-0.98,-0.5267,0.483,-0.5658,-0.5267,0.6985,0.0,-0.5267,0.8206,0.5658,-0.5267,0.6985,0.98,-0.5267,0.483,1.132,-0.5267,0.0273,0.98,-0.5267,-0.3648,0.5658,-0.5267,-0.6985,0.0,-0.9123,-0.4353,-0.3267,-0.9123,-0.3648,-0.5658,-0.9123,-0.2358,-0.6534,-0.9123,0.0273,-0.5658,-0.9123,0.2904,-0.3267,-0.9123,0.483,0.0,-0.9123,0.5536,0.3267,-0.9123,0.483,0.5658,-0.9123,0.2904,0.6534,-0.9123,0.0273,0.5658,-0.9123,-0.2358,0.3267,-0.9123,-0.3648,0.0,-1.053,0.0273}, 186);
IndexedFaceSet410.setCoord(&Coordinate411);

TextureCoordinate& TextureCoordinate412 =  TextureCoordinate();
TextureCoordinate412.setContainerField("texCoord");
...
RigidBody413.setDEF(std::string("hanim_humanoid_root_rb"));
RigidBody413.setPosition(new float[]{0.0,30.53,-0.7076});
RigidBody413.setMass(0.5);
CollidableShape& CollidableShape414 =  CollidableShape();
CollidableShape414.setDEF(std::string("hanim_sacrum_cs"));
Shape& Shape415 =  Shape();
Shape415.setContainerField("shape");
Appearance& Appearance416 =  Appearance();
Appearance416.setContainerField("appearance");
Material& Material417 =  Material();
Material417.setContainerField("material");
...
ImageTexture418.setContainerField("texture");
ImageTexture418.setUSE(std::string("JinLOA1TextureAtlas"));
...
TextureCoordinate421.setContainerField("texCoord");
...
SingleAxisHingeJoint422.setAnchorPoint(new float[]{0.0,35.8,-0.7076});
SingleAxisHingeJoint422.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint422.setMinAngle(1.5708);
SingleAxisHingeJoint422.setMaxAngle(1.5708);
RigidBody& RigidBody423 =  RigidBody();
RigidBody423.setContainerField("body1");
RigidBody423.setUSE(std::string("hanim_humanoid_root_rb"));
SingleAxisHingeJoint422.setBody1(RigidBody423);

RigidBody& RigidBody424 =  RigidBody();
RigidBody424.setContainerField("body2");
RigidBody424.setUSE(std::string("hanim_sacroiliac_rb"));
...
SingleAxisHingeJoint425.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint425.setMinAngle(1.5708);
SingleAxisHingeJoint425.setMaxAngle(1.5708);
RigidBody& RigidBody426 =  RigidBody();
RigidBody426.setContainerField("body1");
RigidBody426.setUSE(std::string("hanim_sacroiliac_rb"));
SingleAxisHingeJoint425.setBody1(RigidBody426);

RigidBody& RigidBody427 =  RigidBody();
RigidBody427.setContainerField("body2");
RigidBody427.setUSE(std::string("hanim_l_hip_rb"));
...
SingleAxisHingeJoint428.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint428.setMinAngle(1.5708);
SingleAxisHingeJoint428.setMaxAngle(1.5708);
RigidBody& RigidBody429 =  RigidBody();
RigidBody429.setContainerField("body1");
RigidBody429.setUSE(std::string("hanim_l_hip_rb"));
SingleAxisHingeJoint428.setBody1(RigidBody429);

RigidBody& RigidBody430 =  RigidBody();
RigidBody430.setContainerField("body2");
RigidBody430.setUSE(std::string("hanim_l_knee_rb"));
...
SingleAxisHingeJoint431.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint431.setMinAngle(1.5708);
SingleAxisHingeJoint431.setMaxAngle(1.5708);
RigidBody& RigidBody432 =  RigidBody();
RigidBody432.setContainerField("body1");
RigidBody432.setUSE(std::string("hanim_l_knee_rb"));
SingleAxisHingeJoint431.setBody1(RigidBody432);

RigidBody& RigidBody433 =  RigidBody();
RigidBody433.setContainerField("body2");
RigidBody433.setUSE(std::string("hanim_l_talocrural_rb"));
...
SingleAxisHingeJoint434.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint434.setMinAngle(1.5708);
SingleAxisHingeJoint434.setMaxAngle(1.5708);
RigidBody& RigidBody435 =  RigidBody();
RigidBody435.setContainerField("body1");
RigidBody435.setUSE(std::string("hanim_l_talocrural_rb"));
SingleAxisHingeJoint434.setBody1(RigidBody435);

RigidBody& RigidBody436 =  RigidBody();
RigidBody436.setContainerField("body2");
RigidBody436.setUSE(std::string("hanim_l_metatarsophalangeal_2_rb"));
...
SingleAxisHingeJoint437.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint437.setMinAngle(1.5708);
SingleAxisHingeJoint437.setMaxAngle(1.5708);
RigidBody& RigidBody438 =  RigidBody();
RigidBody438.setContainerField("body1");
RigidBody438.setUSE(std::string("hanim_sacroiliac_rb"));
SingleAxisHingeJoint437.setBody1(RigidBody438);

RigidBody& RigidBody439 =  RigidBody();
RigidBody439.setContainerField("body2");
RigidBody439.setUSE(std::string("hanim_r_hip_rb"));
...
SingleAxisHingeJoint440.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint440.setMinAngle(1.5708);
SingleAxisHingeJoint440.setMaxAngle(1.5708);
RigidBody& RigidBody441 =  RigidBody();
RigidBody441.setContainerField("body1");
RigidBody441.setUSE(std::string("hanim_r_hip_rb"));
SingleAxisHingeJoint440.setBody1(RigidBody441);

RigidBody& RigidBody442 =  RigidBody();
RigidBody442.setContainerField("body2");
RigidBody442.setUSE(std::string("hanim_r_knee_rb"));
...
SingleAxisHingeJoint443.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint443.setMinAngle(1.5708);
SingleAxisHingeJoint443.setMaxAngle(1.5708);
RigidBody& RigidBody444 =  RigidBody();
RigidBody444.setContainerField("body1");
RigidBody444.setUSE(std::string("hanim_r_knee_rb"));
SingleAxisHingeJoint443.setBody1(RigidBody444);

RigidBody& RigidBody445 =  RigidBody();
RigidBody445.setContainerField("body2");
RigidBody445.setUSE(std::string("hanim_r_talocrural_rb"));
...
SingleAxisHingeJoint446.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint446.setMinAngle(1.5708);
SingleAxisHingeJoint446.setMaxAngle(1.5708);
RigidBody& RigidBody447 =  RigidBody();
RigidBody447.setContainerField("body1");
RigidBody447.setUSE(std::string("hanim_r_talocrural_rb"));
SingleAxisHingeJoint446.setBody1(RigidBody447);

RigidBody& RigidBody448 =  RigidBody();
RigidBody448.setContainerField("body2");
RigidBody448.setUSE(std::string("hanim_r_metatarsophalangeal_2_rb"));
...
SingleAxisHingeJoint449.setAnchorPoint(new float[]{0.0,40.07,-0.8527});
SingleAxisHingeJoint449.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint449.setMinAngle(1.5708);
SingleAxisHingeJoint449.setMaxAngle(1.5708);
RigidBody& RigidBody450 =  RigidBody();
RigidBody450.setContainerField("body1");
RigidBody450.setUSE(std::string("hanim_humanoid_root_rb"));
SingleAxisHingeJoint449.setBody1(RigidBody450);

RigidBody& RigidBody451 =  RigidBody();
RigidBody451.setContainerField("body2");
RigidBody451.setUSE(std::string("hanim_vl5_rb"));
...
SingleAxisHingeJoint452.setAnchorPoint(new float[]{0.0,57.43,-0.6863});
SingleAxisHingeJoint452.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint452.setMinAngle(1.5708);
SingleAxisHingeJoint452.setMaxAngle(1.5708);
RigidBody& RigidBody453 =  RigidBody();
RigidBody453.setContainerField("body1");
RigidBody453.setUSE(std::string("hanim_vl5_rb"));
SingleAxisHingeJoint452.setBody1(RigidBody453);

RigidBody& RigidBody454 =  RigidBody();
RigidBody454.setContainerField("body2");
RigidBody454.setUSE(std::string("hanim_skullbase_rb"));
...
SingleAxisHingeJoint455.setAnchorPoint(new float[]{5.975,52.0,-0.1452});
SingleAxisHingeJoint455.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint455.setMinAngle(1.5708);
SingleAxisHingeJoint455.setMaxAngle(1.5708);
RigidBody& RigidBody456 =  RigidBody();
RigidBody456.setContainerField("body1");
RigidBody456.setUSE(std::string("hanim_skullbase_rb"));
SingleAxisHingeJoint455.setBody1(RigidBody456);

RigidBody& RigidBody457 =  RigidBody();
RigidBody457.setContainerField("body2");
RigidBody457.setUSE(std::string("hanim_l_shoulder_rb"));
...
SingleAxisHingeJoint458.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint458.setMinAngle(1.5708);
SingleAxisHingeJoint458.setMaxAngle(1.5708);
RigidBody& RigidBody459 =  RigidBody();
RigidBody459.setContainerField("body1");
RigidBody459.setUSE(std::string("hanim_l_shoulder_rb"));
SingleAxisHingeJoint458.setBody1(RigidBody459);

RigidBody& RigidBody460 =  RigidBody();
RigidBody460.setContainerField("body2");
RigidBody460.setUSE(std::string("hanim_l_elbow_rb"));
...
SingleAxisHingeJoint461.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint461.setMinAngle(1.5708);
SingleAxisHingeJoint461.setMaxAngle(1.5708);
RigidBody& RigidBody462 =  RigidBody();
RigidBody462.setContainerField("body1");
RigidBody462.setUSE(std::string("hanim_l_elbow_rb"));
SingleAxisHingeJoint461.setBody1(RigidBody462);

RigidBody& RigidBody463 =  RigidBody();
RigidBody463.setContainerField("body2");
RigidBody463.setUSE(std::string("hanim_l_radiocarpal_rb"));
...
SingleAxisHingeJoint464.setAnchorPoint(new float[]{-5.975,52.0,-0.1452});
SingleAxisHingeJoint464.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint464.setMinAngle(1.5708);
SingleAxisHingeJoint464.setMaxAngle(1.5708);
RigidBody& RigidBody465 =  RigidBody();
RigidBody465.setContainerField("body1");
RigidBody465.setUSE(std::string("hanim_skullbase_rb"));
SingleAxisHingeJoint464.setBody1(RigidBody465);

RigidBody& RigidBody466 =  RigidBody();
RigidBody466.setContainerField("body2");
RigidBody466.setUSE(std::string("hanim_r_shoulder_rb"));
...
SingleAxisHingeJoint467.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint467.setMinAngle(1.5708);
SingleAxisHingeJoint467.setMaxAngle(1.5708);
RigidBody& RigidBody468 =  RigidBody();
RigidBody468.setContainerField("body1");
RigidBody468.setUSE(std::string("hanim_r_shoulder_rb"));
SingleAxisHingeJoint467.setBody1(RigidBody468);

RigidBody& RigidBody469 =  RigidBody();
RigidBody469.setContainerField("body2");
RigidBody469.setUSE(std::string("hanim_r_elbow_rb"));
...
SingleAxisHingeJoint470.setAxis(new float[]{0.0,0.0,1.0});
SingleAxisHingeJoint470.setMinAngle(1.5708);
SingleAxisHingeJoint470.setMaxAngle(1.5708);
RigidBody& RigidBody471 =  RigidBody();
RigidBody471.setContainerField("body1");
RigidBody471.setUSE(std::string("hanim_r_elbow_rb"));
SingleAxisHingeJoint470.setBody1(RigidBody471);

RigidBody& RigidBody472 =  RigidBody();
RigidBody472.setContainerField("body2");
RigidBody472.setUSE(std::string("hanim_r_radiocarpal_rb"));
...
EXPORT473.setAS(new std::string("JinLOA1"));
EXPORT473.setLocalDEF(std::string("hanim_JinLOA1"));
Scene26.addChild(&EXPORT473);

Transform& Transform474 =  Transform();
Transform474.setTranslation(new float[]{0.0,-3.0,0.0});
Shape& Shape475 =  Shape();
Shape475.setUSE(std::string("box"));
Transform474.addChild(&Shape475);

Scene26.addChild(&Transform474);

ROUTE& ROUTE476 =  ROUTE();
ROUTE476.setFromNode(std::string("hanim_humanoid_root_rb"));
ROUTE476.setToNode(std::string("hanim_humanoid_root"));
ROUTE476.setFromField(std::string("orientation"));
ROUTE476.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE476);

ROUTE& ROUTE477 =  ROUTE();
ROUTE477.setFromNode(std::string("hanim_sacroiliac_rb"));
ROUTE477.setToNode(std::string("hanim_sacroiliac"));
ROUTE477.setFromField(std::string("orientation"));
ROUTE477.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE477);

ROUTE& ROUTE478 =  ROUTE();
ROUTE478.setFromNode(std::string("hanim_l_hip_rb"));
ROUTE478.setToNode(std::string("hanim_l_hip"));
ROUTE478.setFromField(std::string("orientation"));
ROUTE478.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE478);

ROUTE& ROUTE479 =  ROUTE();
ROUTE479.setFromNode(std::string("hanim_l_knee_rb"));
ROUTE479.setToNode(std::string("hanim_l_knee"));
ROUTE479.setFromField(std::string("orientation"));
ROUTE479.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE479);

ROUTE& ROUTE480 =  ROUTE();
ROUTE480.setFromNode(std::string("hanim_l_talocrural_rb"));
ROUTE480.setToNode(std::string("hanim_l_talocrural"));
ROUTE480.setFromField(std::string("orientation"));
ROUTE480.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE480);

ROUTE& ROUTE481 =  ROUTE();
ROUTE481.setFromNode(std::string("hanim_l_metatarsophalangeal_2_rb"));
ROUTE481.setToNode(std::string("hanim_l_metatarsophalangeal_2"));
ROUTE481.setFromField(std::string("orientation"));
ROUTE481.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE481);

ROUTE& ROUTE482 =  ROUTE();
ROUTE482.setFromNode(std::string("hanim_r_hip_rb"));
ROUTE482.setToNode(std::string("hanim_r_hip"));
ROUTE482.setFromField(std::string("orientation"));
ROUTE482.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE482);

ROUTE& ROUTE483 =  ROUTE();
ROUTE483.setFromNode(std::string("hanim_r_knee_rb"));
ROUTE483.setToNode(std::string("hanim_r_knee"));
ROUTE483.setFromField(std::string("orientation"));
ROUTE483.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE483);

ROUTE& ROUTE484 =  ROUTE();
ROUTE484.setFromNode(std::string("hanim_r_talocrural_rb"));
ROUTE484.setToNode(std::string("hanim_r_talocrural"));
ROUTE484.setFromField(std::string("orientation"));
ROUTE484.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE484);

ROUTE& ROUTE485 =  ROUTE();
ROUTE485.setFromNode(std::string("hanim_r_metatarsophalangeal_2_rb"));
ROUTE485.setToNode(std::string("hanim_r_metatarsophalangeal_2"));
ROUTE485.setFromField(std::string("orientation"));
ROUTE485.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE485);

ROUTE& ROUTE486 =  ROUTE();
ROUTE486.setFromNode(std::string("hanim_vl5_rb"));
ROUTE486.setToNode(std::string("hanim_vl5"));
ROUTE486.setFromField(std::string("orientation"));
ROUTE486.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE486);

ROUTE& ROUTE487 =  ROUTE();
ROUTE487.setFromNode(std::string("hanim_skullbase_rb"));
ROUTE487.setToNode(std::string("hanim_skullbase"));
ROUTE487.setFromField(std::string("orientation"));
ROUTE487.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE487);

ROUTE& ROUTE488 =  ROUTE();
ROUTE488.setFromNode(std::string("hanim_l_shoulder_rb"));
ROUTE488.setToNode(std::string("hanim_l_shoulder"));
ROUTE488.setFromField(std::string("orientation"));
ROUTE488.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE488);

ROUTE& ROUTE489 =  ROUTE();
ROUTE489.setFromNode(std::string("hanim_l_elbow_rb"));
ROUTE489.setToNode(std::string("hanim_l_elbow"));
ROUTE489.setFromField(std::string("orientation"));
ROUTE489.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE489);

ROUTE& ROUTE490 =  ROUTE();
ROUTE490.setFromNode(std::string("hanim_l_radiocarpal_rb"));
ROUTE490.setToNode(std::string("hanim_l_radiocarpal"));
ROUTE490.setFromField(std::string("orientation"));
ROUTE490.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE490);

ROUTE& ROUTE491 =  ROUTE();
ROUTE491.setFromNode(std::string("hanim_r_shoulder_rb"));
ROUTE491.setToNode(std::string("hanim_r_shoulder"));
ROUTE491.setFromField(std::string("orientation"));
ROUTE491.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE491);

ROUTE& ROUTE492 =  ROUTE();
ROUTE492.setFromNode(std::string("hanim_r_elbow_rb"));
ROUTE492.setToNode(std::string("hanim_r_elbow"));
ROUTE492.setFromField(std::string("orientation"));
ROUTE492.setToField(std::string("rotation"));
Scene26.addChild(&ROUTE492);

ROUTE& ROUTE493 =  ROUTE();
ROUTE493.setFromNode(std::string("hanim_r_radiocarpal_rb"));
ROUTE493.setToNode(std::string("hanim_r_radiocarpal"));
ROUTE493.setFromField(std::string("orientation"));
ROUTE493.setToField(std::string("rotation"));
