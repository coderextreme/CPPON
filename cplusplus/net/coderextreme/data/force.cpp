...
ProtoInstance64.setDEF(CString("nodeC"));
...
ProtoInstance66.setDEF(CString("nodeD"));
fieldValue& fieldValue67 =  fieldValue();
fieldValue67.setName(CString("position"));
fieldValue67.setValue(CString("50 50 -50"));
...
ProtoInstance68.setDEF(CString("linkA"));
...
ProtoInstance70.setDEF(CString("linkC"));
Transform58.addChild(&ProtoInstance70);

Scene10.addChild(&Transform58);

Script& Script71 =  Script();
Script71.setDEF(CString("clickHandler"));
field& field72 =  field();
field72.setName(CString("counter"));
field72.setAccessType(CString("inputOutput"));
field72.setValue(CString("0"));
...
Script71.setSourceCode(CString("ecmascript:")+
