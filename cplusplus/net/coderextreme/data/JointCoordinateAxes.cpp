...
head& head1 =  head();
meta& meta2 =  meta();
meta2.setName(std::string("converter"));
meta2.setContent(std::string("x3d-tidy V1.0.56, https://www.npmjs.com/package/x3d-tidy"));
head1.addMeta(&meta2);

meta& meta3 =  meta();
meta3.setName(std::string("converted"));
meta3.setContent(std::string("Mon, 31 Jul 2023 03:48:04 GMT"));
head1.addMeta(&meta3);
...
Shape& Shape17 =  Shape();
Shape17.setUSE(std::string("ARROW_POINTER"));
...
Group& Group26 =  Group();
Group& Group27 =  Group();
Group27.setUSE(std::string("ARROW"));
...
Group& Group35 =  Group();
Group& Group36 =  Group();
Group36.setUSE(std::string("ARROW"));
