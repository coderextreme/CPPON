...
#include <string>
#include "X3DLib.h"
void flower3(int argc, char ** argv) {
X3D& X3D0 =  X3D();
...
meta2.setContent(std::string("flower3.x3d"));
head1.addMeta(&meta2);
...
meta5.setContent(std::string("https://coderextreme.net/X3DJSONLD/src/main/data/flower3.x3d"));
head1.addMeta(&meta5);
...
Transform12.setDEF(std::string("OrbitTransform"));
