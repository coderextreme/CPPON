...
public class CPPONGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "WS_AND_NL", "COMMENT", "CPPDIR", "NEW", "TRUE", "FALSE", "STATIC_CAST", 
			"DYNAMIC_CAST", "SET", "X3DNODESET", "ADD", "IDENTIFIER", "REFERENCE", 
			"POINTER", "EQUALS", "SEMI", "COMMA", "DOT", "LT", "GT", "WHOLE", "SENTINEL", 
			"FLOAT", "OPENBRACE", "CLOSEBRACE", "OPENBRACKET", "CLOSEBRACKET", "OPENPAREN", 
			"CLOSEPAREN", "STRING"
		};
	}
