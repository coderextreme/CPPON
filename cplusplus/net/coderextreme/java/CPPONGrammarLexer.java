...
public class CPPONGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "WS_AND_NL", "COMMENT", "CPPDIR", "IDENTIFIER", "REFERENCE", 
			"POINTER", "EQUALS", "SEMI", "COMMA", "DOT", "SET", "X3DNODESET", "ADD", 
			"WHOLE", "SENTINEL", "FLOAT", "TRUE", "FALSE", "OPENBRACE", "CLOSEBRACE", 
			"OPENBRACKET", "CLOSEBRACKET", "OPENPAREN", "CLOSEPAREN", "STRING"
		};
	}
