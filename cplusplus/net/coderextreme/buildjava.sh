...
do
	echo $i
	java -Djdk.xml.entityExpansionLimit=120000 -Djdk.xml.totalEntitySizeLimit=50000000 -Djdk.xml.maxGeneralEntitySizeLimit=50000000 -Xss1g -Xmx8g -cp "C:/Users/jcarl/Downloads/antlr-4.13.2-complete.jar;." CPPONGrammarDOMVisitor "$i"
	if [ $? -eq 1 ]
	then
		exit
	fi
